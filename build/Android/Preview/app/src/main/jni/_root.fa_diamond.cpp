// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_diamond.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_diamond.h>
...
// public partial sealed class fa_diamond :2
// {
// static fa_diamond() :4
static void fa_diamond__cctor_4_fn(uType* __type)
{
}

static void fa_diamond_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\231");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_diamond__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_diamond_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_diamond);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_diamond", options);
    type->fp_build_ = fa_diamond_build;
    type->fp_ctor_ = (void*)fa_diamond__New4_fn;
    type->fp_cctor_ = fa_diamond__cctor_4_fn;
...
// public fa_diamond() :8
void fa_diamond__ctor_8_fn(fa_diamond* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_diamond__InitializeUX1_fn(fa_diamond* __this)
{
    __this->InitializeUX1();
}

// public fa_diamond New() :8
void fa_diamond__New4_fn(fa_diamond** __retval)
{
    *__retval = fa_diamond::New4();
}

// public fa_diamond() [instance] :8
void fa_diamond::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_diamond::InitializeUX1()
{
    uStackFrame __("fa_diamond", "InitializeUX()");
    Value(::STRINGS[0/*"\uF219"*/]);
    SourceLineNumber(191);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_diamond New() [static] :8
fa_diamond* fa_diamond::New4()
{
    fa_diamond* obj1 = (fa_diamond*)uNew(fa_diamond_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
