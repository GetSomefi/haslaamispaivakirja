// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cut.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cut.h>
...
// public partial sealed class fa_cut :2
// {
// static fa_cut() :4
static void fa_cut__cctor_4_fn(uType* __type)
{
}

static void fa_cut_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cut__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cut_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cut);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cut", options);
    type->fp_build_ = fa_cut_build;
    type->fp_ctor_ = (void*)fa_cut__New4_fn;
    type->fp_cctor_ = fa_cut__cctor_4_fn;
...
// public fa_cut() :8
void fa_cut__ctor_8_fn(fa_cut* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cut__InitializeUX1_fn(fa_cut* __this)
{
    __this->InitializeUX1();
}

// public fa_cut New() :8
void fa_cut__New4_fn(fa_cut** __retval)
{
    *__retval = fa_cut::New4();
}

// public fa_cut() [instance] :8
void fa_cut::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cut::InitializeUX1()
{
    uStackFrame __("fa_cut", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C4"*/]);
    SourceLineNumber(182);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cut New() [static] :8
fa_cut* fa_cut::New4()
{
    fa_cut* obj1 = (fa_cut*)uNew(fa_cut_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
