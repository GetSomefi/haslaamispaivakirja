// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paragraph.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paragraph.h>
...
// public partial sealed class fa_paragraph :2
// {
// static fa_paragraph() :4
static void fa_paragraph__cctor_4_fn(uType* __type)
{
}

static void fa_paragraph_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\235");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paragraph__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paragraph_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paragraph);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paragraph", options);
    type->fp_build_ = fa_paragraph_build;
    type->fp_ctor_ = (void*)fa_paragraph__New4_fn;
    type->fp_cctor_ = fa_paragraph__cctor_4_fn;
...
// public fa_paragraph() :8
void fa_paragraph__ctor_8_fn(fa_paragraph* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paragraph__InitializeUX1_fn(fa_paragraph* __this)
{
    __this->InitializeUX1();
}

// public fa_paragraph New() :8
void fa_paragraph__New4_fn(fa_paragraph** __retval)
{
    *__retval = fa_paragraph::New4();
}

// public fa_paragraph() [instance] :8
void fa_paragraph::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paragraph::InitializeUX1()
{
    uStackFrame __("fa_paragraph", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1DD"*/]);
    SourceLineNumber(443);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paragraph New() [static] :8
fa_paragraph* fa_paragraph::New4()
{
    fa_paragraph* obj1 = (fa_paragraph*)uNew(fa_paragraph_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
