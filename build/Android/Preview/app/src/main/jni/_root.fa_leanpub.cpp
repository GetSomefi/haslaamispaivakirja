// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_leanpub.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_leanpub.h>
...
// public partial sealed class fa_leanpub :2
// {
// static fa_leanpub() :4
static void fa_leanpub__cctor_4_fn(uType* __type)
{
}

static void fa_leanpub_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_leanpub__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_leanpub_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_leanpub);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_leanpub", options);
    type->fp_build_ = fa_leanpub_build;
    type->fp_ctor_ = (void*)fa_leanpub__New4_fn;
    type->fp_cctor_ = fa_leanpub__cctor_4_fn;
...
// public fa_leanpub() :8
void fa_leanpub__ctor_8_fn(fa_leanpub* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_leanpub__InitializeUX1_fn(fa_leanpub* __this)
{
    __this->InitializeUX1();
}

// public fa_leanpub New() :8
void fa_leanpub__New4_fn(fa_leanpub** __retval)
{
    *__retval = fa_leanpub::New4();
}

// public fa_leanpub() [instance] :8
void fa_leanpub::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_leanpub::InitializeUX1()
{
    uStackFrame __("fa_leanpub", "InitializeUX()");
    Value(::STRINGS[0/*"\uF212"*/]);
    SourceLineNumber(363);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_leanpub New() [static] :8
fa_leanpub* fa_leanpub::New4()
{
    fa_leanpub* obj1 = (fa_leanpub*)uNew(fa_leanpub_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
