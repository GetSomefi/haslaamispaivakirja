// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_magnet.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_magnet.h>
...
// public partial sealed class fa_magnet :2
// {
// static fa_magnet() :4
static void fa_magnet__cctor_4_fn(uType* __type)
{
}

static void fa_magnet_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\266");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_magnet__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_magnet_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_magnet);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_magnet", options);
    type->fp_build_ = fa_magnet_build;
    type->fp_ctor_ = (void*)fa_magnet__New4_fn;
    type->fp_cctor_ = fa_magnet__cctor_4_fn;
...
// public fa_magnet() :8
void fa_magnet__ctor_8_fn(fa_magnet* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_magnet__InitializeUX1_fn(fa_magnet* __this)
{
    __this->InitializeUX1();
}

// public fa_magnet New() :8
void fa_magnet__New4_fn(fa_magnet** __retval)
{
    *__retval = fa_magnet::New4();
}

// public fa_magnet() [instance] :8
void fa_magnet::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_magnet::InitializeUX1()
{
    uStackFrame __("fa_magnet", "InitializeUX()");
    Value(::STRINGS[0/*"\uF076"*/]);
    SourceLineNumber(389);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_magnet New() [static] :8
fa_magnet* fa_magnet::New4()
{
    fa_magnet* obj1 = (fa_magnet*)uNew(fa_magnet_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
