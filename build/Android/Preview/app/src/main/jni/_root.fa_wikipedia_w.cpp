// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wikipedia_w.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wikipedia_w.h>
...
// public partial sealed class fa_wikipedia_w :2
// {
// static fa_wikipedia_w() :4
static void fa_wikipedia_w__cctor_4_fn(uType* __type)
{
}

static void fa_wikipedia_w_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wikipedia_w__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wikipedia_w_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wikipedia_w);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wikipedia_w", options);
    type->fp_build_ = fa_wikipedia_w_build;
    type->fp_ctor_ = (void*)fa_wikipedia_w__New4_fn;
    type->fp_cctor_ = fa_wikipedia_w__cctor_4_fn;
...
// public fa_wikipedia_w() :8
void fa_wikipedia_w__ctor_8_fn(fa_wikipedia_w* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wikipedia_w__InitializeUX1_fn(fa_wikipedia_w* __this)
{
    __this->InitializeUX1();
}

// public fa_wikipedia_w New() :8
void fa_wikipedia_w__New4_fn(fa_wikipedia_w** __retval)
{
    *__retval = fa_wikipedia_w::New4();
}

// public fa_wikipedia_w() [instance] :8
void fa_wikipedia_w::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_wikipedia_w::InitializeUX1()
{
    uStackFrame __("fa_wikipedia_w", "InitializeUX()");
    Value(::STRINGS[0/*"\uF266"*/]);
    SourceLineNumber(679);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wikipedia_w New() [static] :8
fa_wikipedia_w* fa_wikipedia_w::New4()
{
    fa_wikipedia_w* obj1 = (fa_wikipedia_w*)uNew(fa_wikipedia_w_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
