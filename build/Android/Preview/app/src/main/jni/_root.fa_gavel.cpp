// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gavel.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gavel.h>
...
// public partial sealed class fa_gavel :2
// {
// static fa_gavel() :4
static void fa_gavel__cctor_4_fn(uType* __type)
{
}

static void fa_gavel_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gavel__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gavel_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gavel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gavel", options);
    type->fp_build_ = fa_gavel_build;
    type->fp_ctor_ = (void*)fa_gavel__New4_fn;
    type->fp_cctor_ = fa_gavel__cctor_4_fn;
...
// public fa_gavel() :8
void fa_gavel__ctor_8_fn(fa_gavel* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gavel__InitializeUX1_fn(fa_gavel* __this)
{
    __this->InitializeUX1();
}

// public fa_gavel New() :8
void fa_gavel__New4_fn(fa_gavel** __retval)
{
    *__retval = fa_gavel::New4();
}

// public fa_gavel() [instance] :8
void fa_gavel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_gavel::InitializeUX1()
{
    uStackFrame __("fa_gavel", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E3"*/]);
    SourceLineNumber(276);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gavel New() [static] :8
fa_gavel* fa_gavel::New4()
{
    fa_gavel* obj1 = (fa_gavel*)uNew(fa_gavel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
