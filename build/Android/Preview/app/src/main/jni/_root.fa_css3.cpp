// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_css3.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_css3.h>
...
// public partial sealed class fa_css3 :2
// {
// static fa_css3() :4
static void fa_css3__cctor_4_fn(uType* __type)
{
}

static void fa_css3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_css3__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_css3_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_css3);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_css3", options);
    type->fp_build_ = fa_css3_build;
    type->fp_ctor_ = (void*)fa_css3__New4_fn;
    type->fp_cctor_ = fa_css3__cctor_4_fn;
...
// public fa_css3() :8
void fa_css3__ctor_8_fn(fa_css3* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_css3__InitializeUX1_fn(fa_css3* __this)
{
    __this->InitializeUX1();
}

// public fa_css3 New() :8
void fa_css3__New4_fn(fa_css3** __retval)
{
    *__retval = fa_css3::New4();
}

// public fa_css3() [instance] :8
void fa_css3::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_css3::InitializeUX1()
{
    uStackFrame __("fa_css3", "InitializeUX()");
    Value(::STRINGS[0/*"\uF13C"*/]);
    SourceLineNumber(179);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_css3 New() [static] :8
fa_css3* fa_css3::New4()
{
    fa_css3* obj1 = (fa_css3*)uNew(fa_css3_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
