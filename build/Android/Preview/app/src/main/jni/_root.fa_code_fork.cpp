// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_code_fork.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_code_fork.h>
...
// public partial sealed class fa_code_fork :2
// {
// static fa_code_fork() :4
static void fa_code_fork__cctor_4_fn(uType* __type)
{
}

static void fa_code_fork_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_code_fork__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_code_fork_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_code_fork);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_code_fork", options);
    type->fp_build_ = fa_code_fork_build;
    type->fp_ctor_ = (void*)fa_code_fork__New4_fn;
    type->fp_cctor_ = fa_code_fork__cctor_4_fn;
...
// public fa_code_fork() :8
void fa_code_fork__ctor_8_fn(fa_code_fork* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_code_fork__InitializeUX1_fn(fa_code_fork* __this)
{
    __this->InitializeUX1();
}

// public fa_code_fork New() :8
void fa_code_fork__New4_fn(fa_code_fork** __retval)
{
    *__retval = fa_code_fork::New4();
}

// public fa_code_fork() [instance] :8
void fa_code_fork::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_code_fork::InitializeUX1()
{
    uStackFrame __("fa_code_fork", "InitializeUX()");
    Value(::STRINGS[0/*"\uF126"*/]);
...
// public fa_code_fork New() [static] :8
fa_code_fork* fa_code_fork::New4()
{
    fa_code_fork* obj1 = (fa_code_fork*)uNew(fa_code_fork_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
