// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_desktop.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_desktop.h>
...
// public partial sealed class fa_desktop :2
// {
// static fa_desktop() :4
static void fa_desktop__cctor_4_fn(uType* __type)
{
}

static void fa_desktop_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_desktop__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_desktop_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_desktop);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_desktop", options);
    type->fp_build_ = fa_desktop_build;
    type->fp_ctor_ = (void*)fa_desktop__New4_fn;
    type->fp_cctor_ = fa_desktop__cctor_4_fn;
...
// public fa_desktop() :8
void fa_desktop__ctor_8_fn(fa_desktop* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_desktop__InitializeUX1_fn(fa_desktop* __this)
{
    __this->InitializeUX1();
}

// public fa_desktop New() :8
void fa_desktop__New4_fn(fa_desktop** __retval)
{
    *__retval = fa_desktop::New4();
}

// public fa_desktop() [instance] :8
void fa_desktop::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_desktop::InitializeUX1()
{
    uStackFrame __("fa_desktop", "InitializeUX()");
    Value(::STRINGS[0/*"\uF108"*/]);
    SourceLineNumber(189);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_desktop New() [static] :8
fa_desktop* fa_desktop::New4()
{
    fa_desktop* obj1 = (fa_desktop*)uNew(fa_desktop_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
