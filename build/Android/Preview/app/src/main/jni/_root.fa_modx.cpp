// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_modx.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_modx.h>
...
// public partial sealed class fa_modx :2
// {
// static fa_modx() :4
static void fa_modx__cctor_4_fn(uType* __type)
{
}

static void fa_modx_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_modx__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_modx_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_modx);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_modx", options);
    type->fp_build_ = fa_modx_build;
    type->fp_ctor_ = (void*)fa_modx__New4_fn;
    type->fp_cctor_ = fa_modx__cctor_4_fn;
...
// public fa_modx() :8
void fa_modx__ctor_8_fn(fa_modx* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_modx__InitializeUX1_fn(fa_modx* __this)
{
    __this->InitializeUX1();
}

// public fa_modx New() :8
void fa_modx__New4_fn(fa_modx** __retval)
{
    *__retval = fa_modx::New4();
}

// public fa_modx() [instance] :8
void fa_modx::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_modx::InitializeUX1()
{
    uStackFrame __("fa_modx", "InitializeUX()");
    Value(::STRINGS[0/*"\uF285"*/]);
    SourceLineNumber(419);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_modx New() [static] :8
fa_modx* fa_modx::New4()
{
    fa_modx* obj1 = (fa_modx*)uNew(fa_modx_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
