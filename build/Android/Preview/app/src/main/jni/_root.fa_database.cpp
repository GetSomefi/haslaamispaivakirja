// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_database.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_database.h>
...
// public partial sealed class fa_database :2
// {
// static fa_database() :4
static void fa_database__cctor_4_fn(uType* __type)
{
}

static void fa_database_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_database__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_database_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_database);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_database", options);
    type->fp_build_ = fa_database_build;
    type->fp_ctor_ = (void*)fa_database__New4_fn;
    type->fp_cctor_ = fa_database__cctor_4_fn;
...
// public fa_database() :8
void fa_database__ctor_8_fn(fa_database* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_database__InitializeUX1_fn(fa_database* __this)
{
    __this->InitializeUX1();
}

// public fa_database New() :8
void fa_database__New4_fn(fa_database** __retval)
{
    *__retval = fa_database::New4();
}

// public fa_database() [instance] :8
void fa_database::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_database::InitializeUX1()
{
    uStackFrame __("fa_database", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1C0"*/]);
    SourceLineNumber(186);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_database New() [static] :8
fa_database* fa_database::New4()
{
    fa_database* obj1 = (fa_database*)uNew(fa_database_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
