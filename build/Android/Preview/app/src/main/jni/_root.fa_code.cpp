// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_code.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_code.h>
...
// public partial sealed class fa_code :2
// {
// static fa_code() :4
static void fa_code__cctor_4_fn(uType* __type)
{
}

static void fa_code_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\241");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_code__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_code_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_code);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_code", options);
    type->fp_build_ = fa_code_build;
    type->fp_ctor_ = (void*)fa_code__New4_fn;
    type->fp_cctor_ = fa_code__cctor_4_fn;
...
// public fa_code() :8
void fa_code__ctor_8_fn(fa_code* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_code__InitializeUX1_fn(fa_code* __this)
{
    __this->InitializeUX1();
}

// public fa_code New() :8
void fa_code__New4_fn(fa_code** __retval)
{
    *__retval = fa_code::New4();
}

// public fa_code() [instance] :8
void fa_code::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_code::InitializeUX1()
{
    uStackFrame __("fa_code", "InitializeUX()");
    Value(::STRINGS[0/*"\uF121"*/]);
...
// public fa_code New() [static] :8
fa_code* fa_code::New4()
{
    fa_code* obj1 = (fa_code*)uNew(fa_code_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
