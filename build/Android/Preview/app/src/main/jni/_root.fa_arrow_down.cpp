// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_arrow_down.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_arrow_down.h>
...
// public partial sealed class fa_arrow_down :2
// {
// static fa_arrow_down() :4
static void fa_arrow_down__cctor_4_fn(uType* __type)
{
}

static void fa_arrow_down_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_arrow_down__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_arrow_down_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_arrow_down);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_arrow_down", options);
    type->fp_build_ = fa_arrow_down_build;
    type->fp_ctor_ = (void*)fa_arrow_down__New4_fn;
    type->fp_cctor_ = fa_arrow_down__cctor_4_fn;
...
// public fa_arrow_down() :8
void fa_arrow_down__ctor_8_fn(fa_arrow_down* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_arrow_down__InitializeUX1_fn(fa_arrow_down* __this)
{
    __this->InitializeUX1();
}

// public fa_arrow_down New() :8
void fa_arrow_down__New4_fn(fa_arrow_down** __retval)
{
    *__retval = fa_arrow_down::New4();
}

// public fa_arrow_down() [instance] :8
void fa_arrow_down::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_arrow_down::InitializeUX1()
{
    uStackFrame __("fa_arrow_down", "InitializeUX()");
    Value(::STRINGS[0/*"\uF063"*/]);
    SourceLineNumber(33);
...
// public fa_arrow_down New() [static] :8
fa_arrow_down* fa_arrow_down::New4()
{
    fa_arrow_down* obj1 = (fa_arrow_down*)uNew(fa_arrow_down_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
