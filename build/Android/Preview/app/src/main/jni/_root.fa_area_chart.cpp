// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_area_chart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_area_chart.h>
...
// public partial sealed class fa_area_chart :2
// {
// static fa_area_chart() :4
static void fa_area_chart__cctor_4_fn(uType* __type)
{
}

static void fa_area_chart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_area_chart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_area_chart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_area_chart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_area_chart", options);
    type->fp_build_ = fa_area_chart_build;
    type->fp_ctor_ = (void*)fa_area_chart__New4_fn;
    type->fp_cctor_ = fa_area_chart__cctor_4_fn;
...
// public fa_area_chart() :8
void fa_area_chart__ctor_8_fn(fa_area_chart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_area_chart__InitializeUX1_fn(fa_area_chart* __this)
{
    __this->InitializeUX1();
}

// public fa_area_chart New() :8
void fa_area_chart__New4_fn(fa_area_chart** __retval)
{
    *__retval = fa_area_chart::New4();
}

// public fa_area_chart() [instance] :8
void fa_area_chart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_area_chart::InitializeUX1()
{
    uStackFrame __("fa_area_chart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1FE"*/]);
    SourceLineNumber(24);
...
// public fa_area_chart New() [static] :8
fa_area_chart* fa_area_chart::New4()
{
    fa_area_chart* obj1 = (fa_area_chart*)uNew(fa_area_chart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
