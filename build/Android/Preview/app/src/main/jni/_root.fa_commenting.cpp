// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_commenting.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_commenting.h>
...
// public partial sealed class fa_commenting :2
// {
// static fa_commenting() :4
static void fa_commenting__cctor_4_fn(uType* __type)
{
}

static void fa_commenting_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_commenting__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_commenting_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_commenting);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_commenting", options);
    type->fp_build_ = fa_commenting_build;
    type->fp_ctor_ = (void*)fa_commenting__New4_fn;
    type->fp_cctor_ = fa_commenting__cctor_4_fn;
...
// public fa_commenting() :8
void fa_commenting__ctor_8_fn(fa_commenting* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_commenting__InitializeUX1_fn(fa_commenting* __this)
{
    __this->InitializeUX1();
}

// public fa_commenting New() :8
void fa_commenting__New4_fn(fa_commenting** __retval)
{
    *__retval = fa_commenting::New4();
}

// public fa_commenting() [instance] :8
void fa_commenting::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_commenting::InitializeUX1()
{
    uStackFrame __("fa_commenting", "InitializeUX()");
    Value(::STRINGS[0/*"\uF27A"*/]);
    SourceLineNumber(164);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_commenting New() [static] :8
fa_commenting* fa_commenting::New4()
{
    fa_commenting* obj1 = (fa_commenting*)uNew(fa_commenting_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
