// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bluetooth.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bluetooth.h>
...
// public partial sealed class fa_bluetooth :2
// {
// static fa_bluetooth() :4
static void fa_bluetooth__cctor_4_fn(uType* __type)
{
}

static void fa_bluetooth_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bluetooth__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bluetooth_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bluetooth);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bluetooth", options);
    type->fp_build_ = fa_bluetooth_build;
    type->fp_ctor_ = (void*)fa_bluetooth__New4_fn;
    type->fp_cctor_ = fa_bluetooth__cctor_4_fn;
...
// public fa_bluetooth() :8
void fa_bluetooth__ctor_8_fn(fa_bluetooth* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bluetooth__InitializeUX1_fn(fa_bluetooth* __this)
{
    __this->InitializeUX1();
}

// public fa_bluetooth New() :8
void fa_bluetooth__New4_fn(fa_bluetooth** __retval)
{
    *__retval = fa_bluetooth::New4();
}

// public fa_bluetooth() [instance] :8
void fa_bluetooth::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bluetooth::InitializeUX1()
{
    uStackFrame __("fa_bluetooth", "InitializeUX()");
    Value(::STRINGS[0/*"\uF293"*/]);
    SourceLineNumber(77);
...
// public fa_bluetooth New() [static] :8
fa_bluetooth* fa_bluetooth::New4()
{
    fa_bluetooth* obj1 = (fa_bluetooth*)uNew(fa_bluetooth_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
