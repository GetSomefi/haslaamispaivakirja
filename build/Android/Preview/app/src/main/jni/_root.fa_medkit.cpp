// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_medkit.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_medkit.h>
...
// public partial sealed class fa_medkit :2
// {
// static fa_medkit() :4
static void fa_medkit__cctor_4_fn(uType* __type)
{
}

static void fa_medkit_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_medkit__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_medkit_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_medkit);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_medkit", options);
    type->fp_build_ = fa_medkit_build;
    type->fp_ctor_ = (void*)fa_medkit__New4_fn;
    type->fp_cctor_ = fa_medkit__cctor_4_fn;
...
// public fa_medkit() :8
void fa_medkit__ctor_8_fn(fa_medkit* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_medkit__InitializeUX1_fn(fa_medkit* __this)
{
    __this->InitializeUX1();
}

// public fa_medkit New() :8
void fa_medkit__New4_fn(fa_medkit** __retval)
{
    *__retval = fa_medkit::New4();
}

// public fa_medkit() [instance] :8
void fa_medkit::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_medkit::InitializeUX1()
{
    uStackFrame __("fa_medkit", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0FA"*/]);
    SourceLineNumber(407);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_medkit New() [static] :8
fa_medkit* fa_medkit::New4()
{
    fa_medkit* obj1 = (fa_medkit*)uNew(fa_medkit_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
