// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_simplybuilt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_simplybuilt.h>
...
// public partial sealed class fa_simplybuilt :2
// {
// static fa_simplybuilt() :4
static void fa_simplybuilt__cctor_4_fn(uType* __type)
{
}

static void fa_simplybuilt_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_simplybuilt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_simplybuilt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_simplybuilt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_simplybuilt", options);
    type->fp_build_ = fa_simplybuilt_build;
    type->fp_ctor_ = (void*)fa_simplybuilt__New4_fn;
    type->fp_cctor_ = fa_simplybuilt__cctor_4_fn;
...
// public fa_simplybuilt() :8
void fa_simplybuilt__ctor_8_fn(fa_simplybuilt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_simplybuilt__InitializeUX1_fn(fa_simplybuilt* __this)
{
    __this->InitializeUX1();
}

// public fa_simplybuilt New() :8
void fa_simplybuilt__New4_fn(fa_simplybuilt** __retval)
{
    *__retval = fa_simplybuilt::New4();
}

// public fa_simplybuilt() [instance] :8
void fa_simplybuilt::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_simplybuilt::InitializeUX1()
{
    uStackFrame __("fa_simplybuilt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF215"*/]);
    SourceLineNumber(537);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_simplybuilt New() [static] :8
fa_simplybuilt* fa_simplybuilt::New4()
{
    fa_simplybuilt* obj1 = (fa_simplybuilt*)uNew(fa_simplybuilt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
