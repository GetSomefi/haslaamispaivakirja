// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_product_hunt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_product_hunt.h>
...
// public partial sealed class fa_product_hunt :2
// {
// static fa_product_hunt() :4
static void fa_product_hunt__cctor_4_fn(uType* __type)
{
}

static void fa_product_hunt_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_product_hunt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_product_hunt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_product_hunt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_product_hunt", options);
    type->fp_build_ = fa_product_hunt_build;
    type->fp_ctor_ = (void*)fa_product_hunt__New4_fn;
    type->fp_cctor_ = fa_product_hunt__cctor_4_fn;
...
// public fa_product_hunt() :8
void fa_product_hunt__ctor_8_fn(fa_product_hunt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_product_hunt__InitializeUX1_fn(fa_product_hunt* __this)
{
    __this->InitializeUX1();
}

// public fa_product_hunt New() :8
void fa_product_hunt__New4_fn(fa_product_hunt** __retval)
{
    *__retval = fa_product_hunt::New4();
}

// public fa_product_hunt() [instance] :8
void fa_product_hunt::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_product_hunt::InitializeUX1()
{
    uStackFrame __("fa_product_hunt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF288"*/]);
    SourceLineNumber(475);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_product_hunt New() [static] :8
fa_product_hunt* fa_product_hunt::New4()
{
    fa_product_hunt* obj1 = (fa_product_hunt*)uNew(fa_product_hunt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
