// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bluetooth_b.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bluetooth_b.h>
...
// public partial sealed class fa_bluetooth_b :2
// {
// static fa_bluetooth_b() :4
static void fa_bluetooth_b__cctor_4_fn(uType* __type)
{
}

static void fa_bluetooth_b_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\224");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bluetooth_b__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bluetooth_b_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bluetooth_b);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bluetooth_b", options);
    type->fp_build_ = fa_bluetooth_b_build;
    type->fp_ctor_ = (void*)fa_bluetooth_b__New4_fn;
    type->fp_cctor_ = fa_bluetooth_b__cctor_4_fn;
...
// public fa_bluetooth_b() :8
void fa_bluetooth_b__ctor_8_fn(fa_bluetooth_b* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bluetooth_b__InitializeUX1_fn(fa_bluetooth_b* __this)
{
    __this->InitializeUX1();
}

// public fa_bluetooth_b New() :8
void fa_bluetooth_b__New4_fn(fa_bluetooth_b** __retval)
{
    *__retval = fa_bluetooth_b::New4();
}

// public fa_bluetooth_b() [instance] :8
void fa_bluetooth_b::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bluetooth_b::InitializeUX1()
{
    uStackFrame __("fa_bluetooth_b", "InitializeUX()");
    Value(::STRINGS[0/*"\uF294"*/]);
    SourceLineNumber(78);
...
// public fa_bluetooth_b New() [static] :8
fa_bluetooth_b* fa_bluetooth_b::New4()
{
    fa_bluetooth_b* obj1 = (fa_bluetooth_b*)uNew(fa_bluetooth_b_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
