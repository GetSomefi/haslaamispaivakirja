// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hourglass.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hourglass.h>
...
// public partial sealed class fa_hourglass :2
// {
// static fa_hourglass() :4
static void fa_hourglass__cctor_4_fn(uType* __type)
{
}

static void fa_hourglass_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\224");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hourglass__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hourglass_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hourglass);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hourglass", options);
    type->fp_build_ = fa_hourglass_build;
    type->fp_ctor_ = (void*)fa_hourglass__New4_fn;
    type->fp_cctor_ = fa_hourglass__cctor_4_fn;
...
// public fa_hourglass() :8
void fa_hourglass__ctor_8_fn(fa_hourglass* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hourglass__InitializeUX1_fn(fa_hourglass* __this)
{
    __this->InitializeUX1();
}

// public fa_hourglass New() :8
void fa_hourglass__New4_fn(fa_hourglass** __retval)
{
    *__retval = fa_hourglass::New4();
}

// public fa_hourglass() [instance] :8
void fa_hourglass::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hourglass::InitializeUX1()
{
    uStackFrame __("fa_hourglass", "InitializeUX()");
    Value(::STRINGS[0/*"\uF254"*/]);
    SourceLineNumber(327);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hourglass New() [static] :8
fa_hourglass* fa_hourglass::New4()
{
    fa_hourglass* obj1 = (fa_hourglass*)uNew(fa_hourglass_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
