// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_google.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_google.h>
...
// public partial sealed class fa_google :2
// {
// static fa_google() :4
static void fa_google__cctor_4_fn(uType* __type)
{
}

static void fa_google_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\240");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_google__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_google_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_google);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_google", options);
    type->fp_build_ = fa_google_build;
    type->fp_ctor_ = (void*)fa_google__New4_fn;
    type->fp_cctor_ = fa_google__cctor_4_fn;
...
// public fa_google() :8
void fa_google__ctor_8_fn(fa_google* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_google__InitializeUX1_fn(fa_google* __this)
{
    __this->InitializeUX1();
}

// public fa_google New() :8
void fa_google__New4_fn(fa_google** __retval)
{
    *__retval = fa_google::New4();
}

// public fa_google() [instance] :8
void fa_google::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_google::InitializeUX1()
{
    uStackFrame __("fa_google", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A0"*/]);
    SourceLineNumber(294);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_google New() [static] :8
fa_google* fa_google::New4()
{
    fa_google* obj1 = (fa_google*)uNew(fa_google_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
