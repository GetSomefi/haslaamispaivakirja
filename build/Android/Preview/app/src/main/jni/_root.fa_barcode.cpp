// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_barcode.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_barcode.h>
...
// public partial sealed class fa_barcode :2
// {
// static fa_barcode() :4
static void fa_barcode__cctor_4_fn(uType* __type)
{
}

static void fa_barcode_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_barcode__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_barcode_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_barcode);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_barcode", options);
    type->fp_build_ = fa_barcode_build;
    type->fp_ctor_ = (void*)fa_barcode__New4_fn;
    type->fp_cctor_ = fa_barcode__cctor_4_fn;
...
// public fa_barcode() :8
void fa_barcode__ctor_8_fn(fa_barcode* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_barcode__InitializeUX1_fn(fa_barcode* __this)
{
    __this->InitializeUX1();
}

// public fa_barcode New() :8
void fa_barcode__New4_fn(fa_barcode** __retval)
{
    *__retval = fa_barcode::New4();
}

// public fa_barcode() [instance] :8
void fa_barcode::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_barcode::InitializeUX1()
{
    uStackFrame __("fa_barcode", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02A"*/]);
    SourceLineNumber(50);
...
// public fa_barcode New() [static] :8
fa_barcode* fa_barcode::New4()
{
    fa_barcode* obj1 = (fa_barcode*)uNew(fa_barcode_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
