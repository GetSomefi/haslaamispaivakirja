// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pie_chart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pie_chart.h>
...
// public partial sealed class fa_pie_chart :2
// {
// static fa_pie_chart() :4
static void fa_pie_chart__cctor_4_fn(uType* __type)
{
}

static void fa_pie_chart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pie_chart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pie_chart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pie_chart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pie_chart", options);
    type->fp_build_ = fa_pie_chart_build;
    type->fp_ctor_ = (void*)fa_pie_chart__New4_fn;
    type->fp_cctor_ = fa_pie_chart__cctor_4_fn;
...
// public fa_pie_chart() :8
void fa_pie_chart__ctor_8_fn(fa_pie_chart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pie_chart__InitializeUX1_fn(fa_pie_chart* __this)
{
    __this->InitializeUX1();
}

// public fa_pie_chart New() :8
void fa_pie_chart__New4_fn(fa_pie_chart** __retval)
{
    *__retval = fa_pie_chart::New4();
}

// public fa_pie_chart() [instance] :8
void fa_pie_chart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pie_chart::InitializeUX1()
{
    uStackFrame __("fa_pie_chart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF200"*/]);
    SourceLineNumber(458);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pie_chart New() [static] :8
fa_pie_chart* fa_pie_chart::New4()
{
    fa_pie_chart* obj1 = (fa_pie_chart*)uNew(fa_pie_chart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
