// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basic.LabelText.g.uno'.
...
// {
// static LabelText() :6
static void LabelText__cctor_5_fn(uType* __type)
{
}

static void LabelText_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Components/basic.LabelText.ux");
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LabelText__New5_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* LabelText_typeof()
{
    ...
    options.BaseDefinition = ::g::generaltext::Text_typeof();
    options.FieldCount = 121;
    options.InterfaceCount = 19;
    options.ObjectSize = sizeof(LabelText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("basic.LabelText", options);
    type->fp_build_ = LabelText_build;
    type->fp_ctor_ = (void*)LabelText__New5_fn;
    type->fp_cctor_ = LabelText__cctor_5_fn;
...
// public LabelText New() :10
void LabelText__New5_fn(LabelText** __retval)
{
    *__retval = LabelText::New5();
}

// public LabelText() [instance] :10
void LabelText::ctor_9()
{
    ctor_8();
    InitializeUX2();
}
...
void LabelText::InitializeUX2()
{
    uStackFrame __("basic.LabelText", "InitializeUX()");
...
// public LabelText New() [static] :10
LabelText* LabelText::New5()
{
    LabelText* obj1 = (LabelText*)uNew(LabelText_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
