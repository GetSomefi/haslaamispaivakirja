// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_trademark.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_trademark.h>
...
// public partial sealed class fa_trademark :2
// {
// static fa_trademark() :4
static void fa_trademark__cctor_4_fn(uType* __type)
{
}

static void fa_trademark_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_trademark__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_trademark_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_trademark);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_trademark", options);
    type->fp_build_ = fa_trademark_build;
    type->fp_ctor_ = (void*)fa_trademark__New4_fn;
    type->fp_cctor_ = fa_trademark__cctor_4_fn;
...
// public fa_trademark() :8
void fa_trademark__ctor_8_fn(fa_trademark* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_trademark__InitializeUX1_fn(fa_trademark* __this)
{
    __this->InitializeUX1();
}

// public fa_trademark New() :8
void fa_trademark__New4_fn(fa_trademark** __retval)
{
    *__retval = fa_trademark::New4();
}

// public fa_trademark() [instance] :8
void fa_trademark::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_trademark::InitializeUX1()
{
    uStackFrame __("fa_trademark", "InitializeUX()");
    Value(::STRINGS[0/*"\uF25C"*/]);
    SourceLineNumber(623);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_trademark New() [static] :8
fa_trademark* fa_trademark::New4()
{
    fa_trademark* obj1 = (fa_trademark*)uNew(fa_trademark_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
