// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cutlery.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cutlery.h>
...
// public partial sealed class fa_cutlery :2
// {
// static fa_cutlery() :4
static void fa_cutlery__cctor_4_fn(uType* __type)
{
}

static void fa_cutlery_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cutlery__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cutlery_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cutlery);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cutlery", options);
    type->fp_build_ = fa_cutlery_build;
    type->fp_ctor_ = (void*)fa_cutlery__New4_fn;
    type->fp_cctor_ = fa_cutlery__cctor_4_fn;
...
// public fa_cutlery() :8
void fa_cutlery__ctor_8_fn(fa_cutlery* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cutlery__InitializeUX1_fn(fa_cutlery* __this)
{
    __this->InitializeUX1();
}

// public fa_cutlery New() :8
void fa_cutlery__New4_fn(fa_cutlery** __retval)
{
    *__retval = fa_cutlery::New4();
}

// public fa_cutlery() [instance] :8
void fa_cutlery::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cutlery::InitializeUX1()
{
    uStackFrame __("fa_cutlery", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F5"*/]);
    SourceLineNumber(183);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cutlery New() [static] :8
fa_cutlery* fa_cutlery::New4()
{
    fa_cutlery* obj1 = (fa_cutlery*)uNew(fa_cutlery_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
