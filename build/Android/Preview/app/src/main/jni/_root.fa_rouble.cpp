// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rouble.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rouble.h>
...
// public partial sealed class fa_rouble :2
// {
// static fa_rouble() :4
static void fa_rouble__cctor_4_fn(uType* __type)
{
}

static void fa_rouble_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\230");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rouble__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rouble_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rouble);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rouble", options);
    type->fp_build_ = fa_rouble_build;
    type->fp_ctor_ = (void*)fa_rouble__New4_fn;
    type->fp_cctor_ = fa_rouble__cctor_4_fn;
...
// public fa_rouble() :8
void fa_rouble__ctor_8_fn(fa_rouble* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rouble__InitializeUX1_fn(fa_rouble* __this)
{
    __this->InitializeUX1();
}

// public fa_rouble New() :8
void fa_rouble__New4_fn(fa_rouble** __retval)
{
    *__retval = fa_rouble::New4();
}

// public fa_rouble() [instance] :8
void fa_rouble::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_rouble::InitializeUX1()
{
    uStackFrame __("fa_rouble", "InitializeUX()");
    Value(::STRINGS[0/*"\uF158"*/]);
    SourceLineNumber(504);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rouble New() [static] :8
fa_rouble* fa_rouble::New4()
{
    fa_rouble* obj1 = (fa_rouble*)uNew(fa_rouble_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
