// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_html5.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_html5.h>
...
// public partial sealed class fa_html5 :2
// {
// static fa_html5() :4
static void fa_html5__cctor_4_fn(uType* __type)
{
}

static void fa_html5_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_html5__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_html5_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_html5);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_html5", options);
    type->fp_build_ = fa_html5_build;
    type->fp_ctor_ = (void*)fa_html5__New4_fn;
    type->fp_cctor_ = fa_html5__cctor_4_fn;
...
// public fa_html5() :8
void fa_html5__ctor_8_fn(fa_html5* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_html5__InitializeUX1_fn(fa_html5* __this)
{
    __this->InitializeUX1();
}

// public fa_html5 New() :8
void fa_html5__New4_fn(fa_html5** __retval)
{
    *__retval = fa_html5::New4();
}

// public fa_html5() [instance] :8
void fa_html5::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_html5::InitializeUX1()
{
    uStackFrame __("fa_html5", "InitializeUX()");
    Value(::STRINGS[0/*"\uF13B"*/]);
    SourceLineNumber(336);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_html5 New() [static] :8
fa_html5* fa_html5::New4()
{
    fa_html5* obj1 = (fa_html5*)uNew(fa_html5_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
