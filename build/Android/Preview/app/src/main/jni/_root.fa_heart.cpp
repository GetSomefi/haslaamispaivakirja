// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_heart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_heart.h>
...
// public partial sealed class fa_heart :2
// {
// static fa_heart() :4
static void fa_heart__cctor_4_fn(uType* __type)
{
}

static void fa_heart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_heart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_heart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_heart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_heart", options);
    type->fp_build_ = fa_heart_build;
    type->fp_ctor_ = (void*)fa_heart__New4_fn;
    type->fp_cctor_ = fa_heart__cctor_4_fn;
...
// public fa_heart() :8
void fa_heart__ctor_8_fn(fa_heart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_heart__InitializeUX1_fn(fa_heart* __this)
{
    __this->InitializeUX1();
}

// public fa_heart New() :8
void fa_heart__New4_fn(fa_heart** __retval)
{
    *__retval = fa_heart::New4();
}

// public fa_heart() [instance] :8
void fa_heart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_heart::InitializeUX1()
{
    uStackFrame __("fa_heart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF004"*/]);
    SourceLineNumber(320);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_heart New() [static] :8
fa_heart* fa_heart::New4()
{
    fa_heart* obj1 = (fa_heart*)uNew(fa_heart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
