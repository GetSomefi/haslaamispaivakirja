// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_jcb.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_jcb.h>
...
// public partial sealed class fa_cc_jcb :2
// {
// static fa_cc_jcb() :4
static void fa_cc_jcb__cctor_4_fn(uType* __type)
{
}

static void fa_cc_jcb_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\213");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_jcb__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_jcb_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_jcb);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_jcb", options);
    type->fp_build_ = fa_cc_jcb_build;
    type->fp_ctor_ = (void*)fa_cc_jcb__New4_fn;
    type->fp_cctor_ = fa_cc_jcb__cctor_4_fn;
...
// public fa_cc_jcb() :8
void fa_cc_jcb__ctor_8_fn(fa_cc_jcb* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_jcb__InitializeUX1_fn(fa_cc_jcb* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_jcb New() :8
void fa_cc_jcb__New4_fn(fa_cc_jcb** __retval)
{
    *__retval = fa_cc_jcb::New4();
}

// public fa_cc_jcb() [instance] :8
void fa_cc_jcb::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_jcb::InitializeUX1()
{
    uStackFrame __("fa_cc_jcb", "InitializeUX()");
    Value(::STRINGS[0/*"\uF24B"*/]);
...
// public fa_cc_jcb New() [static] :8
fa_cc_jcb* fa_cc_jcb::New4()
{
    fa_cc_jcb* obj1 = (fa_cc_jcb*)uNew(fa_cc_jcb_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
