...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersWhileString_Value_Property", "Get(Uno.UX.PropertyObject)");
    uString* ret2;
...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersWhileString_Value_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
