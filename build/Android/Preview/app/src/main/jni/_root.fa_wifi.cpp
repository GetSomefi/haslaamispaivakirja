// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wifi.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wifi.h>
...
// public partial sealed class fa_wifi :2
// {
// static fa_wifi() :4
static void fa_wifi__cctor_4_fn(uType* __type)
{
}

static void fa_wifi_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wifi__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wifi_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wifi);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wifi", options);
    type->fp_build_ = fa_wifi_build;
    type->fp_ctor_ = (void*)fa_wifi__New4_fn;
    type->fp_cctor_ = fa_wifi__cctor_4_fn;
...
// public fa_wifi() :8
void fa_wifi__ctor_8_fn(fa_wifi* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wifi__InitializeUX1_fn(fa_wifi* __this)
{
    __this->InitializeUX1();
}

// public fa_wifi New() :8
void fa_wifi__New4_fn(fa_wifi** __retval)
{
    *__retval = fa_wifi::New4();
}

// public fa_wifi() [instance] :8
void fa_wifi::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_wifi::InitializeUX1()
{
    uStackFrame __("fa_wifi", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1EB"*/]);
    SourceLineNumber(678);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wifi New() [static] :8
fa_wifi* fa_wifi::New4()
{
    fa_wifi* obj1 = (fa_wifi*)uNew(fa_wifi_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
