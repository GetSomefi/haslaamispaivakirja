// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fast_forward.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fast_forward.h>
...
// public partial sealed class fa_fast_forward :2
// {
// static fa_fast_forward() :4
static void fa_fast_forward__cctor_4_fn(uType* __type)
{
}

static void fa_fast_forward_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fast_forward__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fast_forward_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fast_forward);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fast_forward", options);
    type->fp_build_ = fa_fast_forward_build;
    type->fp_ctor_ = (void*)fa_fast_forward__New4_fn;
    type->fp_cctor_ = fa_fast_forward__cctor_4_fn;
...
// public fa_fast_forward() :8
void fa_fast_forward__ctor_8_fn(fa_fast_forward* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fast_forward__InitializeUX1_fn(fa_fast_forward* __this)
{
    __this->InitializeUX1();
}

// public fa_fast_forward New() :8
void fa_fast_forward__New4_fn(fa_fast_forward** __retval)
{
    *__retval = fa_fast_forward::New4();
}

// public fa_fast_forward() [instance] :8
void fa_fast_forward::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_fast_forward::InitializeUX1()
{
    uStackFrame __("fa_fast_forward", "InitializeUX()");
    Value(::STRINGS[0/*"\uF050"*/]);
    SourceLineNumber(227);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fast_forward New() [static] :8
fa_fast_forward* fa_fast_forward::New4()
{
    fa_fast_forward* obj1 = (fa_fast_forward*)uNew(fa_fast_forward_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
