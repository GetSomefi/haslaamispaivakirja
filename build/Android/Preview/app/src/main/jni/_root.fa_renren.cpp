// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_renren.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_renren.h>
...
// public partial sealed class fa_renren :2
// {
// static fa_renren() :4
static void fa_renren__cctor_4_fn(uType* __type)
{
}

static void fa_renren_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\213");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_renren__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_renren_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_renren);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_renren", options);
    type->fp_build_ = fa_renren_build;
    type->fp_ctor_ = (void*)fa_renren__New4_fn;
    type->fp_cctor_ = fa_renren__cctor_4_fn;
...
// public fa_renren() :8
void fa_renren__ctor_8_fn(fa_renren* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_renren__InitializeUX1_fn(fa_renren* __this)
{
    __this->InitializeUX1();
}

// public fa_renren New() :8
void fa_renren__New4_fn(fa_renren** __retval)
{
    *__retval = fa_renren::New4();
}

// public fa_renren() [instance] :8
void fa_renren::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_renren::InitializeUX1()
{
    uStackFrame __("fa_renren", "InitializeUX()");
    Value(::STRINGS[0/*"\uF18B"*/]);
    SourceLineNumber(493);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_renren New() [static] :8
fa_renren* fa_renren::New4()
{
    fa_renren* obj1 = (fa_renren*)uNew(fa_renren_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
