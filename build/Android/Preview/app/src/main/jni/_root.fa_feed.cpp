// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_feed.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_feed.h>
...
// public partial sealed class fa_feed :2
// {
// static fa_feed() :4
static void fa_feed__cctor_4_fn(uType* __type)
{
}

static void fa_feed_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_feed__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_feed_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_feed);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_feed", options);
    type->fp_build_ = fa_feed_build;
    type->fp_ctor_ = (void*)fa_feed__New4_fn;
    type->fp_cctor_ = fa_feed__cctor_4_fn;
...
// public fa_feed() :8
void fa_feed__ctor_8_fn(fa_feed* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_feed__InitializeUX1_fn(fa_feed* __this)
{
    __this->InitializeUX1();
}

// public fa_feed New() :8
void fa_feed__New4_fn(fa_feed** __retval)
{
    *__retval = fa_feed::New4();
}

// public fa_feed() [instance] :8
void fa_feed::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_feed::InitializeUX1()
{
    uStackFrame __("fa_feed", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09E"*/]);
    SourceLineNumber(229);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_feed New() [static] :8
fa_feed* fa_feed::New4()
{
    fa_feed* obj1 = (fa_feed*)uNew(fa_feed_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
