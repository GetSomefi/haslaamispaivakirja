// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bell.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bell.h>
...
// public partial sealed class fa_bell :2
// {
// static fa_bell() :4
static void fa_bell__cctor_4_fn(uType* __type)
{
}

static void fa_bell_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bell__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bell_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bell);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bell", options);
    type->fp_build_ = fa_bell_build;
    type->fp_ctor_ = (void*)fa_bell__New4_fn;
    type->fp_cctor_ = fa_bell__cctor_4_fn;
...
// public fa_bell() :8
void fa_bell__ctor_8_fn(fa_bell* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bell__InitializeUX1_fn(fa_bell* __this)
{
    __this->InitializeUX1();
}

// public fa_bell New() :8
void fa_bell__New4_fn(fa_bell** __retval)
{
    *__retval = fa_bell::New4();
}

// public fa_bell() [instance] :8
void fa_bell::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bell::InitializeUX1()
{
    uStackFrame __("fa_bell", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F3"*/]);
    SourceLineNumber(66);
...
// public fa_bell New() [static] :8
fa_bell* fa_bell::New4()
{
    fa_bell* obj1 = (fa_bell*)uNew(fa_bell_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
