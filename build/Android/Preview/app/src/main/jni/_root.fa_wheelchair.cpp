// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wheelchair.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wheelchair.h>
...
// public partial sealed class fa_wheelchair :2
// {
// static fa_wheelchair() :4
static void fa_wheelchair__cctor_4_fn(uType* __type)
{
}

static void fa_wheelchair_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wheelchair__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wheelchair_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wheelchair);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wheelchair", options);
    type->fp_build_ = fa_wheelchair_build;
    type->fp_ctor_ = (void*)fa_wheelchair__New4_fn;
    type->fp_cctor_ = fa_wheelchair__cctor_4_fn;
...
// public fa_wheelchair() :8
void fa_wheelchair__ctor_8_fn(fa_wheelchair* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wheelchair__InitializeUX1_fn(fa_wheelchair* __this)
{
    __this->InitializeUX1();
}

// public fa_wheelchair New() :8
void fa_wheelchair__New4_fn(fa_wheelchair** __retval)
{
    *__retval = fa_wheelchair::New4();
}

// public fa_wheelchair() [instance] :8
void fa_wheelchair::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_wheelchair::InitializeUX1()
{
    uStackFrame __("fa_wheelchair", "InitializeUX()");
    Value(::STRINGS[0/*"\uF193"*/]);
    SourceLineNumber(677);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wheelchair New() [static] :8
fa_wheelchair* fa_wheelchair::New4()
{
    fa_wheelchair* obj1 = (fa_wheelchair*)uNew(fa_wheelchair_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
