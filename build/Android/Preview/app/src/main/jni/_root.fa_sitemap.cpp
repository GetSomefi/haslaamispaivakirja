// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sitemap.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sitemap.h>
...
// public partial sealed class fa_sitemap :2
// {
// static fa_sitemap() :4
static void fa_sitemap__cctor_4_fn(uType* __type)
{
}

static void fa_sitemap_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sitemap__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sitemap_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sitemap);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sitemap", options);
    type->fp_build_ = fa_sitemap_build;
    type->fp_ctor_ = (void*)fa_sitemap__New4_fn;
    type->fp_cctor_ = fa_sitemap__cctor_4_fn;
...
// public fa_sitemap() :8
void fa_sitemap__ctor_8_fn(fa_sitemap* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sitemap__InitializeUX1_fn(fa_sitemap* __this)
{
    __this->InitializeUX1();
}

// public fa_sitemap New() :8
void fa_sitemap__New4_fn(fa_sitemap** __retval)
{
    *__retval = fa_sitemap::New4();
}

// public fa_sitemap() [instance] :8
void fa_sitemap::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sitemap::InitializeUX1()
{
    uStackFrame __("fa_sitemap", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E8"*/]);
    SourceLineNumber(538);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sitemap New() [static] :8
fa_sitemap* fa_sitemap::New4()
{
    fa_sitemap* obj1 = (fa_sitemap*)uNew(fa_sitemap_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
