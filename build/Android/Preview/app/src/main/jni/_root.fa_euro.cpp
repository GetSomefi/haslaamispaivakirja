// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_euro.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_euro.h>
...
// public partial sealed class fa_euro :2
// {
// static fa_euro() :4
static void fa_euro__cctor_4_fn(uType* __type)
{
}

static void fa_euro_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_euro__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_euro_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_euro);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_euro", options);
    type->fp_build_ = fa_euro_build;
    type->fp_ctor_ = (void*)fa_euro__New4_fn;
    type->fp_cctor_ = fa_euro__cctor_4_fn;
...
// public fa_euro() :8
void fa_euro__ctor_8_fn(fa_euro* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_euro__InitializeUX1_fn(fa_euro* __this)
{
    __this->InitializeUX1();
}

// public fa_euro New() :8
void fa_euro__New4_fn(fa_euro** __retval)
{
    *__retval = fa_euro::New4();
}

// public fa_euro() [instance] :8
void fa_euro::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_euro::InitializeUX1()
{
    uStackFrame __("fa_euro", "InitializeUX()");
    Value(::STRINGS[0/*"\uF153"*/]);
    SourceLineNumber(210);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_euro New() [static] :8
fa_euro* fa_euro::New4()
{
    fa_euro* obj1 = (fa_euro*)uNew(fa_euro_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
