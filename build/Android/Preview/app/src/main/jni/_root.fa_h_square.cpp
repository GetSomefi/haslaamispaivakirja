// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_h_square.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_h_square.h>
...
// public partial sealed class fa_h_square :2
// {
// static fa_h_square() :4
static void fa_h_square__cctor_4_fn(uType* __type)
{
}

static void fa_h_square_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_h_square__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_h_square_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_h_square);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_h_square", options);
    type->fp_build_ = fa_h_square_build;
    type->fp_ctor_ = (void*)fa_h_square__New4_fn;
    type->fp_cctor_ = fa_h_square__cctor_4_fn;
...
// public fa_h_square() :8
void fa_h_square__ctor_8_fn(fa_h_square* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_h_square__InitializeUX1_fn(fa_h_square* __this)
{
    __this->InitializeUX1();
}

// public fa_h_square New() :8
void fa_h_square__New4_fn(fa_h_square** __retval)
{
    *__retval = fa_h_square::New4();
}

// public fa_h_square() [instance] :8
void fa_h_square::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_h_square::InitializeUX1()
{
    uStackFrame __("fa_h_square", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0FD"*/]);
    SourceLineNumber(301);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_h_square New() [static] :8
fa_h_square* fa_h_square::New4()
{
    fa_h_square* obj1 = (fa_h_square*)uNew(fa_h_square_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
