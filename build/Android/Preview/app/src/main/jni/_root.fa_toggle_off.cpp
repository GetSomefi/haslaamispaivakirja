// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_toggle_off.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_toggle_off.h>
...
// public partial sealed class fa_toggle_off :2
// {
// static fa_toggle_off() :4
static void fa_toggle_off__cctor_4_fn(uType* __type)
{
}

static void fa_toggle_off_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_toggle_off__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_toggle_off_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_toggle_off);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_toggle_off", options);
    type->fp_build_ = fa_toggle_off_build;
    type->fp_ctor_ = (void*)fa_toggle_off__New4_fn;
    type->fp_cctor_ = fa_toggle_off__cctor_4_fn;
...
// public fa_toggle_off() :8
void fa_toggle_off__ctor_8_fn(fa_toggle_off* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_toggle_off__InitializeUX1_fn(fa_toggle_off* __this)
{
    __this->InitializeUX1();
}

// public fa_toggle_off New() :8
void fa_toggle_off__New4_fn(fa_toggle_off** __retval)
{
    *__retval = fa_toggle_off::New4();
}

// public fa_toggle_off() [instance] :8
void fa_toggle_off::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_toggle_off::InitializeUX1()
{
    uStackFrame __("fa_toggle_off", "InitializeUX()");
    Value(::STRINGS[0/*"\uF204"*/]);
    SourceLineNumber(619);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_toggle_off New() [static] :8
fa_toggle_off* fa_toggle_off::New4()
{
    fa_toggle_off* obj1 = (fa_toggle_off*)uNew(fa_toggle_off_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
