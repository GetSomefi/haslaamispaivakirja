// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_print.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_print.h>
...
// public partial sealed class fa_print :2
// {
// static fa_print() :4
static void fa_print__cctor_4_fn(uType* __type)
{
}

static void fa_print_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\257");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_print__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_print_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_print);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_print", options);
    type->fp_build_ = fa_print_build;
    type->fp_ctor_ = (void*)fa_print__New4_fn;
    type->fp_cctor_ = fa_print__cctor_4_fn;
...
// public fa_print() :8
void fa_print__ctor_8_fn(fa_print* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_print__InitializeUX1_fn(fa_print* __this)
{
    __this->InitializeUX1();
}

// public fa_print New() :8
void fa_print__New4_fn(fa_print** __retval)
{
    *__retval = fa_print::New4();
}

// public fa_print() [instance] :8
void fa_print::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_print::InitializeUX1()
{
    uStackFrame __("fa_print", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02F"*/]);
    SourceLineNumber(474);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_print New() [static] :8
fa_print* fa_print::New4()
{
    fa_print* obj1 = (fa_print*)uNew(fa_print_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
