// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dashboard.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dashboard.h>
...
// public partial sealed class fa_dashboard :2
// {
// static fa_dashboard() :4
static void fa_dashboard__cctor_4_fn(uType* __type)
{
}

static void fa_dashboard_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dashboard__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dashboard_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dashboard);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dashboard", options);
    type->fp_build_ = fa_dashboard_build;
    type->fp_ctor_ = (void*)fa_dashboard__New4_fn;
    type->fp_cctor_ = fa_dashboard__cctor_4_fn;
...
// public fa_dashboard() :8
void fa_dashboard__ctor_8_fn(fa_dashboard* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dashboard__InitializeUX1_fn(fa_dashboard* __this)
{
    __this->InitializeUX1();
}

// public fa_dashboard New() :8
void fa_dashboard__New4_fn(fa_dashboard** __retval)
{
    *__retval = fa_dashboard::New4();
}

// public fa_dashboard() [instance] :8
void fa_dashboard::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dashboard::InitializeUX1()
{
    uStackFrame __("fa_dashboard", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E4"*/]);
    SourceLineNumber(184);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dashboard New() [static] :8
fa_dashboard* fa_dashboard::New4()
{
    fa_dashboard* obj1 = (fa_dashboard*)uNew(fa_dashboard_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
