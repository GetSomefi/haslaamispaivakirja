// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tint.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tint.h>
...
// public partial sealed class fa_tint :2
// {
// static fa_tint() :4
static void fa_tint__cctor_4_fn(uType* __type)
{
}

static void fa_tint_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tint__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tint_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tint);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tint", options);
    type->fp_build_ = fa_tint_build;
    type->fp_ctor_ = (void*)fa_tint__New4_fn;
    type->fp_cctor_ = fa_tint__cctor_4_fn;
...
// public fa_tint() :8
void fa_tint__ctor_8_fn(fa_tint* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tint__InitializeUX1_fn(fa_tint* __this)
{
    __this->InitializeUX1();
}

// public fa_tint New() :8
void fa_tint__New4_fn(fa_tint** __retval)
{
    *__retval = fa_tint::New4();
}

// public fa_tint() [instance] :8
void fa_tint::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tint::InitializeUX1()
{
    uStackFrame __("fa_tint", "InitializeUX()");
    Value(::STRINGS[0/*"\uF043"*/]);
    SourceLineNumber(616);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tint New() [static] :8
fa_tint* fa_tint::New4()
{
    fa_tint* obj1 = (fa_tint*)uNew(fa_tint_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
