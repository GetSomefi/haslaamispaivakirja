// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_anchor.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_anchor.h>
...
// public partial sealed class fa_anchor :2
// {
// static fa_anchor() :4
static void fa_anchor__cctor_4_fn(uType* __type)
{
}

static void fa_anchor_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_anchor__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_anchor_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_anchor);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_anchor", options);
    type->fp_build_ = fa_anchor_build;
    type->fp_ctor_ = (void*)fa_anchor__New4_fn;
    type->fp_cctor_ = fa_anchor__cctor_4_fn;
...
// public fa_anchor() :8
void fa_anchor__ctor_8_fn(fa_anchor* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_anchor__InitializeUX1_fn(fa_anchor* __this)
{
    __this->InitializeUX1();
}

// public fa_anchor New() :8
void fa_anchor__New4_fn(fa_anchor** __retval)
{
    *__retval = fa_anchor::New4();
}

// public fa_anchor() [instance] :8
void fa_anchor::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_anchor::InitializeUX1()
{
    uStackFrame __("fa_anchor", "InitializeUX()");
    Value(::STRINGS[0/*"\uF13D"*/]);
    SourceLineNumber(11);
...
// public fa_anchor New() [static] :8
fa_anchor* fa_anchor::New4()
{
    fa_anchor* obj1 = (fa_anchor*)uNew(fa_anchor_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
