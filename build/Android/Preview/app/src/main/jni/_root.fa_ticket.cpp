// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ticket.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ticket.h>
...
// public partial sealed class fa_ticket :2
// {
// static fa_ticket() :4
static void fa_ticket__cctor_4_fn(uType* __type)
{
}

static void fa_ticket_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ticket__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ticket_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ticket);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ticket", options);
    type->fp_build_ = fa_ticket_build;
    type->fp_ctor_ = (void*)fa_ticket__New4_fn;
    type->fp_cctor_ = fa_ticket__cctor_4_fn;
...
// public fa_ticket() :8
void fa_ticket__ctor_8_fn(fa_ticket* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ticket__InitializeUX1_fn(fa_ticket* __this)
{
    __this->InitializeUX1();
}

// public fa_ticket New() :8
void fa_ticket__New4_fn(fa_ticket** __retval)
{
    *__retval = fa_ticket::New4();
}

// public fa_ticket() [instance] :8
void fa_ticket::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_ticket::InitializeUX1()
{
    uStackFrame __("fa_ticket", "InitializeUX()");
    Value(::STRINGS[0/*"\uF145"*/]);
    SourceLineNumber(612);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ticket New() [static] :8
fa_ticket* fa_ticket::New4()
{
    fa_ticket* obj1 = (fa_ticket*)uNew(fa_ticket_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
