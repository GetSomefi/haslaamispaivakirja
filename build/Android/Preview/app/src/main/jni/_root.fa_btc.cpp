// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_btc.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_btc.h>
...
// public partial sealed class fa_btc :2
// {
// static fa_btc() :4
static void fa_btc__cctor_4_fn(uType* __type)
{
}

static void fa_btc_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_btc__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_btc_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_btc);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_btc", options);
    type->fp_build_ = fa_btc_build;
    type->fp_ctor_ = (void*)fa_btc__New4_fn;
    type->fp_cctor_ = fa_btc__cctor_4_fn;
...
// public fa_btc() :8
void fa_btc__ctor_8_fn(fa_btc* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_btc__InitializeUX1_fn(fa_btc* __this)
{
    __this->InitializeUX1();
}

// public fa_btc New() :8
void fa_btc__New4_fn(fa_btc** __retval)
{
    *__retval = fa_btc::New4();
}

// public fa_btc() [instance] :8
void fa_btc::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_btc::InitializeUX1()
{
    uStackFrame __("fa_btc", "InitializeUX()");
    Value(::STRINGS[0/*"\uF15A"*/]);
    SourceLineNumber(86);
...
// public fa_btc New() [static] :8
fa_btc* fa_btc::New4()
{
    fa_btc* obj1 = (fa_btc*)uNew(fa_btc_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
