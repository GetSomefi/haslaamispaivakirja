// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basic.TitleText.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/basic.TitleText.ux");
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* TitleText_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("basic.TitleText", options);
...
{
    uStackFrame __("basic.TitleText", "InitializeUX()");
    FontSize(20.0f);
...
// public TitleText New() [static] :10
