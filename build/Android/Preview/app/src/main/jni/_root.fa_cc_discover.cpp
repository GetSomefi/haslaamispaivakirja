// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_discover.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_discover.h>
...
// public partial sealed class fa_cc_discover :2
// {
// static fa_cc_discover() :4
static void fa_cc_discover__cctor_4_fn(uType* __type)
{
}

static void fa_cc_discover_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_discover__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_discover_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_discover);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_discover", options);
    type->fp_build_ = fa_cc_discover_build;
    type->fp_ctor_ = (void*)fa_cc_discover__New4_fn;
    type->fp_cctor_ = fa_cc_discover__cctor_4_fn;
...
// public fa_cc_discover() :8
void fa_cc_discover__ctor_8_fn(fa_cc_discover* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_discover__InitializeUX1_fn(fa_cc_discover* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_discover New() :8
void fa_cc_discover__New4_fn(fa_cc_discover** __retval)
{
    *__retval = fa_cc_discover::New4();
}

// public fa_cc_discover() [instance] :8
void fa_cc_discover::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_discover::InitializeUX1()
{
    uStackFrame __("fa_cc_discover", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F2"*/]);
...
// public fa_cc_discover New() [static] :8
fa_cc_discover* fa_cc_discover::New4()
{
    fa_cc_discover* obj1 = (fa_cc_discover*)uNew(fa_cc_discover_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
