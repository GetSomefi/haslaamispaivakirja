// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mouse_pointer.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mouse_pointer.h>
...
// public partial sealed class fa_mouse_pointer :2
// {
// static fa_mouse_pointer() :4
static void fa_mouse_pointer__cctor_4_fn(uType* __type)
{
}

static void fa_mouse_pointer_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mouse_pointer__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mouse_pointer_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mouse_pointer);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mouse_pointer", options);
    type->fp_build_ = fa_mouse_pointer_build;
    type->fp_ctor_ = (void*)fa_mouse_pointer__New4_fn;
    type->fp_cctor_ = fa_mouse_pointer__cctor_4_fn;
...
// public fa_mouse_pointer() :8
void fa_mouse_pointer__ctor_8_fn(fa_mouse_pointer* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mouse_pointer__InitializeUX1_fn(fa_mouse_pointer* __this)
{
    __this->InitializeUX1();
}

// public fa_mouse_pointer New() :8
void fa_mouse_pointer__New4_fn(fa_mouse_pointer** __retval)
{
    *__retval = fa_mouse_pointer::New4();
}

// public fa_mouse_pointer() [instance] :8
void fa_mouse_pointer::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mouse_pointer::InitializeUX1()
{
    uStackFrame __("fa_mouse_pointer", "InitializeUX()");
    Value(::STRINGS[0/*"\uF245"*/]);
    SourceLineNumber(424);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mouse_pointer New() [static] :8
fa_mouse_pointer* fa_mouse_pointer::New4()
{
    fa_mouse_pointer* obj1 = (fa_mouse_pointer*)uNew(fa_mouse_pointer_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
