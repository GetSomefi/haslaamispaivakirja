// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_arrows_h.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_arrows_h.h>
...
// public partial sealed class fa_arrows_h :2
// {
// static fa_arrows_h() :4
static void fa_arrows_h__cctor_4_fn(uType* __type)
{
}

static void fa_arrows_h_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_arrows_h__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_arrows_h_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_arrows_h);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_arrows_h", options);
    type->fp_build_ = fa_arrows_h_build;
    type->fp_ctor_ = (void*)fa_arrows_h__New4_fn;
    type->fp_cctor_ = fa_arrows_h__cctor_4_fn;
...
// public fa_arrows_h() :8
void fa_arrows_h__ctor_8_fn(fa_arrows_h* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_arrows_h__InitializeUX1_fn(fa_arrows_h* __this)
{
    __this->InitializeUX1();
}

// public fa_arrows_h New() :8
void fa_arrows_h__New4_fn(fa_arrows_h** __retval)
{
    *__retval = fa_arrows_h::New4();
}

// public fa_arrows_h() [instance] :8
void fa_arrows_h::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_arrows_h::InitializeUX1()
{
    uStackFrame __("fa_arrows_h", "InitializeUX()");
    Value(::STRINGS[0/*"\uF07E"*/]);
    SourceLineNumber(39);
...
// public fa_arrows_h New() [static] :8
fa_arrows_h* fa_arrows_h::New4()
{
    fa_arrows_h* obj1 = (fa_arrows_h*)uNew(fa_arrows_h_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
