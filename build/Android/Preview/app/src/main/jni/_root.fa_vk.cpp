// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_vk.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_vk.h>
...
// public partial sealed class fa_vk :2
// {
// static fa_vk() :4
static void fa_vk__cctor_4_fn(uType* __type)
{
}

static void fa_vk_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_vk__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_vk_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_vk);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_vk", options);
    type->fp_build_ = fa_vk_build;
    type->fp_ctor_ = (void*)fa_vk__New4_fn;
    type->fp_cctor_ = fa_vk__cctor_4_fn;
...
// public fa_vk() :8
void fa_vk__ctor_8_fn(fa_vk* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_vk__InitializeUX1_fn(fa_vk* __this)
{
    __this->InitializeUX1();
}

// public fa_vk New() :8
void fa_vk__New4_fn(fa_vk** __retval)
{
    *__retval = fa_vk::New4();
}

// public fa_vk() [instance] :8
void fa_vk::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_vk::InitializeUX1()
{
    uStackFrame __("fa_vk", "InitializeUX()");
    Value(::STRINGS[0/*"\uF189"*/]);
    SourceLineNumber(668);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_vk New() [static] :8
fa_vk* fa_vk::New4()
{
    fa_vk* obj1 = (fa_vk*)uNew(fa_vk_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
