// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ge.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ge.h>
...
// public partial sealed class fa_ge :2
// {
// static fa_ge() :4
static void fa_ge__cctor_4_fn(uType* __type)
{
}

static void fa_ge_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ge__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ge_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ge);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ge", options);
    type->fp_build_ = fa_ge_build;
    type->fp_ctor_ = (void*)fa_ge__New4_fn;
    type->fp_cctor_ = fa_ge__cctor_4_fn;
...
// public fa_ge() :8
void fa_ge__ctor_8_fn(fa_ge* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ge__InitializeUX1_fn(fa_ge* __this)
{
    __this->InitializeUX1();
}

// public fa_ge New() :8
void fa_ge__New4_fn(fa_ge** __retval)
{
    *__retval = fa_ge::New4();
}

// public fa_ge() [instance] :8
void fa_ge::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_ge::InitializeUX1()
{
    uStackFrame __("fa_ge", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D1"*/]);
    SourceLineNumber(278);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ge New() [static] :8
fa_ge* fa_ge::New4()
{
    fa_ge* obj1 = (fa_ge*)uNew(fa_ge_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
