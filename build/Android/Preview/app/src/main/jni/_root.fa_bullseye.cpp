// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bullseye.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bullseye.h>
...
// public partial sealed class fa_bullseye :2
// {
// static fa_bullseye() :4
static void fa_bullseye__cctor_4_fn(uType* __type)
{
}

static void fa_bullseye_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bullseye__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bullseye_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bullseye);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bullseye", options);
    type->fp_build_ = fa_bullseye_build;
    type->fp_ctor_ = (void*)fa_bullseye__New4_fn;
    type->fp_cctor_ = fa_bullseye__cctor_4_fn;
...
// public fa_bullseye() :8
void fa_bullseye__ctor_8_fn(fa_bullseye* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bullseye__InitializeUX1_fn(fa_bullseye* __this)
{
    __this->InitializeUX1();
}

// public fa_bullseye New() :8
void fa_bullseye__New4_fn(fa_bullseye** __retval)
{
    *__retval = fa_bullseye::New4();
}

// public fa_bullseye() [instance] :8
void fa_bullseye::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bullseye::InitializeUX1()
{
    uStackFrame __("fa_bullseye", "InitializeUX()");
    Value(::STRINGS[0/*"\uF140"*/]);
    SourceLineNumber(91);
...
// public fa_bullseye New() [static] :8
fa_bullseye* fa_bullseye::New4()
{
    fa_bullseye* obj1 = (fa_bullseye*)uNew(fa_bullseye_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
