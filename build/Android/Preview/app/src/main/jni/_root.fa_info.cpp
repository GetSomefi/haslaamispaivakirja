// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_info.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_info.h>
...
// public partial sealed class fa_info :2
// {
// static fa_info() :4
static void fa_info__cctor_4_fn(uType* __type)
{
}

static void fa_info_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_info__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_info_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_info);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_info", options);
    type->fp_build_ = fa_info_build;
    type->fp_ctor_ = (void*)fa_info__New4_fn;
    type->fp_cctor_ = fa_info__cctor_4_fn;
...
// public fa_info() :8
void fa_info__ctor_8_fn(fa_info* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_info__InitializeUX1_fn(fa_info* __this)
{
    __this->InitializeUX1();
}

// public fa_info New() :8
void fa_info__New4_fn(fa_info** __retval)
{
    *__retval = fa_info::New4();
}

// public fa_info() [instance] :8
void fa_info::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_info::InitializeUX1()
{
    uStackFrame __("fa_info", "InitializeUX()");
    Value(::STRINGS[0/*"\uF129"*/]);
    SourceLineNumber(343);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_info New() [static] :8
fa_info* fa_info::New4()
{
    fa_info* obj1 = (fa_info*)uNew(fa_info_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
