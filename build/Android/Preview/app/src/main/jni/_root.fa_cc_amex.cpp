// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_amex.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_amex.h>
...
// public partial sealed class fa_cc_amex :2
// {
// static fa_cc_amex() :4
static void fa_cc_amex__cctor_4_fn(uType* __type)
{
}

static void fa_cc_amex_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_amex__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_amex_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_amex);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_amex", options);
    type->fp_build_ = fa_cc_amex_build;
    type->fp_ctor_ = (void*)fa_cc_amex__New4_fn;
    type->fp_cctor_ = fa_cc_amex__cctor_4_fn;
...
// public fa_cc_amex() :8
void fa_cc_amex__ctor_8_fn(fa_cc_amex* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_amex__InitializeUX1_fn(fa_cc_amex* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_amex New() :8
void fa_cc_amex__New4_fn(fa_cc_amex** __retval)
{
    *__retval = fa_cc_amex::New4();
}

// public fa_cc_amex() [instance] :8
void fa_cc_amex::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_amex::InitializeUX1()
{
    uStackFrame __("fa_cc_amex", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F3"*/]);
    SourceLineNumber(116);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cc_amex New() [static] :8
fa_cc_amex* fa_cc_amex::New4()
{
    fa_cc_amex* obj1 = (fa_cc_amex*)uNew(fa_cc_amex_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
