// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sheqel.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sheqel.h>
...
// public partial sealed class fa_sheqel :2
// {
// static fa_sheqel() :4
static void fa_sheqel__cctor_4_fn(uType* __type)
{
}

static void fa_sheqel_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sheqel__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sheqel_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sheqel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sheqel", options);
    type->fp_build_ = fa_sheqel_build;
    type->fp_ctor_ = (void*)fa_sheqel__New4_fn;
    type->fp_cctor_ = fa_sheqel__cctor_4_fn;
...
// public fa_sheqel() :8
void fa_sheqel__ctor_8_fn(fa_sheqel* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sheqel__InitializeUX1_fn(fa_sheqel* __this)
{
    __this->InitializeUX1();
}

// public fa_sheqel New() :8
void fa_sheqel__New4_fn(fa_sheqel** __retval)
{
    *__retval = fa_sheqel::New4();
}

// public fa_sheqel() [instance] :8
void fa_sheqel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sheqel::InitializeUX1()
{
    uStackFrame __("fa_sheqel", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20B"*/]);
    SourceLineNumber(527);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sheqel New() [static] :8
fa_sheqel* fa_sheqel::New4()
{
    fa_sheqel* obj1 = (fa_sheqel*)uNew(fa_sheqel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
