// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_toggle_right.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_toggle_right.h>
...
// public partial sealed class fa_toggle_right :2
// {
// static fa_toggle_right() :4
static void fa_toggle_right__cctor_4_fn(uType* __type)
{
}

static void fa_toggle_right_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_toggle_right__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_toggle_right_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_toggle_right);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_toggle_right", options);
    type->fp_build_ = fa_toggle_right_build;
    type->fp_ctor_ = (void*)fa_toggle_right__New4_fn;
    type->fp_cctor_ = fa_toggle_right__cctor_4_fn;
...
// public fa_toggle_right() :8
void fa_toggle_right__ctor_8_fn(fa_toggle_right* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_toggle_right__InitializeUX1_fn(fa_toggle_right* __this)
{
    __this->InitializeUX1();
}

// public fa_toggle_right New() :8
void fa_toggle_right__New4_fn(fa_toggle_right** __retval)
{
    *__retval = fa_toggle_right::New4();
}

// public fa_toggle_right() [instance] :8
void fa_toggle_right::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_toggle_right::InitializeUX1()
{
    uStackFrame __("fa_toggle_right", "InitializeUX()");
    Value(::STRINGS[0/*"\uF152"*/]);
    SourceLineNumber(621);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_toggle_right New() [static] :8
fa_toggle_right* fa_toggle_right::New4()
{
    fa_toggle_right* obj1 = (fa_toggle_right*)uNew(fa_toggle_right_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
