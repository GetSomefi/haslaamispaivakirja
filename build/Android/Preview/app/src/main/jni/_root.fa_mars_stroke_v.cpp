// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mars_stroke_v.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mars_stroke_v.h>
...
// public partial sealed class fa_mars_stroke_v :2
// {
// static fa_mars_stroke_v() :4
static void fa_mars_stroke_v__cctor_4_fn(uType* __type)
{
}

static void fa_mars_stroke_v_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mars_stroke_v__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mars_stroke_v_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mars_stroke_v);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mars_stroke_v", options);
    type->fp_build_ = fa_mars_stroke_v_build;
    type->fp_ctor_ = (void*)fa_mars_stroke_v__New4_fn;
    type->fp_cctor_ = fa_mars_stroke_v__cctor_4_fn;
...
// public fa_mars_stroke_v() :8
void fa_mars_stroke_v__ctor_8_fn(fa_mars_stroke_v* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mars_stroke_v__InitializeUX1_fn(fa_mars_stroke_v* __this)
{
    __this->InitializeUX1();
}

// public fa_mars_stroke_v New() :8
void fa_mars_stroke_v__New4_fn(fa_mars_stroke_v** __retval)
{
    *__retval = fa_mars_stroke_v::New4();
}

// public fa_mars_stroke_v() [instance] :8
void fa_mars_stroke_v::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mars_stroke_v::InitializeUX1()
{
    uStackFrame __("fa_mars_stroke_v", "InitializeUX()");
    Value(::STRINGS[0/*"\uF22A"*/]);
    SourceLineNumber(403);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mars_stroke_v New() [static] :8
fa_mars_stroke_v* fa_mars_stroke_v::New4()
{
    fa_mars_stroke_v* obj1 = (fa_mars_stroke_v*)uNew(fa_mars_stroke_v_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
