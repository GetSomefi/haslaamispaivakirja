// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_empire.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_empire.h>
...
// public partial sealed class fa_empire :2
// {
// static fa_empire() :4
static void fa_empire__cctor_4_fn(uType* __type)
{
}

static void fa_empire_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_empire__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_empire_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_empire);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_empire", options);
    type->fp_build_ = fa_empire_build;
    type->fp_ctor_ = (void*)fa_empire__New4_fn;
    type->fp_cctor_ = fa_empire__cctor_4_fn;
...
// public fa_empire() :8
void fa_empire__ctor_8_fn(fa_empire* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_empire__InitializeUX1_fn(fa_empire* __this)
{
    __this->InitializeUX1();
}

// public fa_empire New() :8
void fa_empire__New4_fn(fa_empire** __retval)
{
    *__retval = fa_empire::New4();
}

// public fa_empire() [instance] :8
void fa_empire::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_empire::InitializeUX1()
{
    uStackFrame __("fa_empire", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D1"*/]);
    SourceLineNumber(204);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_empire New() [static] :8
fa_empire* fa_empire::New4()
{
    fa_empire* obj1 = (fa_empire*)uNew(fa_empire_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
