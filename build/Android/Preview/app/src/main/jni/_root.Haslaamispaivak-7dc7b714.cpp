...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersActionsSetbool_Value_Property", "Get(Uno.UX.PropertyObject)");
    bool ret2;
...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersActionsSetbool_Value_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
