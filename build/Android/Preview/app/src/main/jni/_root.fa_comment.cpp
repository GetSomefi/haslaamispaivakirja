// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_comment.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_comment.h>
...
// public partial sealed class fa_comment :2
// {
// static fa_comment() :4
static void fa_comment__cctor_4_fn(uType* __type)
{
}

static void fa_comment_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_comment__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_comment_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_comment);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_comment", options);
    type->fp_build_ = fa_comment_build;
    type->fp_ctor_ = (void*)fa_comment__New4_fn;
    type->fp_cctor_ = fa_comment__cctor_4_fn;
...
// public fa_comment() :8
void fa_comment__ctor_8_fn(fa_comment* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_comment__InitializeUX1_fn(fa_comment* __this)
{
    __this->InitializeUX1();
}

// public fa_comment New() :8
void fa_comment__New4_fn(fa_comment** __retval)
{
    *__retval = fa_comment::New4();
}

// public fa_comment() [instance] :8
void fa_comment::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_comment::InitializeUX1()
{
    uStackFrame __("fa_comment", "InitializeUX()");
    Value(::STRINGS[0/*"\uF075"*/]);
    SourceLineNumber(162);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_comment New() [static] :8
fa_comment* fa_comment::New4()
{
    fa_comment* obj1 = (fa_comment*)uNew(fa_comment_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
