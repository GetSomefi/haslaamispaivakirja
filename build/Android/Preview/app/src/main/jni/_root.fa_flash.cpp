// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_flash.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_flash.h>
...
// public partial sealed class fa_flash :2
// {
// static fa_flash() :4
static void fa_flash__cctor_4_fn(uType* __type)
{
}

static void fa_flash_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_flash__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_flash_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_flash);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_flash", options);
    type->fp_build_ = fa_flash_build;
    type->fp_ctor_ = (void*)fa_flash__New4_fn;
    type->fp_cctor_ = fa_flash__cctor_4_fn;
...
// public fa_flash() :8
void fa_flash__ctor_8_fn(fa_flash* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_flash__InitializeUX1_fn(fa_flash* __this)
{
    __this->InitializeUX1();
}

// public fa_flash New() :8
void fa_flash__New4_fn(fa_flash** __retval)
{
    *__retval = fa_flash::New4();
}

// public fa_flash() [instance] :8
void fa_flash::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_flash::InitializeUX1()
{
    uStackFrame __("fa_flash", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E7"*/]);
...
// public fa_flash New() [static] :8
fa_flash* fa_flash::New4()
{
    fa_flash* obj1 = (fa_flash*)uNew(fa_flash_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
