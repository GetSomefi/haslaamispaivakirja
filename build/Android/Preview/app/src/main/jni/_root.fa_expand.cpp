// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_expand.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_expand.h>
...
// public partial sealed class fa_expand :2
// {
// static fa_expand() :4
static void fa_expand__cctor_4_fn(uType* __type)
{
}

static void fa_expand_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_expand__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_expand_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_expand);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_expand", options);
    type->fp_build_ = fa_expand_build;
    type->fp_ctor_ = (void*)fa_expand__New4_fn;
    type->fp_cctor_ = fa_expand__cctor_4_fn;
...
// public fa_expand() :8
void fa_expand__ctor_8_fn(fa_expand* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_expand__InitializeUX1_fn(fa_expand* __this)
{
    __this->InitializeUX1();
}

// public fa_expand New() :8
void fa_expand__New4_fn(fa_expand** __retval)
{
    *__retval = fa_expand::New4();
}

// public fa_expand() [instance] :8
void fa_expand::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_expand::InitializeUX1()
{
    uStackFrame __("fa_expand", "InitializeUX()");
    Value(::STRINGS[0/*"\uF065"*/]);
    SourceLineNumber(215);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_expand New() [static] :8
fa_expand* fa_expand::New4()
{
    fa_expand* obj1 = (fa_expand*)uNew(fa_expand_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
