// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bed.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bed.h>
...
// public partial sealed class fa_bed :2
// {
// static fa_bed() :4
static void fa_bed__cctor_4_fn(uType* __type)
{
}

static void fa_bed_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bed__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bed_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bed);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bed", options);
    type->fp_build_ = fa_bed_build;
    type->fp_ctor_ = (void*)fa_bed__New4_fn;
    type->fp_cctor_ = fa_bed__cctor_4_fn;
...
// public fa_bed() :8
void fa_bed__ctor_8_fn(fa_bed* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bed__InitializeUX1_fn(fa_bed* __this)
{
    __this->InitializeUX1();
}

// public fa_bed New() :8
void fa_bed__New4_fn(fa_bed** __retval)
{
    *__retval = fa_bed::New4();
}

// public fa_bed() [instance] :8
void fa_bed::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bed::InitializeUX1()
{
    uStackFrame __("fa_bed", "InitializeUX()");
    Value(::STRINGS[0/*"\uF236"*/]);
    SourceLineNumber(62);
...
// public fa_bed New() [static] :8
fa_bed* fa_bed::New4()
{
    fa_bed* obj1 = (fa_bed*)uNew(fa_bed_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
