// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_venus_mars.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_venus_mars.h>
...
// public partial sealed class fa_venus_mars :2
// {
// static fa_venus_mars() :4
static void fa_venus_mars__cctor_4_fn(uType* __type)
{
}

static void fa_venus_mars_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_venus_mars__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_venus_mars_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_venus_mars);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_venus_mars", options);
    type->fp_build_ = fa_venus_mars_build;
    type->fp_ctor_ = (void*)fa_venus_mars__New4_fn;
    type->fp_cctor_ = fa_venus_mars__cctor_4_fn;
...
// public fa_venus_mars() :8
void fa_venus_mars__ctor_8_fn(fa_venus_mars* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_venus_mars__InitializeUX1_fn(fa_venus_mars* __this)
{
    __this->InitializeUX1();
}

// public fa_venus_mars New() :8
void fa_venus_mars__New4_fn(fa_venus_mars** __retval)
{
    *__retval = fa_venus_mars::New4();
}

// public fa_venus_mars() [instance] :8
void fa_venus_mars::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_venus_mars::InitializeUX1()
{
    uStackFrame __("fa_venus_mars", "InitializeUX()");
    Value(::STRINGS[0/*"\uF228"*/]);
    SourceLineNumber(662);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_venus_mars New() [static] :8
fa_venus_mars* fa_venus_mars::New4()
{
    fa_venus_mars* obj1 = (fa_venus_mars*)uNew(fa_venus_mars_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
