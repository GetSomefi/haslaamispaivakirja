// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_y_combinator.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_y_combinator.h>
...
// public partial sealed class fa_y_combinator :2
// {
// static fa_y_combinator() :4
static void fa_y_combinator__cctor_4_fn(uType* __type)
{
}

static void fa_y_combinator_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_y_combinator__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_y_combinator_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_y_combinator);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_y_combinator", options);
    type->fp_build_ = fa_y_combinator_build;
    type->fp_ctor_ = (void*)fa_y_combinator__New4_fn;
    type->fp_cctor_ = fa_y_combinator__cctor_4_fn;
...
// public fa_y_combinator() :8
void fa_y_combinator__ctor_8_fn(fa_y_combinator* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_y_combinator__InitializeUX1_fn(fa_y_combinator* __this)
{
    __this->InitializeUX1();
}

// public fa_y_combinator New() :8
void fa_y_combinator__New4_fn(fa_y_combinator** __retval)
{
    *__retval = fa_y_combinator::New4();
}

// public fa_y_combinator() [instance] :8
void fa_y_combinator::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_y_combinator::InitializeUX1()
{
    uStackFrame __("fa_y_combinator", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23B"*/]);
    SourceLineNumber(686);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_y_combinator New() [static] :8
fa_y_combinator* fa_y_combinator::New4()
{
    fa_y_combinator* obj1 = (fa_y_combinator*)uNew(fa_y_combinator_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
