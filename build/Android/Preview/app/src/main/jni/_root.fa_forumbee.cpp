// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_forumbee.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_forumbee.h>
...
// public partial sealed class fa_forumbee :2
// {
// static fa_forumbee() :4
static void fa_forumbee__cctor_4_fn(uType* __type)
{
}

static void fa_forumbee_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_forumbee__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_forumbee_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_forumbee);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_forumbee", options);
    type->fp_build_ = fa_forumbee_build;
    type->fp_ctor_ = (void*)fa_forumbee__New4_fn;
    type->fp_cctor_ = fa_forumbee__cctor_4_fn;
...
// public fa_forumbee() :8
void fa_forumbee__ctor_8_fn(fa_forumbee* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_forumbee__InitializeUX1_fn(fa_forumbee* __this)
{
    __this->InitializeUX1();
}

// public fa_forumbee New() :8
void fa_forumbee__New4_fn(fa_forumbee** __retval)
{
    *__retval = fa_forumbee::New4();
}

// public fa_forumbee() [instance] :8
void fa_forumbee::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_forumbee::InitializeUX1()
{
    uStackFrame __("fa_forumbee", "InitializeUX()");
    Value(::STRINGS[0/*"\uF211"*/]);
    SourceLineNumber(270);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_forumbee New() [static] :8
fa_forumbee* fa_forumbee::New4()
{
    fa_forumbee* obj1 = (fa_forumbee*)uNew(fa_forumbee_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
