// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pencil.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pencil.h>
...
// public partial sealed class fa_pencil :2
// {
// static fa_pencil() :4
static void fa_pencil__cctor_4_fn(uType* __type)
{
}

static void fa_pencil_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pencil__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pencil_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pencil);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pencil", options);
    type->fp_build_ = fa_pencil_build;
    type->fp_ctor_ = (void*)fa_pencil__New4_fn;
    type->fp_cctor_ = fa_pencil__cctor_4_fn;
...
// public fa_pencil() :8
void fa_pencil__ctor_8_fn(fa_pencil* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pencil__InitializeUX1_fn(fa_pencil* __this)
{
    __this->InitializeUX1();
}

// public fa_pencil New() :8
void fa_pencil__New4_fn(fa_pencil** __retval)
{
    *__retval = fa_pencil::New4();
}

// public fa_pencil() [instance] :8
void fa_pencil::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pencil::InitializeUX1()
{
    uStackFrame __("fa_pencil", "InitializeUX()");
    Value(::STRINGS[0/*"\uF040"*/]);
    SourceLineNumber(450);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pencil New() [static] :8
fa_pencil* fa_pencil::New4()
{
    fa_pencil* obj1 = (fa_pencil*)uNew(fa_pencil_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
