// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_flickr.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_flickr.h>
...
// public partial sealed class fa_flickr :2
// {
// static fa_flickr() :4
static void fa_flickr__cctor_4_fn(uType* __type)
{
}

static void fa_flickr_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_flickr__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_flickr_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_flickr);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_flickr", options);
    type->fp_build_ = fa_flickr_build;
    type->fp_ctor_ = (void*)fa_flickr__New4_fn;
    type->fp_cctor_ = fa_flickr__cctor_4_fn;
...
// public fa_flickr() :8
void fa_flickr__ctor_8_fn(fa_flickr* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_flickr__InitializeUX1_fn(fa_flickr* __this)
{
    __this->InitializeUX1();
}

// public fa_flickr New() :8
void fa_flickr__New4_fn(fa_flickr** __retval)
{
    *__retval = fa_flickr::New4();
}

// public fa_flickr() [instance] :8
void fa_flickr::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_flickr::InitializeUX1()
{
    uStackFrame __("fa_flickr", "InitializeUX()");
    Value(::STRINGS[0/*"\uF16E"*/]);
    SourceLineNumber(261);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_flickr New() [static] :8
fa_flickr* fa_flickr::New4()
{
    fa_flickr* obj1 = (fa_flickr*)uNew(fa_flickr_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
