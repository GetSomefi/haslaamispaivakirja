// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gears.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gears.h>
...
// public partial sealed class fa_gears :2
// {
// static fa_gears() :4
static void fa_gears__cctor_4_fn(uType* __type)
{
}

static void fa_gears_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gears__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gears_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gears);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gears", options);
    type->fp_build_ = fa_gears_build;
    type->fp_ctor_ = (void*)fa_gears__New4_fn;
    type->fp_cctor_ = fa_gears__cctor_4_fn;
...
// public fa_gears() :8
void fa_gears__ctor_8_fn(fa_gears* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gears__InitializeUX1_fn(fa_gears* __this)
{
    __this->InitializeUX1();
}

// public fa_gears New() :8
void fa_gears__New4_fn(fa_gears** __retval)
{
    *__retval = fa_gears::New4();
}

// public fa_gears() [instance] :8
void fa_gears::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_gears::InitializeUX1()
{
    uStackFrame __("fa_gears", "InitializeUX()");
    Value(::STRINGS[0/*"\uF085"*/]);
...
// public fa_gears New() [static] :8
fa_gears* fa_gears::New4()
{
    fa_gears* obj1 = (fa_gears*)uNew(fa_gears_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
