// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_vimeo.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_vimeo.h>
...
// public partial sealed class fa_vimeo :2
// {
// static fa_vimeo() :4
static void fa_vimeo__cctor_4_fn(uType* __type)
{
}

static void fa_vimeo_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_vimeo__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_vimeo_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_vimeo);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_vimeo", options);
    type->fp_build_ = fa_vimeo_build;
    type->fp_ctor_ = (void*)fa_vimeo__New4_fn;
    type->fp_cctor_ = fa_vimeo__cctor_4_fn;
...
// public fa_vimeo() :8
void fa_vimeo__ctor_8_fn(fa_vimeo* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_vimeo__InitializeUX1_fn(fa_vimeo* __this)
{
    __this->InitializeUX1();
}

// public fa_vimeo New() :8
void fa_vimeo__New4_fn(fa_vimeo** __retval)
{
    *__retval = fa_vimeo::New4();
}

// public fa_vimeo() [instance] :8
void fa_vimeo::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_vimeo::InitializeUX1()
{
    uStackFrame __("fa_vimeo", "InitializeUX()");
    Value(::STRINGS[0/*"\uF27D"*/]);
    SourceLineNumber(665);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_vimeo New() [static] :8
fa_vimeo* fa_vimeo::New4()
{
    fa_vimeo* obj1 = (fa_vimeo*)uNew(fa_vimeo_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
