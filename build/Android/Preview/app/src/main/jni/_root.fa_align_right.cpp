// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_align_right.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_align_right.h>
...
// public partial sealed class fa_align_right :2
// {
// static fa_align_right() :4
static void fa_align_right__cctor_4_fn(uType* __type)
{
}

static void fa_align_right_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\270");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_align_right__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_align_right_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_align_right);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_align_right", options);
    type->fp_build_ = fa_align_right_build;
    type->fp_ctor_ = (void*)fa_align_right__New4_fn;
    type->fp_cctor_ = fa_align_right__cctor_4_fn;
...
// public fa_align_right() :8
void fa_align_right__ctor_8_fn(fa_align_right* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_align_right__InitializeUX1_fn(fa_align_right* __this)
{
    __this->InitializeUX1();
}

// public fa_align_right New() :8
void fa_align_right__New4_fn(fa_align_right** __retval)
{
    *__retval = fa_align_right::New4();
}

// public fa_align_right() [instance] :8
void fa_align_right::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_align_right::InitializeUX1()
{
    uStackFrame __("fa_align_right", "InitializeUX()");
    Value(::STRINGS[0/*"\uF038"*/]);
    SourceLineNumber(8);
...
// public fa_align_right New() [static] :8
fa_align_right* fa_align_right::New4()
{
    fa_align_right* obj1 = (fa_align_right*)uNew(fa_align_right_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
