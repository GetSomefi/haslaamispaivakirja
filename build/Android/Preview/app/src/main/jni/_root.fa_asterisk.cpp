// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_asterisk.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_asterisk.h>
...
// public partial sealed class fa_asterisk :2
// {
// static fa_asterisk() :4
static void fa_asterisk__cctor_4_fn(uType* __type)
{
}

static void fa_asterisk_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_asterisk__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_asterisk_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_asterisk);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_asterisk", options);
    type->fp_build_ = fa_asterisk_build;
    type->fp_ctor_ = (void*)fa_asterisk__New4_fn;
    type->fp_cctor_ = fa_asterisk__cctor_4_fn;
...
// public fa_asterisk() :8
void fa_asterisk__ctor_8_fn(fa_asterisk* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_asterisk__InitializeUX1_fn(fa_asterisk* __this)
{
    __this->InitializeUX1();
}

// public fa_asterisk New() :8
void fa_asterisk__New4_fn(fa_asterisk** __retval)
{
    *__retval = fa_asterisk::New4();
}

// public fa_asterisk() [instance] :8
void fa_asterisk::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_asterisk::InitializeUX1()
{
    uStackFrame __("fa_asterisk", "InitializeUX()");
    Value(::STRINGS[0/*"\uF069"*/]);
    SourceLineNumber(41);
...
// public fa_asterisk New() [static] :8
fa_asterisk* fa_asterisk::New4()
{
    fa_asterisk* obj1 = (fa_asterisk*)uNew(fa_asterisk_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
