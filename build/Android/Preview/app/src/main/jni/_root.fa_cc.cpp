// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc.h>
...
// public partial sealed class fa_cc :2
// {
// static fa_cc() :4
static void fa_cc__cctor_4_fn(uType* __type)
{
}

static void fa_cc_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc", options);
    type->fp_build_ = fa_cc_build;
    type->fp_ctor_ = (void*)fa_cc__New4_fn;
    type->fp_cctor_ = fa_cc__cctor_4_fn;
...
// public fa_cc() :8
void fa_cc__ctor_8_fn(fa_cc* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc__InitializeUX1_fn(fa_cc* __this)
{
    __this->InitializeUX1();
}

// public fa_cc New() :8
void fa_cc__New4_fn(fa_cc** __retval)
{
    *__retval = fa_cc::New4();
}

// public fa_cc() [instance] :8
void fa_cc::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cc::InitializeUX1()
{
    uStackFrame __("fa_cc", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20A"*/]);
    SourceLineNumber(115);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cc New() [static] :8
fa_cc* fa_cc::New4()
{
    fa_cc* obj1 = (fa_cc*)uNew(fa_cc_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
