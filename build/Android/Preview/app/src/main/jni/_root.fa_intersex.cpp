// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_intersex.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_intersex.h>
...
// public partial sealed class fa_intersex :2
// {
// static fa_intersex() :4
static void fa_intersex__cctor_4_fn(uType* __type)
{
}

static void fa_intersex_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_intersex__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_intersex_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_intersex);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_intersex", options);
    type->fp_build_ = fa_intersex_build;
    type->fp_ctor_ = (void*)fa_intersex__New4_fn;
    type->fp_cctor_ = fa_intersex__cctor_4_fn;
...
// public fa_intersex() :8
void fa_intersex__ctor_8_fn(fa_intersex* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_intersex__InitializeUX1_fn(fa_intersex* __this)
{
    __this->InitializeUX1();
}

// public fa_intersex New() :8
void fa_intersex__New4_fn(fa_intersex** __retval)
{
    *__retval = fa_intersex::New4();
}

// public fa_intersex() [instance] :8
void fa_intersex::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_intersex::InitializeUX1()
{
    uStackFrame __("fa_intersex", "InitializeUX()");
    Value(::STRINGS[0/*"\uF224"*/]);
    SourceLineNumber(349);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_intersex New() [static] :8
fa_intersex* fa_intersex::New4()
{
    fa_intersex* obj1 = (fa_intersex*)uNew(fa_intersex_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
