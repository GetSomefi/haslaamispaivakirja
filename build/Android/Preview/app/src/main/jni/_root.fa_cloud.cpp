// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cloud.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cloud.h>
...
// public partial sealed class fa_cloud :2
// {
// static fa_cloud() :4
static void fa_cloud__cctor_4_fn(uType* __type)
{
}

static void fa_cloud_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cloud__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cloud_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cloud);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cloud", options);
    type->fp_build_ = fa_cloud_build;
    type->fp_ctor_ = (void*)fa_cloud__New4_fn;
    type->fp_cctor_ = fa_cloud__cctor_4_fn;
...
// public fa_cloud() :8
void fa_cloud__ctor_8_fn(fa_cloud* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cloud__InitializeUX1_fn(fa_cloud* __this)
{
    __this->InitializeUX1();
}

// public fa_cloud New() :8
void fa_cloud__New4_fn(fa_cloud** __retval)
{
    *__retval = fa_cloud::New4();
}

// public fa_cloud() [instance] :8
void fa_cloud::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cloud::InitializeUX1()
{
    uStackFrame __("fa_cloud", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C2"*/]);
    SourceLineNumber(150);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cloud New() [static] :8
fa_cloud* fa_cloud::New4()
{
    fa_cloud* obj1 = (fa_cloud*)uNew(fa_cloud_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
