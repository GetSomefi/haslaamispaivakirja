// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_heartbeat.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_heartbeat.h>
...
// public partial sealed class fa_heartbeat :2
// {
// static fa_heartbeat() :4
static void fa_heartbeat__cctor_4_fn(uType* __type)
{
}

static void fa_heartbeat_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_heartbeat__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_heartbeat_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_heartbeat);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_heartbeat", options);
    type->fp_build_ = fa_heartbeat_build;
    type->fp_ctor_ = (void*)fa_heartbeat__New4_fn;
    type->fp_cctor_ = fa_heartbeat__cctor_4_fn;
...
// public fa_heartbeat() :8
void fa_heartbeat__ctor_8_fn(fa_heartbeat* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_heartbeat__InitializeUX1_fn(fa_heartbeat* __this)
{
    __this->InitializeUX1();
}

// public fa_heartbeat New() :8
void fa_heartbeat__New4_fn(fa_heartbeat** __retval)
{
    *__retval = fa_heartbeat::New4();
}

// public fa_heartbeat() [instance] :8
void fa_heartbeat::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_heartbeat::InitializeUX1()
{
    uStackFrame __("fa_heartbeat", "InitializeUX()");
    Value(::STRINGS[0/*"\uF21E"*/]);
    SourceLineNumber(322);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_heartbeat New() [static] :8
fa_heartbeat* fa_heartbeat::New4()
{
    fa_heartbeat* obj1 = (fa_heartbeat*)uNew(fa_heartbeat_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
