// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_share.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_share.h>
...
// public partial sealed class fa_share :2
// {
// static fa_share() :4
static void fa_share__cctor_4_fn(uType* __type)
{
}

static void fa_share_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_share__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_share_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_share);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_share", options);
    type->fp_build_ = fa_share_build;
    type->fp_ctor_ = (void*)fa_share__New4_fn;
    type->fp_cctor_ = fa_share__cctor_4_fn;
...
// public fa_share() :8
void fa_share__ctor_8_fn(fa_share* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_share__InitializeUX1_fn(fa_share* __this)
{
    __this->InitializeUX1();
}

// public fa_share New() :8
void fa_share__New4_fn(fa_share** __retval)
{
    *__retval = fa_share::New4();
}

// public fa_share() [instance] :8
void fa_share::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_share::InitializeUX1()
{
    uStackFrame __("fa_share", "InitializeUX()");
    Value(::STRINGS[0/*"\uF064"*/]);
    SourceLineNumber(521);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_share New() [static] :8
fa_share* fa_share::New4()
{
    fa_share* obj1 = (fa_share*)uNew(fa_share_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
