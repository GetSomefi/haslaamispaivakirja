// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bolt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bolt.h>
...
// public partial sealed class fa_bolt :2
// {
// static fa_bolt() :4
static void fa_bolt__cctor_4_fn(uType* __type)
{
}

static void fa_bolt_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bolt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bolt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bolt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bolt", options);
    type->fp_build_ = fa_bolt_build;
    type->fp_ctor_ = (void*)fa_bolt__New4_fn;
    type->fp_cctor_ = fa_bolt__cctor_4_fn;
...
// public fa_bolt() :8
void fa_bolt__ctor_8_fn(fa_bolt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bolt__InitializeUX1_fn(fa_bolt* __this)
{
    __this->InitializeUX1();
}

// public fa_bolt New() :8
void fa_bolt__New4_fn(fa_bolt** __retval)
{
    *__retval = fa_bolt::New4();
}

// public fa_bolt() [instance] :8
void fa_bolt::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bolt::InitializeUX1()
{
    uStackFrame __("fa_bolt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E7"*/]);
    SourceLineNumber(80);
...
// public fa_bolt New() [static] :8
fa_bolt* fa_bolt::New4()
{
    fa_bolt* obj1 = (fa_bolt*)uNew(fa_bolt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
