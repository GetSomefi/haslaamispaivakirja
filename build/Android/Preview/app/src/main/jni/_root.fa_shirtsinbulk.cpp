// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_shirtsinbulk.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_shirtsinbulk.h>
...
// public partial sealed class fa_shirtsinbulk :2
// {
// static fa_shirtsinbulk() :4
static void fa_shirtsinbulk__cctor_4_fn(uType* __type)
{
}

static void fa_shirtsinbulk_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\224");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_shirtsinbulk__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_shirtsinbulk_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_shirtsinbulk);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_shirtsinbulk", options);
    type->fp_build_ = fa_shirtsinbulk_build;
    type->fp_ctor_ = (void*)fa_shirtsinbulk__New4_fn;
    type->fp_cctor_ = fa_shirtsinbulk__cctor_4_fn;
...
// public fa_shirtsinbulk() :8
void fa_shirtsinbulk__ctor_8_fn(fa_shirtsinbulk* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_shirtsinbulk__InitializeUX1_fn(fa_shirtsinbulk* __this)
{
    __this->InitializeUX1();
}

// public fa_shirtsinbulk New() :8
void fa_shirtsinbulk__New4_fn(fa_shirtsinbulk** __retval)
{
    *__retval = fa_shirtsinbulk::New4();
}

// public fa_shirtsinbulk() [instance] :8
void fa_shirtsinbulk::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_shirtsinbulk::InitializeUX1()
{
    uStackFrame __("fa_shirtsinbulk", "InitializeUX()");
    Value(::STRINGS[0/*"\uF214"*/]);
    SourceLineNumber(530);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_shirtsinbulk New() [static] :8
fa_shirtsinbulk* fa_shirtsinbulk::New4()
{
    fa_shirtsinbulk* obj1 = (fa_shirtsinbulk*)uNew(fa_shirtsinbulk_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
