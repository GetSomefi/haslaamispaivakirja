// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dropbox.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dropbox.h>
...
// public partial sealed class fa_dropbox :2
// {
// static fa_dropbox() :4
static void fa_dropbox__cctor_4_fn(uType* __type)
{
}

static void fa_dropbox_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dropbox__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dropbox_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dropbox);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dropbox", options);
    type->fp_build_ = fa_dropbox_build;
    type->fp_ctor_ = (void*)fa_dropbox__New4_fn;
    type->fp_cctor_ = fa_dropbox__cctor_4_fn;
...
// public fa_dropbox() :8
void fa_dropbox__ctor_8_fn(fa_dropbox* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dropbox__InitializeUX1_fn(fa_dropbox* __this)
{
    __this->InitializeUX1();
}

// public fa_dropbox New() :8
void fa_dropbox__New4_fn(fa_dropbox** __retval)
{
    *__retval = fa_dropbox::New4();
}

// public fa_dropbox() [instance] :8
void fa_dropbox::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dropbox::InitializeUX1()
{
    uStackFrame __("fa_dropbox", "InitializeUX()");
    Value(::STRINGS[0/*"\uF16B"*/]);
    SourceLineNumber(197);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dropbox New() [static] :8
fa_dropbox* fa_dropbox::New4()
{
    fa_dropbox* obj1 = (fa_dropbox*)uNew(fa_dropbox_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
