// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_i_cursor.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_i_cursor.h>
...
// public partial sealed class fa_i_cursor :2
// {
// static fa_i_cursor() :4
static void fa_i_cursor__cctor_4_fn(uType* __type)
{
}

static void fa_i_cursor_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\206");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_i_cursor__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_i_cursor_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_i_cursor);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_i_cursor", options);
    type->fp_build_ = fa_i_cursor_build;
    type->fp_ctor_ = (void*)fa_i_cursor__New4_fn;
    type->fp_cctor_ = fa_i_cursor__cctor_4_fn;
...
// public fa_i_cursor() :8
void fa_i_cursor__ctor_8_fn(fa_i_cursor* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_i_cursor__InitializeUX1_fn(fa_i_cursor* __this)
{
    __this->InitializeUX1();
}

// public fa_i_cursor New() :8
void fa_i_cursor__New4_fn(fa_i_cursor** __retval)
{
    *__retval = fa_i_cursor::New4();
}

// public fa_i_cursor() [instance] :8
void fa_i_cursor::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_i_cursor::InitializeUX1()
{
    uStackFrame __("fa_i_cursor", "InitializeUX()");
    Value(::STRINGS[0/*"\uF246"*/]);
    SourceLineNumber(337);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_i_cursor New() [static] :8
fa_i_cursor* fa_i_cursor::New4()
{
    fa_i_cursor* obj1 = (fa_i_cursor*)uNew(fa_i_cursor_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
