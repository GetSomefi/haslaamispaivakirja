// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_caret_square_o_down.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_caret_square_o_down.h>
...
// public partial sealed class fa_caret_square_o_down :2
// {
// static fa_caret_square_o_down() :4
static void fa_caret_square_o_down__cctor_4_fn(uType* __type)
{
}

static void fa_caret_square_o_down_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_caret_square_o_down__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_caret_square_o_down_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_caret_square_o_down);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_caret_square_o_down", options);
    type->fp_build_ = fa_caret_square_o_down_build;
    type->fp_ctor_ = (void*)fa_caret_square_o_down__New4_fn;
    type->fp_cctor_ = fa_caret_square_o_down__cctor_4_fn;
...
// public fa_caret_square_o_down() :8
void fa_caret_square_o_down__ctor_8_fn(fa_caret_square_o_down* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_caret_square_o_down__InitializeUX1_fn(fa_caret_square_o_down* __this)
{
    __this->InitializeUX1();
}

// public fa_caret_square_o_down New() :8
void fa_caret_square_o_down__New4_fn(fa_caret_square_o_down** __retval)
{
    *__retval = fa_caret_square_o_down::New4();
}

// public fa_caret_square_o_down() [instance] :8
void fa_caret_square_o_down::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_caret_square_o_down::InitializeUX1()
{
    uStackFrame __("fa_caret_square_o_down", "InitializeUX()");
    Value(::STRINGS[0/*"\uF150"*/]);
...
// public fa_caret_square_o_down New() [static] :8
fa_caret_square_o_down* fa_caret_square_o_down::New4()
{
    fa_caret_square_o_down* obj1 = (fa_caret_square_o_down*)uNew(fa_caret_square_o_down_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
