// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_save.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_save.h>
...
// public partial sealed class fa_save :2
// {
// static fa_save() :4
static void fa_save__cctor_4_fn(uType* __type)
{
}

static void fa_save_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_save__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_save_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_save);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_save", options);
    type->fp_build_ = fa_save_build;
    type->fp_ctor_ = (void*)fa_save__New4_fn;
    type->fp_cctor_ = fa_save__cctor_4_fn;
...
// public fa_save() :8
void fa_save__ctor_8_fn(fa_save* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_save__InitializeUX1_fn(fa_save* __this)
{
    __this->InitializeUX1();
}

// public fa_save New() :8
void fa_save__New4_fn(fa_save** __retval)
{
    *__retval = fa_save::New4();
}

// public fa_save() [instance] :8
void fa_save::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_save::InitializeUX1()
{
    uStackFrame __("fa_save", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C7"*/]);
    SourceLineNumber(511);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_save New() [static] :8
fa_save* fa_save::New4()
{
    fa_save* obj1 = (fa_save*)uNew(fa_save_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
