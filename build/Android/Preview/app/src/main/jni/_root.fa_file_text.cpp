// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_file_text.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_file_text.h>
...
// public partial sealed class fa_file_text :2
// {
// static fa_file_text() :4
static void fa_file_text__cctor_4_fn(uType* __type)
{
}

static void fa_file_text_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_file_text__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_file_text_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_file_text);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_file_text", options);
    type->fp_build_ = fa_file_text_build;
    type->fp_ctor_ = (void*)fa_file_text__New4_fn;
    type->fp_cctor_ = fa_file_text__cctor_4_fn;
...
// public fa_file_text() :8
void fa_file_text__ctor_8_fn(fa_file_text* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_file_text__InitializeUX1_fn(fa_file_text* __this)
{
    __this->InitializeUX1();
}

// public fa_file_text New() :8
void fa_file_text__New4_fn(fa_file_text** __retval)
{
    *__retval = fa_file_text::New4();
}

// public fa_file_text() [instance] :8
void fa_file_text::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_file_text::InitializeUX1()
{
    uStackFrame __("fa_file_text", "InitializeUX()");
    Value(::STRINGS[0/*"\uF15C"*/]);
...
// public fa_file_text New() [static] :8
fa_file_text* fa_file_text::New4()
{
    fa_file_text* obj1 = (fa_file_text*)uNew(fa_file_text_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
