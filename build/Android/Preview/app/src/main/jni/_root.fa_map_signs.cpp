// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_map_signs.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_map_signs.h>
...
// public partial sealed class fa_map_signs :2
// {
// static fa_map_signs() :4
static void fa_map_signs__cctor_4_fn(uType* __type)
{
}

static void fa_map_signs_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\267");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_map_signs__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_map_signs_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_map_signs);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_map_signs", options);
    type->fp_build_ = fa_map_signs_build;
    type->fp_ctor_ = (void*)fa_map_signs__New4_fn;
    type->fp_cctor_ = fa_map_signs__cctor_4_fn;
...
// public fa_map_signs() :8
void fa_map_signs__ctor_8_fn(fa_map_signs* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_map_signs__InitializeUX1_fn(fa_map_signs* __this)
{
    __this->InitializeUX1();
}

// public fa_map_signs New() :8
void fa_map_signs__New4_fn(fa_map_signs** __retval)
{
    *__retval = fa_map_signs::New4();
}

// public fa_map_signs() [instance] :8
void fa_map_signs::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_map_signs::InitializeUX1()
{
    uStackFrame __("fa_map_signs", "InitializeUX()");
    Value(::STRINGS[0/*"\uF277"*/]);
    SourceLineNumber(398);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_map_signs New() [static] :8
fa_map_signs* fa_map_signs::New4()
{
    fa_map_signs* obj1 = (fa_map_signs*)uNew(fa_map_signs_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
