// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mars_stroke.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mars_stroke.h>
...
// public partial sealed class fa_mars_stroke :2
// {
// static fa_mars_stroke() :4
static void fa_mars_stroke__cctor_4_fn(uType* __type)
{
}

static void fa_mars_stroke_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mars_stroke__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mars_stroke_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mars_stroke);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mars_stroke", options);
    type->fp_build_ = fa_mars_stroke_build;
    type->fp_ctor_ = (void*)fa_mars_stroke__New4_fn;
    type->fp_cctor_ = fa_mars_stroke__cctor_4_fn;
...
// public fa_mars_stroke() :8
void fa_mars_stroke__ctor_8_fn(fa_mars_stroke* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mars_stroke__InitializeUX1_fn(fa_mars_stroke* __this)
{
    __this->InitializeUX1();
}

// public fa_mars_stroke New() :8
void fa_mars_stroke__New4_fn(fa_mars_stroke** __retval)
{
    *__retval = fa_mars_stroke::New4();
}

// public fa_mars_stroke() [instance] :8
void fa_mars_stroke::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mars_stroke::InitializeUX1()
{
    uStackFrame __("fa_mars_stroke", "InitializeUX()");
    Value(::STRINGS[0/*"\uF229"*/]);
    SourceLineNumber(401);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mars_stroke New() [static] :8
fa_mars_stroke* fa_mars_stroke::New4()
{
    fa_mars_stroke* obj1 = (fa_mars_stroke*)uNew(fa_mars_stroke_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
