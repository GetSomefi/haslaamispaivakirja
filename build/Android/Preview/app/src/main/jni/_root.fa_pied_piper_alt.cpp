// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pied_piper_alt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pied_piper_alt.h>
...
// public partial sealed class fa_pied_piper_alt :2
// {
// static fa_pied_piper_alt() :4
static void fa_pied_piper_alt__cctor_4_fn(uType* __type)
{
}

static void fa_pied_piper_alt_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pied_piper_alt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pied_piper_alt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pied_piper_alt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pied_piper_alt", options);
    type->fp_build_ = fa_pied_piper_alt_build;
    type->fp_ctor_ = (void*)fa_pied_piper_alt__New4_fn;
    type->fp_cctor_ = fa_pied_piper_alt__cctor_4_fn;
...
// public fa_pied_piper_alt() :8
void fa_pied_piper_alt__ctor_8_fn(fa_pied_piper_alt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pied_piper_alt__InitializeUX1_fn(fa_pied_piper_alt* __this)
{
    __this->InitializeUX1();
}

// public fa_pied_piper_alt New() :8
void fa_pied_piper_alt__New4_fn(fa_pied_piper_alt** __retval)
{
    *__retval = fa_pied_piper_alt::New4();
}

// public fa_pied_piper_alt() [instance] :8
void fa_pied_piper_alt::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pied_piper_alt::InitializeUX1()
{
    uStackFrame __("fa_pied_piper_alt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A8"*/]);
    SourceLineNumber(460);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pied_piper_alt New() [static] :8
fa_pied_piper_alt* fa_pied_piper_alt::New4()
{
    fa_pied_piper_alt* obj1 = (fa_pied_piper_alt*)uNew(fa_pied_piper_alt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
