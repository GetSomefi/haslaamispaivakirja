// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_eyedropper.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_eyedropper.h>
...
// public partial sealed class fa_eyedropper :2
// {
// static fa_eyedropper() :4
static void fa_eyedropper__cctor_4_fn(uType* __type)
{
}

static void fa_eyedropper_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_eyedropper__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_eyedropper_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_eyedropper);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_eyedropper", options);
    type->fp_build_ = fa_eyedropper_build;
    type->fp_ctor_ = (void*)fa_eyedropper__New4_fn;
    type->fp_cctor_ = fa_eyedropper__cctor_4_fn;
...
// public fa_eyedropper() :8
void fa_eyedropper__ctor_8_fn(fa_eyedropper* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_eyedropper__InitializeUX1_fn(fa_eyedropper* __this)
{
    __this->InitializeUX1();
}

// public fa_eyedropper New() :8
void fa_eyedropper__New4_fn(fa_eyedropper** __retval)
{
    *__retval = fa_eyedropper::New4();
}

// public fa_eyedropper() [instance] :8
void fa_eyedropper::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_eyedropper::InitializeUX1()
{
    uStackFrame __("fa_eyedropper", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1FB"*/]);
    SourceLineNumber(221);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_eyedropper New() [static] :8
fa_eyedropper* fa_eyedropper::New4()
{
    fa_eyedropper* obj1 = (fa_eyedropper*)uNew(fa_eyedropper_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
