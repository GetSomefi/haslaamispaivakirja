// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_google_wallet.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_google_wallet.h>
...
// public partial sealed class fa_google_wallet :2
// {
// static fa_google_wallet() :4
static void fa_google_wallet__cctor_4_fn(uType* __type)
{
}

static void fa_google_wallet_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_google_wallet__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_google_wallet_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_google_wallet);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_google_wallet", options);
    type->fp_build_ = fa_google_wallet_build;
    type->fp_ctor_ = (void*)fa_google_wallet__New4_fn;
    type->fp_cctor_ = fa_google_wallet__cctor_4_fn;
...
// public fa_google_wallet() :8
void fa_google_wallet__ctor_8_fn(fa_google_wallet* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_google_wallet__InitializeUX1_fn(fa_google_wallet* __this)
{
    __this->InitializeUX1();
}

// public fa_google_wallet New() :8
void fa_google_wallet__New4_fn(fa_google_wallet** __retval)
{
    *__retval = fa_google_wallet::New4();
}

// public fa_google_wallet() [instance] :8
void fa_google_wallet::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_google_wallet::InitializeUX1()
{
    uStackFrame __("fa_google_wallet", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1EE"*/]);
    SourceLineNumber(297);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_google_wallet New() [static] :8
fa_google_wallet* fa_google_wallet::New4()
{
    fa_google_wallet* obj1 = (fa_google_wallet*)uNew(fa_google_wallet_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
