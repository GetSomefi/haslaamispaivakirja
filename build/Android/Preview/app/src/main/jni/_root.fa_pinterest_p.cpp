// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pinterest_p.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pinterest_p.h>
...
// public partial sealed class fa_pinterest_p :2
// {
// static fa_pinterest_p() :4
static void fa_pinterest_p__cctor_4_fn(uType* __type)
{
}

static void fa_pinterest_p_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pinterest_p__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pinterest_p_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pinterest_p);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pinterest_p", options);
    type->fp_build_ = fa_pinterest_p_build;
    type->fp_ctor_ = (void*)fa_pinterest_p__New4_fn;
    type->fp_cctor_ = fa_pinterest_p__cctor_4_fn;
...
// public fa_pinterest_p() :8
void fa_pinterest_p__ctor_8_fn(fa_pinterest_p* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pinterest_p__InitializeUX1_fn(fa_pinterest_p* __this)
{
    __this->InitializeUX1();
}

// public fa_pinterest_p New() :8
void fa_pinterest_p__New4_fn(fa_pinterest_p** __retval)
{
    *__retval = fa_pinterest_p::New4();
}

// public fa_pinterest_p() [instance] :8
void fa_pinterest_p::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pinterest_p::InitializeUX1()
{
    uStackFrame __("fa_pinterest_p", "InitializeUX()");
    Value(::STRINGS[0/*"\uF231"*/]);
...
// public fa_pinterest_p New() [static] :8
fa_pinterest_p* fa_pinterest_p::New4()
{
    fa_pinterest_p* obj1 = (fa_pinterest_p*)uNew(fa_pinterest_p_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
