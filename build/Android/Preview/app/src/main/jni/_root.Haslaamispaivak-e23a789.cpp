...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersActionsTriggerAction_IsActive_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_FuseTriggersActionsTriggerAction_IsActive_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
