// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_full.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_full.h>
...
// public partial sealed class fa_battery_full :2
// {
// static fa_battery_full() :4
static void fa_battery_full__cctor_4_fn(uType* __type)
{
}

static void fa_battery_full_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_full__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_full_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_full);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_full", options);
    type->fp_build_ = fa_battery_full_build;
    type->fp_ctor_ = (void*)fa_battery_full__New4_fn;
    type->fp_cctor_ = fa_battery_full__cctor_4_fn;
...
// public fa_battery_full() :8
void fa_battery_full__ctor_8_fn(fa_battery_full* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_full__InitializeUX1_fn(fa_battery_full* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_full New() :8
void fa_battery_full__New4_fn(fa_battery_full** __retval)
{
    *__retval = fa_battery_full::New4();
}

// public fa_battery_full() [instance] :8
void fa_battery_full::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_full::InitializeUX1()
{
    uStackFrame __("fa_battery_full", "InitializeUX()");
    Value(::STRINGS[0/*"\uF240"*/]);
    SourceLineNumber(58);
...
// public fa_battery_full New() [static] :8
fa_battery_full* fa_battery_full::New4()
{
    fa_battery_full* obj1 = (fa_battery_full*)uNew(fa_battery_full_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
