...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"first"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("first");
...
void MainView__Template1__New1_fn(MainView__Template1* __this, uObject** __retval)
{
    ...
    ::g::FirstPage* __self1 = ::g::FirstPage::New5(uPtr(__this->__parent1)->router);
