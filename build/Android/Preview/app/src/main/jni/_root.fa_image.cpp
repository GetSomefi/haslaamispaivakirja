// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_image.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_image.h>
...
// public partial sealed class fa_image :2
// {
// static fa_image() :4
static void fa_image__cctor_4_fn(uType* __type)
{
}

static void fa_image_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_image__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_image_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_image);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_image", options);
    type->fp_build_ = fa_image_build;
    type->fp_ctor_ = (void*)fa_image__New4_fn;
    type->fp_cctor_ = fa_image__cctor_4_fn;
...
// public fa_image() :8
void fa_image__ctor_8_fn(fa_image* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_image__InitializeUX1_fn(fa_image* __this)
{
    __this->InitializeUX1();
}

// public fa_image New() :8
void fa_image__New4_fn(fa_image** __retval)
{
    *__retval = fa_image::New4();
}

// public fa_image() [instance] :8
void fa_image::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_image::InitializeUX1()
{
    uStackFrame __("fa_image", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03E"*/]);
    SourceLineNumber(339);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_image New() [static] :8
fa_image* fa_image::New4()
{
    fa_image* obj1 = (fa_image*)uNew(fa_image_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
