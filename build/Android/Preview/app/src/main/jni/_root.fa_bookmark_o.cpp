// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bookmark_o.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bookmark_o.h>
...
// public partial sealed class fa_bookmark_o :2
// {
// static fa_bookmark_o() :4
static void fa_bookmark_o__cctor_4_fn(uType* __type)
{
}

static void fa_bookmark_o_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\227");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bookmark_o__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bookmark_o_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bookmark_o);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bookmark_o", options);
    type->fp_build_ = fa_bookmark_o_build;
    type->fp_ctor_ = (void*)fa_bookmark_o__New4_fn;
    type->fp_cctor_ = fa_bookmark_o__cctor_4_fn;
...
// public fa_bookmark_o() :8
void fa_bookmark_o__ctor_8_fn(fa_bookmark_o* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bookmark_o__InitializeUX1_fn(fa_bookmark_o* __this)
{
    __this->InitializeUX1();
}

// public fa_bookmark_o New() :8
void fa_bookmark_o__New4_fn(fa_bookmark_o** __retval)
{
    *__retval = fa_bookmark_o::New4();
}

// public fa_bookmark_o() [instance] :8
void fa_bookmark_o::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bookmark_o::InitializeUX1()
{
    uStackFrame __("fa_bookmark_o", "InitializeUX()");
    Value(::STRINGS[0/*"\uF097"*/]);
    SourceLineNumber(84);
...
// public fa_bookmark_o New() [static] :8
fa_bookmark_o* fa_bookmark_o::New4()
{
    fa_bookmark_o* obj1 = (fa_bookmark_o*)uNew(fa_bookmark_o_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
