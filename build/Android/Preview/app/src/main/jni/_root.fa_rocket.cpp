// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rocket.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rocket.h>
...
// public partial sealed class fa_rocket :2
// {
// static fa_rocket() :4
static void fa_rocket__cctor_4_fn(uType* __type)
{
}

static void fa_rocket_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rocket__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rocket_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rocket);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rocket", options);
    type->fp_build_ = fa_rocket_build;
    type->fp_ctor_ = (void*)fa_rocket__New4_fn;
    type->fp_cctor_ = fa_rocket__cctor_4_fn;
...
// public fa_rocket() :8
void fa_rocket__ctor_8_fn(fa_rocket* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rocket__InitializeUX1_fn(fa_rocket* __this)
{
    __this->InitializeUX1();
}

// public fa_rocket New() :8
void fa_rocket__New4_fn(fa_rocket** __retval)
{
    *__retval = fa_rocket::New4();
}

// public fa_rocket() [instance] :8
void fa_rocket::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_rocket::InitializeUX1()
{
    uStackFrame __("fa_rocket", "InitializeUX()");
    Value(::STRINGS[0/*"\uF135"*/]);
    SourceLineNumber(501);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rocket New() [static] :8
fa_rocket* fa_rocket::New4()
{
    fa_rocket* obj1 = (fa_rocket*)uNew(fa_rocket_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
