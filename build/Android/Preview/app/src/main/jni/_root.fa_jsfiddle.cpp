// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_jsfiddle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_jsfiddle.h>
...
// public partial sealed class fa_jsfiddle :2
// {
// static fa_jsfiddle() :4
static void fa_jsfiddle__cctor_4_fn(uType* __type)
{
}

static void fa_jsfiddle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_jsfiddle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_jsfiddle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_jsfiddle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_jsfiddle", options);
    type->fp_build_ = fa_jsfiddle_build;
    type->fp_ctor_ = (void*)fa_jsfiddle__New4_fn;
    type->fp_cctor_ = fa_jsfiddle__cctor_4_fn;
...
// public fa_jsfiddle() :8
void fa_jsfiddle__ctor_8_fn(fa_jsfiddle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_jsfiddle__InitializeUX1_fn(fa_jsfiddle* __this)
{
    __this->InitializeUX1();
}

// public fa_jsfiddle New() :8
void fa_jsfiddle__New4_fn(fa_jsfiddle** __retval)
{
    *__retval = fa_jsfiddle::New4();
}

// public fa_jsfiddle() [instance] :8
void fa_jsfiddle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_jsfiddle::InitializeUX1()
{
    uStackFrame __("fa_jsfiddle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CC"*/]);
    SourceLineNumber(354);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_jsfiddle New() [static] :8
fa_jsfiddle* fa_jsfiddle::New4()
{
    fa_jsfiddle* obj1 = (fa_jsfiddle*)uNew(fa_jsfiddle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
