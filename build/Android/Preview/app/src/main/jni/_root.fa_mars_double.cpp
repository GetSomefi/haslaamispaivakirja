// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mars_double.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mars_double.h>
...
// public partial sealed class fa_mars_double :2
// {
// static fa_mars_double() :4
static void fa_mars_double__cctor_4_fn(uType* __type)
{
}

static void fa_mars_double_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mars_double__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mars_double_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mars_double);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mars_double", options);
    type->fp_build_ = fa_mars_double_build;
    type->fp_ctor_ = (void*)fa_mars_double__New4_fn;
    type->fp_cctor_ = fa_mars_double__cctor_4_fn;
...
// public fa_mars_double() :8
void fa_mars_double__ctor_8_fn(fa_mars_double* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mars_double__InitializeUX1_fn(fa_mars_double* __this)
{
    __this->InitializeUX1();
}

// public fa_mars_double New() :8
void fa_mars_double__New4_fn(fa_mars_double** __retval)
{
    *__retval = fa_mars_double::New4();
}

// public fa_mars_double() [instance] :8
void fa_mars_double::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mars_double::InitializeUX1()
{
    uStackFrame __("fa_mars_double", "InitializeUX()");
    Value(::STRINGS[0/*"\uF227"*/]);
    SourceLineNumber(400);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mars_double New() [static] :8
fa_mars_double* fa_mars_double::New4()
{
    fa_mars_double* obj1 = (fa_mars_double*)uNew(fa_mars_double_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
