// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_remove.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_remove.h>
...
// public partial sealed class fa_remove :2
// {
// static fa_remove() :4
static void fa_remove__cctor_4_fn(uType* __type)
{
}

static void fa_remove_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_remove__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_remove_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_remove);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_remove", options);
    type->fp_build_ = fa_remove_build;
    type->fp_ctor_ = (void*)fa_remove__New4_fn;
    type->fp_cctor_ = fa_remove__cctor_4_fn;
...
// public fa_remove() :8
void fa_remove__ctor_8_fn(fa_remove* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_remove__InitializeUX1_fn(fa_remove* __this)
{
    __this->InitializeUX1();
}

// public fa_remove New() :8
void fa_remove__New4_fn(fa_remove** __retval)
{
    *__retval = fa_remove::New4();
}

// public fa_remove() [instance] :8
void fa_remove::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_remove::InitializeUX1()
{
    uStackFrame __("fa_remove", "InitializeUX()");
    Value(::STRINGS[0/*"\uF00D"*/]);
    SourceLineNumber(492);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_remove New() [static] :8
fa_remove* fa_remove::New4()
{
    fa_remove* obj1 = (fa_remove*)uNew(fa_remove_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
