// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_youtube_play.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_youtube_play.h>
...
// public partial sealed class fa_youtube_play :2
// {
// static fa_youtube_play() :4
static void fa_youtube_play__cctor_4_fn(uType* __type)
{
}

static void fa_youtube_play_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_youtube_play__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_youtube_play_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_youtube_play);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_youtube_play", options);
    type->fp_build_ = fa_youtube_play_build;
    type->fp_ctor_ = (void*)fa_youtube_play__New4_fn;
    type->fp_cctor_ = fa_youtube_play__cctor_4_fn;
...
// public fa_youtube_play() :8
void fa_youtube_play__ctor_8_fn(fa_youtube_play* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_youtube_play__InitializeUX1_fn(fa_youtube_play* __this)
{
    __this->InitializeUX1();
}

// public fa_youtube_play New() :8
void fa_youtube_play__New4_fn(fa_youtube_play** __retval)
{
    *__retval = fa_youtube_play::New4();
}

// public fa_youtube_play() [instance] :8
void fa_youtube_play::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_youtube_play::InitializeUX1()
{
    uStackFrame __("fa_youtube_play", "InitializeUX()");
    Value(::STRINGS[0/*"\uF16A"*/]);
    SourceLineNumber(694);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_youtube_play New() [static] :8
fa_youtube_play* fa_youtube_play::New4()
{
    fa_youtube_play* obj1 = (fa_youtube_play*)uNew(fa_youtube_play_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
