// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_list.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_list.h>
...
// public partial sealed class fa_list :2
// {
// static fa_list() :4
static void fa_list__cctor_4_fn(uType* __type)
{
}

static void fa_list_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_list__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_list_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_list);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_list", options);
    type->fp_build_ = fa_list_build;
    type->fp_ctor_ = (void*)fa_list__New4_fn;
    type->fp_cctor_ = fa_list__cctor_4_fn;
...
// public fa_list() :8
void fa_list__ctor_8_fn(fa_list* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_list__InitializeUX1_fn(fa_list* __this)
{
    __this->InitializeUX1();
}

// public fa_list New() :8
void fa_list__New4_fn(fa_list** __retval)
{
    *__retval = fa_list::New4();
}

// public fa_list() [instance] :8
void fa_list::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_list::InitializeUX1()
{
    uStackFrame __("fa_list", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03A"*/]);
    SourceLineNumber(378);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_list New() [static] :8
fa_list* fa_list::New4()
{
    fa_list* obj1 = (fa_list*)uNew(fa_list_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
