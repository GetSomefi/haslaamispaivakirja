// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tree.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tree.h>
...
// public partial sealed class fa_tree :2
// {
// static fa_tree() :4
static void fa_tree__cctor_4_fn(uType* __type)
{
}

static void fa_tree_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tree__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tree_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tree);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tree", options);
    type->fp_build_ = fa_tree_build;
    type->fp_ctor_ = (void*)fa_tree__New4_fn;
    type->fp_cctor_ = fa_tree__cctor_4_fn;
...
// public fa_tree() :8
void fa_tree__ctor_8_fn(fa_tree* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tree__InitializeUX1_fn(fa_tree* __this)
{
    __this->InitializeUX1();
}

// public fa_tree New() :8
void fa_tree__New4_fn(fa_tree** __retval)
{
    *__retval = fa_tree::New4();
}

// public fa_tree() [instance] :8
void fa_tree::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tree::InitializeUX1()
{
    uStackFrame __("fa_tree", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BB"*/]);
    SourceLineNumber(629);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tree New() [static] :8
fa_tree* fa_tree::New4()
{
    fa_tree* obj1 = (fa_tree*)uNew(fa_tree_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
