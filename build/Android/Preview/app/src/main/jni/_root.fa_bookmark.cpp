// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bookmark.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bookmark.h>
...
// public partial sealed class fa_bookmark :2
// {
// static fa_bookmark() :4
static void fa_bookmark__cctor_4_fn(uType* __type)
{
}

static void fa_bookmark_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bookmark__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bookmark_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bookmark);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bookmark", options);
    type->fp_build_ = fa_bookmark_build;
    type->fp_ctor_ = (void*)fa_bookmark__New4_fn;
    type->fp_cctor_ = fa_bookmark__cctor_4_fn;
...
// public fa_bookmark() :8
void fa_bookmark__ctor_8_fn(fa_bookmark* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bookmark__InitializeUX1_fn(fa_bookmark* __this)
{
    __this->InitializeUX1();
}

// public fa_bookmark New() :8
void fa_bookmark__New4_fn(fa_bookmark** __retval)
{
    *__retval = fa_bookmark::New4();
}

// public fa_bookmark() [instance] :8
void fa_bookmark::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bookmark::InitializeUX1()
{
    uStackFrame __("fa_bookmark", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02E"*/]);
    SourceLineNumber(83);
...
// public fa_bookmark New() [static] :8
fa_bookmark* fa_bookmark::New4()
{
    fa_bookmark* obj1 = (fa_bookmark*)uNew(fa_bookmark_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
