// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_music.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_music.h>
...
// public partial sealed class fa_music :2
// {
// static fa_music() :4
static void fa_music__cctor_4_fn(uType* __type)
{
}

static void fa_music_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_music__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_music_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_music);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_music", options);
    type->fp_build_ = fa_music_build;
    type->fp_ctor_ = (void*)fa_music__New4_fn;
    type->fp_cctor_ = fa_music__cctor_4_fn;
...
// public fa_music() :8
void fa_music__ctor_8_fn(fa_music* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_music__InitializeUX1_fn(fa_music* __this)
{
    __this->InitializeUX1();
}

// public fa_music New() :8
void fa_music__New4_fn(fa_music** __retval)
{
    *__retval = fa_music::New4();
}

// public fa_music() [instance] :8
void fa_music::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_music::InitializeUX1()
{
    uStackFrame __("fa_music", "InitializeUX()");
    Value(::STRINGS[0/*"\uF001"*/]);
    SourceLineNumber(425);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_music New() [static] :8
fa_music* fa_music::New4()
{
    fa_music* obj1 = (fa_music*)uNew(fa_music_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
