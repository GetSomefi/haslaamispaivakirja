// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_undo.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_undo.h>
...
// public partial sealed class fa_undo :2
// {
// static fa_undo() :4
static void fa_undo__cctor_4_fn(uType* __type)
{
}

static void fa_undo_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_undo__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_undo_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_undo);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_undo", options);
    type->fp_build_ = fa_undo_build;
    type->fp_ctor_ = (void*)fa_undo__New4_fn;
    type->fp_cctor_ = fa_undo__cctor_4_fn;
...
// public fa_undo() :8
void fa_undo__ctor_8_fn(fa_undo* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_undo__InitializeUX1_fn(fa_undo* __this)
{
    __this->InitializeUX1();
}

// public fa_undo New() :8
void fa_undo__New4_fn(fa_undo** __retval)
{
    *__retval = fa_undo::New4();
}

// public fa_undo() [instance] :8
void fa_undo::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_undo::InitializeUX1()
{
    uStackFrame __("fa_undo", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E2"*/]);
    SourceLineNumber(645);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_undo New() [static] :8
fa_undo* fa_undo::New4()
{
    fa_undo* obj1 = (fa_undo*)uNew(fa_undo_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
