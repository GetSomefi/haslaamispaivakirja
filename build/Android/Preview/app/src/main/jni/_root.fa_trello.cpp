// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_trello.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_trello.h>
...
// public partial sealed class fa_trello :2
// {
// static fa_trello() :4
static void fa_trello__cctor_4_fn(uType* __type)
{
}

static void fa_trello_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_trello__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_trello_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_trello);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_trello", options);
    type->fp_build_ = fa_trello_build;
    type->fp_ctor_ = (void*)fa_trello__New4_fn;
    type->fp_cctor_ = fa_trello__cctor_4_fn;
...
// public fa_trello() :8
void fa_trello__ctor_8_fn(fa_trello* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_trello__InitializeUX1_fn(fa_trello* __this)
{
    __this->InitializeUX1();
}

// public fa_trello New() :8
void fa_trello__New4_fn(fa_trello** __retval)
{
    *__retval = fa_trello::New4();
}

// public fa_trello() [instance] :8
void fa_trello::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_trello::InitializeUX1()
{
    uStackFrame __("fa_trello", "InitializeUX()");
    Value(::STRINGS[0/*"\uF181"*/]);
    SourceLineNumber(630);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_trello New() [static] :8
fa_trello* fa_trello::New4()
{
    fa_trello* obj1 = (fa_trello*)uNew(fa_trello_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
