// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_4.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_4.h>
...
// public partial sealed class fa_battery_4 :2
// {
// static fa_battery_4() :4
static void fa_battery_4__cctor_4_fn(uType* __type)
{
}

static void fa_battery_4_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_4__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_4_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_4);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_4", options);
    type->fp_build_ = fa_battery_4_build;
    type->fp_ctor_ = (void*)fa_battery_4__New4_fn;
    type->fp_cctor_ = fa_battery_4__cctor_4_fn;
...
// public fa_battery_4() :8
void fa_battery_4__ctor_8_fn(fa_battery_4* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_4__InitializeUX1_fn(fa_battery_4* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_4 New() :8
void fa_battery_4__New4_fn(fa_battery_4** __retval)
{
    *__retval = fa_battery_4::New4();
}

// public fa_battery_4() [instance] :8
void fa_battery_4::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_4::InitializeUX1()
{
    uStackFrame __("fa_battery_4", "InitializeUX()");
    Value(::STRINGS[0/*"\uF240"*/]);
    SourceLineNumber(56);
...
// public fa_battery_4 New() [static] :8
fa_battery_4* fa_battery_4::New4()
{
    fa_battery_4* obj1 = (fa_battery_4*)uNew(fa_battery_4_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
