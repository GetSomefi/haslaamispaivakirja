// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_file.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_file.h>
...
// public partial sealed class fa_file :2
// {
// static fa_file() :4
static void fa_file__cctor_4_fn(uType* __type)
{
}

static void fa_file_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_file__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_file_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_file);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_file", options);
    type->fp_build_ = fa_file_build;
    type->fp_ctor_ = (void*)fa_file__New4_fn;
    type->fp_cctor_ = fa_file__cctor_4_fn;
...
// public fa_file() :8
void fa_file__ctor_8_fn(fa_file* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_file__InitializeUX1_fn(fa_file* __this)
{
    __this->InitializeUX1();
}

// public fa_file New() :8
void fa_file__New4_fn(fa_file** __retval)
{
    *__retval = fa_file::New4();
}

// public fa_file() [instance] :8
void fa_file::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_file::InitializeUX1()
{
    uStackFrame __("fa_file", "InitializeUX()");
    Value(::STRINGS[0/*"\uF15B"*/]);
    SourceLineNumber(232);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_file New() [static] :8
fa_file* fa_file::New4()
{
    fa_file* obj1 = (fa_file*)uNew(fa_file_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
