// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rub.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rub.h>
...
// public partial sealed class fa_rub :2
// {
// static fa_rub() :4
static void fa_rub__cctor_4_fn(uType* __type)
{
}

static void fa_rub_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rub__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rub_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rub);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rub", options);
    type->fp_build_ = fa_rub_build;
    type->fp_ctor_ = (void*)fa_rub__New4_fn;
    type->fp_cctor_ = fa_rub__cctor_4_fn;
...
// public fa_rub() :8
void fa_rub__ctor_8_fn(fa_rub* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rub__InitializeUX1_fn(fa_rub* __this)
{
    __this->InitializeUX1();
}

// public fa_rub New() :8
void fa_rub__New4_fn(fa_rub** __retval)
{
    *__retval = fa_rub::New4();
}

// public fa_rub() [instance] :8
void fa_rub::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_rub::InitializeUX1()
{
    uStackFrame __("fa_rub", "InitializeUX()");
    Value(::STRINGS[0/*"\uF158"*/]);
    SourceLineNumber(507);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rub New() [static] :8
fa_rub* fa_rub::New4()
{
    fa_rub* obj1 = (fa_rub*)uNew(fa_rub_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
