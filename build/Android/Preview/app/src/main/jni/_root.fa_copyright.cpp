// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_copyright.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_copyright.h>
...
// public partial sealed class fa_copyright :2
// {
// static fa_copyright() :4
static void fa_copyright__cctor_4_fn(uType* __type)
{
}

static void fa_copyright_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_copyright__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_copyright_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_copyright);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_copyright", options);
    type->fp_build_ = fa_copyright_build;
    type->fp_ctor_ = (void*)fa_copyright__New4_fn;
    type->fp_cctor_ = fa_copyright__cctor_4_fn;
...
// public fa_copyright() :8
void fa_copyright__ctor_8_fn(fa_copyright* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_copyright__InitializeUX1_fn(fa_copyright* __this)
{
    __this->InitializeUX1();
}

// public fa_copyright New() :8
void fa_copyright__New4_fn(fa_copyright** __retval)
{
    *__retval = fa_copyright::New4();
}

// public fa_copyright() [instance] :8
void fa_copyright::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_copyright::InitializeUX1()
{
    uStackFrame __("fa_copyright", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F9"*/]);
    SourceLineNumber(173);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_copyright New() [static] :8
fa_copyright* fa_copyright::New4()
{
    fa_copyright* obj1 = (fa_copyright*)uNew(fa_copyright_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
