// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_linux.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_linux.h>
...
// public partial sealed class fa_linux :2
// {
// static fa_linux() :4
static void fa_linux__cctor_4_fn(uType* __type)
{
}

static void fa_linux_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_linux__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_linux_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_linux);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_linux", options);
    type->fp_build_ = fa_linux_build;
    type->fp_ctor_ = (void*)fa_linux__New4_fn;
    type->fp_cctor_ = fa_linux__cctor_4_fn;
...
// public fa_linux() :8
void fa_linux__ctor_8_fn(fa_linux* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_linux__InitializeUX1_fn(fa_linux* __this)
{
    __this->InitializeUX1();
}

// public fa_linux New() :8
void fa_linux__New4_fn(fa_linux** __retval)
{
    *__retval = fa_linux::New4();
}

// public fa_linux() [instance] :8
void fa_linux::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_linux::InitializeUX1()
{
    uStackFrame __("fa_linux", "InitializeUX()");
    Value(::STRINGS[0/*"\uF17C"*/]);
    SourceLineNumber(377);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_linux New() [static] :8
fa_linux* fa_linux::New4()
{
    fa_linux* obj1 = (fa_linux*)uNew(fa_linux_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
