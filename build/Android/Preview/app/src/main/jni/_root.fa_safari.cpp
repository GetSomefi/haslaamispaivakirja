// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_safari.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_safari.h>
...
// public partial sealed class fa_safari :2
// {
// static fa_safari() :4
static void fa_safari__cctor_4_fn(uType* __type)
{
}

static void fa_safari_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_safari__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_safari_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_safari);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_safari", options);
    type->fp_build_ = fa_safari_build;
    type->fp_ctor_ = (void*)fa_safari__New4_fn;
    type->fp_cctor_ = fa_safari__cctor_4_fn;
...
// public fa_safari() :8
void fa_safari__ctor_8_fn(fa_safari* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_safari__InitializeUX1_fn(fa_safari* __this)
{
    __this->InitializeUX1();
}

// public fa_safari New() :8
void fa_safari__New4_fn(fa_safari** __retval)
{
    *__retval = fa_safari::New4();
}

// public fa_safari() [instance] :8
void fa_safari::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_safari::InitializeUX1()
{
    uStackFrame __("fa_safari", "InitializeUX()");
    Value(::STRINGS[0/*"\uF267"*/]);
    SourceLineNumber(510);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_safari New() [static] :8
fa_safari* fa_safari::New4()
{
    fa_safari* obj1 = (fa_safari*)uNew(fa_safari_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
