// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_birthday_cake.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_birthday_cake.h>
...
// public partial sealed class fa_birthday_cake :2
// {
// static fa_birthday_cake() :4
static void fa_birthday_cake__cctor_4_fn(uType* __type)
{
}

static void fa_birthday_cake_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_birthday_cake__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_birthday_cake_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_birthday_cake);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_birthday_cake", options);
    type->fp_build_ = fa_birthday_cake_build;
    type->fp_ctor_ = (void*)fa_birthday_cake__New4_fn;
    type->fp_cctor_ = fa_birthday_cake__cctor_4_fn;
...
// public fa_birthday_cake() :8
void fa_birthday_cake__ctor_8_fn(fa_birthday_cake* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_birthday_cake__InitializeUX1_fn(fa_birthday_cake* __this)
{
    __this->InitializeUX1();
}

// public fa_birthday_cake New() :8
void fa_birthday_cake__New4_fn(fa_birthday_cake** __retval)
{
    *__retval = fa_birthday_cake::New4();
}

// public fa_birthday_cake() [instance] :8
void fa_birthday_cake::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_birthday_cake::InitializeUX1()
{
    uStackFrame __("fa_birthday_cake", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1FD"*/]);
    SourceLineNumber(72);
...
// public fa_birthday_cake New() [static] :8
fa_birthday_cake* fa_birthday_cake::New4()
{
    fa_birthday_cake* obj1 = (fa_birthday_cake*)uNew(fa_birthday_cake_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
