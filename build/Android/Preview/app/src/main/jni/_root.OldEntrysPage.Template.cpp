...
static void OldEntrysPage__Template_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("openEntry");
    ::STRINGS[2] = uString::Const("key");
    ...
    type->SetFields(2,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(OldEntrysPage__Template, temp_eb9), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&OldEntrysPage__Template::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)OldEntrysPage__Template__New2_fn, 0, true, type, 2, ::g::OldEntrysPage_typeof(), ::g::OldEntrysPage_typeof()));
}
...
{
    uStackFrame __("OldEntrysPage.Template", "New()");
    ::g::basicBtn::Button* __self1 = ::g::basicBtn::Button::New4();
    ::g::Fuse::Reactive::Data* temp = ::g::Fuse::Reactive::Data::New1(::STRINGS[1/*"openEntry"*/]);
    ...
    ::g::Fuse::Reactive::Data* temp1 = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"key"*/]);
    __this->temp_eb9 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp);
    ::g::Fuse::Reactive::DataBinding* temp2 = ::g::Fuse::Reactive::DataBinding::New1(__this->__self_Text_inst1, (uObject*)temp1, 3);
    ...
    temp1->SourceFileName(::STRINGS[3/*"OldEntrysPa...*/]);
