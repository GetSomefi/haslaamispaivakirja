// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_inbox.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_inbox.h>
...
// public partial sealed class fa_inbox :2
// {
// static fa_inbox() :4
static void fa_inbox__cctor_4_fn(uType* __type)
{
}

static void fa_inbox_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_inbox__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_inbox_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_inbox);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_inbox", options);
    type->fp_build_ = fa_inbox_build;
    type->fp_ctor_ = (void*)fa_inbox__New4_fn;
    type->fp_cctor_ = fa_inbox__cctor_4_fn;
...
// public fa_inbox() :8
void fa_inbox__ctor_8_fn(fa_inbox* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_inbox__InitializeUX1_fn(fa_inbox* __this)
{
    __this->InitializeUX1();
}

// public fa_inbox New() :8
void fa_inbox__New4_fn(fa_inbox** __retval)
{
    *__retval = fa_inbox::New4();
}

// public fa_inbox() [instance] :8
void fa_inbox::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_inbox::InitializeUX1()
{
    uStackFrame __("fa_inbox", "InitializeUX()");
    Value(::STRINGS[0/*"\uF01C"*/]);
    SourceLineNumber(340);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_inbox New() [static] :8
fa_inbox* fa_inbox::New4()
{
    fa_inbox* obj1 = (fa_inbox*)uNew(fa_inbox_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
