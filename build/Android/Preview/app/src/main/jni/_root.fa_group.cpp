// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_group.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_group.h>
...
// public partial sealed class fa_group :2
// {
// static fa_group() :4
static void fa_group__cctor_4_fn(uType* __type)
{
}

static void fa_group_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_group__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_group_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_group);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_group", options);
    type->fp_build_ = fa_group_build;
    type->fp_ctor_ = (void*)fa_group__New4_fn;
    type->fp_cctor_ = fa_group__cctor_4_fn;
...
// public fa_group() :8
void fa_group__ctor_8_fn(fa_group* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_group__InitializeUX1_fn(fa_group* __this)
{
    __this->InitializeUX1();
}

// public fa_group New() :8
void fa_group__New4_fn(fa_group** __retval)
{
    *__retval = fa_group::New4();
}

// public fa_group() [instance] :8
void fa_group::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_group::InitializeUX1()
{
    uStackFrame __("fa_group", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C0"*/]);
    SourceLineNumber(300);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_group New() [static] :8
fa_group* fa_group::New4()
{
    fa_group* obj1 = (fa_group*)uNew(fa_group_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
