// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_eject.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_eject.h>
...
// public partial sealed class fa_eject :2
// {
// static fa_eject() :4
static void fa_eject__cctor_4_fn(uType* __type)
{
}

static void fa_eject_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_eject__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_eject_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_eject);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_eject", options);
    type->fp_build_ = fa_eject_build;
    type->fp_ctor_ = (void*)fa_eject__New4_fn;
    type->fp_cctor_ = fa_eject__cctor_4_fn;
...
// public fa_eject() :8
void fa_eject__ctor_8_fn(fa_eject* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_eject__InitializeUX1_fn(fa_eject* __this)
{
    __this->InitializeUX1();
}

// public fa_eject New() :8
void fa_eject__New4_fn(fa_eject** __retval)
{
    *__retval = fa_eject::New4();
}

// public fa_eject() [instance] :8
void fa_eject::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_eject::InitializeUX1()
{
    uStackFrame __("fa_eject", "InitializeUX()");
    Value(::STRINGS[0/*"\uF052"*/]);
    SourceLineNumber(201);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_eject New() [static] :8
fa_eject* fa_eject::New4()
{
    fa_eject* obj1 = (fa_eject*)uNew(fa_eject_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
