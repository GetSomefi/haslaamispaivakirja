// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_life_bouy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_life_bouy.h>
...
// public partial sealed class fa_life_bouy :2
// {
// static fa_life_bouy() :4
static void fa_life_bouy__cctor_4_fn(uType* __type)
{
}

static void fa_life_bouy_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_life_bouy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_life_bouy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_life_bouy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_life_bouy", options);
    type->fp_build_ = fa_life_bouy_build;
    type->fp_ctor_ = (void*)fa_life_bouy__New4_fn;
    type->fp_cctor_ = fa_life_bouy__cctor_4_fn;
...
// public fa_life_bouy() :8
void fa_life_bouy__ctor_8_fn(fa_life_bouy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_life_bouy__InitializeUX1_fn(fa_life_bouy* __this)
{
    __this->InitializeUX1();
}

// public fa_life_bouy New() :8
void fa_life_bouy__New4_fn(fa_life_bouy** __retval)
{
    *__retval = fa_life_bouy::New4();
}

// public fa_life_bouy() [instance] :8
void fa_life_bouy::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_life_bouy::InitializeUX1()
{
    uStackFrame __("fa_life_bouy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CD"*/]);
    SourceLineNumber(368);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_life_bouy New() [static] :8
fa_life_bouy* fa_life_bouy::New4()
{
    fa_life_bouy* obj1 = (fa_life_bouy*)uNew(fa_life_bouy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
