// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_houzz.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_houzz.h>
...
// public partial sealed class fa_houzz :2
// {
// static fa_houzz() :4
static void fa_houzz__cctor_4_fn(uType* __type)
{
}

static void fa_houzz_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_houzz__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_houzz_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_houzz);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_houzz", options);
    type->fp_build_ = fa_houzz_build;
    type->fp_ctor_ = (void*)fa_houzz__New4_fn;
    type->fp_cctor_ = fa_houzz__cctor_4_fn;
...
// public fa_houzz() :8
void fa_houzz__ctor_8_fn(fa_houzz* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_houzz__InitializeUX1_fn(fa_houzz* __this)
{
    __this->InitializeUX1();
}

// public fa_houzz New() :8
void fa_houzz__New4_fn(fa_houzz** __retval)
{
    *__retval = fa_houzz::New4();
}

// public fa_houzz() [instance] :8
void fa_houzz::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_houzz::InitializeUX1()
{
    uStackFrame __("fa_houzz", "InitializeUX()");
    Value(::STRINGS[0/*"\uF27C"*/]);
    SourceLineNumber(335);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_houzz New() [static] :8
fa_houzz* fa_houzz::New4()
{
    fa_houzz* obj1 = (fa_houzz*)uNew(fa_houzz_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
