// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_strikethrough.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_strikethrough.h>
...
// public partial sealed class fa_strikethrough :2
// {
// static fa_strikethrough() :4
static void fa_strikethrough__cctor_4_fn(uType* __type)
{
}

static void fa_strikethrough_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_strikethrough__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_strikethrough_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_strikethrough);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_strikethrough", options);
    type->fp_build_ = fa_strikethrough_build;
    type->fp_ctor_ = (void*)fa_strikethrough__New4_fn;
    type->fp_cctor_ = fa_strikethrough__cctor_4_fn;
...
// public fa_strikethrough() :8
void fa_strikethrough__ctor_8_fn(fa_strikethrough* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_strikethrough__InitializeUX1_fn(fa_strikethrough* __this)
{
    __this->InitializeUX1();
}

// public fa_strikethrough New() :8
void fa_strikethrough__New4_fn(fa_strikethrough** __retval)
{
    *__retval = fa_strikethrough::New4();
}

// public fa_strikethrough() [instance] :8
void fa_strikethrough::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_strikethrough::InitializeUX1()
{
    uStackFrame __("fa_strikethrough", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0CC"*/]);
    SourceLineNumber(583);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_strikethrough New() [static] :8
fa_strikethrough* fa_strikethrough::New4()
{
    fa_strikethrough* obj1 = (fa_strikethrough*)uNew(fa_strikethrough_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
