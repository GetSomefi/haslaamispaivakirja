// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_subway.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_subway.h>
...
// public partial sealed class fa_subway :2
// {
// static fa_subway() :4
static void fa_subway__cctor_4_fn(uType* __type)
{
}

static void fa_subway_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_subway__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_subway_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_subway);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_subway", options);
    type->fp_build_ = fa_subway_build;
    type->fp_ctor_ = (void*)fa_subway__New4_fn;
    type->fp_cctor_ = fa_subway__cctor_4_fn;
...
// public fa_subway() :8
void fa_subway__ctor_8_fn(fa_subway* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_subway__InitializeUX1_fn(fa_subway* __this)
{
    __this->InitializeUX1();
}

// public fa_subway New() :8
void fa_subway__New4_fn(fa_subway** __retval)
{
    *__retval = fa_subway::New4();
}

// public fa_subway() [instance] :8
void fa_subway::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_subway::InitializeUX1()
{
    uStackFrame __("fa_subway", "InitializeUX()");
    Value(::STRINGS[0/*"\uF239"*/]);
    SourceLineNumber(587);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_subway New() [static] :8
fa_subway* fa_subway::New4()
{
    fa_subway* obj1 = (fa_subway*)uNew(fa_subway_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
