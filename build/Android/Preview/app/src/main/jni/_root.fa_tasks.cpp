// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tasks.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tasks.h>
...
// public partial sealed class fa_tasks :2
// {
// static fa_tasks() :4
static void fa_tasks__cctor_4_fn(uType* __type)
{
}

static void fa_tasks_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tasks__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tasks_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tasks);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tasks", options);
    type->fp_build_ = fa_tasks_build;
    type->fp_ctor_ = (void*)fa_tasks__New4_fn;
    type->fp_cctor_ = fa_tasks__cctor_4_fn;
...
// public fa_tasks() :8
void fa_tasks__ctor_8_fn(fa_tasks* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tasks__InitializeUX1_fn(fa_tasks* __this)
{
    __this->InitializeUX1();
}

// public fa_tasks New() :8
void fa_tasks__New4_fn(fa_tasks** __retval)
{
    *__retval = fa_tasks::New4();
}

// public fa_tasks() [instance] :8
void fa_tasks::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tasks::InitializeUX1()
{
    uStackFrame __("fa_tasks", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0AE"*/]);
    SourceLineNumber(597);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tasks New() [static] :8
fa_tasks* fa_tasks::New4()
{
    fa_tasks* obj1 = (fa_tasks*)uNew(fa_tasks_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
