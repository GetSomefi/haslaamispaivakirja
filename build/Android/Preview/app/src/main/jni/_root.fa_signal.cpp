// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_signal.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_signal.h>
...
// public partial sealed class fa_signal :2
// {
// static fa_signal() :4
static void fa_signal__cctor_4_fn(uType* __type)
{
}

static void fa_signal_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_signal__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_signal_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_signal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_signal", options);
    type->fp_build_ = fa_signal_build;
    type->fp_ctor_ = (void*)fa_signal__New4_fn;
    type->fp_cctor_ = fa_signal__cctor_4_fn;
...
// public fa_signal() :8
void fa_signal__ctor_8_fn(fa_signal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_signal__InitializeUX1_fn(fa_signal* __this)
{
    __this->InitializeUX1();
}

// public fa_signal New() :8
void fa_signal__New4_fn(fa_signal** __retval)
{
    *__retval = fa_signal::New4();
}

// public fa_signal() [instance] :8
void fa_signal::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_signal::InitializeUX1()
{
    uStackFrame __("fa_signal", "InitializeUX()");
    Value(::STRINGS[0/*"\uF012"*/]);
    SourceLineNumber(536);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_signal New() [static] :8
fa_signal* fa_signal::New4()
{
    fa_signal* obj1 = (fa_signal*)uNew(fa_signal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
