// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_headphones.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_headphones.h>
...
// public partial sealed class fa_headphones :2
// {
// static fa_headphones() :4
static void fa_headphones__cctor_4_fn(uType* __type)
{
}

static void fa_headphones_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_headphones__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_headphones_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_headphones);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_headphones", options);
    type->fp_build_ = fa_headphones_build;
    type->fp_ctor_ = (void*)fa_headphones__New4_fn;
    type->fp_cctor_ = fa_headphones__cctor_4_fn;
...
// public fa_headphones() :8
void fa_headphones__ctor_8_fn(fa_headphones* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_headphones__InitializeUX1_fn(fa_headphones* __this)
{
    __this->InitializeUX1();
}

// public fa_headphones New() :8
void fa_headphones__New4_fn(fa_headphones** __retval)
{
    *__retval = fa_headphones::New4();
}

// public fa_headphones() [instance] :8
void fa_headphones::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_headphones::InitializeUX1()
{
    uStackFrame __("fa_headphones", "InitializeUX()");
    Value(::STRINGS[0/*"\uF025"*/]);
    SourceLineNumber(319);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_headphones New() [static] :8
fa_headphones* fa_headphones::New4()
{
    fa_headphones* obj1 = (fa_headphones*)uNew(fa_headphones_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
