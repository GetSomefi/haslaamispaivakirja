// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sticky_note.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sticky_note.h>
...
// public partial sealed class fa_sticky_note :2
// {
// static fa_sticky_note() :4
static void fa_sticky_note__cctor_4_fn(uType* __type)
{
}

static void fa_sticky_note_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sticky_note__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sticky_note_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sticky_note);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sticky_note", options);
    type->fp_build_ = fa_sticky_note_build;
    type->fp_ctor_ = (void*)fa_sticky_note__New4_fn;
    type->fp_cctor_ = fa_sticky_note__cctor_4_fn;
...
// public fa_sticky_note() :8
void fa_sticky_note__ctor_8_fn(fa_sticky_note* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sticky_note__InitializeUX1_fn(fa_sticky_note* __this)
{
    __this->InitializeUX1();
}

// public fa_sticky_note New() :8
void fa_sticky_note__New4_fn(fa_sticky_note** __retval)
{
    *__retval = fa_sticky_note::New4();
}

// public fa_sticky_note() [instance] :8
void fa_sticky_note::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sticky_note::InitializeUX1()
{
    uStackFrame __("fa_sticky_note", "InitializeUX()");
    Value(::STRINGS[0/*"\uF249"*/]);
    SourceLineNumber(577);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sticky_note New() [static] :8
fa_sticky_note* fa_sticky_note::New4()
{
    fa_sticky_note* obj1 = (fa_sticky_note*)uNew(fa_sticky_note_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
