// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_language.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_language.h>
...
// public partial sealed class fa_language :2
// {
// static fa_language() :4
static void fa_language__cctor_4_fn(uType* __type)
{
}

static void fa_language_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_language__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_language_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_language);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_language", options);
    type->fp_build_ = fa_language_build;
    type->fp_ctor_ = (void*)fa_language__New4_fn;
    type->fp_cctor_ = fa_language__cctor_4_fn;
...
// public fa_language() :8
void fa_language__ctor_8_fn(fa_language* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_language__InitializeUX1_fn(fa_language* __this)
{
    __this->InitializeUX1();
}

// public fa_language New() :8
void fa_language__New4_fn(fa_language** __retval)
{
    *__retval = fa_language::New4();
}

// public fa_language() [instance] :8
void fa_language::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_language::InitializeUX1()
{
    uStackFrame __("fa_language", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1AB"*/]);
    SourceLineNumber(358);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_language New() [static] :8
fa_language* fa_language::New4()
{
    fa_language* obj1 = (fa_language*)uNew(fa_language_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
