// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_linkedin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_linkedin.h>
...
// public partial sealed class fa_linkedin :2
// {
// static fa_linkedin() :4
static void fa_linkedin__cctor_4_fn(uType* __type)
{
}

static void fa_linkedin_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\241");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_linkedin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_linkedin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_linkedin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_linkedin", options);
    type->fp_build_ = fa_linkedin_build;
    type->fp_ctor_ = (void*)fa_linkedin__New4_fn;
    type->fp_cctor_ = fa_linkedin__cctor_4_fn;
...
// public fa_linkedin() :8
void fa_linkedin__ctor_8_fn(fa_linkedin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_linkedin__InitializeUX1_fn(fa_linkedin* __this)
{
    __this->InitializeUX1();
}

// public fa_linkedin New() :8
void fa_linkedin__New4_fn(fa_linkedin** __retval)
{
    *__retval = fa_linkedin::New4();
}

// public fa_linkedin() [instance] :8
void fa_linkedin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_linkedin::InitializeUX1()
{
    uStackFrame __("fa_linkedin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E1"*/]);
    SourceLineNumber(375);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_linkedin New() [static] :8
fa_linkedin* fa_linkedin::New4()
{
    fa_linkedin* obj1 = (fa_linkedin*)uNew(fa_linkedin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
