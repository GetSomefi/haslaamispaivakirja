// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_spotify.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_spotify.h>
...
// public partial sealed class fa_spotify :2
// {
// static fa_spotify() :4
static void fa_spotify__cctor_4_fn(uType* __type)
{
}

static void fa_spotify_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_spotify__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_spotify_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_spotify);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_spotify", options);
    type->fp_build_ = fa_spotify_build;
    type->fp_ctor_ = (void*)fa_spotify__New4_fn;
    type->fp_cctor_ = fa_spotify__cctor_4_fn;
...
// public fa_spotify() :8
void fa_spotify__ctor_8_fn(fa_spotify* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_spotify__InitializeUX1_fn(fa_spotify* __this)
{
    __this->InitializeUX1();
}

// public fa_spotify New() :8
void fa_spotify__New4_fn(fa_spotify** __retval)
{
    *__retval = fa_spotify::New4();
}

// public fa_spotify() [instance] :8
void fa_spotify::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_spotify::InitializeUX1()
{
    uStackFrame __("fa_spotify", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BC"*/]);
    SourceLineNumber(561);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_spotify New() [static] :8
fa_spotify* fa_spotify::New4()
{
    fa_spotify* obj1 = (fa_spotify*)uNew(fa_spotify_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
