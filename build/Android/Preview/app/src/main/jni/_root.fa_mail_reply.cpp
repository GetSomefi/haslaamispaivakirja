// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mail_reply.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mail_reply.h>
...
// public partial sealed class fa_mail_reply :2
// {
// static fa_mail_reply() :4
static void fa_mail_reply__cctor_4_fn(uType* __type)
{
}

static void fa_mail_reply_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mail_reply__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mail_reply_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mail_reply);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mail_reply", options);
    type->fp_build_ = fa_mail_reply_build;
    type->fp_ctor_ = (void*)fa_mail_reply__New4_fn;
    type->fp_cctor_ = fa_mail_reply__cctor_4_fn;
...
// public fa_mail_reply() :8
void fa_mail_reply__ctor_8_fn(fa_mail_reply* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mail_reply__InitializeUX1_fn(fa_mail_reply* __this)
{
    __this->InitializeUX1();
}

// public fa_mail_reply New() :8
void fa_mail_reply__New4_fn(fa_mail_reply** __retval)
{
    *__retval = fa_mail_reply::New4();
}

// public fa_mail_reply() [instance] :8
void fa_mail_reply::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mail_reply::InitializeUX1()
{
    uStackFrame __("fa_mail_reply", "InitializeUX()");
    Value(::STRINGS[0/*"\uF112"*/]);
    SourceLineNumber(391);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mail_reply New() [static] :8
fa_mail_reply* fa_mail_reply::New4()
{
    fa_mail_reply* obj1 = (fa_mail_reply*)uNew(fa_mail_reply_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
