// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hand_o_up.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hand_o_up.h>
...
// public partial sealed class fa_hand_o_up :2
// {
// static fa_hand_o_up() :4
static void fa_hand_o_up__cctor_4_fn(uType* __type)
{
}

static void fa_hand_o_up_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hand_o_up__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hand_o_up_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hand_o_up);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hand_o_up", options);
    type->fp_build_ = fa_hand_o_up_build;
    type->fp_ctor_ = (void*)fa_hand_o_up__New4_fn;
    type->fp_cctor_ = fa_hand_o_up__cctor_4_fn;
...
// public fa_hand_o_up() :8
void fa_hand_o_up__ctor_8_fn(fa_hand_o_up* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hand_o_up__InitializeUX1_fn(fa_hand_o_up* __this)
{
    __this->InitializeUX1();
}

// public fa_hand_o_up New() :8
void fa_hand_o_up__New4_fn(fa_hand_o_up** __retval)
{
    *__retval = fa_hand_o_up::New4();
}

// public fa_hand_o_up() [instance] :8
void fa_hand_o_up::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hand_o_up::InitializeUX1()
{
    uStackFrame __("fa_hand_o_up", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0A6"*/]);
    SourceLineNumber(308);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hand_o_up New() [static] :8
fa_hand_o_up* fa_hand_o_up::New4()
{
    fa_hand_o_up* obj1 = (fa_hand_o_up*)uNew(fa_hand_o_up_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
