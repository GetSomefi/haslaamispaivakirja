// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_object_group.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_object_group.h>
...
// public partial sealed class fa_object_group :2
// {
// static fa_object_group() :4
static void fa_object_group__cctor_4_fn(uType* __type)
{
}

static void fa_object_group_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_object_group__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_object_group_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_object_group);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_object_group", options);
    type->fp_build_ = fa_object_group_build;
    type->fp_ctor_ = (void*)fa_object_group__New4_fn;
    type->fp_cctor_ = fa_object_group__cctor_4_fn;
...
// public fa_object_group() :8
void fa_object_group__ctor_8_fn(fa_object_group* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_object_group__InitializeUX1_fn(fa_object_group* __this)
{
    __this->InitializeUX1();
}

// public fa_object_group New() :8
void fa_object_group__New4_fn(fa_object_group** __retval)
{
    *__retval = fa_object_group::New4();
}

// public fa_object_group() [instance] :8
void fa_object_group::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_object_group::InitializeUX1()
{
    uStackFrame __("fa_object_group", "InitializeUX()");
    Value(::STRINGS[0/*"\uF247"*/]);
    SourceLineNumber(429);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_object_group New() [static] :8
fa_object_group* fa_object_group::New4()
{
    fa_object_group* obj1 = (fa_object_group*)uNew(fa_object_group_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
