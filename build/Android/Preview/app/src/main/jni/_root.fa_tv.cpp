// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tv.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tv.h>
...
// public partial sealed class fa_tv :2
// {
// static fa_tv() :4
static void fa_tv__cctor_4_fn(uType* __type)
{
}

static void fa_tv_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tv__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tv_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tv);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tv", options);
    type->fp_build_ = fa_tv_build;
    type->fp_ctor_ = (void*)fa_tv__New4_fn;
    type->fp_cctor_ = fa_tv__cctor_4_fn;
...
// public fa_tv() :8
void fa_tv__ctor_8_fn(fa_tv* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tv__InitializeUX1_fn(fa_tv* __this)
{
    __this->InitializeUX1();
}

// public fa_tv New() :8
void fa_tv__New4_fn(fa_tv** __retval)
{
    *__retval = fa_tv::New4();
}

// public fa_tv() [instance] :8
void fa_tv::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tv::InitializeUX1()
{
    uStackFrame __("fa_tv", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26C"*/]);
    SourceLineNumber(639);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tv New() [static] :8
fa_tv* fa_tv::New4()
{
    fa_tv* obj1 = (fa_tv*)uNew(fa_tv_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
