// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_steam.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_steam.h>
...
// public partial sealed class fa_steam :2
// {
// static fa_steam() :4
static void fa_steam__cctor_4_fn(uType* __type)
{
}

static void fa_steam_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\266");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_steam__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_steam_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_steam);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_steam", options);
    type->fp_build_ = fa_steam_build;
    type->fp_ctor_ = (void*)fa_steam__New4_fn;
    type->fp_cctor_ = fa_steam__cctor_4_fn;
...
// public fa_steam() :8
void fa_steam__ctor_8_fn(fa_steam* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_steam__InitializeUX1_fn(fa_steam* __this)
{
    __this->InitializeUX1();
}

// public fa_steam New() :8
void fa_steam__New4_fn(fa_steam** __retval)
{
    *__retval = fa_steam::New4();
}

// public fa_steam() [instance] :8
void fa_steam::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_steam::InitializeUX1()
{
    uStackFrame __("fa_steam", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B6"*/]);
    SourceLineNumber(572);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_steam New() [static] :8
fa_steam* fa_steam::New4()
{
    fa_steam* obj1 = (fa_steam*)uNew(fa_steam_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
