// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_youtube.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_youtube.h>
...
// public partial sealed class fa_youtube :2
// {
// static fa_youtube() :4
static void fa_youtube__cctor_4_fn(uType* __type)
{
}

static void fa_youtube_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_youtube__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_youtube_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_youtube);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_youtube", options);
    type->fp_build_ = fa_youtube_build;
    type->fp_ctor_ = (void*)fa_youtube__New4_fn;
    type->fp_cctor_ = fa_youtube__cctor_4_fn;
...
// public fa_youtube() :8
void fa_youtube__ctor_8_fn(fa_youtube* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_youtube__InitializeUX1_fn(fa_youtube* __this)
{
    __this->InitializeUX1();
}

// public fa_youtube New() :8
void fa_youtube__New4_fn(fa_youtube** __retval)
{
    *__retval = fa_youtube::New4();
}

// public fa_youtube() [instance] :8
void fa_youtube::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_youtube::InitializeUX1()
{
    uStackFrame __("fa_youtube", "InitializeUX()");
    Value(::STRINGS[0/*"\uF167"*/]);
    SourceLineNumber(693);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_youtube New() [static] :8
fa_youtube* fa_youtube::New4()
{
    fa_youtube* obj1 = (fa_youtube*)uNew(fa_youtube_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
