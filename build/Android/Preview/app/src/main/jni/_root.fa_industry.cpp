// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_industry.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_industry.h>
...
// public partial sealed class fa_industry :2
// {
// static fa_industry() :4
static void fa_industry__cctor_4_fn(uType* __type)
{
}

static void fa_industry_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_industry__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_industry_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_industry);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_industry", options);
    type->fp_build_ = fa_industry_build;
    type->fp_ctor_ = (void*)fa_industry__New4_fn;
    type->fp_cctor_ = fa_industry__cctor_4_fn;
...
// public fa_industry() :8
void fa_industry__ctor_8_fn(fa_industry* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_industry__InitializeUX1_fn(fa_industry* __this)
{
    __this->InitializeUX1();
}

// public fa_industry New() :8
void fa_industry__New4_fn(fa_industry** __retval)
{
    *__retval = fa_industry::New4();
}

// public fa_industry() [instance] :8
void fa_industry::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_industry::InitializeUX1()
{
    uStackFrame __("fa_industry", "InitializeUX()");
    Value(::STRINGS[0/*"\uF275"*/]);
    SourceLineNumber(342);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_industry New() [static] :8
fa_industry* fa_industry::New4()
{
    fa_industry* obj1 = (fa_industry*)uNew(fa_industry_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
