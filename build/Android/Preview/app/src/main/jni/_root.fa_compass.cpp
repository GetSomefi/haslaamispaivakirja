// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_compass.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_compass.h>
...
// public partial sealed class fa_compass :2
// {
// static fa_compass() :4
static void fa_compass__cctor_4_fn(uType* __type)
{
}

static void fa_compass_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_compass__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_compass_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_compass);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_compass", options);
    type->fp_build_ = fa_compass_build;
    type->fp_ctor_ = (void*)fa_compass__New4_fn;
    type->fp_cctor_ = fa_compass__cctor_4_fn;
...
// public fa_compass() :8
void fa_compass__ctor_8_fn(fa_compass* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_compass__InitializeUX1_fn(fa_compass* __this)
{
    __this->InitializeUX1();
}

// public fa_compass New() :8
void fa_compass__New4_fn(fa_compass** __retval)
{
    *__retval = fa_compass::New4();
}

// public fa_compass() [instance] :8
void fa_compass::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_compass::InitializeUX1()
{
    uStackFrame __("fa_compass", "InitializeUX()");
    Value(::STRINGS[0/*"\uF14E"*/]);
    SourceLineNumber(168);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_compass New() [static] :8
fa_compass* fa_compass::New4()
{
    fa_compass* obj1 = (fa_compass*)uNew(fa_compass_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
