// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_random.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_random.h>
...
// public partial sealed class fa_random :2
// {
// static fa_random() :4
static void fa_random__cctor_4_fn(uType* __type)
{
}

static void fa_random_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\264");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_random__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_random_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_random);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_random", options);
    type->fp_build_ = fa_random_build;
    type->fp_ctor_ = (void*)fa_random__New4_fn;
    type->fp_cctor_ = fa_random__cctor_4_fn;
...
// public fa_random() :8
void fa_random__ctor_8_fn(fa_random* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_random__InitializeUX1_fn(fa_random* __this)
{
    __this->InitializeUX1();
}

// public fa_random New() :8
void fa_random__New4_fn(fa_random** __retval)
{
    *__retval = fa_random::New4();
}

// public fa_random() [instance] :8
void fa_random::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_random::InitializeUX1()
{
    uStackFrame __("fa_random", "InitializeUX()");
    Value(::STRINGS[0/*"\uF074"*/]);
    SourceLineNumber(484);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_random New() [static] :8
fa_random* fa_random::New4()
{
    fa_random* obj1 = (fa_random*)uNew(fa_random_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
