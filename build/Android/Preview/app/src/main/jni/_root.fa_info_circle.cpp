// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_info_circle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_info_circle.h>
...
// public partial sealed class fa_info_circle :2
// {
// static fa_info_circle() :4
static void fa_info_circle__cctor_4_fn(uType* __type)
{
}

static void fa_info_circle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_info_circle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_info_circle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_info_circle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_info_circle", options);
    type->fp_build_ = fa_info_circle_build;
    type->fp_ctor_ = (void*)fa_info_circle__New4_fn;
    type->fp_cctor_ = fa_info_circle__cctor_4_fn;
...
// public fa_info_circle() :8
void fa_info_circle__ctor_8_fn(fa_info_circle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_info_circle__InitializeUX1_fn(fa_info_circle* __this)
{
    __this->InitializeUX1();
}

// public fa_info_circle New() :8
void fa_info_circle__New4_fn(fa_info_circle** __retval)
{
    *__retval = fa_info_circle::New4();
}

// public fa_info_circle() [instance] :8
void fa_info_circle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_info_circle::InitializeUX1()
{
    uStackFrame __("fa_info_circle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF05A"*/]);
    SourceLineNumber(344);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_info_circle New() [static] :8
fa_info_circle* fa_info_circle::New4()
{
    fa_info_circle* obj1 = (fa_info_circle*)uNew(fa_info_circle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
