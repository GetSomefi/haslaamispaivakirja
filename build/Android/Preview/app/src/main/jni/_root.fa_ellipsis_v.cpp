// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ellipsis_v.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ellipsis_v.h>
...
// public partial sealed class fa_ellipsis_v :2
// {
// static fa_ellipsis_v() :4
static void fa_ellipsis_v__cctor_4_fn(uType* __type)
{
}

static void fa_ellipsis_v_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ellipsis_v__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ellipsis_v_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ellipsis_v);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ellipsis_v", options);
    type->fp_build_ = fa_ellipsis_v_build;
    type->fp_ctor_ = (void*)fa_ellipsis_v__New4_fn;
    type->fp_cctor_ = fa_ellipsis_v__cctor_4_fn;
...
// public fa_ellipsis_v() :8
void fa_ellipsis_v__ctor_8_fn(fa_ellipsis_v* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ellipsis_v__InitializeUX1_fn(fa_ellipsis_v* __this)
{
    __this->InitializeUX1();
}

// public fa_ellipsis_v New() :8
void fa_ellipsis_v__New4_fn(fa_ellipsis_v** __retval)
{
    *__retval = fa_ellipsis_v::New4();
}

// public fa_ellipsis_v() [instance] :8
void fa_ellipsis_v::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_ellipsis_v::InitializeUX1()
{
    uStackFrame __("fa_ellipsis_v", "InitializeUX()");
    Value(::STRINGS[0/*"\uF142"*/]);
    SourceLineNumber(203);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ellipsis_v New() [static] :8
fa_ellipsis_v* fa_ellipsis_v::New4()
{
    fa_ellipsis_v* obj1 = (fa_ellipsis_v*)uNew(fa_ellipsis_v_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
