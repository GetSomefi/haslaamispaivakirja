// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_creative_commons.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_creative_commons.h>
...
// public partial sealed class fa_creative_commons :2
// {
// static fa_creative_commons() :4
static void fa_creative_commons__cctor_4_fn(uType* __type)
{
}

static void fa_creative_commons_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_creative_commons__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_creative_commons_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_creative_commons);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_creative_commons", options);
    type->fp_build_ = fa_creative_commons_build;
    type->fp_ctor_ = (void*)fa_creative_commons__New4_fn;
    type->fp_cctor_ = fa_creative_commons__cctor_4_fn;
...
// public fa_creative_commons() :8
void fa_creative_commons__ctor_8_fn(fa_creative_commons* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_creative_commons__InitializeUX1_fn(fa_creative_commons* __this)
{
    __this->InitializeUX1();
}

// public fa_creative_commons New() :8
void fa_creative_commons__New4_fn(fa_creative_commons** __retval)
{
    *__retval = fa_creative_commons::New4();
}

// public fa_creative_commons() [instance] :8
void fa_creative_commons::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_creative_commons::InitializeUX1()
{
    uStackFrame __("fa_creative_commons", "InitializeUX()");
    Value(::STRINGS[0/*"\uF25E"*/]);
    SourceLineNumber(174);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_creative_commons New() [static] :8
fa_creative_commons* fa_creative_commons::New4()
{
    fa_creative_commons* obj1 = (fa_creative_commons*)uNew(fa_creative_commons_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
