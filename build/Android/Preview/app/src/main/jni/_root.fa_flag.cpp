// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_flag.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_flag.h>
...
// public partial sealed class fa_flag :2
// {
// static fa_flag() :4
static void fa_flag__cctor_4_fn(uType* __type)
{
}

static void fa_flag_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_flag__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_flag_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_flag);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_flag", options);
    type->fp_build_ = fa_flag_build;
    type->fp_ctor_ = (void*)fa_flag__New4_fn;
    type->fp_cctor_ = fa_flag__cctor_4_fn;
...
// public fa_flag() :8
void fa_flag__ctor_8_fn(fa_flag* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_flag__InitializeUX1_fn(fa_flag* __this)
{
    __this->InitializeUX1();
}

// public fa_flag New() :8
void fa_flag__New4_fn(fa_flag** __retval)
{
    *__retval = fa_flag::New4();
}

// public fa_flag() [instance] :8
void fa_flag::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_flag::InitializeUX1()
{
    uStackFrame __("fa_flag", "InitializeUX()");
    Value(::STRINGS[0/*"\uF024"*/]);
    SourceLineNumber(256);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_flag New() [static] :8
fa_flag* fa_flag::New4()
{
    fa_flag* obj1 = (fa_flag*)uNew(fa_flag_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
