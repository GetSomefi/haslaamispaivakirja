// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_venus_double.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_venus_double.h>
...
// public partial sealed class fa_venus_double :2
// {
// static fa_venus_double() :4
static void fa_venus_double__cctor_4_fn(uType* __type)
{
}

static void fa_venus_double_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_venus_double__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_venus_double_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_venus_double);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_venus_double", options);
    type->fp_build_ = fa_venus_double_build;
    type->fp_ctor_ = (void*)fa_venus_double__New4_fn;
    type->fp_cctor_ = fa_venus_double__cctor_4_fn;
...
// public fa_venus_double() :8
void fa_venus_double__ctor_8_fn(fa_venus_double* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_venus_double__InitializeUX1_fn(fa_venus_double* __this)
{
    __this->InitializeUX1();
}

// public fa_venus_double New() :8
void fa_venus_double__New4_fn(fa_venus_double** __retval)
{
    *__retval = fa_venus_double::New4();
}

// public fa_venus_double() [instance] :8
void fa_venus_double::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_venus_double::InitializeUX1()
{
    uStackFrame __("fa_venus_double", "InitializeUX()");
    Value(::STRINGS[0/*"\uF226"*/]);
    SourceLineNumber(661);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_venus_double New() [static] :8
fa_venus_double* fa_venus_double::New4()
{
    fa_venus_double* obj1 = (fa_venus_double*)uNew(fa_venus_double_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
