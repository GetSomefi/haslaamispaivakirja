// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fax.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fax.h>
...
// public partial sealed class fa_fax :2
// {
// static fa_fax() :4
static void fa_fax__cctor_4_fn(uType* __type)
{
}

static void fa_fax_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fax__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fax_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fax);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fax", options);
    type->fp_build_ = fa_fax_build;
    type->fp_ctor_ = (void*)fa_fax__New4_fn;
    type->fp_cctor_ = fa_fax__cctor_4_fn;
...
// public fa_fax() :8
void fa_fax__ctor_8_fn(fa_fax* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fax__InitializeUX1_fn(fa_fax* __this)
{
    __this->InitializeUX1();
}

// public fa_fax New() :8
void fa_fax__New4_fn(fa_fax** __retval)
{
    *__retval = fa_fax::New4();
}

// public fa_fax() [instance] :8
void fa_fax::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_fax::InitializeUX1()
{
    uStackFrame __("fa_fax", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1AC"*/]);
    SourceLineNumber(228);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fax New() [static] :8
fa_fax* fa_fax::New4()
{
    fa_fax* obj1 = (fa_fax*)uNew(fa_fax_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
