// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_delicious.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_delicious.h>
...
// public partial sealed class fa_delicious :2
// {
// static fa_delicious() :4
static void fa_delicious__cctor_4_fn(uType* __type)
{
}

static void fa_delicious_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_delicious__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_delicious_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_delicious);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_delicious", options);
    type->fp_build_ = fa_delicious_build;
    type->fp_ctor_ = (void*)fa_delicious__New4_fn;
    type->fp_cctor_ = fa_delicious__cctor_4_fn;
...
// public fa_delicious() :8
void fa_delicious__ctor_8_fn(fa_delicious* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_delicious__InitializeUX1_fn(fa_delicious* __this)
{
    __this->InitializeUX1();
}

// public fa_delicious New() :8
void fa_delicious__New4_fn(fa_delicious** __retval)
{
    *__retval = fa_delicious::New4();
}

// public fa_delicious() [instance] :8
void fa_delicious::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_delicious::InitializeUX1()
{
    uStackFrame __("fa_delicious", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A5"*/]);
    SourceLineNumber(188);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_delicious New() [static] :8
fa_delicious* fa_delicious::New4()
{
    fa_delicious* obj1 = (fa_delicious*)uNew(fa_delicious_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
