// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_align_center.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_align_center.h>
...
// public partial sealed class fa_align_center :2
// {
// static fa_align_center() :4
static void fa_align_center__cctor_4_fn(uType* __type)
{
}

static void fa_align_center_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\267");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_align_center__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_align_center_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_align_center);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_align_center", options);
    type->fp_build_ = fa_align_center_build;
    type->fp_ctor_ = (void*)fa_align_center__New4_fn;
    type->fp_cctor_ = fa_align_center__cctor_4_fn;
...
// public fa_align_center() :8
void fa_align_center__ctor_8_fn(fa_align_center* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_align_center__InitializeUX1_fn(fa_align_center* __this)
{
    __this->InitializeUX1();
}

// public fa_align_center New() :8
void fa_align_center__New4_fn(fa_align_center** __retval)
{
    *__retval = fa_align_center::New4();
}

// public fa_align_center() [instance] :8
void fa_align_center::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_align_center::InitializeUX1()
{
    uStackFrame __("fa_align_center", "InitializeUX()");
    Value(::STRINGS[0/*"\uF037"*/]);
    SourceLineNumber(5);
...
// public fa_align_center New() [static] :8
fa_align_center* fa_align_center::New4()
{
    fa_align_center* obj1 = (fa_align_center*)uNew(fa_align_center_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
