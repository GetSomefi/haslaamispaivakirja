// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_reply.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_reply.h>
...
// public partial sealed class fa_reply :2
// {
// static fa_reply() :4
static void fa_reply__cctor_4_fn(uType* __type)
{
}

static void fa_reply_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_reply__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_reply_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_reply);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_reply", options);
    type->fp_build_ = fa_reply_build;
    type->fp_ctor_ = (void*)fa_reply__New4_fn;
    type->fp_cctor_ = fa_reply__cctor_4_fn;
...
// public fa_reply() :8
void fa_reply__ctor_8_fn(fa_reply* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_reply__InitializeUX1_fn(fa_reply* __this)
{
    __this->InitializeUX1();
}

// public fa_reply New() :8
void fa_reply__New4_fn(fa_reply** __retval)
{
    *__retval = fa_reply::New4();
}

// public fa_reply() [instance] :8
void fa_reply::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_reply::InitializeUX1()
{
    uStackFrame __("fa_reply", "InitializeUX()");
    Value(::STRINGS[0/*"\uF112"*/]);
    SourceLineNumber(496);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_reply New() [static] :8
fa_reply* fa_reply::New4()
{
    fa_reply* obj1 = (fa_reply*)uNew(fa_reply_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
