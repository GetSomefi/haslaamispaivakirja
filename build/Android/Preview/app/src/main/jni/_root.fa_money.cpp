// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_money.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_money.h>
...
// public partial sealed class fa_money :2
// {
// static fa_money() :4
static void fa_money__cctor_4_fn(uType* __type)
{
}

static void fa_money_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\226");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_money__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_money_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_money);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_money", options);
    type->fp_build_ = fa_money_build;
    type->fp_ctor_ = (void*)fa_money__New4_fn;
    type->fp_cctor_ = fa_money__cctor_4_fn;
...
// public fa_money() :8
void fa_money__ctor_8_fn(fa_money* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_money__InitializeUX1_fn(fa_money* __this)
{
    __this->InitializeUX1();
}

// public fa_money New() :8
void fa_money__New4_fn(fa_money** __retval)
{
    *__retval = fa_money::New4();
}

// public fa_money() [instance] :8
void fa_money::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_money::InitializeUX1()
{
    uStackFrame __("fa_money", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D6"*/]);
    SourceLineNumber(420);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_money New() [static] :8
fa_money* fa_money::New4()
{
    fa_money* obj1 = (fa_money*)uNew(fa_money_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
