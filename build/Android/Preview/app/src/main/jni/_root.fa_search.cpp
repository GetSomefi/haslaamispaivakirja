// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_search.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_search.h>
...
// public partial sealed class fa_search :2
// {
// static fa_search() :4
static void fa_search__cctor_4_fn(uType* __type)
{
}

static void fa_search_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_search__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_search_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_search);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_search", options);
    type->fp_build_ = fa_search_build;
    type->fp_ctor_ = (void*)fa_search__New4_fn;
    type->fp_cctor_ = fa_search__cctor_4_fn;
...
// public fa_search() :8
void fa_search__ctor_8_fn(fa_search* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_search__InitializeUX1_fn(fa_search* __this)
{
    __this->InitializeUX1();
}

// public fa_search New() :8
void fa_search__New4_fn(fa_search** __retval)
{
    *__retval = fa_search::New4();
}

// public fa_search() [instance] :8
void fa_search::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_search::InitializeUX1()
{
    uStackFrame __("fa_search", "InitializeUX()");
    Value(::STRINGS[0/*"\uF002"*/]);
    SourceLineNumber(514);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_search New() [static] :8
fa_search* fa_search::New4()
{
    fa_search* obj1 = (fa_search*)uNew(fa_search_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
