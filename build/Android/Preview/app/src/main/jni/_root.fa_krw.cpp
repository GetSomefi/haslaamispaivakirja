// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_krw.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_krw.h>
...
// public partial sealed class fa_krw :2
// {
// static fa_krw() :4
static void fa_krw__cctor_4_fn(uType* __type)
{
}

static void fa_krw_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_krw__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_krw_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_krw);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_krw", options);
    type->fp_build_ = fa_krw_build;
    type->fp_ctor_ = (void*)fa_krw__New4_fn;
    type->fp_cctor_ = fa_krw__cctor_4_fn;
...
// public fa_krw() :8
void fa_krw__ctor_8_fn(fa_krw* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_krw__InitializeUX1_fn(fa_krw* __this)
{
    __this->InitializeUX1();
}

// public fa_krw New() :8
void fa_krw__New4_fn(fa_krw** __retval)
{
    *__retval = fa_krw::New4();
}

// public fa_krw() [instance] :8
void fa_krw::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_krw::InitializeUX1()
{
    uStackFrame __("fa_krw", "InitializeUX()");
    Value(::STRINGS[0/*"\uF159"*/]);
    SourceLineNumber(357);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_krw New() [static] :8
fa_krw* fa_krw::New4()
{
    fa_krw* obj1 = (fa_krw*)uNew(fa_krw_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
