// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_navicon.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_navicon.h>
...
// public partial sealed class fa_navicon :2
// {
// static fa_navicon() :4
static void fa_navicon__cctor_4_fn(uType* __type)
{
}

static void fa_navicon_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_navicon__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_navicon_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_navicon);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_navicon", options);
    type->fp_build_ = fa_navicon_build;
    type->fp_ctor_ = (void*)fa_navicon__New4_fn;
    type->fp_cctor_ = fa_navicon__cctor_4_fn;
...
// public fa_navicon() :8
void fa_navicon__ctor_8_fn(fa_navicon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_navicon__InitializeUX1_fn(fa_navicon* __this)
{
    __this->InitializeUX1();
}

// public fa_navicon New() :8
void fa_navicon__New4_fn(fa_navicon** __retval)
{
    *__retval = fa_navicon::New4();
}

// public fa_navicon() [instance] :8
void fa_navicon::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_navicon::InitializeUX1()
{
    uStackFrame __("fa_navicon", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C9"*/]);
    SourceLineNumber(426);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_navicon New() [static] :8
fa_navicon* fa_navicon::New4()
{
    fa_navicon* obj1 = (fa_navicon*)uNew(fa_navicon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
