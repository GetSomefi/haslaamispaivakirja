// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rss_square.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rss_square.h>
...
// public partial sealed class fa_rss_square :2
// {
// static fa_rss_square() :4
static void fa_rss_square__cctor_4_fn(uType* __type)
{
}

static void fa_rss_square_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rss_square__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rss_square_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rss_square);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rss_square", options);
    type->fp_build_ = fa_rss_square_build;
    type->fp_ctor_ = (void*)fa_rss_square__New4_fn;
    type->fp_cctor_ = fa_rss_square__cctor_4_fn;
...
// public fa_rss_square() :8
void fa_rss_square__ctor_8_fn(fa_rss_square* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rss_square__InitializeUX1_fn(fa_rss_square* __this)
{
    __this->InitializeUX1();
}

// public fa_rss_square New() :8
void fa_rss_square__New4_fn(fa_rss_square** __retval)
{
    *__retval = fa_rss_square::New4();
}

// public fa_rss_square() [instance] :8
void fa_rss_square::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_rss_square::InitializeUX1()
{
    uStackFrame __("fa_rss_square", "InitializeUX()");
    Value(::STRINGS[0/*"\uF143"*/]);
    SourceLineNumber(506);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rss_square New() [static] :8
fa_rss_square* fa_rss_square::New4()
{
    fa_rss_square* obj1 = (fa_rss_square*)uNew(fa_rss_square_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
