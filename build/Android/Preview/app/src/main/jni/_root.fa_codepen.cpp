// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_codepen.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_codepen.h>
...
// public partial sealed class fa_codepen :2
// {
// static fa_codepen() :4
static void fa_codepen__cctor_4_fn(uType* __type)
{
}

static void fa_codepen_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\213");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_codepen__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_codepen_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_codepen);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_codepen", options);
    type->fp_build_ = fa_codepen_build;
    type->fp_ctor_ = (void*)fa_codepen__New4_fn;
    type->fp_cctor_ = fa_codepen__cctor_4_fn;
...
// public fa_codepen() :8
void fa_codepen__ctor_8_fn(fa_codepen* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_codepen__InitializeUX1_fn(fa_codepen* __this)
{
    __this->InitializeUX1();
}

// public fa_codepen New() :8
void fa_codepen__New4_fn(fa_codepen** __retval)
{
    *__retval = fa_codepen::New4();
}

// public fa_codepen() [instance] :8
void fa_codepen::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_codepen::InitializeUX1()
{
    uStackFrame __("fa_codepen", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CB"*/]);
    SourceLineNumber(156);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_codepen New() [static] :8
fa_codepen* fa_codepen::New4()
{
    fa_codepen* obj1 = (fa_codepen*)uNew(fa_codepen_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
