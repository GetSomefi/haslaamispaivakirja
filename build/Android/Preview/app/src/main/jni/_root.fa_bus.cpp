// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bus.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bus.h>
...
// public partial sealed class fa_bus :2
// {
// static fa_bus() :4
static void fa_bus__cctor_4_fn(uType* __type)
{
}

static void fa_bus_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bus__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bus_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bus);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bus", options);
    type->fp_build_ = fa_bus_build;
    type->fp_ctor_ = (void*)fa_bus__New4_fn;
    type->fp_cctor_ = fa_bus__cctor_4_fn;
...
// public fa_bus() :8
void fa_bus__ctor_8_fn(fa_bus* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bus__InitializeUX1_fn(fa_bus* __this)
{
    __this->InitializeUX1();
}

// public fa_bus New() :8
void fa_bus__New4_fn(fa_bus** __retval)
{
    *__retval = fa_bus::New4();
}

// public fa_bus() [instance] :8
void fa_bus::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bus::InitializeUX1()
{
    uStackFrame __("fa_bus", "InitializeUX()");
    Value(::STRINGS[0/*"\uF207"*/]);
    SourceLineNumber(92);
...
// public fa_bus New() [static] :8
fa_bus* fa_bus::New4()
{
    fa_bus* obj1 = (fa_bus*)uNew(fa_bus_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
