// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_warning.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_warning.h>
...
// public partial sealed class fa_warning :2
// {
// static fa_warning() :4
static void fa_warning__cctor_4_fn(uType* __type)
{
}

static void fa_warning_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_warning__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_warning_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_warning);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_warning", options);
    type->fp_build_ = fa_warning_build;
    type->fp_ctor_ = (void*)fa_warning__New4_fn;
    type->fp_cctor_ = fa_warning__cctor_4_fn;
...
// public fa_warning() :8
void fa_warning__ctor_8_fn(fa_warning* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_warning__InitializeUX1_fn(fa_warning* __this)
{
    __this->InitializeUX1();
}

// public fa_warning New() :8
void fa_warning__New4_fn(fa_warning** __retval)
{
    *__retval = fa_warning::New4();
}

// public fa_warning() [instance] :8
void fa_warning::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_warning::InitializeUX1()
{
    uStackFrame __("fa_warning", "InitializeUX()");
    Value(::STRINGS[0/*"\uF071"*/]);
    SourceLineNumber(672);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_warning New() [static] :8
fa_warning* fa_warning::New4()
{
    fa_warning* obj1 = (fa_warning*)uNew(fa_warning_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
