// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_whatsapp.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_whatsapp.h>
...
// public partial sealed class fa_whatsapp :2
// {
// static fa_whatsapp() :4
static void fa_whatsapp__cctor_4_fn(uType* __type)
{
}

static void fa_whatsapp_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_whatsapp__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_whatsapp_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_whatsapp);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_whatsapp", options);
    type->fp_build_ = fa_whatsapp_build;
    type->fp_ctor_ = (void*)fa_whatsapp__New4_fn;
    type->fp_cctor_ = fa_whatsapp__cctor_4_fn;
...
// public fa_whatsapp() :8
void fa_whatsapp__ctor_8_fn(fa_whatsapp* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_whatsapp__InitializeUX1_fn(fa_whatsapp* __this)
{
    __this->InitializeUX1();
}

// public fa_whatsapp New() :8
void fa_whatsapp__New4_fn(fa_whatsapp** __retval)
{
    *__retval = fa_whatsapp::New4();
}

// public fa_whatsapp() [instance] :8
void fa_whatsapp::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_whatsapp::InitializeUX1()
{
    uStackFrame __("fa_whatsapp", "InitializeUX()");
    Value(::STRINGS[0/*"\uF232"*/]);
    SourceLineNumber(676);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_whatsapp New() [static] :8
fa_whatsapp* fa_whatsapp::New4()
{
    fa_whatsapp* obj1 = (fa_whatsapp*)uNew(fa_whatsapp_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
