// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dedent.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dedent.h>
...
// public partial sealed class fa_dedent :2
// {
// static fa_dedent() :4
static void fa_dedent__cctor_4_fn(uType* __type)
{
}

static void fa_dedent_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dedent__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dedent_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dedent);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dedent", options);
    type->fp_build_ = fa_dedent_build;
    type->fp_ctor_ = (void*)fa_dedent__New4_fn;
    type->fp_cctor_ = fa_dedent__cctor_4_fn;
...
// public fa_dedent() :8
void fa_dedent__ctor_8_fn(fa_dedent* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dedent__InitializeUX1_fn(fa_dedent* __this)
{
    __this->InitializeUX1();
}

// public fa_dedent New() :8
void fa_dedent__New4_fn(fa_dedent** __retval)
{
    *__retval = fa_dedent::New4();
}

// public fa_dedent() [instance] :8
void fa_dedent::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dedent::InitializeUX1()
{
    uStackFrame __("fa_dedent", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03B"*/]);
    SourceLineNumber(187);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dedent New() [static] :8
fa_dedent* fa_dedent::New4()
{
    fa_dedent* obj1 = (fa_dedent*)uNew(fa_dedent_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
