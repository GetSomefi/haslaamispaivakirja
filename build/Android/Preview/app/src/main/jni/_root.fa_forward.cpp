// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_forward.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_forward.h>
...
// public partial sealed class fa_forward :2
// {
// static fa_forward() :4
static void fa_forward__cctor_4_fn(uType* __type)
{
}

static void fa_forward_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_forward__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_forward_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_forward);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_forward", options);
    type->fp_build_ = fa_forward_build;
    type->fp_ctor_ = (void*)fa_forward__New4_fn;
    type->fp_cctor_ = fa_forward__cctor_4_fn;
...
// public fa_forward() :8
void fa_forward__ctor_8_fn(fa_forward* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_forward__InitializeUX1_fn(fa_forward* __this)
{
    __this->InitializeUX1();
}

// public fa_forward New() :8
void fa_forward__New4_fn(fa_forward** __retval)
{
    *__retval = fa_forward::New4();
}

// public fa_forward() [instance] :8
void fa_forward::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_forward::InitializeUX1()
{
    uStackFrame __("fa_forward", "InitializeUX()");
    Value(::STRINGS[0/*"\uF04E"*/]);
...
// public fa_forward New() [static] :8
fa_forward* fa_forward::New4()
{
    fa_forward* obj1 = (fa_forward*)uNew(fa_forward_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
