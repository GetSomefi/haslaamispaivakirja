// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_joomla.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_joomla.h>
...
// public partial sealed class fa_joomla :2
// {
// static fa_joomla() :4
static void fa_joomla__cctor_4_fn(uType* __type)
{
}

static void fa_joomla_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_joomla__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_joomla_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_joomla);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_joomla", options);
    type->fp_build_ = fa_joomla_build;
    type->fp_ctor_ = (void*)fa_joomla__New4_fn;
    type->fp_cctor_ = fa_joomla__cctor_4_fn;
...
// public fa_joomla() :8
void fa_joomla__ctor_8_fn(fa_joomla* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_joomla__InitializeUX1_fn(fa_joomla* __this)
{
    __this->InitializeUX1();
}

// public fa_joomla New() :8
void fa_joomla__New4_fn(fa_joomla** __retval)
{
    *__retval = fa_joomla::New4();
}

// public fa_joomla() [instance] :8
void fa_joomla::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_joomla::InitializeUX1()
{
    uStackFrame __("fa_joomla", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1AA"*/]);
    SourceLineNumber(352);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_joomla New() [static] :8
fa_joomla* fa_joomla::New4()
{
    fa_joomla* obj1 = (fa_joomla*)uNew(fa_joomla_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
