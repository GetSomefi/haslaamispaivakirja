// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_location_arrow.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_location_arrow.h>
...
// public partial sealed class fa_location_arrow :2
// {
// static fa_location_arrow() :4
static void fa_location_arrow__cctor_4_fn(uType* __type)
{
}

static void fa_location_arrow_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_location_arrow__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_location_arrow_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_location_arrow);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_location_arrow", options);
    type->fp_build_ = fa_location_arrow_build;
    type->fp_ctor_ = (void*)fa_location_arrow__New4_fn;
    type->fp_cctor_ = fa_location_arrow__cctor_4_fn;
...
// public fa_location_arrow() :8
void fa_location_arrow__ctor_8_fn(fa_location_arrow* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_location_arrow__InitializeUX1_fn(fa_location_arrow* __this)
{
    __this->InitializeUX1();
}

// public fa_location_arrow New() :8
void fa_location_arrow__New4_fn(fa_location_arrow** __retval)
{
    *__retval = fa_location_arrow::New4();
}

// public fa_location_arrow() [instance] :8
void fa_location_arrow::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_location_arrow::InitializeUX1()
{
    uStackFrame __("fa_location_arrow", "InitializeUX()");
    Value(::STRINGS[0/*"\uF124"*/]);
    SourceLineNumber(382);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_location_arrow New() [static] :8
fa_location_arrow* fa_location_arrow::New4()
{
    fa_location_arrow* obj1 = (fa_location_arrow*)uNew(fa_location_arrow_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
