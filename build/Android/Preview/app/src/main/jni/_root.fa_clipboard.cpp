// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_clipboard.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_clipboard.h>
...
// public partial sealed class fa_clipboard :2
// {
// static fa_clipboard() :4
static void fa_clipboard__cctor_4_fn(uType* __type)
{
}

static void fa_clipboard_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_clipboard__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_clipboard_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_clipboard);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_clipboard", options);
    type->fp_build_ = fa_clipboard_build;
    type->fp_ctor_ = (void*)fa_clipboard__New4_fn;
    type->fp_cctor_ = fa_clipboard__cctor_4_fn;
...
// public fa_clipboard() :8
void fa_clipboard__ctor_8_fn(fa_clipboard* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_clipboard__InitializeUX1_fn(fa_clipboard* __this)
{
    __this->InitializeUX1();
}

// public fa_clipboard New() :8
void fa_clipboard__New4_fn(fa_clipboard** __retval)
{
    *__retval = fa_clipboard::New4();
}

// public fa_clipboard() [instance] :8
void fa_clipboard::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_clipboard::InitializeUX1()
{
    uStackFrame __("fa_clipboard", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0EA"*/]);
    SourceLineNumber(146);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_clipboard New() [static] :8
fa_clipboard* fa_clipboard::New4()
{
    fa_clipboard* obj1 = (fa_clipboard*)uNew(fa_clipboard_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
