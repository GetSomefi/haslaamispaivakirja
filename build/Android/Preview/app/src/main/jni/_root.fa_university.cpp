// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_university.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_university.h>
...
// public partial sealed class fa_university :2
// {
// static fa_university() :4
static void fa_university__cctor_4_fn(uType* __type)
{
}

static void fa_university_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_university__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_university_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_university);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_university", options);
    type->fp_build_ = fa_university_build;
    type->fp_ctor_ = (void*)fa_university__New4_fn;
    type->fp_cctor_ = fa_university__cctor_4_fn;
...
// public fa_university() :8
void fa_university__ctor_8_fn(fa_university* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_university__InitializeUX1_fn(fa_university* __this)
{
    __this->InitializeUX1();
}

// public fa_university New() :8
void fa_university__New4_fn(fa_university** __retval)
{
    *__retval = fa_university::New4();
}

// public fa_university() [instance] :8
void fa_university::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_university::InitializeUX1()
{
    uStackFrame __("fa_university", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19C"*/]);
    SourceLineNumber(646);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_university New() [static] :8
fa_university* fa_university::New4()
{
    fa_university* obj1 = (fa_university*)uNew(fa_university_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
