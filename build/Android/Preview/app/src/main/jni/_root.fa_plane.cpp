// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_plane.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_plane.h>
...
// public partial sealed class fa_plane :2
// {
// static fa_plane() :4
static void fa_plane__cctor_4_fn(uType* __type)
{
}

static void fa_plane_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_plane__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_plane_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_plane);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_plane", options);
    type->fp_build_ = fa_plane_build;
    type->fp_ctor_ = (void*)fa_plane__New4_fn;
    type->fp_cctor_ = fa_plane__cctor_4_fn;
...
// public fa_plane() :8
void fa_plane__ctor_8_fn(fa_plane* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_plane__InitializeUX1_fn(fa_plane* __this)
{
    __this->InitializeUX1();
}

// public fa_plane New() :8
void fa_plane__New4_fn(fa_plane** __retval)
{
    *__retval = fa_plane::New4();
}

// public fa_plane() [instance] :8
void fa_plane::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_plane::InitializeUX1()
{
    uStackFrame __("fa_plane", "InitializeUX()");
    Value(::STRINGS[0/*"\uF072"*/]);
    SourceLineNumber(464);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_plane New() [static] :8
fa_plane* fa_plane::New4()
{
    fa_plane* obj1 = (fa_plane*)uNew(fa_plane_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
