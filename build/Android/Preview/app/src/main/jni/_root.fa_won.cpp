// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_won.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_won.h>
...
// public partial sealed class fa_won :2
// {
// static fa_won() :4
static void fa_won__cctor_4_fn(uType* __type)
{
}

static void fa_won_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\231");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_won__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_won_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_won);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_won", options);
    type->fp_build_ = fa_won_build;
    type->fp_ctor_ = (void*)fa_won__New4_fn;
    type->fp_cctor_ = fa_won__cctor_4_fn;
...
// public fa_won() :8
void fa_won__ctor_8_fn(fa_won* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_won__InitializeUX1_fn(fa_won* __this)
{
    __this->InitializeUX1();
}

// public fa_won New() :8
void fa_won__New4_fn(fa_won** __retval)
{
    *__retval = fa_won::New4();
}

// public fa_won() [instance] :8
void fa_won::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_won::InitializeUX1()
{
    uStackFrame __("fa_won", "InitializeUX()");
    Value(::STRINGS[0/*"\uF159"*/]);
    SourceLineNumber(681);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_won New() [static] :8
fa_won* fa_won::New4()
{
    fa_won* obj1 = (fa_won*)uNew(fa_won_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
