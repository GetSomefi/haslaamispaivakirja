// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_shekel.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_shekel.h>
...
// public partial sealed class fa_shekel :2
// {
// static fa_shekel() :4
static void fa_shekel__cctor_4_fn(uType* __type)
{
}

static void fa_shekel_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\213");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_shekel__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_shekel_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_shekel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_shekel", options);
    type->fp_build_ = fa_shekel_build;
    type->fp_ctor_ = (void*)fa_shekel__New4_fn;
    type->fp_cctor_ = fa_shekel__cctor_4_fn;
...
// public fa_shekel() :8
void fa_shekel__ctor_8_fn(fa_shekel* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_shekel__InitializeUX1_fn(fa_shekel* __this)
{
    __this->InitializeUX1();
}

// public fa_shekel New() :8
void fa_shekel__New4_fn(fa_shekel** __retval)
{
    *__retval = fa_shekel::New4();
}

// public fa_shekel() [instance] :8
void fa_shekel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_shekel::InitializeUX1()
{
    uStackFrame __("fa_shekel", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20B"*/]);
    SourceLineNumber(526);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_shekel New() [static] :8
fa_shekel* fa_shekel::New4()
{
    fa_shekel* obj1 = (fa_shekel*)uNew(fa_shekel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
