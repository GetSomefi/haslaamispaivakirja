// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_flag_checkered.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_flag_checkered.h>
...
// public partial sealed class fa_flag_checkered :2
// {
// static fa_flag_checkered() :4
static void fa_flag_checkered__cctor_4_fn(uType* __type)
{
}

static void fa_flag_checkered_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_flag_checkered__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_flag_checkered_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_flag_checkered);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_flag_checkered", options);
    type->fp_build_ = fa_flag_checkered_build;
    type->fp_ctor_ = (void*)fa_flag_checkered__New4_fn;
    type->fp_cctor_ = fa_flag_checkered__cctor_4_fn;
...
// public fa_flag_checkered() :8
void fa_flag_checkered__ctor_8_fn(fa_flag_checkered* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_flag_checkered__InitializeUX1_fn(fa_flag_checkered* __this)
{
    __this->InitializeUX1();
}

// public fa_flag_checkered New() :8
void fa_flag_checkered__New4_fn(fa_flag_checkered** __retval)
{
    *__retval = fa_flag_checkered::New4();
}

// public fa_flag_checkered() [instance] :8
void fa_flag_checkered::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_flag_checkered::InitializeUX1()
{
    uStackFrame __("fa_flag_checkered", "InitializeUX()");
    Value(::STRINGS[0/*"\uF11E"*/]);
    SourceLineNumber(257);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_flag_checkered New() [static] :8
fa_flag_checkered* fa_flag_checkered::New4()
{
    fa_flag_checkered* obj1 = (fa_flag_checkered*)uNew(fa_flag_checkered_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
