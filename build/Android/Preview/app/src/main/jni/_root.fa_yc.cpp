// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_yc.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_yc.h>
...
// public partial sealed class fa_yc :2
// {
// static fa_yc() :4
static void fa_yc__cctor_4_fn(uType* __type)
{
}

static void fa_yc_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_yc__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_yc_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_yc);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_yc", options);
    type->fp_build_ = fa_yc_build;
    type->fp_ctor_ = (void*)fa_yc__New4_fn;
    type->fp_cctor_ = fa_yc__cctor_4_fn;
...
// public fa_yc() :8
void fa_yc__ctor_8_fn(fa_yc* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_yc__InitializeUX1_fn(fa_yc* __this)
{
    __this->InitializeUX1();
}

// public fa_yc New() :8
void fa_yc__New4_fn(fa_yc** __retval)
{
    *__retval = fa_yc::New4();
}

// public fa_yc() [instance] :8
void fa_yc::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_yc::InitializeUX1()
{
    uStackFrame __("fa_yc", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23B"*/]);
    SourceLineNumber(689);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_yc New() [static] :8
fa_yc* fa_yc::New4()
{
    fa_yc* obj1 = (fa_yc*)uNew(fa_yc_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
