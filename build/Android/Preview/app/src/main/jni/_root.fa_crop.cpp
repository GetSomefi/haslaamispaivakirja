// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_crop.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_crop.h>
...
// public partial sealed class fa_crop :2
// {
// static fa_crop() :4
static void fa_crop__cctor_4_fn(uType* __type)
{
}

static void fa_crop_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_crop__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_crop_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_crop);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_crop", options);
    type->fp_build_ = fa_crop_build;
    type->fp_ctor_ = (void*)fa_crop__New4_fn;
    type->fp_cctor_ = fa_crop__cctor_4_fn;
...
// public fa_crop() :8
void fa_crop__ctor_8_fn(fa_crop* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_crop__InitializeUX1_fn(fa_crop* __this)
{
    __this->InitializeUX1();
}

// public fa_crop New() :8
void fa_crop__New4_fn(fa_crop** __retval)
{
    *__retval = fa_crop::New4();
}

// public fa_crop() [instance] :8
void fa_crop::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_crop::InitializeUX1()
{
    uStackFrame __("fa_crop", "InitializeUX()");
    Value(::STRINGS[0/*"\uF125"*/]);
    SourceLineNumber(177);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_crop New() [static] :8
fa_crop* fa_crop::New4()
{
    fa_crop* obj1 = (fa_crop*)uNew(fa_crop_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
