// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_adn.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_adn.h>
...
// public partial sealed class fa_adn :2
// {
// static fa_adn() :4
static void fa_adn__cctor_4_fn(uType* __type)
{
}

static void fa_adn_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_adn__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_adn_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_adn);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_adn", options);
    type->fp_build_ = fa_adn_build;
    type->fp_ctor_ = (void*)fa_adn__New4_fn;
    type->fp_cctor_ = fa_adn__cctor_4_fn;
...
// public fa_adn() :8
void fa_adn__ctor_8_fn(fa_adn* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_adn__InitializeUX1_fn(fa_adn* __this)
{
    __this->InitializeUX1();
}

// public fa_adn New() :8
void fa_adn__New4_fn(fa_adn** __retval)
{
    *__retval = fa_adn::New4();
}

// public fa_adn() [instance] :8
void fa_adn::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_adn::InitializeUX1()
{
    uStackFrame __("fa_adn", "InitializeUX()");
    Value(::STRINGS[0/*"\uF170"*/]);
    SourceLineNumber(4);
...
// public fa_adn New() [static] :8
fa_adn* fa_adn::New4()
{
    fa_adn* obj1 = (fa_adn*)uNew(fa_adn_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
