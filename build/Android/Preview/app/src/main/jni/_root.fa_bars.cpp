// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bars.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bars.h>
...
// public partial sealed class fa_bars :2
// {
// static fa_bars() :4
static void fa_bars__cctor_4_fn(uType* __type)
{
}

static void fa_bars_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bars__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bars_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bars);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bars", options);
    type->fp_build_ = fa_bars_build;
    type->fp_ctor_ = (void*)fa_bars__New4_fn;
    type->fp_cctor_ = fa_bars__cctor_4_fn;
...
// public fa_bars() :8
void fa_bars__ctor_8_fn(fa_bars* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bars__InitializeUX1_fn(fa_bars* __this)
{
    __this->InitializeUX1();
}

// public fa_bars New() :8
void fa_bars__New4_fn(fa_bars** __retval)
{
    *__retval = fa_bars::New4();
}

// public fa_bars() [instance] :8
void fa_bars::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bars::InitializeUX1()
{
    uStackFrame __("fa_bars", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C9"*/]);
    SourceLineNumber(51);
...
// public fa_bars New() [static] :8
fa_bars* fa_bars::New4()
{
    fa_bars* obj1 = (fa_bars*)uNew(fa_bars_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
