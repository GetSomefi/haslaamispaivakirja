// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_drupal.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_drupal.h>
...
// public partial sealed class fa_drupal :2
// {
// static fa_drupal() :4
static void fa_drupal__cctor_4_fn(uType* __type)
{
}

static void fa_drupal_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_drupal__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_drupal_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_drupal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_drupal", options);
    type->fp_build_ = fa_drupal_build;
    type->fp_ctor_ = (void*)fa_drupal__New4_fn;
    type->fp_cctor_ = fa_drupal__cctor_4_fn;
...
// public fa_drupal() :8
void fa_drupal__ctor_8_fn(fa_drupal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_drupal__InitializeUX1_fn(fa_drupal* __this)
{
    __this->InitializeUX1();
}

// public fa_drupal New() :8
void fa_drupal__New4_fn(fa_drupal** __retval)
{
    *__retval = fa_drupal::New4();
}

// public fa_drupal() [instance] :8
void fa_drupal::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_drupal::InitializeUX1()
{
    uStackFrame __("fa_drupal", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A9"*/]);
    SourceLineNumber(198);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_drupal New() [static] :8
fa_drupal* fa_drupal::New4()
{
    fa_drupal* obj1 = (fa_drupal*)uNew(fa_drupal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
