// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gbp.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gbp.h>
...
// public partial sealed class fa_gbp :2
// {
// static fa_gbp() :4
static void fa_gbp__cctor_4_fn(uType* __type)
{
}

static void fa_gbp_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\224");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gbp__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gbp_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gbp);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gbp", options);
    type->fp_build_ = fa_gbp_build;
    type->fp_ctor_ = (void*)fa_gbp__New4_fn;
    type->fp_cctor_ = fa_gbp__cctor_4_fn;
...
// public fa_gbp() :8
void fa_gbp__ctor_8_fn(fa_gbp* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gbp__InitializeUX1_fn(fa_gbp* __this)
{
    __this->InitializeUX1();
}

// public fa_gbp New() :8
void fa_gbp__New4_fn(fa_gbp** __retval)
{
    *__retval = fa_gbp::New4();
}

// public fa_gbp() [instance] :8
void fa_gbp::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_gbp::InitializeUX1()
{
    uStackFrame __("fa_gbp", "InitializeUX()");
    Value(::STRINGS[0/*"\uF154"*/]);
    SourceLineNumber(277);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gbp New() [static] :8
fa_gbp* fa_gbp::New4()
{
    fa_gbp* obj1 = (fa_gbp*)uNew(fa_gbp_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
