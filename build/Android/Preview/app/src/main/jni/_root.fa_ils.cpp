// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ils.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ils.h>
...
// public partial sealed class fa_ils :2
// {
// static fa_ils() :4
static void fa_ils__cctor_4_fn(uType* __type)
{
}

static void fa_ils_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ils__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ils_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ils);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ils", options);
    type->fp_build_ = fa_ils_build;
    type->fp_ctor_ = (void*)fa_ils__New4_fn;
    type->fp_cctor_ = fa_ils__cctor_4_fn;
...
// public fa_ils() :8
void fa_ils__ctor_8_fn(fa_ils* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ils__InitializeUX1_fn(fa_ils* __this)
{
    __this->InitializeUX1();
}

// public fa_ils New() :8
void fa_ils__New4_fn(fa_ils** __retval)
{
    *__retval = fa_ils::New4();
}

// public fa_ils() [instance] :8
void fa_ils::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_ils::InitializeUX1()
{
    uStackFrame __("fa_ils", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20B"*/]);
    SourceLineNumber(338);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ils New() [static] :8
fa_ils* fa_ils::New4()
{
    fa_ils* obj1 = (fa_ils*)uNew(fa_ils_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
