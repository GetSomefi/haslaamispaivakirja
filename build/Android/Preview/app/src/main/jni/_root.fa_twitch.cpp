// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_twitch.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_twitch.h>
...
// public partial sealed class fa_twitch :2
// {
// static fa_twitch() :4
static void fa_twitch__cctor_4_fn(uType* __type)
{
}

static void fa_twitch_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_twitch__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_twitch_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_twitch);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_twitch", options);
    type->fp_build_ = fa_twitch_build;
    type->fp_ctor_ = (void*)fa_twitch__New4_fn;
    type->fp_cctor_ = fa_twitch__cctor_4_fn;
...
// public fa_twitch() :8
void fa_twitch__ctor_8_fn(fa_twitch* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_twitch__InitializeUX1_fn(fa_twitch* __this)
{
    __this->InitializeUX1();
}

// public fa_twitch New() :8
void fa_twitch__New4_fn(fa_twitch** __retval)
{
    *__retval = fa_twitch::New4();
}

// public fa_twitch() [instance] :8
void fa_twitch::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_twitch::InitializeUX1()
{
    uStackFrame __("fa_twitch", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E8"*/]);
    SourceLineNumber(640);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_twitch New() [static] :8
fa_twitch* fa_twitch::New4()
{
    fa_twitch* obj1 = (fa_twitch*)uNew(fa_twitch_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
