// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basic.TextBoxAction.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/basic.TextBox copy.ux");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TextBoxAction__New4_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("basic.TextBoxAction", "InitializeUX()");
    ...
    temp->Color(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 0.09803922f));
    Background(temp);
}

// public TextBoxAction New() [static] :10
