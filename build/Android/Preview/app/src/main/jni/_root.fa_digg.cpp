// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_digg.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_digg.h>
...
// public partial sealed class fa_digg :2
// {
// static fa_digg() :4
static void fa_digg__cctor_4_fn(uType* __type)
{
}

static void fa_digg_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_digg__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_digg_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_digg);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_digg", options);
    type->fp_build_ = fa_digg_build;
    type->fp_ctor_ = (void*)fa_digg__New4_fn;
    type->fp_cctor_ = fa_digg__cctor_4_fn;
...
// public fa_digg() :8
void fa_digg__ctor_8_fn(fa_digg* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_digg__InitializeUX1_fn(fa_digg* __this)
{
    __this->InitializeUX1();
}

// public fa_digg New() :8
void fa_digg__New4_fn(fa_digg** __retval)
{
    *__retval = fa_digg::New4();
}

// public fa_digg() [instance] :8
void fa_digg::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_digg::InitializeUX1()
{
    uStackFrame __("fa_digg", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A6"*/]);
    SourceLineNumber(192);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_digg New() [static] :8
fa_digg* fa_digg::New4()
{
    fa_digg* obj1 = (fa_digg*)uNew(fa_digg_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
