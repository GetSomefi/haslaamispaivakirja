// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_usd.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_usd.h>
...
// public partial sealed class fa_usd :2
// {
// static fa_usd() :4
static void fa_usd__cctor_4_fn(uType* __type)
{
}

static void fa_usd_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_usd__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_usd_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_usd);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_usd", options);
    type->fp_build_ = fa_usd_build;
    type->fp_ctor_ = (void*)fa_usd__New4_fn;
    type->fp_cctor_ = fa_usd__cctor_4_fn;
...
// public fa_usd() :8
void fa_usd__ctor_8_fn(fa_usd* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_usd__InitializeUX1_fn(fa_usd* __this)
{
    __this->InitializeUX1();
}

// public fa_usd New() :8
void fa_usd__New4_fn(fa_usd** __retval)
{
    *__retval = fa_usd::New4();
}

// public fa_usd() [instance] :8
void fa_usd::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_usd::InitializeUX1()
{
    uStackFrame __("fa_usd", "InitializeUX()");
    Value(::STRINGS[0/*"\uF155"*/]);
    SourceLineNumber(653);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_usd New() [static] :8
fa_usd* fa_usd::New4()
{
    fa_usd* obj1 = (fa_usd*)uNew(fa_usd_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
