// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_xing.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_xing.h>
...
// public partial sealed class fa_xing :2
// {
// static fa_xing() :4
static void fa_xing__cctor_4_fn(uType* __type)
{
}

static void fa_xing_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_xing__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_xing_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_xing);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_xing", options);
    type->fp_build_ = fa_xing_build;
    type->fp_ctor_ = (void*)fa_xing__New4_fn;
    type->fp_cctor_ = fa_xing__cctor_4_fn;
...
// public fa_xing() :8
void fa_xing__ctor_8_fn(fa_xing* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_xing__InitializeUX1_fn(fa_xing* __this)
{
    __this->InitializeUX1();
}

// public fa_xing New() :8
void fa_xing__New4_fn(fa_xing** __retval)
{
    *__retval = fa_xing::New4();
}

// public fa_xing() [instance] :8
void fa_xing::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_xing::InitializeUX1()
{
    uStackFrame __("fa_xing", "InitializeUX()");
    Value(::STRINGS[0/*"\uF168"*/]);
    SourceLineNumber(684);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_xing New() [static] :8
fa_xing* fa_xing::New4()
{
    fa_xing* obj1 = (fa_xing*)uNew(fa_xing_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
