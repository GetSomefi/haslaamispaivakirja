// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_weixin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_weixin.h>
...
// public partial sealed class fa_weixin :2
// {
// static fa_weixin() :4
static void fa_weixin__cctor_4_fn(uType* __type)
{
}

static void fa_weixin_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_weixin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_weixin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_weixin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_weixin", options);
    type->fp_build_ = fa_weixin_build;
    type->fp_ctor_ = (void*)fa_weixin__New4_fn;
    type->fp_cctor_ = fa_weixin__cctor_4_fn;
...
// public fa_weixin() :8
void fa_weixin__ctor_8_fn(fa_weixin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_weixin__InitializeUX1_fn(fa_weixin* __this)
{
    __this->InitializeUX1();
}

// public fa_weixin New() :8
void fa_weixin__New4_fn(fa_weixin** __retval)
{
    *__retval = fa_weixin::New4();
}

// public fa_weixin() [instance] :8
void fa_weixin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_weixin::InitializeUX1()
{
    uStackFrame __("fa_weixin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D7"*/]);
    SourceLineNumber(675);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_weixin New() [static] :8
fa_weixin* fa_weixin::New4()
{
    fa_weixin* obj1 = (fa_weixin*)uNew(fa_weixin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
