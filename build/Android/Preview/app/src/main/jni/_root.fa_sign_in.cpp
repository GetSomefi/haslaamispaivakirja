// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sign_in.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sign_in.h>
...
// public partial sealed class fa_sign_in :2
// {
// static fa_sign_in() :4
static void fa_sign_in__cctor_4_fn(uType* __type)
{
}

static void fa_sign_in_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sign_in__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sign_in_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sign_in);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sign_in", options);
    type->fp_build_ = fa_sign_in_build;
    type->fp_ctor_ = (void*)fa_sign_in__New4_fn;
    type->fp_cctor_ = fa_sign_in__cctor_4_fn;
...
// public fa_sign_in() :8
void fa_sign_in__ctor_8_fn(fa_sign_in* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sign_in__InitializeUX1_fn(fa_sign_in* __this)
{
    __this->InitializeUX1();
}

// public fa_sign_in New() :8
void fa_sign_in__New4_fn(fa_sign_in** __retval)
{
    *__retval = fa_sign_in::New4();
}

// public fa_sign_in() [instance] :8
void fa_sign_in::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sign_in::InitializeUX1()
{
    uStackFrame __("fa_sign_in", "InitializeUX()");
    Value(::STRINGS[0/*"\uF090"*/]);
    SourceLineNumber(534);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sign_in New() [static] :8
fa_sign_in* fa_sign_in::New4()
{
    fa_sign_in* obj1 = (fa_sign_in*)uNew(fa_sign_in_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
