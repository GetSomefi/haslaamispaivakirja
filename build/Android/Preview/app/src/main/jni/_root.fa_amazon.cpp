// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_amazon.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_amazon.h>
...
// public partial sealed class fa_amazon :2
// {
// static fa_amazon() :4
static void fa_amazon__cctor_4_fn(uType* __type)
{
}

static void fa_amazon_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_amazon__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_amazon_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_amazon);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_amazon", options);
    type->fp_build_ = fa_amazon_build;
    type->fp_ctor_ = (void*)fa_amazon__New4_fn;
    type->fp_cctor_ = fa_amazon__cctor_4_fn;
...
// public fa_amazon() :8
void fa_amazon__ctor_8_fn(fa_amazon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_amazon__InitializeUX1_fn(fa_amazon* __this)
{
    __this->InitializeUX1();
}

// public fa_amazon New() :8
void fa_amazon__New4_fn(fa_amazon** __retval)
{
    *__retval = fa_amazon::New4();
}

// public fa_amazon() [instance] :8
void fa_amazon::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_amazon::InitializeUX1()
{
    uStackFrame __("fa_amazon", "InitializeUX()");
    Value(::STRINGS[0/*"\uF270"*/]);
    SourceLineNumber(9);
...
// public fa_amazon New() [static] :8
fa_amazon* fa_amazon::New4()
{
    fa_amazon* obj1 = (fa_amazon*)uNew(fa_amazon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
