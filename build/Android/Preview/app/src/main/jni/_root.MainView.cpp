// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/MainView.g.uno'.
...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::fa_, uString::Const("fa"));
    MainView::fa_ = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::Haslaamispaivakirja_bundle::fontawesomewebfontcf015a92()));
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::fa_, uString::Const("fa"));
}
...
void MainView::InitializeUX()
{
    ...
    temp1->Color(::g::Uno::Float4__New2(0.007843138f, 0.1372549f, 0.1568628f, 1.0f));
    temp1->SourceLineNumber(3);
    temp1->SourceFileName(uString::Const("MainView.ux"));
    temp2->SourceLineNumber(1);
    temp2->SourceFileName(uString::Const("Components/fa_icons.ux"));
