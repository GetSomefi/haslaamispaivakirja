// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_three_quarters.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_thre-5a3cd26b.h>
...
// public partial sealed class fa_battery_three_quarters :2
// {
// static fa_battery_three_quarters() :4
static void fa_battery_three_quarters__cctor_4_fn(uType* __type)
{
}

static void fa_battery_three_quarters_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_three_quarters__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_three_quarters_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_three_quarters);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_three_quarters", options);
    type->fp_build_ = fa_battery_three_quarters_build;
    type->fp_ctor_ = (void*)fa_battery_three_quarters__New4_fn;
    type->fp_cctor_ = fa_battery_three_quarters__cctor_4_fn;
...
// public fa_battery_three_quarters() :8
void fa_battery_three_quarters__ctor_8_fn(fa_battery_three_quarters* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_three_quarters__InitializeUX1_fn(fa_battery_three_quarters* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_three_quarters New() :8
void fa_battery_three_quarters__New4_fn(fa_battery_three_quarters** __retval)
{
    *__retval = fa_battery_three_quarters::New4();
}

// public fa_battery_three_quarters() [instance] :8
void fa_battery_three_quarters::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_three_quarters::InitializeUX1()
{
    uStackFrame __("fa_battery_three_quarters", "InitializeUX()");
    Value(::STRINGS[0/*"\uF241"*/]);
    SourceLineNumber(61);
...
// public fa_battery_three_quarters New() [static] :8
fa_battery_three_quarters* fa_battery_three_quarters::New4()
{
    fa_battery_three_quarters* obj1 = (fa_battery_three_quarters*)uNew(fa_battery_three_quarters_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
