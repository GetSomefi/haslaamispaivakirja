// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_unlock.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_unlock.h>
...
// public partial sealed class fa_unlock :2
// {
// static fa_unlock() :4
static void fa_unlock__cctor_4_fn(uType* __type)
{
}

static void fa_unlock_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_unlock__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_unlock_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_unlock);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_unlock", options);
    type->fp_build_ = fa_unlock_build;
    type->fp_ctor_ = (void*)fa_unlock__New4_fn;
    type->fp_cctor_ = fa_unlock__cctor_4_fn;
...
// public fa_unlock() :8
void fa_unlock__ctor_8_fn(fa_unlock* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_unlock__InitializeUX1_fn(fa_unlock* __this)
{
    __this->InitializeUX1();
}

// public fa_unlock New() :8
void fa_unlock__New4_fn(fa_unlock** __retval)
{
    *__retval = fa_unlock::New4();
}

// public fa_unlock() [instance] :8
void fa_unlock::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_unlock::InitializeUX1()
{
    uStackFrame __("fa_unlock", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09C"*/]);
...
// public fa_unlock New() [static] :8
fa_unlock* fa_unlock::New4()
{
    fa_unlock* obj1 = (fa_unlock*)uNew(fa_unlock_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
