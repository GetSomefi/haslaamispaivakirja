// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hourglass_half.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hourglass_half.h>
...
// public partial sealed class fa_hourglass_half :2
// {
// static fa_hourglass_half() :4
static void fa_hourglass_half__cctor_4_fn(uType* __type)
{
}

static void fa_hourglass_half_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hourglass_half__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hourglass_half_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hourglass_half);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hourglass_half", options);
    type->fp_build_ = fa_hourglass_half_build;
    type->fp_ctor_ = (void*)fa_hourglass_half__New4_fn;
    type->fp_cctor_ = fa_hourglass_half__cctor_4_fn;
...
// public fa_hourglass_half() :8
void fa_hourglass_half__ctor_8_fn(fa_hourglass_half* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hourglass_half__InitializeUX1_fn(fa_hourglass_half* __this)
{
    __this->InitializeUX1();
}

// public fa_hourglass_half New() :8
void fa_hourglass_half__New4_fn(fa_hourglass_half** __retval)
{
    *__retval = fa_hourglass_half::New4();
}

// public fa_hourglass_half() [instance] :8
void fa_hourglass_half::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hourglass_half::InitializeUX1()
{
    uStackFrame __("fa_hourglass_half", "InitializeUX()");
    Value(::STRINGS[0/*"\uF252"*/]);
    SourceLineNumber(332);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hourglass_half New() [static] :8
fa_hourglass_half* fa_hourglass_half::New4()
{
    fa_hourglass_half* obj1 = (fa_hourglass_half*)uNew(fa_hourglass_half_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
