// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_registered.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_registered.h>
...
// public partial sealed class fa_registered :2
// {
// static fa_registered() :4
static void fa_registered__cctor_4_fn(uType* __type)
{
}

static void fa_registered_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\235");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_registered__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_registered_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_registered);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_registered", options);
    type->fp_build_ = fa_registered_build;
    type->fp_ctor_ = (void*)fa_registered__New4_fn;
    type->fp_cctor_ = fa_registered__cctor_4_fn;
...
// public fa_registered() :8
void fa_registered__ctor_8_fn(fa_registered* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_registered__InitializeUX1_fn(fa_registered* __this)
{
    __this->InitializeUX1();
}

// public fa_registered New() :8
void fa_registered__New4_fn(fa_registered** __retval)
{
    *__retval = fa_registered::New4();
}

// public fa_registered() [instance] :8
void fa_registered::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_registered::InitializeUX1()
{
    uStackFrame __("fa_registered", "InitializeUX()");
    Value(::STRINGS[0/*"\uF25D"*/]);
    SourceLineNumber(491);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_registered New() [static] :8
fa_registered* fa_registered::New4()
{
    fa_registered* obj1 = (fa_registered*)uNew(fa_registered_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
