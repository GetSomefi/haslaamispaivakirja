...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
