// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ban.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ban.h>
...
// public partial sealed class fa_ban :2
// {
// static fa_ban() :4
static void fa_ban__cctor_4_fn(uType* __type)
{
}

static void fa_ban_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ban__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ban_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ban);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ban", options);
    type->fp_build_ = fa_ban_build;
    type->fp_ctor_ = (void*)fa_ban__New4_fn;
    type->fp_cctor_ = fa_ban__cctor_4_fn;
...
// public fa_ban() :8
void fa_ban__ctor_8_fn(fa_ban* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ban__InitializeUX1_fn(fa_ban* __this)
{
    __this->InitializeUX1();
}

// public fa_ban New() :8
void fa_ban__New4_fn(fa_ban** __retval)
{
    *__retval = fa_ban::New4();
}

// public fa_ban() [instance] :8
void fa_ban::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_ban::InitializeUX1()
{
    uStackFrame __("fa_ban", "InitializeUX()");
    Value(::STRINGS[0/*"\uF05E"*/]);
    SourceLineNumber(46);
...
// public fa_ban New() [static] :8
fa_ban* fa_ban::New4()
{
    fa_ban* obj1 = (fa_ban*)uNew(fa_ban_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
