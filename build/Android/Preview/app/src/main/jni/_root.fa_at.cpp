// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_at.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_at.h>
...
// public partial sealed class fa_at :2
// {
// static fa_at() :4
static void fa_at__cctor_4_fn(uType* __type)
{
}

static void fa_at_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_at__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_at_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_at);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_at", options);
    type->fp_build_ = fa_at_build;
    type->fp_ctor_ = (void*)fa_at__New4_fn;
    type->fp_cctor_ = fa_at__cctor_4_fn;
...
// public fa_at() :8
void fa_at__ctor_8_fn(fa_at* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_at__InitializeUX1_fn(fa_at* __this)
{
    __this->InitializeUX1();
}

// public fa_at New() :8
void fa_at__New4_fn(fa_at** __retval)
{
    *__retval = fa_at::New4();
}

// public fa_at() [instance] :8
void fa_at::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_at::InitializeUX1()
{
    uStackFrame __("fa_at", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1FA"*/]);
    SourceLineNumber(42);
...
// public fa_at New() [static] :8
fa_at* fa_at::New4()
{
    fa_at* obj1 = (fa_at*)uNew(fa_at_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
