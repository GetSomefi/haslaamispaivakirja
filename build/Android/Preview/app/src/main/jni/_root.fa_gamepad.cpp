...
// {
// static fa_gamepad() :4
static void fa_gamepad__cctor_4_fn(uType* __type)
{
}

static void fa_gamepad_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gamepad__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* fa_gamepad_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gamepad);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gamepad", options);
    type->fp_build_ = fa_gamepad_build;
    type->fp_ctor_ = (void*)fa_gamepad__New4_fn;
    type->fp_cctor_ = fa_gamepad__cctor_4_fn;
...
// public fa_gamepad New() :8
void fa_gamepad__New4_fn(fa_gamepad** __retval)
{
    *__retval = fa_gamepad::New4();
}

// public fa_gamepad() [instance] :8
void fa_gamepad::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_gamepad::InitializeUX1()
{
    uStackFrame __("fa_gamepad", "InitializeUX()");
    Value(::STRINGS[0/*"\uF11B"*/]);
    SourceLineNumber(275);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gamepad New() [static] :8
fa_gamepad* fa_gamepad::New4()
{
    fa_gamepad* obj1 = (fa_gamepad*)uNew(fa_gamepad_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
