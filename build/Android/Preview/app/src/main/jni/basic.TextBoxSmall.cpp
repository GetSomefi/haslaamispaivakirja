// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basic.TextBoxSmall.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/basic.TextBoxSmall.ux");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TextBoxSmall__New5_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextInput_type* TextBoxSmall_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextInput_type*)uClassType::New("basic.TextBoxSmall", options);
...
{
    uStackFrame __("basic.TextBoxSmall", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("basic.TextBoxSmall", "InitializeUX()");
    FontSize(14.0f);
