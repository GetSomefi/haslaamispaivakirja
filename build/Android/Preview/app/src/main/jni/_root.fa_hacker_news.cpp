// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hacker_news.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hacker_news.h>
...
// public partial sealed class fa_hacker_news :2
// {
// static fa_hacker_news() :4
static void fa_hacker_news__cctor_4_fn(uType* __type)
{
}

static void fa_hacker_news_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hacker_news__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hacker_news_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hacker_news);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hacker_news", options);
    type->fp_build_ = fa_hacker_news_build;
    type->fp_ctor_ = (void*)fa_hacker_news__New4_fn;
    type->fp_cctor_ = fa_hacker_news__cctor_4_fn;
...
// public fa_hacker_news() :8
void fa_hacker_news__ctor_8_fn(fa_hacker_news* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hacker_news__InitializeUX1_fn(fa_hacker_news* __this)
{
    __this->InitializeUX1();
}

// public fa_hacker_news New() :8
void fa_hacker_news__New4_fn(fa_hacker_news** __retval)
{
    *__retval = fa_hacker_news::New4();
}

// public fa_hacker_news() [instance] :8
void fa_hacker_news::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hacker_news::InitializeUX1()
{
    uStackFrame __("fa_hacker_news", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D4"*/]);
    SourceLineNumber(302);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hacker_news New() [static] :8
fa_hacker_news* fa_hacker_news::New4()
{
    fa_hacker_news* obj1 = (fa_hacker_news*)uNew(fa_hacker_news_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
