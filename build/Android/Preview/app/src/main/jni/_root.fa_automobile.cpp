// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_automobile.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_automobile.h>
...
// public partial sealed class fa_automobile :2
// {
// static fa_automobile() :4
static void fa_automobile__cctor_4_fn(uType* __type)
{
}

static void fa_automobile_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_automobile__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_automobile_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_automobile);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_automobile", options);
    type->fp_build_ = fa_automobile_build;
    type->fp_ctor_ = (void*)fa_automobile__New4_fn;
    type->fp_cctor_ = fa_automobile__cctor_4_fn;
...
// public fa_automobile() :8
void fa_automobile__ctor_8_fn(fa_automobile* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_automobile__InitializeUX1_fn(fa_automobile* __this)
{
    __this->InitializeUX1();
}

// public fa_automobile New() :8
void fa_automobile__New4_fn(fa_automobile** __retval)
{
    *__retval = fa_automobile::New4();
}

// public fa_automobile() [instance] :8
void fa_automobile::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_automobile::InitializeUX1()
{
    uStackFrame __("fa_automobile", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B9"*/]);
    SourceLineNumber(43);
...
// public fa_automobile New() [static] :8
fa_automobile* fa_automobile::New4()
{
    fa_automobile* obj1 = (fa_automobile*)uNew(fa_automobile_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
