// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_toggle_on.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_toggle_on.h>
...
// public partial sealed class fa_toggle_on :2
// {
// static fa_toggle_on() :4
static void fa_toggle_on__cctor_4_fn(uType* __type)
{
}

static void fa_toggle_on_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_toggle_on__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_toggle_on_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_toggle_on);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_toggle_on", options);
    type->fp_build_ = fa_toggle_on_build;
    type->fp_ctor_ = (void*)fa_toggle_on__New4_fn;
    type->fp_cctor_ = fa_toggle_on__cctor_4_fn;
...
// public fa_toggle_on() :8
void fa_toggle_on__ctor_8_fn(fa_toggle_on* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_toggle_on__InitializeUX1_fn(fa_toggle_on* __this)
{
    __this->InitializeUX1();
}

// public fa_toggle_on New() :8
void fa_toggle_on__New4_fn(fa_toggle_on** __retval)
{
    *__retval = fa_toggle_on::New4();
}

// public fa_toggle_on() [instance] :8
void fa_toggle_on::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_toggle_on::InitializeUX1()
{
    uStackFrame __("fa_toggle_on", "InitializeUX()");
    Value(::STRINGS[0/*"\uF205"*/]);
    SourceLineNumber(620);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_toggle_on New() [static] :8
fa_toggle_on* fa_toggle_on::New4()
{
    fa_toggle_on* obj1 = (fa_toggle_on*)uNew(fa_toggle_on_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
