// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_picture_o.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_picture_o.h>
...
// public partial sealed class fa_picture_o :2
// {
// static fa_picture_o() :4
static void fa_picture_o__cctor_4_fn(uType* __type)
{
}

static void fa_picture_o_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_picture_o__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_picture_o_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_picture_o);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_picture_o", options);
    type->fp_build_ = fa_picture_o_build;
    type->fp_ctor_ = (void*)fa_picture_o__New4_fn;
    type->fp_cctor_ = fa_picture_o__cctor_4_fn;
...
// public fa_picture_o() :8
void fa_picture_o__ctor_8_fn(fa_picture_o* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_picture_o__InitializeUX1_fn(fa_picture_o* __this)
{
    __this->InitializeUX1();
}

// public fa_picture_o New() :8
void fa_picture_o__New4_fn(fa_picture_o** __retval)
{
    *__retval = fa_picture_o::New4();
}

// public fa_picture_o() [instance] :8
void fa_picture_o::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_picture_o::InitializeUX1()
{
    uStackFrame __("fa_picture_o", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03E"*/]);
...
// public fa_picture_o New() [static] :8
fa_picture_o* fa_picture_o::New4()
{
    fa_picture_o* obj1 = (fa_picture_o*)uNew(fa_picture_o_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
