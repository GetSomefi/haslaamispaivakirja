// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_lock.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_lock.h>
...
// public partial sealed class fa_lock :2
// {
// static fa_lock() :4
static void fa_lock__cctor_4_fn(uType* __type)
{
}

static void fa_lock_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_lock__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_lock_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_lock);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_lock", options);
    type->fp_build_ = fa_lock_build;
    type->fp_ctor_ = (void*)fa_lock__New4_fn;
    type->fp_cctor_ = fa_lock__cctor_4_fn;
...
// public fa_lock() :8
void fa_lock__ctor_8_fn(fa_lock* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_lock__InitializeUX1_fn(fa_lock* __this)
{
    __this->InitializeUX1();
}

// public fa_lock New() :8
void fa_lock__New4_fn(fa_lock** __retval)
{
    *__retval = fa_lock::New4();
}

// public fa_lock() [instance] :8
void fa_lock::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_lock::InitializeUX1()
{
    uStackFrame __("fa_lock", "InitializeUX()");
    Value(::STRINGS[0/*"\uF023"*/]);
    SourceLineNumber(383);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_lock New() [static] :8
fa_lock* fa_lock::New4()
{
    fa_lock* obj1 = (fa_lock*)uNew(fa_lock_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
