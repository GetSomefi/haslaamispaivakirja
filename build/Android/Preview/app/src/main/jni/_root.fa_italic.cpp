// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_italic.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_italic.h>
...
// public partial sealed class fa_italic :2
// {
// static fa_italic() :4
static void fa_italic__cctor_4_fn(uType* __type)
{
}

static void fa_italic_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_italic__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_italic_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_italic);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_italic", options);
    type->fp_build_ = fa_italic_build;
    type->fp_ctor_ = (void*)fa_italic__New4_fn;
    type->fp_cctor_ = fa_italic__cctor_4_fn;
...
// public fa_italic() :8
void fa_italic__ctor_8_fn(fa_italic* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_italic__InitializeUX1_fn(fa_italic* __this)
{
    __this->InitializeUX1();
}

// public fa_italic New() :8
void fa_italic__New4_fn(fa_italic** __retval)
{
    *__retval = fa_italic::New4();
}

// public fa_italic() [instance] :8
void fa_italic::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_italic::InitializeUX1()
{
    uStackFrame __("fa_italic", "InitializeUX()");
    Value(::STRINGS[0/*"\uF033"*/]);
    SourceLineNumber(351);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_italic New() [static] :8
fa_italic* fa_italic::New4()
{
    fa_italic* obj1 = (fa_italic*)uNew(fa_italic_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
