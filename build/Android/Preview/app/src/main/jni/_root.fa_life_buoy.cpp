// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_life_buoy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_life_buoy.h>
...
// public partial sealed class fa_life_buoy :2
// {
// static fa_life_buoy() :4
static void fa_life_buoy__cctor_4_fn(uType* __type)
{
}

static void fa_life_buoy_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_life_buoy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_life_buoy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_life_buoy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_life_buoy", options);
    type->fp_build_ = fa_life_buoy_build;
    type->fp_ctor_ = (void*)fa_life_buoy__New4_fn;
    type->fp_cctor_ = fa_life_buoy__cctor_4_fn;
...
// public fa_life_buoy() :8
void fa_life_buoy__ctor_8_fn(fa_life_buoy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_life_buoy__InitializeUX1_fn(fa_life_buoy* __this)
{
    __this->InitializeUX1();
}

// public fa_life_buoy New() :8
void fa_life_buoy__New4_fn(fa_life_buoy** __retval)
{
    *__retval = fa_life_buoy::New4();
}

// public fa_life_buoy() [instance] :8
void fa_life_buoy::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_life_buoy::InitializeUX1()
{
    uStackFrame __("fa_life_buoy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CD"*/]);
    SourceLineNumber(369);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_life_buoy New() [static] :8
fa_life_buoy* fa_life_buoy::New4()
{
    fa_life_buoy* obj1 = (fa_life_buoy*)uNew(fa_life_buoy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
