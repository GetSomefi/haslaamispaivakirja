// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fire_extinguisher.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fire_extinguisher.h>
...
// public partial sealed class fa_fire_extinguisher :2
// {
// static fa_fire_extinguisher() :4
static void fa_fire_extinguisher__cctor_4_fn(uType* __type)
{
}

static void fa_fire_extinguisher_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\264");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fire_extinguisher__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fire_extinguisher_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fire_extinguisher);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fire_extinguisher", options);
    type->fp_build_ = fa_fire_extinguisher_build;
    type->fp_ctor_ = (void*)fa_fire_extinguisher__New4_fn;
    type->fp_cctor_ = fa_fire_extinguisher__cctor_4_fn;
...
// public fa_fire_extinguisher() :8
void fa_fire_extinguisher__ctor_8_fn(fa_fire_extinguisher* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fire_extinguisher__InitializeUX1_fn(fa_fire_extinguisher* __this)
{
    __this->InitializeUX1();
}

// public fa_fire_extinguisher New() :8
void fa_fire_extinguisher__New4_fn(fa_fire_extinguisher** __retval)
{
    *__retval = fa_fire_extinguisher::New4();
}

// public fa_fire_extinguisher() [instance] :8
void fa_fire_extinguisher::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_fire_extinguisher::InitializeUX1()
{
    uStackFrame __("fa_fire_extinguisher", "InitializeUX()");
    Value(::STRINGS[0/*"\uF134"*/]);
    SourceLineNumber(254);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fire_extinguisher New() [static] :8
fa_fire_extinguisher* fa_fire_extinguisher::New4()
{
    fa_fire_extinguisher* obj1 = (fa_fire_extinguisher*)uNew(fa_fire_extinguisher_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
