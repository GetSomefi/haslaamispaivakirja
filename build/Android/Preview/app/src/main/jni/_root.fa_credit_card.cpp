// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_credit_card.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_credit_card.h>
...
// public partial sealed class fa_credit_card :2
// {
// static fa_credit_card() :4
static void fa_credit_card__cctor_4_fn(uType* __type)
{
}

static void fa_credit_card_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\235");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_credit_card__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_credit_card_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_credit_card);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_credit_card", options);
    type->fp_build_ = fa_credit_card_build;
    type->fp_ctor_ = (void*)fa_credit_card__New4_fn;
    type->fp_cctor_ = fa_credit_card__cctor_4_fn;
...
// public fa_credit_card() :8
void fa_credit_card__ctor_8_fn(fa_credit_card* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_credit_card__InitializeUX1_fn(fa_credit_card* __this)
{
    __this->InitializeUX1();
}

// public fa_credit_card New() :8
void fa_credit_card__New4_fn(fa_credit_card** __retval)
{
    *__retval = fa_credit_card::New4();
}

// public fa_credit_card() [instance] :8
void fa_credit_card::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_credit_card::InitializeUX1()
{
    uStackFrame __("fa_credit_card", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09D"*/]);
...
// public fa_credit_card New() [static] :8
fa_credit_card* fa_credit_card::New4()
{
    fa_credit_card* obj1 = (fa_credit_card*)uNew(fa_credit_card_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
