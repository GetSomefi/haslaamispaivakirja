// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_subscript.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_subscript.h>
...
// public partial sealed class fa_subscript :2
// {
// static fa_subscript() :4
static void fa_subscript__cctor_4_fn(uType* __type)
{
}

static void fa_subscript_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_subscript__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_subscript_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_subscript);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_subscript", options);
    type->fp_build_ = fa_subscript_build;
    type->fp_ctor_ = (void*)fa_subscript__New4_fn;
    type->fp_cctor_ = fa_subscript__cctor_4_fn;
...
// public fa_subscript() :8
void fa_subscript__ctor_8_fn(fa_subscript* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_subscript__InitializeUX1_fn(fa_subscript* __this)
{
    __this->InitializeUX1();
}

// public fa_subscript New() :8
void fa_subscript__New4_fn(fa_subscript** __retval)
{
    *__retval = fa_subscript::New4();
}

// public fa_subscript() [instance] :8
void fa_subscript::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_subscript::InitializeUX1()
{
    uStackFrame __("fa_subscript", "InitializeUX()");
    Value(::STRINGS[0/*"\uF12C"*/]);
    SourceLineNumber(586);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_subscript New() [static] :8
fa_subscript* fa_subscript::New4()
{
    fa_subscript* obj1 = (fa_subscript*)uNew(fa_subscript_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
