// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_buysellads.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_buysellads.h>
...
// public partial sealed class fa_buysellads :2
// {
// static fa_buysellads() :4
static void fa_buysellads__cctor_4_fn(uType* __type)
{
}

static void fa_buysellads_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_buysellads__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_buysellads_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_buysellads);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_buysellads", options);
    type->fp_build_ = fa_buysellads_build;
    type->fp_ctor_ = (void*)fa_buysellads__New4_fn;
    type->fp_cctor_ = fa_buysellads__cctor_4_fn;
...
// public fa_buysellads() :8
void fa_buysellads__ctor_8_fn(fa_buysellads* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_buysellads__InitializeUX1_fn(fa_buysellads* __this)
{
    __this->InitializeUX1();
}

// public fa_buysellads New() :8
void fa_buysellads__New4_fn(fa_buysellads** __retval)
{
    *__retval = fa_buysellads::New4();
}

// public fa_buysellads() [instance] :8
void fa_buysellads::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_buysellads::InitializeUX1()
{
    uStackFrame __("fa_buysellads", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20D"*/]);
    SourceLineNumber(93);
...
// public fa_buysellads New() [static] :8
fa_buysellads* fa_buysellads::New4()
{
    fa_buysellads* obj1 = (fa_buysellads*)uNew(fa_buysellads_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
