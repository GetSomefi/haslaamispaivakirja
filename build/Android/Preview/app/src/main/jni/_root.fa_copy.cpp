// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_copy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_copy.h>
...
// public partial sealed class fa_copy :2
// {
// static fa_copy() :4
static void fa_copy__cctor_4_fn(uType* __type)
{
}

static void fa_copy_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_copy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_copy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_copy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_copy", options);
    type->fp_build_ = fa_copy_build;
    type->fp_ctor_ = (void*)fa_copy__New4_fn;
    type->fp_cctor_ = fa_copy__cctor_4_fn;
...
// public fa_copy() :8
void fa_copy__ctor_8_fn(fa_copy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_copy__InitializeUX1_fn(fa_copy* __this)
{
    __this->InitializeUX1();
}

// public fa_copy New() :8
void fa_copy__New4_fn(fa_copy** __retval)
{
    *__retval = fa_copy::New4();
}

// public fa_copy() [instance] :8
void fa_copy::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_copy::InitializeUX1()
{
    uStackFrame __("fa_copy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C5"*/]);
    SourceLineNumber(172);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_copy New() [static] :8
fa_copy* fa_copy::New4()
{
    fa_copy* obj1 = (fa_copy*)uNew(fa_copy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
