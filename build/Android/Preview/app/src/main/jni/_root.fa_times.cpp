// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_times.g.uno'.
...
// public partial sealed class fa_times :2
// {
// static fa_times() :4
static void fa_times__cctor_4_fn(uType* __type)
{
}

static void fa_times_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_times__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_times_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_times);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_times", options);
    type->fp_build_ = fa_times_build;
    type->fp_ctor_ = (void*)fa_times__New4_fn;
    type->fp_cctor_ = fa_times__cctor_4_fn;
...
// public fa_times() :8
void fa_times__ctor_8_fn(fa_times* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_times__InitializeUX1_fn(fa_times* __this)
{
    __this->InitializeUX1();
}

// public fa_times New() :8
void fa_times__New4_fn(fa_times** __retval)
{
    *__retval = fa_times::New4();
}

// public fa_times() [instance] :8
void fa_times::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_times::InitializeUX1()
{
    uStackFrame __("fa_times", "InitializeUX()");
    Value(::STRINGS[0/*"\uF00D"*/]);
...
// public fa_times New() [static] :8
fa_times* fa_times::New4()
{
    fa_times* obj1 = (fa_times*)uNew(fa_times_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
