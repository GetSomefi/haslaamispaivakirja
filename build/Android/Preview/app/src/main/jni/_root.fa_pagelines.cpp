// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pagelines.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pagelines.h>
...
// public partial sealed class fa_pagelines :2
// {
// static fa_pagelines() :4
static void fa_pagelines__cctor_4_fn(uType* __type)
{
}

static void fa_pagelines_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pagelines__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pagelines_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pagelines);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pagelines", options);
    type->fp_build_ = fa_pagelines_build;
    type->fp_ctor_ = (void*)fa_pagelines__New4_fn;
    type->fp_cctor_ = fa_pagelines__cctor_4_fn;
...
// public fa_pagelines() :8
void fa_pagelines__ctor_8_fn(fa_pagelines* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pagelines__InitializeUX1_fn(fa_pagelines* __this)
{
    __this->InitializeUX1();
}

// public fa_pagelines New() :8
void fa_pagelines__New4_fn(fa_pagelines** __retval)
{
    *__retval = fa_pagelines::New4();
}

// public fa_pagelines() [instance] :8
void fa_pagelines::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pagelines::InitializeUX1()
{
    uStackFrame __("fa_pagelines", "InitializeUX()");
    Value(::STRINGS[0/*"\uF18C"*/]);
    SourceLineNumber(438);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pagelines New() [static] :8
fa_pagelines* fa_pagelines::New4()
{
    fa_pagelines* obj1 = (fa_pagelines*)uNew(fa_pagelines_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
