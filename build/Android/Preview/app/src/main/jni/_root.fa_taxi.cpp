// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_taxi.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_taxi.h>
...
// public partial sealed class fa_taxi :2
// {
// static fa_taxi() :4
static void fa_taxi__cctor_4_fn(uType* __type)
{
}

static void fa_taxi_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_taxi__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_taxi_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_taxi);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_taxi", options);
    type->fp_build_ = fa_taxi_build;
    type->fp_ctor_ = (void*)fa_taxi__New4_fn;
    type->fp_cctor_ = fa_taxi__cctor_4_fn;
...
// public fa_taxi() :8
void fa_taxi__ctor_8_fn(fa_taxi* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_taxi__InitializeUX1_fn(fa_taxi* __this)
{
    __this->InitializeUX1();
}

// public fa_taxi New() :8
void fa_taxi__New4_fn(fa_taxi** __retval)
{
    *__retval = fa_taxi::New4();
}

// public fa_taxi() [instance] :8
void fa_taxi::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_taxi::InitializeUX1()
{
    uStackFrame __("fa_taxi", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BA"*/]);
    SourceLineNumber(598);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_taxi New() [static] :8
fa_taxi* fa_taxi::New4()
{
    fa_taxi* obj1 = (fa_taxi*)uNew(fa_taxi_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
