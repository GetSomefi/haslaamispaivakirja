// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_unlink.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_unlink.h>
...
// public partial sealed class fa_unlink :2
// {
// static fa_unlink() :4
static void fa_unlink__cctor_4_fn(uType* __type)
{
}

static void fa_unlink_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_unlink__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_unlink_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_unlink);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_unlink", options);
    type->fp_build_ = fa_unlink_build;
    type->fp_ctor_ = (void*)fa_unlink__New4_fn;
    type->fp_cctor_ = fa_unlink__cctor_4_fn;
...
// public fa_unlink() :8
void fa_unlink__ctor_8_fn(fa_unlink* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_unlink__InitializeUX1_fn(fa_unlink* __this)
{
    __this->InitializeUX1();
}

// public fa_unlink New() :8
void fa_unlink__New4_fn(fa_unlink** __retval)
{
    *__retval = fa_unlink::New4();
}

// public fa_unlink() [instance] :8
void fa_unlink::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_unlink::InitializeUX1()
{
    uStackFrame __("fa_unlink", "InitializeUX()");
    Value(::STRINGS[0/*"\uF127"*/]);
    SourceLineNumber(647);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_unlink New() [static] :8
fa_unlink* fa_unlink::New4()
{
    fa_unlink* obj1 = (fa_unlink*)uNew(fa_unlink_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
