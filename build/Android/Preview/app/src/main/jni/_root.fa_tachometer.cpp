// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tachometer.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tachometer.h>
...
// public partial sealed class fa_tachometer :2
// {
// static fa_tachometer() :4
static void fa_tachometer__cctor_4_fn(uType* __type)
{
}

static void fa_tachometer_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tachometer__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tachometer_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tachometer);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tachometer", options);
    type->fp_build_ = fa_tachometer_build;
    type->fp_ctor_ = (void*)fa_tachometer__New4_fn;
    type->fp_cctor_ = fa_tachometer__cctor_4_fn;
...
// public fa_tachometer() :8
void fa_tachometer__ctor_8_fn(fa_tachometer* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tachometer__InitializeUX1_fn(fa_tachometer* __this)
{
    __this->InitializeUX1();
}

// public fa_tachometer New() :8
void fa_tachometer__New4_fn(fa_tachometer** __retval)
{
    *__retval = fa_tachometer::New4();
}

// public fa_tachometer() [instance] :8
void fa_tachometer::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tachometer::InitializeUX1()
{
    uStackFrame __("fa_tachometer", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E4"*/]);
    SourceLineNumber(594);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tachometer New() [static] :8
fa_tachometer* fa_tachometer::New4()
{
    fa_tachometer* obj1 = (fa_tachometer*)uNew(fa_tachometer_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
