// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_align_justify.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_align_justify.h>
...
// public partial sealed class fa_align_justify :2
// {
// static fa_align_justify() :4
static void fa_align_justify__cctor_4_fn(uType* __type)
{
}

static void fa_align_justify_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_align_justify__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_align_justify_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_align_justify);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_align_justify", options);
    type->fp_build_ = fa_align_justify_build;
    type->fp_ctor_ = (void*)fa_align_justify__New4_fn;
    type->fp_cctor_ = fa_align_justify__cctor_4_fn;
...
// public fa_align_justify() :8
void fa_align_justify__ctor_8_fn(fa_align_justify* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_align_justify__InitializeUX1_fn(fa_align_justify* __this)
{
    __this->InitializeUX1();
}

// public fa_align_justify New() :8
void fa_align_justify__New4_fn(fa_align_justify** __retval)
{
    *__retval = fa_align_justify::New4();
}

// public fa_align_justify() [instance] :8
void fa_align_justify::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_align_justify::InitializeUX1()
{
    uStackFrame __("fa_align_justify", "InitializeUX()");
    Value(::STRINGS[0/*"\uF039"*/]);
    SourceLineNumber(6);
...
// public fa_align_justify New() [static] :8
fa_align_justify* fa_align_justify::New4()
{
    fa_align_justify* obj1 = (fa_align_justify*)uNew(fa_align_justify_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
