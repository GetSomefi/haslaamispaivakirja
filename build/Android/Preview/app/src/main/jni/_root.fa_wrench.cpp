// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wrench.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wrench.h>
...
// public partial sealed class fa_wrench :2
// {
// static fa_wrench() :4
static void fa_wrench__cctor_4_fn(uType* __type)
{
}

static void fa_wrench_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wrench__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wrench_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wrench);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wrench", options);
    type->fp_build_ = fa_wrench_build;
    type->fp_ctor_ = (void*)fa_wrench__New4_fn;
    type->fp_cctor_ = fa_wrench__cctor_4_fn;
...
// public fa_wrench() :8
void fa_wrench__ctor_8_fn(fa_wrench* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wrench__InitializeUX1_fn(fa_wrench* __this)
{
    __this->InitializeUX1();
}

// public fa_wrench New() :8
void fa_wrench__New4_fn(fa_wrench** __retval)
{
    *__retval = fa_wrench::New4();
}

// public fa_wrench() [instance] :8
void fa_wrench::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_wrench::InitializeUX1()
{
    uStackFrame __("fa_wrench", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0AD"*/]);
    SourceLineNumber(683);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wrench New() [static] :8
fa_wrench* fa_wrench::New4()
{
    fa_wrench* obj1 = (fa_wrench*)uNew(fa_wrench_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
