// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bold.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bold.h>
...
// public partial sealed class fa_bold :2
// {
// static fa_bold() :4
static void fa_bold__cctor_4_fn(uType* __type)
{
}

static void fa_bold_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bold__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bold_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bold);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bold", options);
    type->fp_build_ = fa_bold_build;
    type->fp_ctor_ = (void*)fa_bold__New4_fn;
    type->fp_cctor_ = fa_bold__cctor_4_fn;
...
// public fa_bold() :8
void fa_bold__ctor_8_fn(fa_bold* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bold__InitializeUX1_fn(fa_bold* __this)
{
    __this->InitializeUX1();
}

// public fa_bold New() :8
void fa_bold__New4_fn(fa_bold** __retval)
{
    *__retval = fa_bold::New4();
}

// public fa_bold() [instance] :8
void fa_bold::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bold::InitializeUX1()
{
    uStackFrame __("fa_bold", "InitializeUX()");
    Value(::STRINGS[0/*"\uF032"*/]);
    SourceLineNumber(79);
...
// public fa_bold New() [static] :8
fa_bold* fa_bold::New4()
{
    fa_bold* obj1 = (fa_bold*)uNew(fa_bold_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
