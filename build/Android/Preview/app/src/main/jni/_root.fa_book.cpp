// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_book.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_book.h>
...
// public partial sealed class fa_book :2
// {
// static fa_book() :4
static void fa_book__cctor_4_fn(uType* __type)
{
}

static void fa_book_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_book__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_book_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_book);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_book", options);
    type->fp_build_ = fa_book_build;
    type->fp_ctor_ = (void*)fa_book__New4_fn;
    type->fp_cctor_ = fa_book__cctor_4_fn;
...
// public fa_book() :8
void fa_book__ctor_8_fn(fa_book* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_book__InitializeUX1_fn(fa_book* __this)
{
    __this->InitializeUX1();
}

// public fa_book New() :8
void fa_book__New4_fn(fa_book** __retval)
{
    *__retval = fa_book::New4();
}

// public fa_book() [instance] :8
void fa_book::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_book::InitializeUX1()
{
    uStackFrame __("fa_book", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02D"*/]);
    SourceLineNumber(82);
...
// public fa_book New() [static] :8
fa_book* fa_book::New4()
{
    fa_book* obj1 = (fa_book*)uNew(fa_book_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
