// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/generaltext.Text.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/generaltext.Text.ux");
...
::g::Fuse::Controls::TextControl_type* Text_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("generaltext.Text", options);
...
{
    uStackFrame __("generaltext.Text", "InitializeUX()");
    FontSize(16.0f);
