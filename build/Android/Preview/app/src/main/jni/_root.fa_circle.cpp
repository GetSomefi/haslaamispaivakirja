// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_circle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_circle.h>
...
// public partial sealed class fa_circle :2
// {
// static fa_circle() :4
static void fa_circle__cctor_4_fn(uType* __type)
{
}

static void fa_circle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_circle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_circle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_circle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_circle", options);
    type->fp_build_ = fa_circle_build;
    type->fp_ctor_ = (void*)fa_circle__New4_fn;
    type->fp_cctor_ = fa_circle__cctor_4_fn;
...
// public fa_circle() :8
void fa_circle__ctor_8_fn(fa_circle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_circle__InitializeUX1_fn(fa_circle* __this)
{
    __this->InitializeUX1();
}

// public fa_circle New() :8
void fa_circle__New4_fn(fa_circle** __retval)
{
    *__retval = fa_circle::New4();
}

// public fa_circle() [instance] :8
void fa_circle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_circle::InitializeUX1()
{
    uStackFrame __("fa_circle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF111"*/]);
...
// public fa_circle New() [static] :8
fa_circle* fa_circle::New4()
{
    fa_circle* obj1 = (fa_circle*)uNew(fa_circle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
