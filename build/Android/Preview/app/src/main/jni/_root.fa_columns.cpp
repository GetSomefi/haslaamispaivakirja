// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_columns.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_columns.h>
...
// public partial sealed class fa_columns :2
// {
// static fa_columns() :4
static void fa_columns__cctor_4_fn(uType* __type)
{
}

static void fa_columns_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_columns__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_columns_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_columns);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_columns", options);
    type->fp_build_ = fa_columns_build;
    type->fp_ctor_ = (void*)fa_columns__New4_fn;
    type->fp_cctor_ = fa_columns__cctor_4_fn;
...
// public fa_columns() :8
void fa_columns__ctor_8_fn(fa_columns* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_columns__InitializeUX1_fn(fa_columns* __this)
{
    __this->InitializeUX1();
}

// public fa_columns New() :8
void fa_columns__New4_fn(fa_columns** __retval)
{
    *__retval = fa_columns::New4();
}

// public fa_columns() [instance] :8
void fa_columns::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_columns::InitializeUX1()
{
    uStackFrame __("fa_columns", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0DB"*/]);
    SourceLineNumber(161);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_columns New() [static] :8
fa_columns* fa_columns::New4()
{
    fa_columns* obj1 = (fa_columns*)uNew(fa_columns_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
