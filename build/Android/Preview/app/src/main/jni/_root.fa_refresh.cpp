// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_refresh.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_refresh.h>
...
// public partial sealed class fa_refresh :2
// {
// static fa_refresh() :4
static void fa_refresh__cctor_4_fn(uType* __type)
{
}

static void fa_refresh_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\241");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_refresh__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_refresh_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_refresh);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_refresh", options);
    type->fp_build_ = fa_refresh_build;
    type->fp_ctor_ = (void*)fa_refresh__New4_fn;
    type->fp_cctor_ = fa_refresh__cctor_4_fn;
...
// public fa_refresh() :8
void fa_refresh__ctor_8_fn(fa_refresh* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_refresh__InitializeUX1_fn(fa_refresh* __this)
{
    __this->InitializeUX1();
}

// public fa_refresh New() :8
void fa_refresh__New4_fn(fa_refresh** __retval)
{
    *__retval = fa_refresh::New4();
}

// public fa_refresh() [instance] :8
void fa_refresh::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_refresh::InitializeUX1()
{
    uStackFrame __("fa_refresh", "InitializeUX()");
    Value(::STRINGS[0/*"\uF021"*/]);
    SourceLineNumber(490);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_refresh New() [static] :8
fa_refresh* fa_refresh::New4()
{
    fa_refresh* obj1 = (fa_refresh*)uNew(fa_refresh_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
