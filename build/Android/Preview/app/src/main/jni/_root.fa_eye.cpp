// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_eye.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_eye.h>
...
// public partial sealed class fa_eye :2
// {
// static fa_eye() :4
static void fa_eye__cctor_4_fn(uType* __type)
{
}

static void fa_eye_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_eye__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_eye_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_eye);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_eye", options);
    type->fp_build_ = fa_eye_build;
    type->fp_ctor_ = (void*)fa_eye__New4_fn;
    type->fp_cctor_ = fa_eye__cctor_4_fn;
...
// public fa_eye() :8
void fa_eye__ctor_8_fn(fa_eye* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_eye__InitializeUX1_fn(fa_eye* __this)
{
    __this->InitializeUX1();
}

// public fa_eye New() :8
void fa_eye__New4_fn(fa_eye** __retval)
{
    *__retval = fa_eye::New4();
}

// public fa_eye() [instance] :8
void fa_eye::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_eye::InitializeUX1()
{
    uStackFrame __("fa_eye", "InitializeUX()");
    Value(::STRINGS[0/*"\uF06E"*/]);
    SourceLineNumber(219);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_eye New() [static] :8
fa_eye* fa_eye::New4()
{
    fa_eye* obj1 = (fa_eye*)uNew(fa_eye_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
