// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_balance_scale.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_balance_scale.h>
...
// public partial sealed class fa_balance_scale :2
// {
// static fa_balance_scale() :4
static void fa_balance_scale__cctor_4_fn(uType* __type)
{
}

static void fa_balance_scale_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_balance_scale__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_balance_scale_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_balance_scale);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_balance_scale", options);
    type->fp_build_ = fa_balance_scale_build;
    type->fp_ctor_ = (void*)fa_balance_scale__New4_fn;
    type->fp_cctor_ = fa_balance_scale__cctor_4_fn;
...
// public fa_balance_scale() :8
void fa_balance_scale__ctor_8_fn(fa_balance_scale* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_balance_scale__InitializeUX1_fn(fa_balance_scale* __this)
{
    __this->InitializeUX1();
}

// public fa_balance_scale New() :8
void fa_balance_scale__New4_fn(fa_balance_scale** __retval)
{
    *__retval = fa_balance_scale::New4();
}

// public fa_balance_scale() [instance] :8
void fa_balance_scale::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_balance_scale::InitializeUX1()
{
    uStackFrame __("fa_balance_scale", "InitializeUX()");
    Value(::STRINGS[0/*"\uF24E"*/]);
    SourceLineNumber(45);
...
// public fa_balance_scale New() [static] :8
fa_balance_scale* fa_balance_scale::New4()
{
    fa_balance_scale* obj1 = (fa_balance_scale*)uNew(fa_balance_scale_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
