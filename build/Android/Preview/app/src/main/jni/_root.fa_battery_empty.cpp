// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_empty.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_empty.h>
...
// public partial sealed class fa_battery_empty :2
// {
// static fa_battery_empty() :4
static void fa_battery_empty__cctor_4_fn(uType* __type)
{
}

static void fa_battery_empty_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_empty__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_empty_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_empty);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_empty", options);
    type->fp_build_ = fa_battery_empty_build;
    type->fp_ctor_ = (void*)fa_battery_empty__New4_fn;
    type->fp_cctor_ = fa_battery_empty__cctor_4_fn;
...
// public fa_battery_empty() :8
void fa_battery_empty__ctor_8_fn(fa_battery_empty* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_empty__InitializeUX1_fn(fa_battery_empty* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_empty New() :8
void fa_battery_empty__New4_fn(fa_battery_empty** __retval)
{
    *__retval = fa_battery_empty::New4();
}

// public fa_battery_empty() [instance] :8
void fa_battery_empty::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_empty::InitializeUX1()
{
    uStackFrame __("fa_battery_empty", "InitializeUX()");
    Value(::STRINGS[0/*"\uF244"*/]);
    SourceLineNumber(57);
...
// public fa_battery_empty New() [static] :8
fa_battery_empty* fa_battery_empty::New4()
{
    fa_battery_empty* obj1 = (fa_battery_empty*)uNew(fa_battery_empty_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
