// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basicBtn.Button.g.uno'.
...
static void Button_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("get_FontSize", NULL, (void*)Button__get_FontSize_fn, 0, false, ::g::Uno::Float_typeof(), 0),
        new uFunction("set_FontSize", NULL, (void*)Button__set_FontSize_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float_typeof()),
        new uFunction(".ctor", NULL, (void*)Button__New4_fn, 0, true, type, 0),
        new uFunction("SetFontSize", NULL, (void*)Button__SetFontSize_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
...
void Button::ctor_7()
{
    uStackFrame __("basicBtn.Button", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("basicBtn.Button", "set_FontSize(float)");
...
{
    uStackFrame __("basicBtn.Button", "InitializeUX()");
...
{
    uStackFrame __("basicBtn.Button", "SetFontSize(float,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("basicBtn.Button", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("basicBtn.Button", "set_Text(string)");
    SetText(value, NULL);
}
