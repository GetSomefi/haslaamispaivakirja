// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_graduation_cap.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_graduation_cap.h>
...
// public partial sealed class fa_graduation_cap :2
// {
// static fa_graduation_cap() :4
static void fa_graduation_cap__cctor_4_fn(uType* __type)
{
}

static void fa_graduation_cap_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\235");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_graduation_cap__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_graduation_cap_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_graduation_cap);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_graduation_cap", options);
    type->fp_build_ = fa_graduation_cap_build;
    type->fp_ctor_ = (void*)fa_graduation_cap__New4_fn;
    type->fp_cctor_ = fa_graduation_cap__cctor_4_fn;
...
// public fa_graduation_cap() :8
void fa_graduation_cap__ctor_8_fn(fa_graduation_cap* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_graduation_cap__InitializeUX1_fn(fa_graduation_cap* __this)
{
    __this->InitializeUX1();
}

// public fa_graduation_cap New() :8
void fa_graduation_cap__New4_fn(fa_graduation_cap** __retval)
{
    *__retval = fa_graduation_cap::New4();
}

// public fa_graduation_cap() [instance] :8
void fa_graduation_cap::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_graduation_cap::InitializeUX1()
{
    uStackFrame __("fa_graduation_cap", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19D"*/]);
    SourceLineNumber(298);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_graduation_cap New() [static] :8
fa_graduation_cap* fa_graduation_cap::New4()
{
    fa_graduation_cap* obj1 = (fa_graduation_cap*)uNew(fa_graduation_cap_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
