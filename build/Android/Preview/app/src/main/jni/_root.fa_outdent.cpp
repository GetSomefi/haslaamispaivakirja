// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_outdent.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_outdent.h>
...
// public partial sealed class fa_outdent :2
// {
// static fa_outdent() :4
static void fa_outdent__cctor_4_fn(uType* __type)
{
}

static void fa_outdent_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_outdent__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_outdent_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_outdent);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_outdent", options);
    type->fp_build_ = fa_outdent_build;
    type->fp_ctor_ = (void*)fa_outdent__New4_fn;
    type->fp_cctor_ = fa_outdent__cctor_4_fn;
...
// public fa_outdent() :8
void fa_outdent__ctor_8_fn(fa_outdent* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_outdent__InitializeUX1_fn(fa_outdent* __this)
{
    __this->InitializeUX1();
}

// public fa_outdent New() :8
void fa_outdent__New4_fn(fa_outdent** __retval)
{
    *__retval = fa_outdent::New4();
}

// public fa_outdent() [instance] :8
void fa_outdent::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_outdent::InitializeUX1()
{
    uStackFrame __("fa_outdent", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03B"*/]);
    SourceLineNumber(437);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_outdent New() [static] :8
fa_outdent* fa_outdent::New4()
{
    fa_outdent* obj1 = (fa_outdent*)uNew(fa_outdent_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
