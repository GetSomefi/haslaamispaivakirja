// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_step_backward.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_step_backward.h>
...
// public partial sealed class fa_step_backward :2
// {
// static fa_step_backward() :4
static void fa_step_backward__cctor_4_fn(uType* __type)
{
}

static void fa_step_backward_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_step_backward__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_step_backward_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_step_backward);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_step_backward", options);
    type->fp_build_ = fa_step_backward_build;
    type->fp_ctor_ = (void*)fa_step_backward__New4_fn;
    type->fp_cctor_ = fa_step_backward__cctor_4_fn;
...
// public fa_step_backward() :8
void fa_step_backward__ctor_8_fn(fa_step_backward* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_step_backward__InitializeUX1_fn(fa_step_backward* __this)
{
    __this->InitializeUX1();
}

// public fa_step_backward New() :8
void fa_step_backward__New4_fn(fa_step_backward** __retval)
{
    *__retval = fa_step_backward::New4();
}

// public fa_step_backward() [instance] :8
void fa_step_backward::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_step_backward::InitializeUX1()
{
    uStackFrame __("fa_step_backward", "InitializeUX()");
    Value(::STRINGS[0/*"\uF048"*/]);
    SourceLineNumber(574);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_step_backward New() [static] :8
fa_step_backward* fa_step_backward::New4()
{
    fa_step_backward* obj1 = (fa_step_backward*)uNew(fa_step_backward_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
