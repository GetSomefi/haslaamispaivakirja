// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_github.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_github.h>
...
// public partial sealed class fa_github :2
// {
// static fa_github() :4
static void fa_github__cctor_4_fn(uType* __type)
{
}

static void fa_github_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_github__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_github_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_github);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_github", options);
    type->fp_build_ = fa_github_build;
    type->fp_ctor_ = (void*)fa_github__New4_fn;
    type->fp_cctor_ = fa_github__cctor_4_fn;
...
// public fa_github() :8
void fa_github__ctor_8_fn(fa_github* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_github__InitializeUX1_fn(fa_github* __this)
{
    __this->InitializeUX1();
}

// public fa_github New() :8
void fa_github__New4_fn(fa_github** __retval)
{
    *__retval = fa_github::New4();
}

// public fa_github() [instance] :8
void fa_github::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_github::InitializeUX1()
{
    uStackFrame __("fa_github", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09B"*/]);
    SourceLineNumber(288);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_github New() [static] :8
fa_github* fa_github::New4()
{
    fa_github* obj1 = (fa_github*)uNew(fa_github_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
