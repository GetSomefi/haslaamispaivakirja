// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_history.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_history.h>
...
// public partial sealed class fa_history :2
// {
// static fa_history() :4
static void fa_history__cctor_4_fn(uType* __type)
{
}

static void fa_history_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_history__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_history_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_history);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_history", options);
    type->fp_build_ = fa_history_build;
    type->fp_ctor_ = (void*)fa_history__New4_fn;
    type->fp_cctor_ = fa_history__cctor_4_fn;
...
// public fa_history() :8
void fa_history__ctor_8_fn(fa_history* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_history__InitializeUX1_fn(fa_history* __this)
{
    __this->InitializeUX1();
}

// public fa_history New() :8
void fa_history__New4_fn(fa_history** __retval)
{
    *__retval = fa_history::New4();
}

// public fa_history() [instance] :8
void fa_history::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_history::InitializeUX1()
{
    uStackFrame __("fa_history", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1DA"*/]);
    SourceLineNumber(323);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_history New() [static] :8
fa_history* fa_history::New4()
{
    fa_history* obj1 = (fa_history*)uNew(fa_history_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
