// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_motorcycle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_motorcycle.h>
...
// public partial sealed class fa_motorcycle :2
// {
// static fa_motorcycle() :4
static void fa_motorcycle__cctor_4_fn(uType* __type)
{
}

static void fa_motorcycle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_motorcycle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_motorcycle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_motorcycle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_motorcycle", options);
    type->fp_build_ = fa_motorcycle_build;
    type->fp_ctor_ = (void*)fa_motorcycle__New4_fn;
    type->fp_cctor_ = fa_motorcycle__cctor_4_fn;
...
// public fa_motorcycle() :8
void fa_motorcycle__ctor_8_fn(fa_motorcycle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_motorcycle__InitializeUX1_fn(fa_motorcycle* __this)
{
    __this->InitializeUX1();
}

// public fa_motorcycle New() :8
void fa_motorcycle__New4_fn(fa_motorcycle** __retval)
{
    *__retval = fa_motorcycle::New4();
}

// public fa_motorcycle() [instance] :8
void fa_motorcycle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_motorcycle::InitializeUX1()
{
    uStackFrame __("fa_motorcycle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF21C"*/]);
    SourceLineNumber(423);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_motorcycle New() [static] :8
fa_motorcycle* fa_motorcycle::New4()
{
    fa_motorcycle* obj1 = (fa_motorcycle*)uNew(fa_motorcycle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
