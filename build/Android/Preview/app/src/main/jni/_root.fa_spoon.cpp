// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_spoon.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_spoon.h>
...
// public partial sealed class fa_spoon :2
// {
// static fa_spoon() :4
static void fa_spoon__cctor_4_fn(uType* __type)
{
}

static void fa_spoon_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_spoon__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_spoon_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_spoon);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_spoon", options);
    type->fp_build_ = fa_spoon_build;
    type->fp_ctor_ = (void*)fa_spoon__New4_fn;
    type->fp_cctor_ = fa_spoon__cctor_4_fn;
...
// public fa_spoon() :8
void fa_spoon__ctor_8_fn(fa_spoon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_spoon__InitializeUX1_fn(fa_spoon* __this)
{
    __this->InitializeUX1();
}

// public fa_spoon New() :8
void fa_spoon__New4_fn(fa_spoon** __retval)
{
    *__retval = fa_spoon::New4();
}

// public fa_spoon() [instance] :8
void fa_spoon::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_spoon::InitializeUX1()
{
    uStackFrame __("fa_spoon", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B1"*/]);
    SourceLineNumber(560);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_spoon New() [static] :8
fa_spoon* fa_spoon::New4()
{
    fa_spoon* obj1 = (fa_spoon*)uNew(fa_spoon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
