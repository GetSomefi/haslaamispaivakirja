// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_yen.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_yen.h>
...
// public partial sealed class fa_yen :2
// {
// static fa_yen() :4
static void fa_yen__cctor_4_fn(uType* __type)
{
}

static void fa_yen_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\227");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_yen__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_yen_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_yen);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_yen", options);
    type->fp_build_ = fa_yen_build;
    type->fp_ctor_ = (void*)fa_yen__New4_fn;
    type->fp_cctor_ = fa_yen__cctor_4_fn;
...
// public fa_yen() :8
void fa_yen__ctor_8_fn(fa_yen* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_yen__InitializeUX1_fn(fa_yen* __this)
{
    __this->InitializeUX1();
}

// public fa_yen New() :8
void fa_yen__New4_fn(fa_yen** __retval)
{
    *__retval = fa_yen::New4();
}

// public fa_yen() [instance] :8
void fa_yen::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_yen::InitializeUX1()
{
    uStackFrame __("fa_yen", "InitializeUX()");
    Value(::STRINGS[0/*"\uF157"*/]);
    SourceLineNumber(692);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_yen New() [static] :8
fa_yen* fa_yen::New4()
{
    fa_yen* obj1 = (fa_yen*)uNew(fa_yen_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
