// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_inr.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_inr.h>
...
// public partial sealed class fa_inr :2
// {
// static fa_inr() :4
static void fa_inr__cctor_4_fn(uType* __type)
{
}

static void fa_inr_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_inr__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_inr_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_inr);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_inr", options);
    type->fp_build_ = fa_inr_build;
    type->fp_ctor_ = (void*)fa_inr__New4_fn;
    type->fp_cctor_ = fa_inr__cctor_4_fn;
...
// public fa_inr() :8
void fa_inr__ctor_8_fn(fa_inr* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_inr__InitializeUX1_fn(fa_inr* __this)
{
    __this->InitializeUX1();
}

// public fa_inr New() :8
void fa_inr__New4_fn(fa_inr** __retval)
{
    *__retval = fa_inr::New4();
}

// public fa_inr() [instance] :8
void fa_inr::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_inr::InitializeUX1()
{
    uStackFrame __("fa_inr", "InitializeUX()");
    Value(::STRINGS[0/*"\uF156"*/]);
    SourceLineNumber(345);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_inr New() [static] :8
fa_inr* fa_inr::New4()
{
    fa_inr* obj1 = (fa_inr*)uNew(fa_inr_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
