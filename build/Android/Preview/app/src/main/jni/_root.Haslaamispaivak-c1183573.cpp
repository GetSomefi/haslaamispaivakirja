...
{
    uStackFrame __("Haslaamispaivakirja_basicBtnButton_Text_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_basicBtnButton_Text_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
