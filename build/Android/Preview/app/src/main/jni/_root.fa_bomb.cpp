// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bomb.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bomb.h>
...
// public partial sealed class fa_bomb :2
// {
// static fa_bomb() :4
static void fa_bomb__cctor_4_fn(uType* __type)
{
}

static void fa_bomb_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\242");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bomb__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bomb_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bomb);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bomb", options);
    type->fp_build_ = fa_bomb_build;
    type->fp_ctor_ = (void*)fa_bomb__New4_fn;
    type->fp_cctor_ = fa_bomb__cctor_4_fn;
...
// public fa_bomb() :8
void fa_bomb__ctor_8_fn(fa_bomb* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bomb__InitializeUX1_fn(fa_bomb* __this)
{
    __this->InitializeUX1();
}

// public fa_bomb New() :8
void fa_bomb__New4_fn(fa_bomb** __retval)
{
    *__retval = fa_bomb::New4();
}

// public fa_bomb() [instance] :8
void fa_bomb::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bomb::InitializeUX1()
{
    uStackFrame __("fa_bomb", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E2"*/]);
    SourceLineNumber(81);
...
// public fa_bomb New() [static] :8
fa_bomb* fa_bomb::New4()
{
    fa_bomb* obj1 = (fa_bomb*)uNew(fa_bomb_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
