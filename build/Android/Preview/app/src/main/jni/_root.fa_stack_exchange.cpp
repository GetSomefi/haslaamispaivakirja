// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_stack_exchange.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_stack_exchange.h>
...
// public partial sealed class fa_stack_exchange :2
// {
// static fa_stack_exchange() :4
static void fa_stack_exchange__cctor_4_fn(uType* __type)
{
}

static void fa_stack_exchange_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_stack_exchange__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_stack_exchange_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_stack_exchange);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_stack_exchange", options);
    type->fp_build_ = fa_stack_exchange_build;
    type->fp_ctor_ = (void*)fa_stack_exchange__New4_fn;
    type->fp_cctor_ = fa_stack_exchange__cctor_4_fn;
...
// public fa_stack_exchange() :8
void fa_stack_exchange__ctor_8_fn(fa_stack_exchange* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_stack_exchange__InitializeUX1_fn(fa_stack_exchange* __this)
{
    __this->InitializeUX1();
}

// public fa_stack_exchange New() :8
void fa_stack_exchange__New4_fn(fa_stack_exchange** __retval)
{
    *__retval = fa_stack_exchange::New4();
}

// public fa_stack_exchange() [instance] :8
void fa_stack_exchange::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_stack_exchange::InitializeUX1()
{
    uStackFrame __("fa_stack_exchange", "InitializeUX()");
    Value(::STRINGS[0/*"\uF18D"*/]);
    SourceLineNumber(564);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_stack_exchange New() [static] :8
fa_stack_exchange* fa_stack_exchange::New4()
{
    fa_stack_exchange* obj1 = (fa_stack_exchange*)uNew(fa_stack_exchange_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
