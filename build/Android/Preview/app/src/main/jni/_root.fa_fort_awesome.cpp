// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fort_awesome.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fort_awesome.h>
...
// public partial sealed class fa_fort_awesome :2
// {
// static fa_fort_awesome() :4
static void fa_fort_awesome__cctor_4_fn(uType* __type)
{
}

static void fa_fort_awesome_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\206");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fort_awesome__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fort_awesome_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fort_awesome);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fort_awesome", options);
    type->fp_build_ = fa_fort_awesome_build;
    type->fp_ctor_ = (void*)fa_fort_awesome__New4_fn;
    type->fp_cctor_ = fa_fort_awesome__cctor_4_fn;
...
// public fa_fort_awesome() :8
void fa_fort_awesome__ctor_8_fn(fa_fort_awesome* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fort_awesome__InitializeUX1_fn(fa_fort_awesome* __this)
{
    __this->InitializeUX1();
}

// public fa_fort_awesome New() :8
void fa_fort_awesome__New4_fn(fa_fort_awesome** __retval)
{
    *__retval = fa_fort_awesome::New4();
}

// public fa_fort_awesome() [instance] :8
void fa_fort_awesome::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_fort_awesome::InitializeUX1()
{
    uStackFrame __("fa_fort_awesome", "InitializeUX()");
    Value(::STRINGS[0/*"\uF286"*/]);
    SourceLineNumber(269);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fort_awesome New() [static] :8
fa_fort_awesome* fa_fort_awesome::New4()
{
    fa_fort_awesome* obj1 = (fa_fort_awesome*)uNew(fa_fort_awesome_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
