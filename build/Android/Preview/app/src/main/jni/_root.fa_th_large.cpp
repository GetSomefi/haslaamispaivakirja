// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_th_large.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_th_large.h>
...
// public partial sealed class fa_th_large :2
// {
// static fa_th_large() :4
static void fa_th_large__cctor_4_fn(uType* __type)
{
}

static void fa_th_large_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_th_large__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_th_large_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_th_large);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_th_large", options);
    type->fp_build_ = fa_th_large_build;
    type->fp_ctor_ = (void*)fa_th_large__New4_fn;
    type->fp_cctor_ = fa_th_large__cctor_4_fn;
...
// public fa_th_large() :8
void fa_th_large__ctor_8_fn(fa_th_large* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_th_large__InitializeUX1_fn(fa_th_large* __this)
{
    __this->InitializeUX1();
}

// public fa_th_large New() :8
void fa_th_large__New4_fn(fa_th_large** __retval)
{
    *__retval = fa_th_large::New4();
}

// public fa_th_large() [instance] :8
void fa_th_large::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_th_large::InitializeUX1()
{
    uStackFrame __("fa_th_large", "InitializeUX()");
    Value(::STRINGS[0/*"\uF009"*/]);
    SourceLineNumber(605);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_th_large New() [static] :8
fa_th_large* fa_th_large::New4()
{
    fa_th_large* obj1 = (fa_th_large*)uNew(fa_th_large_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
