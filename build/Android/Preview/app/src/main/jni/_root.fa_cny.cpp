// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cny.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cny.h>
...
// public partial sealed class fa_cny :2
// {
// static fa_cny() :4
static void fa_cny__cctor_4_fn(uType* __type)
{
}

static void fa_cny_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cny__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cny_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cny);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cny", options);
    type->fp_build_ = fa_cny_build;
    type->fp_ctor_ = (void*)fa_cny__New4_fn;
    type->fp_cctor_ = fa_cny__cctor_4_fn;
...
// public fa_cny() :8
void fa_cny__ctor_8_fn(fa_cny* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cny__InitializeUX1_fn(fa_cny* __this)
{
    __this->InitializeUX1();
}

// public fa_cny New() :8
void fa_cny__New4_fn(fa_cny** __retval)
{
    *__retval = fa_cny::New4();
}

// public fa_cny() [instance] :8
void fa_cny::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cny::InitializeUX1()
{
    uStackFrame __("fa_cny", "InitializeUX()");
    Value(::STRINGS[0/*"\uF157"*/]);
...
// public fa_cny New() [static] :8
fa_cny* fa_cny::New4()
{
    fa_cny* obj1 = (fa_cny*)uNew(fa_cny_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
