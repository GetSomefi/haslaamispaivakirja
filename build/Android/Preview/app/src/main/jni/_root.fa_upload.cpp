// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_upload.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_upload.h>
...
// public partial sealed class fa_upload :2
// {
// static fa_upload() :4
static void fa_upload__cctor_4_fn(uType* __type)
{
}

static void fa_upload_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_upload__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_upload_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_upload);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_upload", options);
    type->fp_build_ = fa_upload_build;
    type->fp_ctor_ = (void*)fa_upload__New4_fn;
    type->fp_cctor_ = fa_upload__cctor_4_fn;
...
// public fa_upload() :8
void fa_upload__ctor_8_fn(fa_upload* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_upload__InitializeUX1_fn(fa_upload* __this)
{
    __this->InitializeUX1();
}

// public fa_upload New() :8
void fa_upload__New4_fn(fa_upload** __retval)
{
    *__retval = fa_upload::New4();
}

// public fa_upload() [instance] :8
void fa_upload::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_upload::InitializeUX1()
{
    uStackFrame __("fa_upload", "InitializeUX()");
    Value(::STRINGS[0/*"\uF093"*/]);
...
// public fa_upload New() [static] :8
fa_upload* fa_upload::New4()
{
    fa_upload* obj1 = (fa_upload*)uNew(fa_upload_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
