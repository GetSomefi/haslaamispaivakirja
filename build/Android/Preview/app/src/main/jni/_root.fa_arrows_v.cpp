// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_arrows_v.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_arrows_v.h>
...
// public partial sealed class fa_arrows_v :2
// {
// static fa_arrows_v() :4
static void fa_arrows_v__cctor_4_fn(uType* __type)
{
}

static void fa_arrows_v_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_arrows_v__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_arrows_v_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_arrows_v);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_arrows_v", options);
    type->fp_build_ = fa_arrows_v_build;
    type->fp_ctor_ = (void*)fa_arrows_v__New4_fn;
    type->fp_cctor_ = fa_arrows_v__cctor_4_fn;
...
// public fa_arrows_v() :8
void fa_arrows_v__ctor_8_fn(fa_arrows_v* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_arrows_v__InitializeUX1_fn(fa_arrows_v* __this)
{
    __this->InitializeUX1();
}

// public fa_arrows_v New() :8
void fa_arrows_v__New4_fn(fa_arrows_v** __retval)
{
    *__retval = fa_arrows_v::New4();
}

// public fa_arrows_v() [instance] :8
void fa_arrows_v::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_arrows_v::InitializeUX1()
{
    uStackFrame __("fa_arrows_v", "InitializeUX()");
    Value(::STRINGS[0/*"\uF07D"*/]);
    SourceLineNumber(40);
...
// public fa_arrows_v New() [static] :8
fa_arrows_v* fa_arrows_v::New4()
{
    fa_arrows_v* obj1 = (fa_arrows_v*)uNew(fa_arrows_v_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
