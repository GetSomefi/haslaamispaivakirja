// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tty.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tty.h>
...
// public partial sealed class fa_tty :2
// {
// static fa_tty() :4
static void fa_tty__cctor_4_fn(uType* __type)
{
}

static void fa_tty_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tty__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tty_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tty);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tty", options);
    type->fp_build_ = fa_tty_build;
    type->fp_ctor_ = (void*)fa_tty__New4_fn;
    type->fp_cctor_ = fa_tty__cctor_4_fn;
...
// public fa_tty() :8
void fa_tty__ctor_8_fn(fa_tty* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tty__InitializeUX1_fn(fa_tty* __this)
{
    __this->InitializeUX1();
}

// public fa_tty New() :8
void fa_tty__New4_fn(fa_tty** __retval)
{
    *__retval = fa_tty::New4();
}

// public fa_tty() [instance] :8
void fa_tty::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tty::InitializeUX1()
{
    uStackFrame __("fa_tty", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E4"*/]);
    SourceLineNumber(635);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tty New() [static] :8
fa_tty* fa_tty::New4()
{
    fa_tty* obj1 = (fa_tty*)uNew(fa_tty_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
