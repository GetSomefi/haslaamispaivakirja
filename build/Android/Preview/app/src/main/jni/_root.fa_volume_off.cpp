// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_volume_off.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_volume_off.h>
...
// public partial sealed class fa_volume_off :2
// {
// static fa_volume_off() :4
static void fa_volume_off__cctor_4_fn(uType* __type)
{
}

static void fa_volume_off_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_volume_off__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_volume_off_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_volume_off);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_volume_off", options);
    type->fp_build_ = fa_volume_off_build;
    type->fp_ctor_ = (void*)fa_volume_off__New4_fn;
    type->fp_cctor_ = fa_volume_off__cctor_4_fn;
...
// public fa_volume_off() :8
void fa_volume_off__ctor_8_fn(fa_volume_off* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_volume_off__InitializeUX1_fn(fa_volume_off* __this)
{
    __this->InitializeUX1();
}

// public fa_volume_off New() :8
void fa_volume_off__New4_fn(fa_volume_off** __retval)
{
    *__retval = fa_volume_off::New4();
}

// public fa_volume_off() [instance] :8
void fa_volume_off::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_volume_off::InitializeUX1()
{
    uStackFrame __("fa_volume_off", "InitializeUX()");
    Value(::STRINGS[0/*"\uF026"*/]);
...
// public fa_volume_off New() [static] :8
fa_volume_off* fa_volume_off::New4()
{
    fa_volume_off* obj1 = (fa_volume_off*)uNew(fa_volume_off_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
