// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_filter.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_filter.h>
...
// public partial sealed class fa_filter :2
// {
// static fa_filter() :4
static void fa_filter__cctor_4_fn(uType* __type)
{
}

static void fa_filter_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_filter__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_filter_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_filter);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_filter", options);
    type->fp_build_ = fa_filter_build;
    type->fp_ctor_ = (void*)fa_filter__New4_fn;
    type->fp_cctor_ = fa_filter__cctor_4_fn;
...
// public fa_filter() :8
void fa_filter__ctor_8_fn(fa_filter* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_filter__InitializeUX1_fn(fa_filter* __this)
{
    __this->InitializeUX1();
}

// public fa_filter New() :8
void fa_filter__New4_fn(fa_filter** __retval)
{
    *__retval = fa_filter::New4();
}

// public fa_filter() [instance] :8
void fa_filter::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_filter::InitializeUX1()
{
    uStackFrame __("fa_filter", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0B0"*/]);
    SourceLineNumber(252);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_filter New() [static] :8
fa_filter* fa_filter::New4()
{
    fa_filter* obj1 = (fa_filter*)uNew(fa_filter_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
