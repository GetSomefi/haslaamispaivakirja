// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_odnoklassniki_square.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_odnoklassniki_square.h>
...
// public partial sealed class fa_odnoklassniki_square :2
// {
// static fa_odnoklassniki_square() :4
static void fa_odnoklassniki_square__cctor_4_fn(uType* __type)
{
}

static void fa_odnoklassniki_square_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_odnoklassniki_square__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_odnoklassniki_square_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_odnoklassniki_square);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_odnoklassniki_square", options);
    type->fp_build_ = fa_odnoklassniki_square_build;
    type->fp_ctor_ = (void*)fa_odnoklassniki_square__New4_fn;
    type->fp_cctor_ = fa_odnoklassniki_square__cctor_4_fn;
...
// public fa_odnoklassniki_square() :8
void fa_odnoklassniki_square__ctor_8_fn(fa_odnoklassniki_square* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_odnoklassniki_square__InitializeUX1_fn(fa_odnoklassniki_square* __this)
{
    __this->InitializeUX1();
}

// public fa_odnoklassniki_square New() :8
void fa_odnoklassniki_square__New4_fn(fa_odnoklassniki_square** __retval)
{
    *__retval = fa_odnoklassniki_square::New4();
}

// public fa_odnoklassniki_square() [instance] :8
void fa_odnoklassniki_square::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_odnoklassniki_square::InitializeUX1()
{
    uStackFrame __("fa_odnoklassniki_square", "InitializeUX()");
    Value(::STRINGS[0/*"\uF264"*/]);
...
// public fa_odnoklassniki_square New() [static] :8
fa_odnoklassniki_square* fa_odnoklassniki_square::New4()
{
    fa_odnoklassniki_square* obj1 = (fa_odnoklassniki_square*)uNew(fa_odnoklassniki_square_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
