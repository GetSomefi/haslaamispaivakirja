// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_plus.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_plus.h>
...
// public partial sealed class fa_plus :2
// {
// static fa_plus() :4
static void fa_plus__cctor_4_fn(uType* __type)
{
}

static void fa_plus_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_plus__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_plus_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_plus);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_plus", options);
    type->fp_build_ = fa_plus_build;
    type->fp_ctor_ = (void*)fa_plus__New4_fn;
    type->fp_cctor_ = fa_plus__cctor_4_fn;
...
// public fa_plus() :8
void fa_plus__ctor_8_fn(fa_plus* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_plus__InitializeUX1_fn(fa_plus* __this)
{
    __this->InitializeUX1();
}

// public fa_plus New() :8
void fa_plus__New4_fn(fa_plus** __retval)
{
    *__retval = fa_plus::New4();
}

// public fa_plus() [instance] :8
void fa_plus::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_plus::InitializeUX1()
{
    uStackFrame __("fa_plus", "InitializeUX()");
    Value(::STRINGS[0/*"\uF067"*/]);
    SourceLineNumber(469);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_plus New() [static] :8
fa_plus* fa_plus::New4()
{
    fa_plus* obj1 = (fa_plus*)uNew(fa_plus_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
