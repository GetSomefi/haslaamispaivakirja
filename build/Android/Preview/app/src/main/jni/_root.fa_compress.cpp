// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_compress.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_compress.h>
...
// public partial sealed class fa_compress :2
// {
// static fa_compress() :4
static void fa_compress__cctor_4_fn(uType* __type)
{
}

static void fa_compress_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_compress__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_compress_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_compress);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_compress", options);
    type->fp_build_ = fa_compress_build;
    type->fp_ctor_ = (void*)fa_compress__New4_fn;
    type->fp_cctor_ = fa_compress__cctor_4_fn;
...
// public fa_compress() :8
void fa_compress__ctor_8_fn(fa_compress* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_compress__InitializeUX1_fn(fa_compress* __this)
{
    __this->InitializeUX1();
}

// public fa_compress New() :8
void fa_compress__New4_fn(fa_compress** __retval)
{
    *__retval = fa_compress::New4();
}

// public fa_compress() [instance] :8
void fa_compress::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_compress::InitializeUX1()
{
    uStackFrame __("fa_compress", "InitializeUX()");
    Value(::STRINGS[0/*"\uF066"*/]);
    SourceLineNumber(169);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_compress New() [static] :8
fa_compress* fa_compress::New4()
{
    fa_compress* obj1 = (fa_compress*)uNew(fa_compress_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
