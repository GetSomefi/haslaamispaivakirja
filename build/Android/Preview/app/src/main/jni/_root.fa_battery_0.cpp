// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_0.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_0.h>
...
// public partial sealed class fa_battery_0 :2
// {
// static fa_battery_0() :4
static void fa_battery_0__cctor_4_fn(uType* __type)
{
}

static void fa_battery_0_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_0__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_0_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_0);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_0", options);
    type->fp_build_ = fa_battery_0_build;
    type->fp_ctor_ = (void*)fa_battery_0__New4_fn;
    type->fp_cctor_ = fa_battery_0__cctor_4_fn;
...
// public fa_battery_0() :8
void fa_battery_0__ctor_8_fn(fa_battery_0* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_0__InitializeUX1_fn(fa_battery_0* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_0 New() :8
void fa_battery_0__New4_fn(fa_battery_0** __retval)
{
    *__retval = fa_battery_0::New4();
}

// public fa_battery_0() [instance] :8
void fa_battery_0::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_0::InitializeUX1()
{
    uStackFrame __("fa_battery_0", "InitializeUX()");
    Value(::STRINGS[0/*"\uF244"*/]);
    SourceLineNumber(52);
...
// public fa_battery_0 New() [static] :8
fa_battery_0* fa_battery_0::New4()
{
    fa_battery_0* obj1 = (fa_battery_0*)uNew(fa_battery_0_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
