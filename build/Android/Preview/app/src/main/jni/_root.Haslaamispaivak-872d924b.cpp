...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggle_SecondaryColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggle_SecondaryColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
