// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_envelope.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_envelope.h>
...
// public partial sealed class fa_envelope :2
// {
// static fa_envelope() :4
static void fa_envelope__cctor_4_fn(uType* __type)
{
}

static void fa_envelope_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\240");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_envelope__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_envelope_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_envelope);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_envelope", options);
    type->fp_build_ = fa_envelope_build;
    type->fp_ctor_ = (void*)fa_envelope__New4_fn;
    type->fp_cctor_ = fa_envelope__cctor_4_fn;
...
// public fa_envelope() :8
void fa_envelope__ctor_8_fn(fa_envelope* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_envelope__InitializeUX1_fn(fa_envelope* __this)
{
    __this->InitializeUX1();
}

// public fa_envelope New() :8
void fa_envelope__New4_fn(fa_envelope** __retval)
{
    *__retval = fa_envelope::New4();
}

// public fa_envelope() [instance] :8
void fa_envelope::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_envelope::InitializeUX1()
{
    uStackFrame __("fa_envelope", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E0"*/]);
    SourceLineNumber(205);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_envelope New() [static] :8
fa_envelope* fa_envelope::New4()
{
    fa_envelope* obj1 = (fa_envelope*)uNew(fa_envelope_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
