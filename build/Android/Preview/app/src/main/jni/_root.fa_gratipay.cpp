// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gratipay.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gratipay.h>
...
// public partial sealed class fa_gratipay :2
// {
// static fa_gratipay() :4
static void fa_gratipay__cctor_4_fn(uType* __type)
{
}

static void fa_gratipay_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gratipay__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gratipay_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gratipay);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gratipay", options);
    type->fp_build_ = fa_gratipay_build;
    type->fp_ctor_ = (void*)fa_gratipay__New4_fn;
    type->fp_cctor_ = fa_gratipay__cctor_4_fn;
...
// public fa_gratipay() :8
void fa_gratipay__ctor_8_fn(fa_gratipay* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gratipay__InitializeUX1_fn(fa_gratipay* __this)
{
    __this->InitializeUX1();
}

// public fa_gratipay New() :8
void fa_gratipay__New4_fn(fa_gratipay** __retval)
{
    *__retval = fa_gratipay::New4();
}

// public fa_gratipay() [instance] :8
void fa_gratipay::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_gratipay::InitializeUX1()
{
    uStackFrame __("fa_gratipay", "InitializeUX()");
    Value(::STRINGS[0/*"\uF184"*/]);
    SourceLineNumber(299);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gratipay New() [static] :8
fa_gratipay* fa_gratipay::New4()
{
    fa_gratipay* obj1 = (fa_gratipay*)uNew(fa_gratipay_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
