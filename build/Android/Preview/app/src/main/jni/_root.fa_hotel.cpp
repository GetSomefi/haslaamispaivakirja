// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hotel.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hotel.h>
...
// public partial sealed class fa_hotel :2
// {
// static fa_hotel() :4
static void fa_hotel__cctor_4_fn(uType* __type)
{
}

static void fa_hotel_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\266");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hotel__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hotel_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hotel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hotel", options);
    type->fp_build_ = fa_hotel_build;
    type->fp_ctor_ = (void*)fa_hotel__New4_fn;
    type->fp_cctor_ = fa_hotel__cctor_4_fn;
...
// public fa_hotel() :8
void fa_hotel__ctor_8_fn(fa_hotel* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hotel__InitializeUX1_fn(fa_hotel* __this)
{
    __this->InitializeUX1();
}

// public fa_hotel New() :8
void fa_hotel__New4_fn(fa_hotel** __retval)
{
    *__retval = fa_hotel::New4();
}

// public fa_hotel() [instance] :8
void fa_hotel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hotel::InitializeUX1()
{
    uStackFrame __("fa_hotel", "InitializeUX()");
    Value(::STRINGS[0/*"\uF236"*/]);
    SourceLineNumber(326);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hotel New() [static] :8
fa_hotel* fa_hotel::New4()
{
    fa_hotel* obj1 = (fa_hotel*)uNew(fa_hotel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
