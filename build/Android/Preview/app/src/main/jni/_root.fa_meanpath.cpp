// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_meanpath.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_meanpath.h>
...
// public partial sealed class fa_meanpath :2
// {
// static fa_meanpath() :4
static void fa_meanpath__cctor_4_fn(uType* __type)
{
}

static void fa_meanpath_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_meanpath__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_meanpath_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_meanpath);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_meanpath", options);
    type->fp_build_ = fa_meanpath_build;
    type->fp_ctor_ = (void*)fa_meanpath__New4_fn;
    type->fp_cctor_ = fa_meanpath__cctor_4_fn;
...
// public fa_meanpath() :8
void fa_meanpath__ctor_8_fn(fa_meanpath* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_meanpath__InitializeUX1_fn(fa_meanpath* __this)
{
    __this->InitializeUX1();
}

// public fa_meanpath New() :8
void fa_meanpath__New4_fn(fa_meanpath** __retval)
{
    *__retval = fa_meanpath::New4();
}

// public fa_meanpath() [instance] :8
void fa_meanpath::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_meanpath::InitializeUX1()
{
    uStackFrame __("fa_meanpath", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20C"*/]);
    SourceLineNumber(405);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_meanpath New() [static] :8
fa_meanpath* fa_meanpath::New4()
{
    fa_meanpath* obj1 = (fa_meanpath*)uNew(fa_meanpath_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
