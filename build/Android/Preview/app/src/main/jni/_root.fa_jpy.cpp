// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_jpy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_jpy.h>
...
// public partial sealed class fa_jpy :2
// {
// static fa_jpy() :4
static void fa_jpy__cctor_4_fn(uType* __type)
{
}

static void fa_jpy_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_jpy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_jpy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_jpy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_jpy", options);
    type->fp_build_ = fa_jpy_build;
    type->fp_ctor_ = (void*)fa_jpy__New4_fn;
    type->fp_cctor_ = fa_jpy__cctor_4_fn;
...
// public fa_jpy() :8
void fa_jpy__ctor_8_fn(fa_jpy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_jpy__InitializeUX1_fn(fa_jpy* __this)
{
    __this->InitializeUX1();
}

// public fa_jpy New() :8
void fa_jpy__New4_fn(fa_jpy** __retval)
{
    *__retval = fa_jpy::New4();
}

// public fa_jpy() [instance] :8
void fa_jpy::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_jpy::InitializeUX1()
{
    uStackFrame __("fa_jpy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF157"*/]);
    SourceLineNumber(353);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_jpy New() [static] :8
fa_jpy* fa_jpy::New4()
{
    fa_jpy* obj1 = (fa_jpy*)uNew(fa_jpy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
