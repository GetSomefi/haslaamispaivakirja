...
static void Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Controls.TextControl*/], offsetof(Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property", options);
    type->fp_build_ = Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property_build;
    type->fp_Get1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, uTRef))Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property__Get1_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property__get_Object_fn;
    type->fp_Set1 = (void(*)(::g::Uno::UX::Property1*, ::g::Uno::UX::PropertyObject*, void*, uObject*))Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property__Set1_fn;
    return type;
}
...
{
    uStackFrame __("Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_FuseControlsTextControl_FontSize_Property", "Set(Uno.UX.PropertyObject,float,Uno.UX.IPropertyListener)");
    float v_ = *v;
