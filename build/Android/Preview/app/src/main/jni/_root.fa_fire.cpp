// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fire.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fire.h>
...
// public partial sealed class fa_fire :2
// {
// static fa_fire() :4
static void fa_fire__cctor_4_fn(uType* __type)
{
}

static void fa_fire_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fire__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fire_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fire);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fire", options);
    type->fp_build_ = fa_fire_build;
    type->fp_ctor_ = (void*)fa_fire__New4_fn;
    type->fp_cctor_ = fa_fire__cctor_4_fn;
...
// public fa_fire() :8
void fa_fire__ctor_8_fn(fa_fire* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fire__InitializeUX1_fn(fa_fire* __this)
{
    __this->InitializeUX1();
}

// public fa_fire New() :8
void fa_fire__New4_fn(fa_fire** __retval)
{
    *__retval = fa_fire::New4();
}

// public fa_fire() [instance] :8
void fa_fire::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_fire::InitializeUX1()
{
    uStackFrame __("fa_fire", "InitializeUX()");
    Value(::STRINGS[0/*"\uF06D"*/]);
    SourceLineNumber(253);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fire New() [static] :8
fa_fire* fa_fire::New4()
{
    fa_fire* obj1 = (fa_fire*)uNew(fa_fire_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
