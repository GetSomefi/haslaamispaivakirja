...
{
    uStackFrame __("Haslaamispaivakirja_FuseElementsElement_Visibility_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_FuseElementsElement_Visibility_Property", "Set(Uno.UX.PropertyObject,Fuse.Elements.Visibility,Uno.UX.IPropertyListener)");
    int32_t v_ = *v;
