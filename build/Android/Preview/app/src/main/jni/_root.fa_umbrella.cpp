// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_umbrella.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_umbrella.h>
...
// public partial sealed class fa_umbrella :2
// {
// static fa_umbrella() :4
static void fa_umbrella__cctor_4_fn(uType* __type)
{
}

static void fa_umbrella_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_umbrella__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_umbrella_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_umbrella);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_umbrella", options);
    type->fp_build_ = fa_umbrella_build;
    type->fp_ctor_ = (void*)fa_umbrella__New4_fn;
    type->fp_cctor_ = fa_umbrella__cctor_4_fn;
...
// public fa_umbrella() :8
void fa_umbrella__ctor_8_fn(fa_umbrella* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_umbrella__InitializeUX1_fn(fa_umbrella* __this)
{
    __this->InitializeUX1();
}

// public fa_umbrella New() :8
void fa_umbrella__New4_fn(fa_umbrella** __retval)
{
    *__retval = fa_umbrella::New4();
}

// public fa_umbrella() [instance] :8
void fa_umbrella::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_umbrella::InitializeUX1()
{
    uStackFrame __("fa_umbrella", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E9"*/]);
    SourceLineNumber(643);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_umbrella New() [static] :8
fa_umbrella* fa_umbrella::New4()
{
    fa_umbrella* obj1 = (fa_umbrella*)uNew(fa_umbrella_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
