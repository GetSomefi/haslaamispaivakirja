// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ra.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ra.h>
...
// public partial sealed class fa_ra :2
// {
// static fa_ra() :4
static void fa_ra__cctor_4_fn(uType* __type)
{
}

static void fa_ra_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ra__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ra_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ra);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ra", options);
    type->fp_build_ = fa_ra_build;
    type->fp_ctor_ = (void*)fa_ra__New4_fn;
    type->fp_cctor_ = fa_ra__cctor_4_fn;
...
// public fa_ra() :8
void fa_ra__ctor_8_fn(fa_ra* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ra__InitializeUX1_fn(fa_ra* __this)
{
    __this->InitializeUX1();
}

// public fa_ra New() :8
void fa_ra__New4_fn(fa_ra** __retval)
{
    *__retval = fa_ra::New4();
}

// public fa_ra() [instance] :8
void fa_ra::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_ra::InitializeUX1()
{
    uStackFrame __("fa_ra", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D0"*/]);
    SourceLineNumber(483);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ra New() [static] :8
fa_ra* fa_ra::New4()
{
    fa_ra* obj1 = (fa_ra*)uNew(fa_ra_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
