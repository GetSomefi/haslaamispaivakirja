// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fonticons.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fonticons.h>
...
// public partial sealed class fa_fonticons :2
// {
// static fa_fonticons() :4
static void fa_fonticons__cctor_4_fn(uType* __type)
{
}

static void fa_fonticons_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fonticons__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fonticons_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fonticons);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fonticons", options);
    type->fp_build_ = fa_fonticons_build;
    type->fp_ctor_ = (void*)fa_fonticons__New4_fn;
    type->fp_cctor_ = fa_fonticons__cctor_4_fn;
...
// public fa_fonticons() :8
void fa_fonticons__ctor_8_fn(fa_fonticons* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fonticons__InitializeUX1_fn(fa_fonticons* __this)
{
    __this->InitializeUX1();
}

// public fa_fonticons New() :8
void fa_fonticons__New4_fn(fa_fonticons** __retval)
{
    *__retval = fa_fonticons::New4();
}

// public fa_fonticons() [instance] :8
void fa_fonticons::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_fonticons::InitializeUX1()
{
    uStackFrame __("fa_fonticons", "InitializeUX()");
    Value(::STRINGS[0/*"\uF280"*/]);
    SourceLineNumber(268);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fonticons New() [static] :8
fa_fonticons* fa_fonticons::New4()
{
    fa_fonticons* obj1 = (fa_fonticons*)uNew(fa_fonticons_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
