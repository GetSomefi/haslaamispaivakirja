// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mixcloud.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mixcloud.h>
...
// public partial sealed class fa_mixcloud :2
// {
// static fa_mixcloud() :4
static void fa_mixcloud__cctor_4_fn(uType* __type)
{
}

static void fa_mixcloud_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mixcloud__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mixcloud_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mixcloud);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mixcloud", options);
    type->fp_build_ = fa_mixcloud_build;
    type->fp_ctor_ = (void*)fa_mixcloud__New4_fn;
    type->fp_cctor_ = fa_mixcloud__cctor_4_fn;
...
// public fa_mixcloud() :8
void fa_mixcloud__ctor_8_fn(fa_mixcloud* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mixcloud__InitializeUX1_fn(fa_mixcloud* __this)
{
    __this->InitializeUX1();
}

// public fa_mixcloud New() :8
void fa_mixcloud__New4_fn(fa_mixcloud** __retval)
{
    *__retval = fa_mixcloud::New4();
}

// public fa_mixcloud() [instance] :8
void fa_mixcloud::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mixcloud::InitializeUX1()
{
    uStackFrame __("fa_mixcloud", "InitializeUX()");
    Value(::STRINGS[0/*"\uF289"*/]);
    SourceLineNumber(416);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mixcloud New() [static] :8
fa_mixcloud* fa_mixcloud::New4()
{
    fa_mixcloud* obj1 = (fa_mixcloud*)uNew(fa_mixcloud_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
