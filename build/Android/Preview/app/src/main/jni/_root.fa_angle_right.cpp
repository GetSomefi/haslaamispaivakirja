// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_angle_right.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_angle_right.h>
...
// public partial sealed class fa_angle_right :2
// {
// static fa_angle_right() :4
static void fa_angle_right__cctor_4_fn(uType* __type)
{
}

static void fa_angle_right_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_angle_right__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_angle_right_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_angle_right);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_angle_right", options);
    type->fp_build_ = fa_angle_right_build;
    type->fp_ctor_ = (void*)fa_angle_right__New4_fn;
    type->fp_cctor_ = fa_angle_right__cctor_4_fn;
...
// public fa_angle_right() :8
void fa_angle_right__ctor_8_fn(fa_angle_right* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_angle_right__InitializeUX1_fn(fa_angle_right* __this)
{
    __this->InitializeUX1();
}

// public fa_angle_right New() :8
void fa_angle_right__New4_fn(fa_angle_right** __retval)
{
    *__retval = fa_angle_right::New4();
}

// public fa_angle_right() [instance] :8
void fa_angle_right::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_angle_right::InitializeUX1()
{
    uStackFrame __("fa_angle_right", "InitializeUX()");
    Value(::STRINGS[0/*"\uF105"*/]);
    SourceLineNumber(20);
...
// public fa_angle_right New() [static] :8
fa_angle_right* fa_angle_right::New4()
{
    fa_angle_right* obj1 = (fa_angle_right*)uNew(fa_angle_right_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
