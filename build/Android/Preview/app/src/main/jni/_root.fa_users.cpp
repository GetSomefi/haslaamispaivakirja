// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_users.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_users.h>
...
// public partial sealed class fa_users :2
// {
// static fa_users() :4
static void fa_users__cctor_4_fn(uType* __type)
{
}

static void fa_users_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_users__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_users_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_users);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_users", options);
    type->fp_build_ = fa_users_build;
    type->fp_ctor_ = (void*)fa_users__New4_fn;
    type->fp_cctor_ = fa_users__cctor_4_fn;
...
// public fa_users() :8
void fa_users__ctor_8_fn(fa_users* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_users__InitializeUX1_fn(fa_users* __this)
{
    __this->InitializeUX1();
}

// public fa_users New() :8
void fa_users__New4_fn(fa_users** __retval)
{
    *__retval = fa_users::New4();
}

// public fa_users() [instance] :8
void fa_users::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_users::InitializeUX1()
{
    uStackFrame __("fa_users", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C0"*/]);
    SourceLineNumber(659);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_users New() [static] :8
fa_users* fa_users::New4()
{
    fa_users* obj1 = (fa_users*)uNew(fa_users_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
