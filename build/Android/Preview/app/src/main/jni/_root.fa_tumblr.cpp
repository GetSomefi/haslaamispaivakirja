// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tumblr.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tumblr.h>
...
// public partial sealed class fa_tumblr :2
// {
// static fa_tumblr() :4
static void fa_tumblr__cctor_4_fn(uType* __type)
{
}

static void fa_tumblr_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tumblr__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tumblr_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tumblr);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tumblr", options);
    type->fp_build_ = fa_tumblr_build;
    type->fp_ctor_ = (void*)fa_tumblr__New4_fn;
    type->fp_cctor_ = fa_tumblr__cctor_4_fn;
...
// public fa_tumblr() :8
void fa_tumblr__ctor_8_fn(fa_tumblr* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tumblr__InitializeUX1_fn(fa_tumblr* __this)
{
    __this->InitializeUX1();
}

// public fa_tumblr New() :8
void fa_tumblr__New4_fn(fa_tumblr** __retval)
{
    *__retval = fa_tumblr::New4();
}

// public fa_tumblr() [instance] :8
void fa_tumblr::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tumblr::InitializeUX1()
{
    uStackFrame __("fa_tumblr", "InitializeUX()");
    Value(::STRINGS[0/*"\uF173"*/]);
    SourceLineNumber(636);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tumblr New() [static] :8
fa_tumblr* fa_tumblr::New4()
{
    fa_tumblr* obj1 = (fa_tumblr*)uNew(fa_tumblr_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
