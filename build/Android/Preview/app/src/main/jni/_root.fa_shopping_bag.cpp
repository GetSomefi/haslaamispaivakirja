// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_shopping_bag.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_shopping_bag.h>
...
// public partial sealed class fa_shopping_bag :2
// {
// static fa_shopping_bag() :4
static void fa_shopping_bag__cctor_4_fn(uType* __type)
{
}

static void fa_shopping_bag_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_shopping_bag__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_shopping_bag_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_shopping_bag);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_shopping_bag", options);
    type->fp_build_ = fa_shopping_bag_build;
    type->fp_ctor_ = (void*)fa_shopping_bag__New4_fn;
    type->fp_cctor_ = fa_shopping_bag__cctor_4_fn;
...
// public fa_shopping_bag() :8
void fa_shopping_bag__ctor_8_fn(fa_shopping_bag* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_shopping_bag__InitializeUX1_fn(fa_shopping_bag* __this)
{
    __this->InitializeUX1();
}

// public fa_shopping_bag New() :8
void fa_shopping_bag__New4_fn(fa_shopping_bag** __retval)
{
    *__retval = fa_shopping_bag::New4();
}

// public fa_shopping_bag() [instance] :8
void fa_shopping_bag::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_shopping_bag::InitializeUX1()
{
    uStackFrame __("fa_shopping_bag", "InitializeUX()");
    Value(::STRINGS[0/*"\uF290"*/]);
    SourceLineNumber(531);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_shopping_bag New() [static] :8
fa_shopping_bag* fa_shopping_bag::New4()
{
    fa_shopping_bag* obj1 = (fa_shopping_bag*)uNew(fa_shopping_bag_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
