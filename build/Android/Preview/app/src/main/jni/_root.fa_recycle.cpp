// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_recycle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_recycle.h>
...
// public partial sealed class fa_recycle :2
// {
// static fa_recycle() :4
static void fa_recycle__cctor_4_fn(uType* __type)
{
}

static void fa_recycle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\270");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_recycle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_recycle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_recycle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_recycle", options);
    type->fp_build_ = fa_recycle_build;
    type->fp_ctor_ = (void*)fa_recycle__New4_fn;
    type->fp_cctor_ = fa_recycle__cctor_4_fn;
...
// public fa_recycle() :8
void fa_recycle__ctor_8_fn(fa_recycle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_recycle__InitializeUX1_fn(fa_recycle* __this)
{
    __this->InitializeUX1();
}

// public fa_recycle New() :8
void fa_recycle__New4_fn(fa_recycle** __retval)
{
    *__retval = fa_recycle::New4();
}

// public fa_recycle() [instance] :8
void fa_recycle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_recycle::InitializeUX1()
{
    uStackFrame __("fa_recycle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B8"*/]);
    SourceLineNumber(486);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_recycle New() [static] :8
fa_recycle* fa_recycle::New4()
{
    fa_recycle* obj1 = (fa_recycle*)uNew(fa_recycle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
