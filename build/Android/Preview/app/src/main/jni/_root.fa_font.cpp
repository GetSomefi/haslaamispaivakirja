// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_font.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_font.h>
...
// public partial sealed class fa_font :2
// {
// static fa_font() :4
static void fa_font__cctor_4_fn(uType* __type)
{
}

static void fa_font_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_font__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_font_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_font);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_font", options);
    type->fp_build_ = fa_font_build;
    type->fp_ctor_ = (void*)fa_font__New4_fn;
    type->fp_cctor_ = fa_font__cctor_4_fn;
...
// public fa_font() :8
void fa_font__ctor_8_fn(fa_font* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_font__InitializeUX1_fn(fa_font* __this)
{
    __this->InitializeUX1();
}

// public fa_font New() :8
void fa_font__New4_fn(fa_font** __retval)
{
    *__retval = fa_font::New4();
}

// public fa_font() [instance] :8
void fa_font::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_font::InitializeUX1()
{
    uStackFrame __("fa_font", "InitializeUX()");
    Value(::STRINGS[0/*"\uF031"*/]);
    SourceLineNumber(267);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_font New() [static] :8
fa_font* fa_font::New4()
{
    fa_font* obj1 = (fa_font*)uNew(fa_font_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
