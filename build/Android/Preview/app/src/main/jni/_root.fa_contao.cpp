// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_contao.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_contao.h>
...
// public partial sealed class fa_contao :2
// {
// static fa_contao() :4
static void fa_contao__cctor_4_fn(uType* __type)
{
}

static void fa_contao_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_contao__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_contao_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_contao);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_contao", options);
    type->fp_build_ = fa_contao_build;
    type->fp_ctor_ = (void*)fa_contao__New4_fn;
    type->fp_cctor_ = fa_contao__cctor_4_fn;
...
// public fa_contao() :8
void fa_contao__ctor_8_fn(fa_contao* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_contao__InitializeUX1_fn(fa_contao* __this)
{
    __this->InitializeUX1();
}

// public fa_contao New() :8
void fa_contao__New4_fn(fa_contao** __retval)
{
    *__retval = fa_contao::New4();
}

// public fa_contao() [instance] :8
void fa_contao::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_contao::InitializeUX1()
{
    uStackFrame __("fa_contao", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26D"*/]);
    SourceLineNumber(171);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_contao New() [static] :8
fa_contao* fa_contao::New4()
{
    fa_contao* obj1 = (fa_contao*)uNew(fa_contao_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
