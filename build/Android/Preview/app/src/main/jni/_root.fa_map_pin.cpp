// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_map_pin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_map_pin.h>
...
// public partial sealed class fa_map_pin :2
// {
// static fa_map_pin() :4
static void fa_map_pin__cctor_4_fn(uType* __type)
{
}

static void fa_map_pin_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\266");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_map_pin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_map_pin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_map_pin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_map_pin", options);
    type->fp_build_ = fa_map_pin_build;
    type->fp_ctor_ = (void*)fa_map_pin__New4_fn;
    type->fp_cctor_ = fa_map_pin__cctor_4_fn;
...
// public fa_map_pin() :8
void fa_map_pin__ctor_8_fn(fa_map_pin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_map_pin__InitializeUX1_fn(fa_map_pin* __this)
{
    __this->InitializeUX1();
}

// public fa_map_pin New() :8
void fa_map_pin__New4_fn(fa_map_pin** __retval)
{
    *__retval = fa_map_pin::New4();
}

// public fa_map_pin() [instance] :8
void fa_map_pin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_map_pin::InitializeUX1()
{
    uStackFrame __("fa_map_pin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF276"*/]);
    SourceLineNumber(397);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_map_pin New() [static] :8
fa_map_pin* fa_map_pin::New4()
{
    fa_map_pin* obj1 = (fa_map_pin*)uNew(fa_map_pin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
