// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_microphone_slash.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_microphone_slash.h>
...
// public partial sealed class fa_microphone_slash :2
// {
// static fa_microphone_slash() :4
static void fa_microphone_slash__cctor_4_fn(uType* __type)
{
}

static void fa_microphone_slash_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_microphone_slash__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_microphone_slash_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_microphone_slash);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_microphone_slash", options);
    type->fp_build_ = fa_microphone_slash_build;
    type->fp_ctor_ = (void*)fa_microphone_slash__New4_fn;
    type->fp_cctor_ = fa_microphone_slash__cctor_4_fn;
...
// public fa_microphone_slash() :8
void fa_microphone_slash__ctor_8_fn(fa_microphone_slash* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_microphone_slash__InitializeUX1_fn(fa_microphone_slash* __this)
{
    __this->InitializeUX1();
}

// public fa_microphone_slash New() :8
void fa_microphone_slash__New4_fn(fa_microphone_slash** __retval)
{
    *__retval = fa_microphone_slash::New4();
}

// public fa_microphone_slash() [instance] :8
void fa_microphone_slash::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_microphone_slash::InitializeUX1()
{
    uStackFrame __("fa_microphone_slash", "InitializeUX()");
    Value(::STRINGS[0/*"\uF131"*/]);
    SourceLineNumber(411);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_microphone_slash New() [static] :8
fa_microphone_slash* fa_microphone_slash::New4()
{
    fa_microphone_slash* obj1 = (fa_microphone_slash*)uNew(fa_microphone_slash_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
