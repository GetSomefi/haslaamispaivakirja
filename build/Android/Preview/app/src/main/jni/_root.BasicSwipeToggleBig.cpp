// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/BasicSwipeToggleBig.g.uno'.
...
static void BasicSwipeToggleBig_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(16,
        new uFunction("get_IsActive", NULL, (void*)BasicSwipeToggleBig__get_IsActive_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_IsActive", NULL, (void*)BasicSwipeToggleBig__set_IsActive_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)BasicSwipeToggleBig__New4_fn, 0, true, type, 0),
        new uFunction("get_Opacity", NULL, (void*)BasicSwipeToggleBig__get_Opacity1_fn, 0, false, ::g::Uno::Float_typeof(), 0),
        new uFunction("set_Opacity", NULL, (void*)BasicSwipeToggleBig__set_Opacity1_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float_typeof()),
        new uFunction("get_PrimaryColor", NULL, (void*)BasicSwipeToggleBig__get_PrimaryColor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_PrimaryColor", NULL, (void*)BasicSwipeToggleBig__set_PrimaryColor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()),
        new uFunction("get_SecondaryColor", NULL, (void*)BasicSwipeToggleBig__get_SecondaryColor_fn, 0, false, ::g::Uno::Float4_typeof(), 0),
        new uFunction("set_SecondaryColor", NULL, (void*)BasicSwipeToggleBig__set_SecondaryColor_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float4_typeof()),
        new uFunction("get_Sendable", NULL, (void*)BasicSwipeToggleBig__get_Sendable_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_Sendable", NULL, (void*)BasicSwipeToggleBig__set_Sendable_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction("SetIsActive", NULL, (void*)BasicSwipeToggleBig__SetIsActive_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetOpacity", NULL, (void*)BasicSwipeToggleBig__SetOpacity1_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetPrimaryColor", NULL, (void*)BasicSwipeToggleBig__SetPrimaryColor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetSecondaryColor", NULL, (void*)BasicSwipeToggleBig__SetSecondaryColor_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Float4_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("SetSendable", NULL, (void*)BasicSwipeToggleBig__SetSendable_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
{
    uStackFrame __("BasicSwipeToggleBig", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("BasicSwipeToggleBig", "InitializeUX()");
...
{
    uStackFrame __("BasicSwipeToggleBig", "set_IsActive(bool)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "set_Opacity(float)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "set_PrimaryColor(float4)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "set_SecondaryColor(float4)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "set_Sendable(bool)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "SetIsActive(bool,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "SetOpacity(float,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "SetPrimaryColor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "SetSecondaryColor(float4,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("BasicSwipeToggleBig", "SetSendable(bool,Uno.UX.IPropertyListener)");
