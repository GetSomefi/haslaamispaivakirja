// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dollar.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dollar.h>
...
// public partial sealed class fa_dollar :2
// {
// static fa_dollar() :4
static void fa_dollar__cctor_4_fn(uType* __type)
{
}

static void fa_dollar_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dollar__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dollar_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dollar);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dollar", options);
    type->fp_build_ = fa_dollar_build;
    type->fp_ctor_ = (void*)fa_dollar__New4_fn;
    type->fp_cctor_ = fa_dollar__cctor_4_fn;
...
// public fa_dollar() :8
void fa_dollar__ctor_8_fn(fa_dollar* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dollar__InitializeUX1_fn(fa_dollar* __this)
{
    __this->InitializeUX1();
}

// public fa_dollar New() :8
void fa_dollar__New4_fn(fa_dollar** __retval)
{
    *__retval = fa_dollar::New4();
}

// public fa_dollar() [instance] :8
void fa_dollar::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dollar::InitializeUX1()
{
    uStackFrame __("fa_dollar", "InitializeUX()");
    Value(::STRINGS[0/*"\uF155"*/]);
    SourceLineNumber(193);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dollar New() [static] :8
fa_dollar* fa_dollar::New4()
{
    fa_dollar* obj1 = (fa_dollar*)uNew(fa_dollar_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
