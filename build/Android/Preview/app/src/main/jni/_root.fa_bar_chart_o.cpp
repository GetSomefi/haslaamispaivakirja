// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bar_chart_o.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bar_chart_o.h>
...
// public partial sealed class fa_bar_chart_o :2
// {
// static fa_bar_chart_o() :4
static void fa_bar_chart_o__cctor_4_fn(uType* __type)
{
}

static void fa_bar_chart_o_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bar_chart_o__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bar_chart_o_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bar_chart_o);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bar_chart_o", options);
    type->fp_build_ = fa_bar_chart_o_build;
    type->fp_ctor_ = (void*)fa_bar_chart_o__New4_fn;
    type->fp_cctor_ = fa_bar_chart_o__cctor_4_fn;
...
// public fa_bar_chart_o() :8
void fa_bar_chart_o__ctor_8_fn(fa_bar_chart_o* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bar_chart_o__InitializeUX1_fn(fa_bar_chart_o* __this)
{
    __this->InitializeUX1();
}

// public fa_bar_chart_o New() :8
void fa_bar_chart_o__New4_fn(fa_bar_chart_o** __retval)
{
    *__retval = fa_bar_chart_o::New4();
}

// public fa_bar_chart_o() [instance] :8
void fa_bar_chart_o::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bar_chart_o::InitializeUX1()
{
    uStackFrame __("fa_bar_chart_o", "InitializeUX()");
    Value(::STRINGS[0/*"\uF080"*/]);
    SourceLineNumber(49);
...
// public fa_bar_chart_o New() [static] :8
fa_bar_chart_o* fa_bar_chart_o::New4()
{
    fa_bar_chart_o* obj1 = (fa_bar_chart_o*)uNew(fa_bar_chart_o_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
