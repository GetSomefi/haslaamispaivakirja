// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_facebook_f.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_facebook_f.h>
...
// public partial sealed class fa_facebook_f :2
// {
// static fa_facebook_f() :4
static void fa_facebook_f__cctor_4_fn(uType* __type)
{
}

static void fa_facebook_f_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_facebook_f__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_facebook_f_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_facebook_f);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_facebook_f", options);
    type->fp_build_ = fa_facebook_f_build;
    type->fp_ctor_ = (void*)fa_facebook_f__New4_fn;
    type->fp_cctor_ = fa_facebook_f__cctor_4_fn;
...
// public fa_facebook_f() :8
void fa_facebook_f__ctor_8_fn(fa_facebook_f* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_facebook_f__InitializeUX1_fn(fa_facebook_f* __this)
{
    __this->InitializeUX1();
}

// public fa_facebook_f New() :8
void fa_facebook_f__New4_fn(fa_facebook_f** __retval)
{
    *__retval = fa_facebook_f::New4();
}

// public fa_facebook_f() [instance] :8
void fa_facebook_f::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_facebook_f::InitializeUX1()
{
    uStackFrame __("fa_facebook_f", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09A"*/]);
    SourceLineNumber(223);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_facebook_f New() [static] :8
fa_facebook_f* fa_facebook_f::New4()
{
    fa_facebook_f* obj1 = (fa_facebook_f*)uNew(fa_facebook_f_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
