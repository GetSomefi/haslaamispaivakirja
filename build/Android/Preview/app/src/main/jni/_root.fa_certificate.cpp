// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_certificate.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_certificate.h>
...
// public partial sealed class fa_certificate :2
// {
// static fa_certificate() :4
static void fa_certificate__cctor_4_fn(uType* __type)
{
}

static void fa_certificate_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_certificate__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_certificate_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_certificate);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_certificate", options);
    type->fp_build_ = fa_certificate_build;
    type->fp_ctor_ = (void*)fa_certificate__New4_fn;
    type->fp_cctor_ = fa_certificate__cctor_4_fn;
...
// public fa_certificate() :8
void fa_certificate__ctor_8_fn(fa_certificate* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_certificate__InitializeUX1_fn(fa_certificate* __this)
{
    __this->InitializeUX1();
}

// public fa_certificate New() :8
void fa_certificate__New4_fn(fa_certificate** __retval)
{
    *__retval = fa_certificate::New4();
}

// public fa_certificate() [instance] :8
void fa_certificate::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_certificate::InitializeUX1()
{
    uStackFrame __("fa_certificate", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0A3"*/]);
    SourceLineNumber(124);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_certificate New() [static] :8
fa_certificate* fa_certificate::New4()
{
    fa_certificate* obj1 = (fa_certificate*)uNew(fa_certificate_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
