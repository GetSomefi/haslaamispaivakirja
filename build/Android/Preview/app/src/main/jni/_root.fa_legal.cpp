// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_legal.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_legal.h>
...
// public partial sealed class fa_legal :2
// {
// static fa_legal() :4
static void fa_legal__cctor_4_fn(uType* __type)
{
}

static void fa_legal_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_legal__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_legal_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_legal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_legal", options);
    type->fp_build_ = fa_legal_build;
    type->fp_ctor_ = (void*)fa_legal__New4_fn;
    type->fp_cctor_ = fa_legal__cctor_4_fn;
...
// public fa_legal() :8
void fa_legal__ctor_8_fn(fa_legal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_legal__InitializeUX1_fn(fa_legal* __this)
{
    __this->InitializeUX1();
}

// public fa_legal New() :8
void fa_legal__New4_fn(fa_legal** __retval)
{
    *__retval = fa_legal::New4();
}

// public fa_legal() [instance] :8
void fa_legal::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_legal::InitializeUX1()
{
    uStackFrame __("fa_legal", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0E3"*/]);
    SourceLineNumber(364);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_legal New() [static] :8
fa_legal* fa_legal::New4()
{
    fa_legal* obj1 = (fa_legal*)uNew(fa_legal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
