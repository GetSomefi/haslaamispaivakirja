// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_briefcase.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_briefcase.h>
...
// public partial sealed class fa_briefcase :2
// {
// static fa_briefcase() :4
static void fa_briefcase__cctor_4_fn(uType* __type)
{
}

static void fa_briefcase_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_briefcase__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_briefcase_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_briefcase);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_briefcase", options);
    type->fp_build_ = fa_briefcase_build;
    type->fp_ctor_ = (void*)fa_briefcase__New4_fn;
    type->fp_cctor_ = fa_briefcase__cctor_4_fn;
...
// public fa_briefcase() :8
void fa_briefcase__ctor_8_fn(fa_briefcase* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_briefcase__InitializeUX1_fn(fa_briefcase* __this)
{
    __this->InitializeUX1();
}

// public fa_briefcase New() :8
void fa_briefcase__New4_fn(fa_briefcase** __retval)
{
    *__retval = fa_briefcase::New4();
}

// public fa_briefcase() [instance] :8
void fa_briefcase::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_briefcase::InitializeUX1()
{
    uStackFrame __("fa_briefcase", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0B1"*/]);
    SourceLineNumber(85);
...
// public fa_briefcase New() [static] :8
fa_briefcase* fa_briefcase::New4()
{
    fa_briefcase* obj1 = (fa_briefcase*)uNew(fa_briefcase_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
