// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_send.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_send.h>
...
// public partial sealed class fa_send :2
// {
// static fa_send() :4
static void fa_send__cctor_4_fn(uType* __type)
{
}

static void fa_send_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_send__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_send_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_send);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_send", options);
    type->fp_build_ = fa_send_build;
    type->fp_ctor_ = (void*)fa_send__New4_fn;
    type->fp_cctor_ = fa_send__cctor_4_fn;
...
// public fa_send() :8
void fa_send__ctor_8_fn(fa_send* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_send__InitializeUX1_fn(fa_send* __this)
{
    __this->InitializeUX1();
}

// public fa_send New() :8
void fa_send__New4_fn(fa_send** __retval)
{
    *__retval = fa_send::New4();
}

// public fa_send() [instance] :8
void fa_send::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_send::InitializeUX1()
{
    uStackFrame __("fa_send", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D8"*/]);
    SourceLineNumber(518);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_send New() [static] :8
fa_send* fa_send::New4()
{
    fa_send* obj1 = (fa_send*)uNew(fa_send_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
