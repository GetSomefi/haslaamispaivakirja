// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_crosshairs.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_crosshairs.h>
...
// public partial sealed class fa_crosshairs :2
// {
// static fa_crosshairs() :4
static void fa_crosshairs__cctor_4_fn(uType* __type)
{
}

static void fa_crosshairs_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_crosshairs__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_crosshairs_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_crosshairs);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_crosshairs", options);
    type->fp_build_ = fa_crosshairs_build;
    type->fp_ctor_ = (void*)fa_crosshairs__New4_fn;
    type->fp_cctor_ = fa_crosshairs__cctor_4_fn;
...
// public fa_crosshairs() :8
void fa_crosshairs__ctor_8_fn(fa_crosshairs* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_crosshairs__InitializeUX1_fn(fa_crosshairs* __this)
{
    __this->InitializeUX1();
}

// public fa_crosshairs New() :8
void fa_crosshairs__New4_fn(fa_crosshairs** __retval)
{
    *__retval = fa_crosshairs::New4();
}

// public fa_crosshairs() [instance] :8
void fa_crosshairs::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_crosshairs::InitializeUX1()
{
    uStackFrame __("fa_crosshairs", "InitializeUX()");
    Value(::STRINGS[0/*"\uF05B"*/]);
...
// public fa_crosshairs New() [static] :8
fa_crosshairs* fa_crosshairs::New4()
{
    fa_crosshairs* obj1 = (fa_crosshairs*)uNew(fa_crosshairs_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
