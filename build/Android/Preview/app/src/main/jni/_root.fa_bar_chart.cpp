// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bar_chart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bar_chart.h>
...
// public partial sealed class fa_bar_chart :2
// {
// static fa_bar_chart() :4
static void fa_bar_chart__cctor_4_fn(uType* __type)
{
}

static void fa_bar_chart_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bar_chart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bar_chart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bar_chart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bar_chart", options);
    type->fp_build_ = fa_bar_chart_build;
    type->fp_ctor_ = (void*)fa_bar_chart__New4_fn;
    type->fp_cctor_ = fa_bar_chart__cctor_4_fn;
...
// public fa_bar_chart() :8
void fa_bar_chart__ctor_8_fn(fa_bar_chart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bar_chart__InitializeUX1_fn(fa_bar_chart* __this)
{
    __this->InitializeUX1();
}

// public fa_bar_chart New() :8
void fa_bar_chart__New4_fn(fa_bar_chart** __retval)
{
    *__retval = fa_bar_chart::New4();
}

// public fa_bar_chart() [instance] :8
void fa_bar_chart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bar_chart::InitializeUX1()
{
    uStackFrame __("fa_bar_chart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF080"*/]);
    SourceLineNumber(48);
...
// public fa_bar_chart New() [static] :8
fa_bar_chart* fa_bar_chart::New4()
{
    fa_bar_chart* obj1 = (fa_bar_chart*)uNew(fa_bar_chart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
