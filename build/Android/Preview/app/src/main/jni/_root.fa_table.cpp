// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_table.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_table.h>
...
// public partial sealed class fa_table :2
// {
// static fa_table() :4
static void fa_table__cctor_4_fn(uType* __type)
{
}

static void fa_table_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_table__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_table_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_table);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_table", options);
    type->fp_build_ = fa_table_build;
    type->fp_ctor_ = (void*)fa_table__New4_fn;
    type->fp_cctor_ = fa_table__cctor_4_fn;
...
// public fa_table() :8
void fa_table__ctor_8_fn(fa_table* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_table__InitializeUX1_fn(fa_table* __this)
{
    __this->InitializeUX1();
}

// public fa_table New() :8
void fa_table__New4_fn(fa_table** __retval)
{
    *__retval = fa_table::New4();
}

// public fa_table() [instance] :8
void fa_table::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_table::InitializeUX1()
{
    uStackFrame __("fa_table", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0CE"*/]);
    SourceLineNumber(592);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_table New() [static] :8
fa_table* fa_table::New4()
{
    fa_table* obj1 = (fa_table*)uNew(fa_table_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
