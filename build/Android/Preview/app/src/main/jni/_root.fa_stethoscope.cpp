// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_stethoscope.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_stethoscope.h>
...
// public partial sealed class fa_stethoscope :2
// {
// static fa_stethoscope() :4
static void fa_stethoscope__cctor_4_fn(uType* __type)
{
}

static void fa_stethoscope_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_stethoscope__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_stethoscope_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_stethoscope);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_stethoscope", options);
    type->fp_build_ = fa_stethoscope_build;
    type->fp_ctor_ = (void*)fa_stethoscope__New4_fn;
    type->fp_cctor_ = fa_stethoscope__cctor_4_fn;
...
// public fa_stethoscope() :8
void fa_stethoscope__ctor_8_fn(fa_stethoscope* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_stethoscope__InitializeUX1_fn(fa_stethoscope* __this)
{
    __this->InitializeUX1();
}

// public fa_stethoscope New() :8
void fa_stethoscope__New4_fn(fa_stethoscope** __retval)
{
    *__retval = fa_stethoscope::New4();
}

// public fa_stethoscope() [instance] :8
void fa_stethoscope::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_stethoscope::InitializeUX1()
{
    uStackFrame __("fa_stethoscope", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F1"*/]);
    SourceLineNumber(576);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_stethoscope New() [static] :8
fa_stethoscope* fa_stethoscope::New4()
{
    fa_stethoscope* obj1 = (fa_stethoscope*)uNew(fa_stethoscope_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
