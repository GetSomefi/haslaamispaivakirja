// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_yelp.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_yelp.h>
...
// public partial sealed class fa_yelp :2
// {
// static fa_yelp() :4
static void fa_yelp__cctor_4_fn(uType* __type)
{
}

static void fa_yelp_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_yelp__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_yelp_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_yelp);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_yelp", options);
    type->fp_build_ = fa_yelp_build;
    type->fp_ctor_ = (void*)fa_yelp__New4_fn;
    type->fp_cctor_ = fa_yelp__cctor_4_fn;
...
// public fa_yelp() :8
void fa_yelp__ctor_8_fn(fa_yelp* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_yelp__InitializeUX1_fn(fa_yelp* __this)
{
    __this->InitializeUX1();
}

// public fa_yelp New() :8
void fa_yelp__New4_fn(fa_yelp** __retval)
{
    *__retval = fa_yelp::New4();
}

// public fa_yelp() [instance] :8
void fa_yelp::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_yelp::InitializeUX1()
{
    uStackFrame __("fa_yelp", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E9"*/]);
    SourceLineNumber(691);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_yelp New() [static] :8
fa_yelp* fa_yelp::New4()
{
    fa_yelp* obj1 = (fa_yelp*)uNew(fa_yelp_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
