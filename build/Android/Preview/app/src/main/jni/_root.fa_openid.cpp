// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_openid.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_openid.h>
...
// public partial sealed class fa_openid :2
// {
// static fa_openid() :4
static void fa_openid__cctor_4_fn(uType* __type)
{
}

static void fa_openid_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_openid__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_openid_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_openid);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_openid", options);
    type->fp_build_ = fa_openid_build;
    type->fp_ctor_ = (void*)fa_openid__New4_fn;
    type->fp_cctor_ = fa_openid__cctor_4_fn;
...
// public fa_openid() :8
void fa_openid__ctor_8_fn(fa_openid* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_openid__InitializeUX1_fn(fa_openid* __this)
{
    __this->InitializeUX1();
}

// public fa_openid New() :8
void fa_openid__New4_fn(fa_openid** __retval)
{
    *__retval = fa_openid::New4();
}

// public fa_openid() [instance] :8
void fa_openid::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_openid::InitializeUX1()
{
    uStackFrame __("fa_openid", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19B"*/]);
    SourceLineNumber(434);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_openid New() [static] :8
fa_openid* fa_openid::New4()
{
    fa_openid* obj1 = (fa_openid*)uNew(fa_openid_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
