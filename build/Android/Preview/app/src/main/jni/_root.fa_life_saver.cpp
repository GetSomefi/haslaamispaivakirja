// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_life_saver.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_life_saver.h>
...
// public partial sealed class fa_life_saver :2
// {
// static fa_life_saver() :4
static void fa_life_saver__cctor_4_fn(uType* __type)
{
}

static void fa_life_saver_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_life_saver__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_life_saver_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_life_saver);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_life_saver", options);
    type->fp_build_ = fa_life_saver_build;
    type->fp_ctor_ = (void*)fa_life_saver__New4_fn;
    type->fp_cctor_ = fa_life_saver__cctor_4_fn;
...
// public fa_life_saver() :8
void fa_life_saver__ctor_8_fn(fa_life_saver* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_life_saver__InitializeUX1_fn(fa_life_saver* __this)
{
    __this->InitializeUX1();
}

// public fa_life_saver New() :8
void fa_life_saver__New4_fn(fa_life_saver** __retval)
{
    *__retval = fa_life_saver::New4();
}

// public fa_life_saver() [instance] :8
void fa_life_saver::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_life_saver::InitializeUX1()
{
    uStackFrame __("fa_life_saver", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CD"*/]);
    SourceLineNumber(371);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_life_saver New() [static] :8
fa_life_saver* fa_life_saver::New4()
{
    fa_life_saver* obj1 = (fa_life_saver*)uNew(fa_life_saver_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
