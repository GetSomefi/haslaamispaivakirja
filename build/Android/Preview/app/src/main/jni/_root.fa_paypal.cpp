// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paypal.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paypal.h>
...
// public partial sealed class fa_paypal :2
// {
// static fa_paypal() :4
static void fa_paypal__cctor_4_fn(uType* __type)
{
}

static void fa_paypal_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paypal__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paypal_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paypal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paypal", options);
    type->fp_build_ = fa_paypal_build;
    type->fp_ctor_ = (void*)fa_paypal__New4_fn;
    type->fp_cctor_ = fa_paypal__cctor_4_fn;
...
// public fa_paypal() :8
void fa_paypal__ctor_8_fn(fa_paypal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paypal__InitializeUX1_fn(fa_paypal* __this)
{
    __this->InitializeUX1();
}

// public fa_paypal New() :8
void fa_paypal__New4_fn(fa_paypal** __retval)
{
    *__retval = fa_paypal::New4();
}

// public fa_paypal() [instance] :8
void fa_paypal::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paypal::InitializeUX1()
{
    uStackFrame __("fa_paypal", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1ED"*/]);
    SourceLineNumber(449);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paypal New() [static] :8
fa_paypal* fa_paypal::New4()
{
    fa_paypal* obj1 = (fa_paypal*)uNew(fa_paypal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
