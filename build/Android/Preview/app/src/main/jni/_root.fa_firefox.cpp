// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_firefox.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_firefox.h>
...
// public partial sealed class fa_firefox :2
// {
// static fa_firefox() :4
static void fa_firefox__cctor_4_fn(uType* __type)
{
}

static void fa_firefox_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_firefox__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_firefox_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_firefox);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_firefox", options);
    type->fp_build_ = fa_firefox_build;
    type->fp_ctor_ = (void*)fa_firefox__New4_fn;
    type->fp_cctor_ = fa_firefox__cctor_4_fn;
...
// public fa_firefox() :8
void fa_firefox__ctor_8_fn(fa_firefox* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_firefox__InitializeUX1_fn(fa_firefox* __this)
{
    __this->InitializeUX1();
}

// public fa_firefox New() :8
void fa_firefox__New4_fn(fa_firefox** __retval)
{
    *__retval = fa_firefox::New4();
}

// public fa_firefox() [instance] :8
void fa_firefox::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_firefox::InitializeUX1()
{
    uStackFrame __("fa_firefox", "InitializeUX()");
    Value(::STRINGS[0/*"\uF269"*/]);
    SourceLineNumber(255);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_firefox New() [static] :8
fa_firefox* fa_firefox::New4()
{
    fa_firefox* obj1 = (fa_firefox*)uNew(fa_firefox_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
