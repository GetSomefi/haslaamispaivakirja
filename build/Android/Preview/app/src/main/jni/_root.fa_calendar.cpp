// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_calendar.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_calendar.h>
...
// public partial sealed class fa_calendar :2
// {
// static fa_calendar() :4
static void fa_calendar__cctor_4_fn(uType* __type)
{
}

static void fa_calendar_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_calendar__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_calendar_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_calendar);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_calendar", options);
    type->fp_build_ = fa_calendar_build;
    type->fp_ctor_ = (void*)fa_calendar__New4_fn;
    type->fp_cctor_ = fa_calendar__cctor_4_fn;
...
// public fa_calendar() :8
void fa_calendar__ctor_8_fn(fa_calendar* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_calendar__InitializeUX1_fn(fa_calendar* __this)
{
    __this->InitializeUX1();
}

// public fa_calendar New() :8
void fa_calendar__New4_fn(fa_calendar** __retval)
{
    *__retval = fa_calendar::New4();
}

// public fa_calendar() [instance] :8
void fa_calendar::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_calendar::InitializeUX1()
{
    uStackFrame __("fa_calendar", "InitializeUX()");
    Value(::STRINGS[0/*"\uF073"*/]);
    SourceLineNumber(96);
...
// public fa_calendar New() [static] :8
fa_calendar* fa_calendar::New4()
{
    fa_calendar* obj1 = (fa_calendar*)uNew(fa_calendar_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
