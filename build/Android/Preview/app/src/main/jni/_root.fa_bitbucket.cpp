// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bitbucket.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bitbucket.h>
...
// public partial sealed class fa_bitbucket :2
// {
// static fa_bitbucket() :4
static void fa_bitbucket__cctor_4_fn(uType* __type)
{
}

static void fa_bitbucket_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bitbucket__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bitbucket_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bitbucket);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bitbucket", options);
    type->fp_build_ = fa_bitbucket_build;
    type->fp_ctor_ = (void*)fa_bitbucket__New4_fn;
    type->fp_cctor_ = fa_bitbucket__cctor_4_fn;
...
// public fa_bitbucket() :8
void fa_bitbucket__ctor_8_fn(fa_bitbucket* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bitbucket__InitializeUX1_fn(fa_bitbucket* __this)
{
    __this->InitializeUX1();
}

// public fa_bitbucket New() :8
void fa_bitbucket__New4_fn(fa_bitbucket** __retval)
{
    *__retval = fa_bitbucket::New4();
}

// public fa_bitbucket() [instance] :8
void fa_bitbucket::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bitbucket::InitializeUX1()
{
    uStackFrame __("fa_bitbucket", "InitializeUX()");
    Value(::STRINGS[0/*"\uF171"*/]);
    SourceLineNumber(73);
...
// public fa_bitbucket New() [static] :8
fa_bitbucket* fa_bitbucket::New4()
{
    fa_bitbucket* obj1 = (fa_bitbucket*)uNew(fa_bitbucket_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
