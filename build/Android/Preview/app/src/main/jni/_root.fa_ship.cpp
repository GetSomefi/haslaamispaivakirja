// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ship.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ship.h>
...
// public partial sealed class fa_ship :2
// {
// static fa_ship() :4
static void fa_ship__cctor_4_fn(uType* __type)
{
}

static void fa_ship_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ship__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ship_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ship);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ship", options);
    type->fp_build_ = fa_ship_build;
    type->fp_ctor_ = (void*)fa_ship__New4_fn;
    type->fp_cctor_ = fa_ship__cctor_4_fn;
...
// public fa_ship() :8
void fa_ship__ctor_8_fn(fa_ship* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ship__InitializeUX1_fn(fa_ship* __this)
{
    __this->InitializeUX1();
}

// public fa_ship New() :8
void fa_ship__New4_fn(fa_ship** __retval)
{
    *__retval = fa_ship::New4();
}

// public fa_ship() [instance] :8
void fa_ship::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_ship::InitializeUX1()
{
    uStackFrame __("fa_ship", "InitializeUX()");
    Value(::STRINGS[0/*"\uF21A"*/]);
    SourceLineNumber(529);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ship New() [static] :8
fa_ship* fa_ship::New4()
{
    fa_ship* obj1 = (fa_ship*)uNew(fa_ship_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
