// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_shield.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_shield.h>
...
// public partial sealed class fa_shield :2
// {
// static fa_shield() :4
static void fa_shield__cctor_4_fn(uType* __type)
{
}

static void fa_shield_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_shield__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_shield_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_shield);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_shield", options);
    type->fp_build_ = fa_shield_build;
    type->fp_ctor_ = (void*)fa_shield__New4_fn;
    type->fp_cctor_ = fa_shield__cctor_4_fn;
...
// public fa_shield() :8
void fa_shield__ctor_8_fn(fa_shield* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_shield__InitializeUX1_fn(fa_shield* __this)
{
    __this->InitializeUX1();
}

// public fa_shield New() :8
void fa_shield__New4_fn(fa_shield** __retval)
{
    *__retval = fa_shield::New4();
}

// public fa_shield() [instance] :8
void fa_shield::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_shield::InitializeUX1()
{
    uStackFrame __("fa_shield", "InitializeUX()");
    Value(::STRINGS[0/*"\uF132"*/]);
    SourceLineNumber(528);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_shield New() [static] :8
fa_shield* fa_shield::New4()
{
    fa_shield* obj1 = (fa_shield*)uNew(fa_shield_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
