// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_microphone.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_microphone.h>
...
// public partial sealed class fa_microphone :2
// {
// static fa_microphone() :4
static void fa_microphone__cctor_4_fn(uType* __type)
{
}

static void fa_microphone_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_microphone__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_microphone_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_microphone);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_microphone", options);
    type->fp_build_ = fa_microphone_build;
    type->fp_ctor_ = (void*)fa_microphone__New4_fn;
    type->fp_cctor_ = fa_microphone__cctor_4_fn;
...
// public fa_microphone() :8
void fa_microphone__ctor_8_fn(fa_microphone* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_microphone__InitializeUX1_fn(fa_microphone* __this)
{
    __this->InitializeUX1();
}

// public fa_microphone New() :8
void fa_microphone__New4_fn(fa_microphone** __retval)
{
    *__retval = fa_microphone::New4();
}

// public fa_microphone() [instance] :8
void fa_microphone::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_microphone::InitializeUX1()
{
    uStackFrame __("fa_microphone", "InitializeUX()");
    Value(::STRINGS[0/*"\uF130"*/]);
    SourceLineNumber(410);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_microphone New() [static] :8
fa_microphone* fa_microphone::New4()
{
    fa_microphone* obj1 = (fa_microphone*)uNew(fa_microphone_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
