// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_half.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_half.h>
...
// public partial sealed class fa_battery_half :2
// {
// static fa_battery_half() :4
static void fa_battery_half__cctor_4_fn(uType* __type)
{
}

static void fa_battery_half_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_half__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_half_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_half);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_half", options);
    type->fp_build_ = fa_battery_half_build;
    type->fp_ctor_ = (void*)fa_battery_half__New4_fn;
    type->fp_cctor_ = fa_battery_half__cctor_4_fn;
...
// public fa_battery_half() :8
void fa_battery_half__ctor_8_fn(fa_battery_half* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_half__InitializeUX1_fn(fa_battery_half* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_half New() :8
void fa_battery_half__New4_fn(fa_battery_half** __retval)
{
    *__retval = fa_battery_half::New4();
}

// public fa_battery_half() [instance] :8
void fa_battery_half::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_half::InitializeUX1()
{
    uStackFrame __("fa_battery_half", "InitializeUX()");
    Value(::STRINGS[0/*"\uF242"*/]);
    SourceLineNumber(59);
...
// public fa_battery_half New() [static] :8
fa_battery_half* fa_battery_half::New4()
{
    fa_battery_half* obj1 = (fa_battery_half*)uNew(fa_battery_half_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
