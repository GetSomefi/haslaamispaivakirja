// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/header.Text.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/header.Text.ux");
...
::g::Fuse::Controls::TextControl_type* Text_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("header.Text", options);
...
{
    uStackFrame __("header.Text", "InitializeUX()");
    FontSize(30.0f);
    TextAlignment(1);
    Color(::g::Fuse::Drawing::Colors::White());
    Margin(::g::Uno::Float4__New2(0.0f, 50.0f, 0.0f, 50.0f));
    SourceLineNumber(1);
