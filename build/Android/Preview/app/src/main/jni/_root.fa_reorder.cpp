// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_reorder.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_reorder.h>
...
// public partial sealed class fa_reorder :2
// {
// static fa_reorder() :4
static void fa_reorder__cctor_4_fn(uType* __type)
{
}

static void fa_reorder_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_reorder__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_reorder_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_reorder);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_reorder", options);
    type->fp_build_ = fa_reorder_build;
    type->fp_ctor_ = (void*)fa_reorder__New4_fn;
    type->fp_cctor_ = fa_reorder__cctor_4_fn;
...
// public fa_reorder() :8
void fa_reorder__ctor_8_fn(fa_reorder* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_reorder__InitializeUX1_fn(fa_reorder* __this)
{
    __this->InitializeUX1();
}

// public fa_reorder New() :8
void fa_reorder__New4_fn(fa_reorder** __retval)
{
    *__retval = fa_reorder::New4();
}

// public fa_reorder() [instance] :8
void fa_reorder::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_reorder::InitializeUX1()
{
    uStackFrame __("fa_reorder", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C9"*/]);
    SourceLineNumber(494);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_reorder New() [static] :8
fa_reorder* fa_reorder::New4()
{
    fa_reorder* obj1 = (fa_reorder*)uNew(fa_reorder_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
