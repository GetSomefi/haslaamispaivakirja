// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_codiepie.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_codiepie.h>
...
// public partial sealed class fa_codiepie :2
// {
// static fa_codiepie() :4
static void fa_codiepie__cctor_4_fn(uType* __type)
{
}

static void fa_codiepie_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_codiepie__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_codiepie_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_codiepie);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_codiepie", options);
    type->fp_build_ = fa_codiepie_build;
    type->fp_ctor_ = (void*)fa_codiepie__New4_fn;
    type->fp_cctor_ = fa_codiepie__cctor_4_fn;
...
// public fa_codiepie() :8
void fa_codiepie__ctor_8_fn(fa_codiepie* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_codiepie__InitializeUX1_fn(fa_codiepie* __this)
{
    __this->InitializeUX1();
}

// public fa_codiepie New() :8
void fa_codiepie__New4_fn(fa_codiepie** __retval)
{
    *__retval = fa_codiepie::New4();
}

// public fa_codiepie() [instance] :8
void fa_codiepie::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_codiepie::InitializeUX1()
{
    uStackFrame __("fa_codiepie", "InitializeUX()");
    Value(::STRINGS[0/*"\uF284"*/]);
    SourceLineNumber(157);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_codiepie New() [static] :8
fa_codiepie* fa_codiepie::New4()
{
    fa_codiepie* obj1 = (fa_codiepie*)uNew(fa_codiepie_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
