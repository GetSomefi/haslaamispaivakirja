// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_instagram.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_instagram.h>
...
// public partial sealed class fa_instagram :2
// {
// static fa_instagram() :4
static void fa_instagram__cctor_4_fn(uType* __type)
{
}

static void fa_instagram_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_instagram__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_instagram_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_instagram);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_instagram", options);
    type->fp_build_ = fa_instagram_build;
    type->fp_ctor_ = (void*)fa_instagram__New4_fn;
    type->fp_cctor_ = fa_instagram__cctor_4_fn;
...
// public fa_instagram() :8
void fa_instagram__ctor_8_fn(fa_instagram* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_instagram__InitializeUX1_fn(fa_instagram* __this)
{
    __this->InitializeUX1();
}

// public fa_instagram New() :8
void fa_instagram__New4_fn(fa_instagram** __retval)
{
    *__retval = fa_instagram::New4();
}

// public fa_instagram() [instance] :8
void fa_instagram::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_instagram::InitializeUX1()
{
    uStackFrame __("fa_instagram", "InitializeUX()");
    Value(::STRINGS[0/*"\uF16D"*/]);
    SourceLineNumber(346);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_instagram New() [static] :8
fa_instagram* fa_instagram::New4()
{
    fa_instagram* obj1 = (fa_instagram*)uNew(fa_instagram_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
