// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gift.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gift.h>
...
// public partial sealed class fa_gift :2
// {
// static fa_gift() :4
static void fa_gift__cctor_4_fn(uType* __type)
{
}

static void fa_gift_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gift__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gift_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gift);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gift", options);
    type->fp_build_ = fa_gift_build;
    type->fp_ctor_ = (void*)fa_gift__New4_fn;
    type->fp_cctor_ = fa_gift__cctor_4_fn;
...
// public fa_gift() :8
void fa_gift__ctor_8_fn(fa_gift* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gift__InitializeUX1_fn(fa_gift* __this)
{
    __this->InitializeUX1();
}

// public fa_gift New() :8
void fa_gift__New4_fn(fa_gift** __retval)
{
    *__retval = fa_gift::New4();
}

// public fa_gift() [instance] :8
void fa_gift::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_gift::InitializeUX1()
{
    uStackFrame __("fa_gift", "InitializeUX()");
    Value(::STRINGS[0/*"\uF06B"*/]);
...
// public fa_gift New() [static] :8
fa_gift* fa_gift::New4()
{
    fa_gift* obj1 = (fa_gift*)uNew(fa_gift_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
