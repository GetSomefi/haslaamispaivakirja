// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_trophy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_trophy.h>
...
// public partial sealed class fa_trophy :2
// {
// static fa_trophy() :4
static void fa_trophy__cctor_4_fn(uType* __type)
{
}

static void fa_trophy_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_trophy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_trophy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_trophy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_trophy", options);
    type->fp_build_ = fa_trophy_build;
    type->fp_ctor_ = (void*)fa_trophy__New4_fn;
    type->fp_cctor_ = fa_trophy__cctor_4_fn;
...
// public fa_trophy() :8
void fa_trophy__ctor_8_fn(fa_trophy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_trophy__InitializeUX1_fn(fa_trophy* __this)
{
    __this->InitializeUX1();
}

// public fa_trophy New() :8
void fa_trophy__New4_fn(fa_trophy** __retval)
{
    *__retval = fa_trophy::New4();
}

// public fa_trophy() [instance] :8
void fa_trophy::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_trophy::InitializeUX1()
{
    uStackFrame __("fa_trophy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF091"*/]);
    SourceLineNumber(632);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_trophy New() [static] :8
fa_trophy* fa_trophy::New4()
{
    fa_trophy* obj1 = (fa_trophy*)uNew(fa_trophy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
