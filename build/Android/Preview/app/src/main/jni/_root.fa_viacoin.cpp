// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_viacoin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_viacoin.h>
...
// public partial sealed class fa_viacoin :2
// {
// static fa_viacoin() :4
static void fa_viacoin__cctor_4_fn(uType* __type)
{
}

static void fa_viacoin_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\267");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_viacoin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_viacoin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_viacoin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_viacoin", options);
    type->fp_build_ = fa_viacoin_build;
    type->fp_ctor_ = (void*)fa_viacoin__New4_fn;
    type->fp_cctor_ = fa_viacoin__cctor_4_fn;
...
// public fa_viacoin() :8
void fa_viacoin__ctor_8_fn(fa_viacoin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_viacoin__InitializeUX1_fn(fa_viacoin* __this)
{
    __this->InitializeUX1();
}

// public fa_viacoin New() :8
void fa_viacoin__New4_fn(fa_viacoin** __retval)
{
    *__retval = fa_viacoin::New4();
}

// public fa_viacoin() [instance] :8
void fa_viacoin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_viacoin::InitializeUX1()
{
    uStackFrame __("fa_viacoin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF237"*/]);
...
// public fa_viacoin New() [static] :8
fa_viacoin* fa_viacoin::New4()
{
    fa_viacoin* obj1 = (fa_viacoin*)uNew(fa_viacoin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
