// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dashcube.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dashcube.h>
...
// public partial sealed class fa_dashcube :2
// {
// static fa_dashcube() :4
static void fa_dashcube__cctor_4_fn(uType* __type)
{
}

static void fa_dashcube_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dashcube__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dashcube_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dashcube);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dashcube", options);
    type->fp_build_ = fa_dashcube_build;
    type->fp_ctor_ = (void*)fa_dashcube__New4_fn;
    type->fp_cctor_ = fa_dashcube__cctor_4_fn;
...
// public fa_dashcube() :8
void fa_dashcube__ctor_8_fn(fa_dashcube* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dashcube__InitializeUX1_fn(fa_dashcube* __this)
{
    __this->InitializeUX1();
}

// public fa_dashcube New() :8
void fa_dashcube__New4_fn(fa_dashcube** __retval)
{
    *__retval = fa_dashcube::New4();
}

// public fa_dashcube() [instance] :8
void fa_dashcube::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dashcube::InitializeUX1()
{
    uStackFrame __("fa_dashcube", "InitializeUX()");
    Value(::STRINGS[0/*"\uF210"*/]);
    SourceLineNumber(185);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dashcube New() [static] :8
fa_dashcube* fa_dashcube::New4()
{
    fa_dashcube* obj1 = (fa_dashcube*)uNew(fa_dashcube_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
