// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_try.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_try.h>
...
// public partial sealed class fa_try :2
// {
// static fa_try() :4
static void fa_try__cctor_4_fn(uType* __type)
{
}

static void fa_try_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_try__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_try_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_try);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_try", options);
    type->fp_build_ = fa_try_build;
    type->fp_ctor_ = (void*)fa_try__New4_fn;
    type->fp_cctor_ = fa_try__cctor_4_fn;
...
// public fa_try() :8
void fa_try__ctor_8_fn(fa_try* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_try__InitializeUX1_fn(fa_try* __this)
{
    __this->InitializeUX1();
}

// public fa_try New() :8
void fa_try__New4_fn(fa_try** __retval)
{
    *__retval = fa_try::New4();
}

// public fa_try() [instance] :8
void fa_try::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_try::InitializeUX1()
{
    uStackFrame __("fa_try", "InitializeUX()");
    Value(::STRINGS[0/*"\uF195"*/]);
...
// public fa_try New() [static] :8
fa_try* fa_try::New4()
{
    fa_try* obj1 = (fa_try*)uNew(fa_try_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
