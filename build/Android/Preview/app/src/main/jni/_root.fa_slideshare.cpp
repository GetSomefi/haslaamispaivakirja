// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_slideshare.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_slideshare.h>
...
// public partial sealed class fa_slideshare :2
// {
// static fa_slideshare() :4
static void fa_slideshare__cctor_4_fn(uType* __type)
{
}

static void fa_slideshare_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_slideshare__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_slideshare_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_slideshare);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_slideshare", options);
    type->fp_build_ = fa_slideshare_build;
    type->fp_ctor_ = (void*)fa_slideshare__New4_fn;
    type->fp_cctor_ = fa_slideshare__cctor_4_fn;
...
// public fa_slideshare() :8
void fa_slideshare__ctor_8_fn(fa_slideshare* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_slideshare__InitializeUX1_fn(fa_slideshare* __this)
{
    __this->InitializeUX1();
}

// public fa_slideshare New() :8
void fa_slideshare__New4_fn(fa_slideshare** __retval)
{
    *__retval = fa_slideshare::New4();
}

// public fa_slideshare() [instance] :8
void fa_slideshare::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_slideshare::InitializeUX1()
{
    uStackFrame __("fa_slideshare", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E7"*/]);
    SourceLineNumber(543);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_slideshare New() [static] :8
fa_slideshare* fa_slideshare::New4()
{
    fa_slideshare* obj1 = (fa_slideshare*)uNew(fa_slideshare_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
