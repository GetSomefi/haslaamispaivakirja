// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_male.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_male.h>
...
// public partial sealed class fa_male :2
// {
// static fa_male() :4
static void fa_male__cctor_4_fn(uType* __type)
{
}

static void fa_male_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_male__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_male_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_male);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_male", options);
    type->fp_build_ = fa_male_build;
    type->fp_ctor_ = (void*)fa_male__New4_fn;
    type->fp_cctor_ = fa_male__cctor_4_fn;
...
// public fa_male() :8
void fa_male__ctor_8_fn(fa_male* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_male__InitializeUX1_fn(fa_male* __this)
{
    __this->InitializeUX1();
}

// public fa_male New() :8
void fa_male__New4_fn(fa_male** __retval)
{
    *__retval = fa_male::New4();
}

// public fa_male() [instance] :8
void fa_male::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_male::InitializeUX1()
{
    uStackFrame __("fa_male", "InitializeUX()");
    Value(::STRINGS[0/*"\uF183"*/]);
    SourceLineNumber(393);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_male New() [static] :8
fa_male* fa_male::New4()
{
    fa_male* obj1 = (fa_male*)uNew(fa_male_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
