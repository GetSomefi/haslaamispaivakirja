// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hashtag.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hashtag.h>
...
// public partial sealed class fa_hashtag :2
// {
// static fa_hashtag() :4
static void fa_hashtag__cctor_4_fn(uType* __type)
{
}

static void fa_hashtag_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hashtag__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hashtag_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hashtag);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hashtag", options);
    type->fp_build_ = fa_hashtag_build;
    type->fp_ctor_ = (void*)fa_hashtag__New4_fn;
    type->fp_cctor_ = fa_hashtag__cctor_4_fn;
...
// public fa_hashtag() :8
void fa_hashtag__ctor_8_fn(fa_hashtag* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hashtag__InitializeUX1_fn(fa_hashtag* __this)
{
    __this->InitializeUX1();
}

// public fa_hashtag New() :8
void fa_hashtag__New4_fn(fa_hashtag** __retval)
{
    *__retval = fa_hashtag::New4();
}

// public fa_hashtag() [instance] :8
void fa_hashtag::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hashtag::InitializeUX1()
{
    uStackFrame __("fa_hashtag", "InitializeUX()");
    Value(::STRINGS[0/*"\uF292"*/]);
    SourceLineNumber(316);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hashtag New() [static] :8
fa_hashtag* fa_hashtag::New4()
{
    fa_hashtag* obj1 = (fa_hashtag*)uNew(fa_hashtag_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
