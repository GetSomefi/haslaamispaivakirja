// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cab.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cab.h>
...
// public partial sealed class fa_cab :2
// {
// static fa_cab() :4
static void fa_cab__cctor_4_fn(uType* __type)
{
}

static void fa_cab_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cab__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cab_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cab);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cab", options);
    type->fp_build_ = fa_cab_build;
    type->fp_ctor_ = (void*)fa_cab__New4_fn;
    type->fp_cctor_ = fa_cab__cctor_4_fn;
...
// public fa_cab() :8
void fa_cab__ctor_8_fn(fa_cab* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cab__InitializeUX1_fn(fa_cab* __this)
{
    __this->InitializeUX1();
}

// public fa_cab New() :8
void fa_cab__New4_fn(fa_cab** __retval)
{
    *__retval = fa_cab::New4();
}

// public fa_cab() [instance] :8
void fa_cab::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cab::InitializeUX1()
{
    uStackFrame __("fa_cab", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BA"*/]);
    SourceLineNumber(94);
...
// public fa_cab New() [static] :8
fa_cab* fa_cab::New4()
{
    fa_cab* obj1 = (fa_cab*)uNew(fa_cab_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
