// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_shopping_cart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_shopping_cart.h>
...
// public partial sealed class fa_shopping_cart :2
// {
// static fa_shopping_cart() :4
static void fa_shopping_cart__cctor_4_fn(uType* __type)
{
}

static void fa_shopping_cart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_shopping_cart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_shopping_cart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_shopping_cart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_shopping_cart", options);
    type->fp_build_ = fa_shopping_cart_build;
    type->fp_ctor_ = (void*)fa_shopping_cart__New4_fn;
    type->fp_cctor_ = fa_shopping_cart__cctor_4_fn;
...
// public fa_shopping_cart() :8
void fa_shopping_cart__ctor_8_fn(fa_shopping_cart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_shopping_cart__InitializeUX1_fn(fa_shopping_cart* __this)
{
    __this->InitializeUX1();
}

// public fa_shopping_cart New() :8
void fa_shopping_cart__New4_fn(fa_shopping_cart** __retval)
{
    *__retval = fa_shopping_cart::New4();
}

// public fa_shopping_cart() [instance] :8
void fa_shopping_cart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_shopping_cart::InitializeUX1()
{
    uStackFrame __("fa_shopping_cart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF07A"*/]);
    SourceLineNumber(533);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_shopping_cart New() [static] :8
fa_shopping_cart* fa_shopping_cart::New4()
{
    fa_shopping_cart* obj1 = (fa_shopping_cart*)uNew(fa_shopping_cart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
