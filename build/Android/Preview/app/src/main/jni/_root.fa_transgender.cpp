// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_transgender.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_transgender.h>
...
// public partial sealed class fa_transgender :2
// {
// static fa_transgender() :4
static void fa_transgender__cctor_4_fn(uType* __type)
{
}

static void fa_transgender_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_transgender__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_transgender_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_transgender);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_transgender", options);
    type->fp_build_ = fa_transgender_build;
    type->fp_ctor_ = (void*)fa_transgender__New4_fn;
    type->fp_cctor_ = fa_transgender__cctor_4_fn;
...
// public fa_transgender() :8
void fa_transgender__ctor_8_fn(fa_transgender* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_transgender__InitializeUX1_fn(fa_transgender* __this)
{
    __this->InitializeUX1();
}

// public fa_transgender New() :8
void fa_transgender__New4_fn(fa_transgender** __retval)
{
    *__retval = fa_transgender::New4();
}

// public fa_transgender() [instance] :8
void fa_transgender::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_transgender::InitializeUX1()
{
    uStackFrame __("fa_transgender", "InitializeUX()");
    Value(::STRINGS[0/*"\uF224"*/]);
    SourceLineNumber(625);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_transgender New() [static] :8
fa_transgender* fa_transgender::New4()
{
    fa_transgender* obj1 = (fa_transgender*)uNew(fa_transgender_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
