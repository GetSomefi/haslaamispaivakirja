// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mobile.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mobile.h>
...
// public partial sealed class fa_mobile :2
// {
// static fa_mobile() :4
static void fa_mobile__cctor_4_fn(uType* __type)
{
}

static void fa_mobile_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mobile__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mobile_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mobile);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mobile", options);
    type->fp_build_ = fa_mobile_build;
    type->fp_ctor_ = (void*)fa_mobile__New4_fn;
    type->fp_cctor_ = fa_mobile__cctor_4_fn;
...
// public fa_mobile() :8
void fa_mobile__ctor_8_fn(fa_mobile* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mobile__InitializeUX1_fn(fa_mobile* __this)
{
    __this->InitializeUX1();
}

// public fa_mobile New() :8
void fa_mobile__New4_fn(fa_mobile** __retval)
{
    *__retval = fa_mobile::New4();
}

// public fa_mobile() [instance] :8
void fa_mobile::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mobile::InitializeUX1()
{
    uStackFrame __("fa_mobile", "InitializeUX()");
    Value(::STRINGS[0/*"\uF10B"*/]);
    SourceLineNumber(417);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mobile New() [static] :8
fa_mobile* fa_mobile::New4()
{
    fa_mobile* obj1 = (fa_mobile*)uNew(fa_mobile_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
