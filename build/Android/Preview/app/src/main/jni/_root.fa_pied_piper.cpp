// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pied_piper.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pied_piper.h>
...
// public partial sealed class fa_pied_piper :2
// {
// static fa_pied_piper() :4
static void fa_pied_piper__cctor_4_fn(uType* __type)
{
}

static void fa_pied_piper_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pied_piper__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pied_piper_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pied_piper);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pied_piper", options);
    type->fp_build_ = fa_pied_piper_build;
    type->fp_ctor_ = (void*)fa_pied_piper__New4_fn;
    type->fp_cctor_ = fa_pied_piper__cctor_4_fn;
...
// public fa_pied_piper() :8
void fa_pied_piper__ctor_8_fn(fa_pied_piper* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pied_piper__InitializeUX1_fn(fa_pied_piper* __this)
{
    __this->InitializeUX1();
}

// public fa_pied_piper New() :8
void fa_pied_piper__New4_fn(fa_pied_piper** __retval)
{
    *__retval = fa_pied_piper::New4();
}

// public fa_pied_piper() [instance] :8
void fa_pied_piper::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pied_piper::InitializeUX1()
{
    uStackFrame __("fa_pied_piper", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A7"*/]);
    SourceLineNumber(459);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pied_piper New() [static] :8
fa_pied_piper* fa_pied_piper::New4()
{
    fa_pied_piper* obj1 = (fa_pied_piper*)uNew(fa_pied_piper_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
