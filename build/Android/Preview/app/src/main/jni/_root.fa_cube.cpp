// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cube.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cube.h>
...
// public partial sealed class fa_cube :2
// {
// static fa_cube() :4
static void fa_cube__cctor_4_fn(uType* __type)
{
}

static void fa_cube_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cube__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cube_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cube);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cube", options);
    type->fp_build_ = fa_cube_build;
    type->fp_ctor_ = (void*)fa_cube__New4_fn;
    type->fp_cctor_ = fa_cube__cctor_4_fn;
...
// public fa_cube() :8
void fa_cube__ctor_8_fn(fa_cube* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cube__InitializeUX1_fn(fa_cube* __this)
{
    __this->InitializeUX1();
}

// public fa_cube New() :8
void fa_cube__New4_fn(fa_cube** __retval)
{
    *__retval = fa_cube::New4();
}

// public fa_cube() [instance] :8
void fa_cube::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cube::InitializeUX1()
{
    uStackFrame __("fa_cube", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B2"*/]);
    SourceLineNumber(180);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cube New() [static] :8
fa_cube* fa_cube::New4()
{
    fa_cube* obj1 = (fa_cube*)uNew(fa_cube_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
