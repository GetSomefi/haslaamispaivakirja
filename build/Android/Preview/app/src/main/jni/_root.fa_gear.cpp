// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gear.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gear.h>
...
// public partial sealed class fa_gear :2
// {
// static fa_gear() :4
static void fa_gear__cctor_4_fn(uType* __type)
{
}

static void fa_gear_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gear__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gear_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gear);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gear", options);
    type->fp_build_ = fa_gear_build;
    type->fp_ctor_ = (void*)fa_gear__New4_fn;
    type->fp_cctor_ = fa_gear__cctor_4_fn;
...
// public fa_gear() :8
void fa_gear__ctor_8_fn(fa_gear* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gear__InitializeUX1_fn(fa_gear* __this)
{
    __this->InitializeUX1();
}

// public fa_gear New() :8
void fa_gear__New4_fn(fa_gear** __retval)
{
    *__retval = fa_gear::New4();
}

// public fa_gear() [instance] :8
void fa_gear::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_gear::InitializeUX1()
{
    uStackFrame __("fa_gear", "InitializeUX()");
    Value(::STRINGS[0/*"\uF013"*/]);
    SourceLineNumber(279);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gear New() [static] :8
fa_gear* fa_gear::New4()
{
    fa_gear* obj1 = (fa_gear*)uNew(fa_gear_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
