// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_lastfm.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_lastfm.h>
...
// public partial sealed class fa_lastfm :2
// {
// static fa_lastfm() :4
static void fa_lastfm__cctor_4_fn(uType* __type)
{
}

static void fa_lastfm_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_lastfm__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_lastfm_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_lastfm);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_lastfm", options);
    type->fp_build_ = fa_lastfm_build;
    type->fp_ctor_ = (void*)fa_lastfm__New4_fn;
    type->fp_cctor_ = fa_lastfm__cctor_4_fn;
...
// public fa_lastfm() :8
void fa_lastfm__ctor_8_fn(fa_lastfm* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_lastfm__InitializeUX1_fn(fa_lastfm* __this)
{
    __this->InitializeUX1();
}

// public fa_lastfm New() :8
void fa_lastfm__New4_fn(fa_lastfm** __retval)
{
    *__retval = fa_lastfm::New4();
}

// public fa_lastfm() [instance] :8
void fa_lastfm::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_lastfm::InitializeUX1()
{
    uStackFrame __("fa_lastfm", "InitializeUX()");
    Value(::STRINGS[0/*"\uF202"*/]);
    SourceLineNumber(360);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_lastfm New() [static] :8
fa_lastfm* fa_lastfm::New4()
{
    fa_lastfm* obj1 = (fa_lastfm*)uNew(fa_lastfm_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
