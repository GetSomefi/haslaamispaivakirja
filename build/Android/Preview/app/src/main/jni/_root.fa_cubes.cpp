// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cubes.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cubes.h>
...
// public partial sealed class fa_cubes :2
// {
// static fa_cubes() :4
static void fa_cubes__cctor_4_fn(uType* __type)
{
}

static void fa_cubes_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cubes__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cubes_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cubes);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cubes", options);
    type->fp_build_ = fa_cubes_build;
    type->fp_ctor_ = (void*)fa_cubes__New4_fn;
    type->fp_cctor_ = fa_cubes__cctor_4_fn;
...
// public fa_cubes() :8
void fa_cubes__ctor_8_fn(fa_cubes* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cubes__InitializeUX1_fn(fa_cubes* __this)
{
    __this->InitializeUX1();
}

// public fa_cubes New() :8
void fa_cubes__New4_fn(fa_cubes** __retval)
{
    *__retval = fa_cubes::New4();
}

// public fa_cubes() [instance] :8
void fa_cubes::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cubes::InitializeUX1()
{
    uStackFrame __("fa_cubes", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B3"*/]);
    SourceLineNumber(181);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cubes New() [static] :8
fa_cubes* fa_cubes::New4()
{
    fa_cubes* obj1 = (fa_cubes*)uNew(fa_cubes_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
