// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_glass.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_glass.h>
...
// public partial sealed class fa_glass :2
// {
// static fa_glass() :4
static void fa_glass__cctor_4_fn(uType* __type)
{
}

static void fa_glass_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_glass__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_glass_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_glass);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_glass", options);
    type->fp_build_ = fa_glass_build;
    type->fp_ctor_ = (void*)fa_glass__New4_fn;
    type->fp_cctor_ = fa_glass__cctor_4_fn;
...
// public fa_glass() :8
void fa_glass__ctor_8_fn(fa_glass* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_glass__InitializeUX1_fn(fa_glass* __this)
{
    __this->InitializeUX1();
}

// public fa_glass New() :8
void fa_glass__New4_fn(fa_glass** __retval)
{
    *__retval = fa_glass::New4();
}

// public fa_glass() [instance] :8
void fa_glass::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_glass::InitializeUX1()
{
    uStackFrame __("fa_glass", "InitializeUX()");
    Value(::STRINGS[0/*"\uF000"*/]);
...
// public fa_glass New() [static] :8
fa_glass* fa_glass::New4()
{
    fa_glass* obj1 = (fa_glass*)uNew(fa_glass_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
