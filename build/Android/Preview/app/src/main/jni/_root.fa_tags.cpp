// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tags.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tags.h>
...
// public partial sealed class fa_tags :2
// {
// static fa_tags() :4
static void fa_tags__cctor_4_fn(uType* __type)
{
}

static void fa_tags_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tags__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tags_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tags);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tags", options);
    type->fp_build_ = fa_tags_build;
    type->fp_ctor_ = (void*)fa_tags__New4_fn;
    type->fp_cctor_ = fa_tags__cctor_4_fn;
...
// public fa_tags() :8
void fa_tags__ctor_8_fn(fa_tags* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tags__InitializeUX1_fn(fa_tags* __this)
{
    __this->InitializeUX1();
}

// public fa_tags New() :8
void fa_tags__New4_fn(fa_tags** __retval)
{
    *__retval = fa_tags::New4();
}

// public fa_tags() [instance] :8
void fa_tags::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tags::InitializeUX1()
{
    uStackFrame __("fa_tags", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02C"*/]);
...
// public fa_tags New() [static] :8
fa_tags* fa_tags::New4()
{
    fa_tags* obj1 = (fa_tags*)uNew(fa_tags_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
