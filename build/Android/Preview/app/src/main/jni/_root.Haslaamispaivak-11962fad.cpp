...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggleBig_PrimaryColor", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_accessor_BasicSwipeToggleBig_PrimaryColor", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
