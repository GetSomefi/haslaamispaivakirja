// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_venus.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_venus.h>
...
// public partial sealed class fa_venus :2
// {
// static fa_venus() :4
static void fa_venus__cctor_4_fn(uType* __type)
{
}

static void fa_venus_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\241");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_venus__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_venus_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_venus);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_venus", options);
    type->fp_build_ = fa_venus_build;
    type->fp_ctor_ = (void*)fa_venus__New4_fn;
    type->fp_cctor_ = fa_venus__cctor_4_fn;
...
// public fa_venus() :8
void fa_venus__ctor_8_fn(fa_venus* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_venus__InitializeUX1_fn(fa_venus* __this)
{
    __this->InitializeUX1();
}

// public fa_venus New() :8
void fa_venus__New4_fn(fa_venus** __retval)
{
    *__retval = fa_venus::New4();
}

// public fa_venus() [instance] :8
void fa_venus::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_venus::InitializeUX1()
{
    uStackFrame __("fa_venus", "InitializeUX()");
    Value(::STRINGS[0/*"\uF221"*/]);
    SourceLineNumber(660);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_venus New() [static] :8
fa_venus* fa_venus::New4()
{
    fa_venus* obj1 = (fa_venus*)uNew(fa_venus_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
