// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_question.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_question.h>
...
// public partial sealed class fa_question :2
// {
// static fa_question() :4
static void fa_question__cctor_4_fn(uType* __type)
{
}

static void fa_question_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_question__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_question_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_question);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_question", options);
    type->fp_build_ = fa_question_build;
    type->fp_ctor_ = (void*)fa_question__New4_fn;
    type->fp_cctor_ = fa_question__cctor_4_fn;
...
// public fa_question() :8
void fa_question__ctor_8_fn(fa_question* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_question__InitializeUX1_fn(fa_question* __this)
{
    __this->InitializeUX1();
}

// public fa_question New() :8
void fa_question__New4_fn(fa_question** __retval)
{
    *__retval = fa_question::New4();
}

// public fa_question() [instance] :8
void fa_question::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_question::InitializeUX1()
{
    uStackFrame __("fa_question", "InitializeUX()");
    Value(::STRINGS[0/*"\uF128"*/]);
    SourceLineNumber(479);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_question New() [static] :8
fa_question* fa_question::New4()
{
    fa_question* obj1 = (fa_question*)uNew(fa_question_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
