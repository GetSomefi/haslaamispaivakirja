// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_coffee.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_coffee.h>
...
// public partial sealed class fa_coffee :2
// {
// static fa_coffee() :4
static void fa_coffee__cctor_4_fn(uType* __type)
{
}

static void fa_coffee_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\264");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_coffee__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_coffee_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_coffee);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_coffee", options);
    type->fp_build_ = fa_coffee_build;
    type->fp_ctor_ = (void*)fa_coffee__New4_fn;
    type->fp_cctor_ = fa_coffee__cctor_4_fn;
...
// public fa_coffee() :8
void fa_coffee__ctor_8_fn(fa_coffee* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_coffee__InitializeUX1_fn(fa_coffee* __this)
{
    __this->InitializeUX1();
}

// public fa_coffee New() :8
void fa_coffee__New4_fn(fa_coffee** __retval)
{
    *__retval = fa_coffee::New4();
}

// public fa_coffee() [instance] :8
void fa_coffee::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_coffee::InitializeUX1()
{
    uStackFrame __("fa_coffee", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F4"*/]);
    SourceLineNumber(158);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_coffee New() [static] :8
fa_coffee* fa_coffee::New4()
{
    fa_coffee* obj1 = (fa_coffee*)uNew(fa_coffee_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
