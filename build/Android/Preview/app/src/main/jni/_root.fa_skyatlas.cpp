// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_skyatlas.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_skyatlas.h>
...
// public partial sealed class fa_skyatlas :2
// {
// static fa_skyatlas() :4
static void fa_skyatlas__cctor_4_fn(uType* __type)
{
}

static void fa_skyatlas_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\226");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_skyatlas__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_skyatlas_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_skyatlas);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_skyatlas", options);
    type->fp_build_ = fa_skyatlas_build;
    type->fp_ctor_ = (void*)fa_skyatlas__New4_fn;
    type->fp_cctor_ = fa_skyatlas__cctor_4_fn;
...
// public fa_skyatlas() :8
void fa_skyatlas__ctor_8_fn(fa_skyatlas* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_skyatlas__InitializeUX1_fn(fa_skyatlas* __this)
{
    __this->InitializeUX1();
}

// public fa_skyatlas New() :8
void fa_skyatlas__New4_fn(fa_skyatlas** __retval)
{
    *__retval = fa_skyatlas::New4();
}

// public fa_skyatlas() [instance] :8
void fa_skyatlas::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_skyatlas::InitializeUX1()
{
    uStackFrame __("fa_skyatlas", "InitializeUX()");
    Value(::STRINGS[0/*"\uF216"*/]);
    SourceLineNumber(539);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_skyatlas New() [static] :8
fa_skyatlas* fa_skyatlas::New4()
{
    fa_skyatlas* obj1 = (fa_skyatlas*)uNew(fa_skyatlas_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
