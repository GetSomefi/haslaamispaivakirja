// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_twitter.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_twitter.h>
...
// public partial sealed class fa_twitter :2
// {
// static fa_twitter() :4
static void fa_twitter__cctor_4_fn(uType* __type)
{
}

static void fa_twitter_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\231");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_twitter__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_twitter_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_twitter);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_twitter", options);
    type->fp_build_ = fa_twitter_build;
    type->fp_ctor_ = (void*)fa_twitter__New4_fn;
    type->fp_cctor_ = fa_twitter__cctor_4_fn;
...
// public fa_twitter() :8
void fa_twitter__ctor_8_fn(fa_twitter* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_twitter__InitializeUX1_fn(fa_twitter* __this)
{
    __this->InitializeUX1();
}

// public fa_twitter New() :8
void fa_twitter__New4_fn(fa_twitter** __retval)
{
    *__retval = fa_twitter::New4();
}

// public fa_twitter() [instance] :8
void fa_twitter::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_twitter::InitializeUX1()
{
    uStackFrame __("fa_twitter", "InitializeUX()");
    Value(::STRINGS[0/*"\uF099"*/]);
...
// public fa_twitter New() [static] :8
fa_twitter* fa_twitter::New4()
{
    fa_twitter* obj1 = (fa_twitter*)uNew(fa_twitter_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
