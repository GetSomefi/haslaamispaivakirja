// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paw.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paw.h>
...
// public partial sealed class fa_paw :2
// {
// static fa_paw() :4
static void fa_paw__cctor_4_fn(uType* __type)
{
}

static void fa_paw_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paw__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paw_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paw);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paw", options);
    type->fp_build_ = fa_paw_build;
    type->fp_ctor_ = (void*)fa_paw__New4_fn;
    type->fp_cctor_ = fa_paw__cctor_4_fn;
...
// public fa_paw() :8
void fa_paw__ctor_8_fn(fa_paw* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paw__InitializeUX1_fn(fa_paw* __this)
{
    __this->InitializeUX1();
}

// public fa_paw New() :8
void fa_paw__New4_fn(fa_paw** __retval)
{
    *__retval = fa_paw::New4();
}

// public fa_paw() [instance] :8
void fa_paw::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_paw::InitializeUX1()
{
    uStackFrame __("fa_paw", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B0"*/]);
    SourceLineNumber(448);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paw New() [static] :8
fa_paw* fa_paw::New4()
{
    fa_paw* obj1 = (fa_paw*)uNew(fa_paw_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
