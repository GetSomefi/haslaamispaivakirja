// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_text_width.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_text_width.h>
...
// public partial sealed class fa_text_width :2
// {
// static fa_text_width() :4
static void fa_text_width__cctor_4_fn(uType* __type)
{
}

static void fa_text_width_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_text_width__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_text_width_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_text_width);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_text_width", options);
    type->fp_build_ = fa_text_width_build;
    type->fp_ctor_ = (void*)fa_text_width__New4_fn;
    type->fp_cctor_ = fa_text_width__cctor_4_fn;
...
// public fa_text_width() :8
void fa_text_width__ctor_8_fn(fa_text_width* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_text_width__InitializeUX1_fn(fa_text_width* __this)
{
    __this->InitializeUX1();
}

// public fa_text_width New() :8
void fa_text_width__New4_fn(fa_text_width** __retval)
{
    *__retval = fa_text_width::New4();
}

// public fa_text_width() [instance] :8
void fa_text_width::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_text_width::InitializeUX1()
{
    uStackFrame __("fa_text_width", "InitializeUX()");
    Value(::STRINGS[0/*"\uF035"*/]);
...
// public fa_text_width New() [static] :8
fa_text_width* fa_text_width::New4()
{
    fa_text_width* obj1 = (fa_text_width*)uNew(fa_text_width_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
