// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_reply_all.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_reply_all.h>
...
// public partial sealed class fa_reply_all :2
// {
// static fa_reply_all() :4
static void fa_reply_all__cctor_4_fn(uType* __type)
{
}

static void fa_reply_all_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_reply_all__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_reply_all_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_reply_all);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_reply_all", options);
    type->fp_build_ = fa_reply_all_build;
    type->fp_ctor_ = (void*)fa_reply_all__New4_fn;
    type->fp_cctor_ = fa_reply_all__cctor_4_fn;
...
// public fa_reply_all() :8
void fa_reply_all__ctor_8_fn(fa_reply_all* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_reply_all__InitializeUX1_fn(fa_reply_all* __this)
{
    __this->InitializeUX1();
}

// public fa_reply_all New() :8
void fa_reply_all__New4_fn(fa_reply_all** __retval)
{
    *__retval = fa_reply_all::New4();
}

// public fa_reply_all() [instance] :8
void fa_reply_all::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_reply_all::InitializeUX1()
{
    uStackFrame __("fa_reply_all", "InitializeUX()");
    Value(::STRINGS[0/*"\uF122"*/]);
    SourceLineNumber(497);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_reply_all New() [static] :8
fa_reply_all* fa_reply_all::New4()
{
    fa_reply_all* obj1 = (fa_reply_all*)uNew(fa_reply_all_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
