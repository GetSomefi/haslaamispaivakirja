// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_retweet.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_retweet.h>
...
// public partial sealed class fa_retweet :2
// {
// static fa_retweet() :4
static void fa_retweet__cctor_4_fn(uType* __type)
{
}

static void fa_retweet_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_retweet__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_retweet_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_retweet);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_retweet", options);
    type->fp_build_ = fa_retweet_build;
    type->fp_ctor_ = (void*)fa_retweet__New4_fn;
    type->fp_cctor_ = fa_retweet__cctor_4_fn;
...
// public fa_retweet() :8
void fa_retweet__ctor_8_fn(fa_retweet* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_retweet__InitializeUX1_fn(fa_retweet* __this)
{
    __this->InitializeUX1();
}

// public fa_retweet New() :8
void fa_retweet__New4_fn(fa_retweet** __retval)
{
    *__retval = fa_retweet::New4();
}

// public fa_retweet() [instance] :8
void fa_retweet::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_retweet::InitializeUX1()
{
    uStackFrame __("fa_retweet", "InitializeUX()");
    Value(::STRINGS[0/*"\uF079"*/]);
    SourceLineNumber(498);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_retweet New() [static] :8
fa_retweet* fa_retweet::New4()
{
    fa_retweet* obj1 = (fa_retweet*)uNew(fa_retweet_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
