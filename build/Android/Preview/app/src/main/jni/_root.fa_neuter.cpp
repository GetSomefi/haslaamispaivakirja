// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_neuter.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_neuter.h>
...
// public partial sealed class fa_neuter :2
// {
// static fa_neuter() :4
static void fa_neuter__cctor_4_fn(uType* __type)
{
}

static void fa_neuter_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_neuter__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_neuter_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_neuter);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_neuter", options);
    type->fp_build_ = fa_neuter_build;
    type->fp_ctor_ = (void*)fa_neuter__New4_fn;
    type->fp_cctor_ = fa_neuter__cctor_4_fn;
...
// public fa_neuter() :8
void fa_neuter__ctor_8_fn(fa_neuter* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_neuter__InitializeUX1_fn(fa_neuter* __this)
{
    __this->InitializeUX1();
}

// public fa_neuter New() :8
void fa_neuter__New4_fn(fa_neuter** __retval)
{
    *__retval = fa_neuter::New4();
}

// public fa_neuter() [instance] :8
void fa_neuter::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_neuter::InitializeUX1()
{
    uStackFrame __("fa_neuter", "InitializeUX()");
    Value(::STRINGS[0/*"\uF22C"*/]);
    SourceLineNumber(427);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_neuter New() [static] :8
fa_neuter* fa_neuter::New4()
{
    fa_neuter* obj1 = (fa_neuter*)uNew(fa_neuter_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
