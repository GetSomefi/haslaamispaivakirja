// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_visa.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_visa.h>
...
// public partial sealed class fa_cc_visa :2
// {
// static fa_cc_visa() :4
static void fa_cc_visa__cctor_4_fn(uType* __type)
{
}

static void fa_cc_visa_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_visa__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_visa_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_visa);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_visa", options);
    type->fp_build_ = fa_cc_visa_build;
    type->fp_ctor_ = (void*)fa_cc_visa__New4_fn;
    type->fp_cctor_ = fa_cc_visa__cctor_4_fn;
...
// public fa_cc_visa() :8
void fa_cc_visa__ctor_8_fn(fa_cc_visa* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_visa__InitializeUX1_fn(fa_cc_visa* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_visa New() :8
void fa_cc_visa__New4_fn(fa_cc_visa** __retval)
{
    *__retval = fa_cc_visa::New4();
}

// public fa_cc_visa() [instance] :8
void fa_cc_visa::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_visa::InitializeUX1()
{
    uStackFrame __("fa_cc_visa", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F0"*/]);
...
// public fa_cc_visa New() [static] :8
fa_cc_visa* fa_cc_visa::New4()
{
    fa_cc_visa* obj1 = (fa_cc_visa*)uNew(fa_cc_visa_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
