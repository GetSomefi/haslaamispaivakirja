// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_archive.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_archive.h>
...
// public partial sealed class fa_archive :2
// {
// static fa_archive() :4
static void fa_archive__cctor_4_fn(uType* __type)
{
}

static void fa_archive_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_archive__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_archive_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_archive);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_archive", options);
    type->fp_build_ = fa_archive_build;
    type->fp_ctor_ = (void*)fa_archive__New4_fn;
    type->fp_cctor_ = fa_archive__cctor_4_fn;
...
// public fa_archive() :8
void fa_archive__ctor_8_fn(fa_archive* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_archive__InitializeUX1_fn(fa_archive* __this)
{
    __this->InitializeUX1();
}

// public fa_archive New() :8
void fa_archive__New4_fn(fa_archive** __retval)
{
    *__retval = fa_archive::New4();
}

// public fa_archive() [instance] :8
void fa_archive::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_archive::InitializeUX1()
{
    uStackFrame __("fa_archive", "InitializeUX()");
    Value(::STRINGS[0/*"\uF187"*/]);
    SourceLineNumber(23);
...
// public fa_archive New() [static] :8
fa_archive* fa_archive::New4()
{
    fa_archive* obj1 = (fa_archive*)uNew(fa_archive_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
