// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paste.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paste.h>
...
// public partial sealed class fa_paste :2
// {
// static fa_paste() :4
static void fa_paste__cctor_4_fn(uType* __type)
{
}

static void fa_paste_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paste__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paste_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paste);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paste", options);
    type->fp_build_ = fa_paste_build;
    type->fp_ctor_ = (void*)fa_paste__New4_fn;
    type->fp_cctor_ = fa_paste__cctor_4_fn;
...
// public fa_paste() :8
void fa_paste__ctor_8_fn(fa_paste* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paste__InitializeUX1_fn(fa_paste* __this)
{
    __this->InitializeUX1();
}

// public fa_paste New() :8
void fa_paste__New4_fn(fa_paste** __retval)
{
    *__retval = fa_paste::New4();
}

// public fa_paste() [instance] :8
void fa_paste::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paste::InitializeUX1()
{
    uStackFrame __("fa_paste", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0EA"*/]);
    SourceLineNumber(444);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paste New() [static] :8
fa_paste* fa_paste::New4()
{
    fa_paste* obj1 = (fa_paste*)uNew(fa_paste_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
