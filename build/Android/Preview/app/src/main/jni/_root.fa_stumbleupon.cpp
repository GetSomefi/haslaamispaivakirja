// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_stumbleupon.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_stumbleupon.h>
...
// public partial sealed class fa_stumbleupon :2
// {
// static fa_stumbleupon() :4
static void fa_stumbleupon__cctor_4_fn(uType* __type)
{
}

static void fa_stumbleupon_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\244");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_stumbleupon__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_stumbleupon_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_stumbleupon);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_stumbleupon", options);
    type->fp_build_ = fa_stumbleupon_build;
    type->fp_ctor_ = (void*)fa_stumbleupon__New4_fn;
    type->fp_cctor_ = fa_stumbleupon__cctor_4_fn;
...
// public fa_stumbleupon() :8
void fa_stumbleupon__ctor_8_fn(fa_stumbleupon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_stumbleupon__InitializeUX1_fn(fa_stumbleupon* __this)
{
    __this->InitializeUX1();
}

// public fa_stumbleupon New() :8
void fa_stumbleupon__New4_fn(fa_stumbleupon** __retval)
{
    *__retval = fa_stumbleupon::New4();
}

// public fa_stumbleupon() [instance] :8
void fa_stumbleupon::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_stumbleupon::InitializeUX1()
{
    uStackFrame __("fa_stumbleupon", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1A4"*/]);
    SourceLineNumber(584);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_stumbleupon New() [static] :8
fa_stumbleupon* fa_stumbleupon::New4()
{
    fa_stumbleupon* obj1 = (fa_stumbleupon*)uNew(fa_stumbleupon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
