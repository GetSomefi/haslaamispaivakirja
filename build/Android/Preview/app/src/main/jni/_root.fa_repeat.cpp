// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_repeat.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_repeat.h>
...
// public partial sealed class fa_repeat :2
// {
// static fa_repeat() :4
static void fa_repeat__cctor_4_fn(uType* __type)
{
}

static void fa_repeat_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_repeat__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_repeat_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_repeat);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_repeat", options);
    type->fp_build_ = fa_repeat_build;
    type->fp_ctor_ = (void*)fa_repeat__New4_fn;
    type->fp_cctor_ = fa_repeat__cctor_4_fn;
...
// public fa_repeat() :8
void fa_repeat__ctor_8_fn(fa_repeat* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_repeat__InitializeUX1_fn(fa_repeat* __this)
{
    __this->InitializeUX1();
}

// public fa_repeat New() :8
void fa_repeat__New4_fn(fa_repeat** __retval)
{
    *__retval = fa_repeat::New4();
}

// public fa_repeat() [instance] :8
void fa_repeat::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_repeat::InitializeUX1()
{
    uStackFrame __("fa_repeat", "InitializeUX()");
    Value(::STRINGS[0/*"\uF01E"*/]);
    SourceLineNumber(495);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_repeat New() [static] :8
fa_repeat* fa_repeat::New4()
{
    fa_repeat* obj1 = (fa_repeat*)uNew(fa_repeat_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
