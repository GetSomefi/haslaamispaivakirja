// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_level_down.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_level_down.h>
...
// public partial sealed class fa_level_down :2
// {
// static fa_level_down() :4
static void fa_level_down__cctor_4_fn(uType* __type)
{
}

static void fa_level_down_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_level_down__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_level_down_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_level_down);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_level_down", options);
    type->fp_build_ = fa_level_down_build;
    type->fp_ctor_ = (void*)fa_level_down__New4_fn;
    type->fp_cctor_ = fa_level_down__cctor_4_fn;
...
// public fa_level_down() :8
void fa_level_down__ctor_8_fn(fa_level_down* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_level_down__InitializeUX1_fn(fa_level_down* __this)
{
    __this->InitializeUX1();
}

// public fa_level_down New() :8
void fa_level_down__New4_fn(fa_level_down** __retval)
{
    *__retval = fa_level_down::New4();
}

// public fa_level_down() [instance] :8
void fa_level_down::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_level_down::InitializeUX1()
{
    uStackFrame __("fa_level_down", "InitializeUX()");
    Value(::STRINGS[0/*"\uF149"*/]);
    SourceLineNumber(366);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_level_down New() [static] :8
fa_level_down* fa_level_down::New4()
{
    fa_level_down* obj1 = (fa_level_down*)uNew(fa_level_down_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
