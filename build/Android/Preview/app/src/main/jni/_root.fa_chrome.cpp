// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_chrome.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_chrome.h>
...
// public partial sealed class fa_chrome :2
// {
// static fa_chrome() :4
static void fa_chrome__cctor_4_fn(uType* __type)
{
}

static void fa_chrome_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_chrome__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_chrome_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_chrome);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_chrome", options);
    type->fp_build_ = fa_chrome_build;
    type->fp_ctor_ = (void*)fa_chrome__New4_fn;
    type->fp_cctor_ = fa_chrome__cctor_4_fn;
...
// public fa_chrome() :8
void fa_chrome__ctor_8_fn(fa_chrome* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_chrome__InitializeUX1_fn(fa_chrome* __this)
{
    __this->InitializeUX1();
}

// public fa_chrome New() :8
void fa_chrome__New4_fn(fa_chrome** __retval)
{
    *__retval = fa_chrome::New4();
}

// public fa_chrome() [instance] :8
void fa_chrome::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_chrome::InitializeUX1()
{
    uStackFrame __("fa_chrome", "InitializeUX()");
    Value(::STRINGS[0/*"\uF268"*/]);
    SourceLineNumber(141);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_chrome New() [static] :8
fa_chrome* fa_chrome::New4()
{
    fa_chrome* obj1 = (fa_chrome*)uNew(fa_chrome_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
