// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_trash.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_trash.h>
...
// public partial sealed class fa_trash :2
// {
// static fa_trash() :4
static void fa_trash__cctor_4_fn(uType* __type)
{
}

static void fa_trash_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\270");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_trash__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_trash_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_trash);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_trash", options);
    type->fp_build_ = fa_trash_build;
    type->fp_ctor_ = (void*)fa_trash__New4_fn;
    type->fp_cctor_ = fa_trash__cctor_4_fn;
...
// public fa_trash() :8
void fa_trash__ctor_8_fn(fa_trash* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_trash__InitializeUX1_fn(fa_trash* __this)
{
    __this->InitializeUX1();
}

// public fa_trash New() :8
void fa_trash__New4_fn(fa_trash** __retval)
{
    *__retval = fa_trash::New4();
}

// public fa_trash() [instance] :8
void fa_trash::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_trash::InitializeUX1()
{
    uStackFrame __("fa_trash", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F8"*/]);
    SourceLineNumber(627);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_trash New() [static] :8
fa_trash* fa_trash::New4()
{
    fa_trash* obj1 = (fa_trash*)uNew(fa_trash_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
