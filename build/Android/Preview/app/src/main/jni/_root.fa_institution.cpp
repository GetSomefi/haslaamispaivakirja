// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_institution.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_institution.h>
...
// public partial sealed class fa_institution :2
// {
// static fa_institution() :4
static void fa_institution__cctor_4_fn(uType* __type)
{
}

static void fa_institution_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_institution__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_institution_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_institution);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_institution", options);
    type->fp_build_ = fa_institution_build;
    type->fp_ctor_ = (void*)fa_institution__New4_fn;
    type->fp_cctor_ = fa_institution__cctor_4_fn;
...
// public fa_institution() :8
void fa_institution__ctor_8_fn(fa_institution* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_institution__InitializeUX1_fn(fa_institution* __this)
{
    __this->InitializeUX1();
}

// public fa_institution New() :8
void fa_institution__New4_fn(fa_institution** __retval)
{
    *__retval = fa_institution::New4();
}

// public fa_institution() [instance] :8
void fa_institution::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_institution::InitializeUX1()
{
    uStackFrame __("fa_institution", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19C"*/]);
    SourceLineNumber(347);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_institution New() [static] :8
fa_institution* fa_institution::New4()
{
    fa_institution* obj1 = (fa_institution*)uNew(fa_institution_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
