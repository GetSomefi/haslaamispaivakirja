// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_indent.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_indent.h>
...
// public partial sealed class fa_indent :2
// {
// static fa_indent() :4
static void fa_indent__cctor_4_fn(uType* __type)
{
}

static void fa_indent_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_indent__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_indent_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_indent);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_indent", options);
    type->fp_build_ = fa_indent_build;
    type->fp_ctor_ = (void*)fa_indent__New4_fn;
    type->fp_cctor_ = fa_indent__cctor_4_fn;
...
// public fa_indent() :8
void fa_indent__ctor_8_fn(fa_indent* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_indent__InitializeUX1_fn(fa_indent* __this)
{
    __this->InitializeUX1();
}

// public fa_indent New() :8
void fa_indent__New4_fn(fa_indent** __retval)
{
    *__retval = fa_indent::New4();
}

// public fa_indent() [instance] :8
void fa_indent::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_indent::InitializeUX1()
{
    uStackFrame __("fa_indent", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03C"*/]);
    SourceLineNumber(341);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_indent New() [static] :8
fa_indent* fa_indent::New4()
{
    fa_indent* obj1 = (fa_indent*)uNew(fa_indent_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
