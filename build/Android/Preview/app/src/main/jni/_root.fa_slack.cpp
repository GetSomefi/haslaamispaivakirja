// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_slack.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_slack.h>
...
// public partial sealed class fa_slack :2
// {
// static fa_slack() :4
static void fa_slack__cctor_4_fn(uType* __type)
{
}

static void fa_slack_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\230");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_slack__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_slack_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_slack);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_slack", options);
    type->fp_build_ = fa_slack_build;
    type->fp_ctor_ = (void*)fa_slack__New4_fn;
    type->fp_cctor_ = fa_slack__cctor_4_fn;
...
// public fa_slack() :8
void fa_slack__ctor_8_fn(fa_slack* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_slack__InitializeUX1_fn(fa_slack* __this)
{
    __this->InitializeUX1();
}

// public fa_slack New() :8
void fa_slack__New4_fn(fa_slack** __retval)
{
    *__retval = fa_slack::New4();
}

// public fa_slack() [instance] :8
void fa_slack::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_slack::InitializeUX1()
{
    uStackFrame __("fa_slack", "InitializeUX()");
    Value(::STRINGS[0/*"\uF198"*/]);
    SourceLineNumber(541);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_slack New() [static] :8
fa_slack* fa_slack::New4()
{
    fa_slack* obj1 = (fa_slack*)uNew(fa_slack_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
