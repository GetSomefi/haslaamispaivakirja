// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_underline.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_underline.h>
...
// public partial sealed class fa_underline :2
// {
// static fa_underline() :4
static void fa_underline__cctor_4_fn(uType* __type)
{
}

static void fa_underline_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_underline__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_underline_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_underline);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_underline", options);
    type->fp_build_ = fa_underline_build;
    type->fp_ctor_ = (void*)fa_underline__New4_fn;
    type->fp_cctor_ = fa_underline__cctor_4_fn;
...
// public fa_underline() :8
void fa_underline__ctor_8_fn(fa_underline* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_underline__InitializeUX1_fn(fa_underline* __this)
{
    __this->InitializeUX1();
}

// public fa_underline New() :8
void fa_underline__New4_fn(fa_underline** __retval)
{
    *__retval = fa_underline::New4();
}

// public fa_underline() [instance] :8
void fa_underline::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_underline::InitializeUX1()
{
    uStackFrame __("fa_underline", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0CD"*/]);
    SourceLineNumber(644);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_underline New() [static] :8
fa_underline* fa_underline::New4()
{
    fa_underline* obj1 = (fa_underline*)uNew(fa_underline_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
