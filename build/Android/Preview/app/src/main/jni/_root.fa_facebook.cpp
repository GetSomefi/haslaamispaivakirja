// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_facebook.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_facebook.h>
...
// public partial sealed class fa_facebook :2
// {
// static fa_facebook() :4
static void fa_facebook__cctor_4_fn(uType* __type)
{
}

static void fa_facebook_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_facebook__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_facebook_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_facebook);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_facebook", options);
    type->fp_build_ = fa_facebook_build;
    type->fp_ctor_ = (void*)fa_facebook__New4_fn;
    type->fp_cctor_ = fa_facebook__cctor_4_fn;
...
// public fa_facebook() :8
void fa_facebook__ctor_8_fn(fa_facebook* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_facebook__InitializeUX1_fn(fa_facebook* __this)
{
    __this->InitializeUX1();
}

// public fa_facebook New() :8
void fa_facebook__New4_fn(fa_facebook** __retval)
{
    *__retval = fa_facebook::New4();
}

// public fa_facebook() [instance] :8
void fa_facebook::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_facebook::InitializeUX1()
{
    uStackFrame __("fa_facebook", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09A"*/]);
    SourceLineNumber(222);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_facebook New() [static] :8
fa_facebook* fa_facebook::New4()
{
    fa_facebook* obj1 = (fa_facebook*)uNew(fa_facebook_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
