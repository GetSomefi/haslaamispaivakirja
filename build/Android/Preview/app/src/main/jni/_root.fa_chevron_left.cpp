// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_chevron_left.g.uno'.
...
// public partial sealed class fa_chevron_left :2
// {
// static fa_chevron_left() :4
static void fa_chevron_left__cctor_4_fn(uType* __type)
{
}

static void fa_chevron_left_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_chevron_left__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_chevron_left_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_chevron_left);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_chevron_left", options);
    type->fp_build_ = fa_chevron_left_build;
    type->fp_ctor_ = (void*)fa_chevron_left__New4_fn;
    type->fp_cctor_ = fa_chevron_left__cctor_4_fn;
...
// public fa_chevron_left() :8
void fa_chevron_left__ctor_8_fn(fa_chevron_left* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_chevron_left__InitializeUX1_fn(fa_chevron_left* __this)
{
    __this->InitializeUX1();
}

// public fa_chevron_left New() :8
void fa_chevron_left__New4_fn(fa_chevron_left** __retval)
{
    *__retval = fa_chevron_left::New4();
}

// public fa_chevron_left() [instance] :8
void fa_chevron_left::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_chevron_left::InitializeUX1()
{
    uStackFrame __("fa_chevron_left", "InitializeUX()");
    Value(::STRINGS[0/*"\uF053"*/]);
    SourceLineNumber(137);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_chevron_left New() [static] :8
fa_chevron_left* fa_chevron_left::New4()
{
    fa_chevron_left* obj1 = (fa_chevron_left*)uNew(fa_chevron_left_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
