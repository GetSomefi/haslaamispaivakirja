// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_th.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_th.h>
...
// public partial sealed class fa_th :2
// {
// static fa_th() :4
static void fa_th__cctor_4_fn(uType* __type)
{
}

static void fa_th_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_th__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_th_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_th);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_th", options);
    type->fp_build_ = fa_th_build;
    type->fp_ctor_ = (void*)fa_th__New4_fn;
    type->fp_cctor_ = fa_th__cctor_4_fn;
...
// public fa_th() :8
void fa_th__ctor_8_fn(fa_th* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_th__InitializeUX1_fn(fa_th* __this)
{
    __this->InitializeUX1();
}

// public fa_th New() :8
void fa_th__New4_fn(fa_th** __retval)
{
    *__retval = fa_th::New4();
}

// public fa_th() [instance] :8
void fa_th::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_th::InitializeUX1()
{
    uStackFrame __("fa_th", "InitializeUX()");
    Value(::STRINGS[0/*"\uF00A"*/]);
    SourceLineNumber(604);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_th New() [static] :8
fa_th* fa_th::New4()
{
    fa_th* obj1 = (fa_th*)uNew(fa_th_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
