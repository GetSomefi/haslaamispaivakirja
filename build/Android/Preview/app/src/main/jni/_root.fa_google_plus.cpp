// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_google_plus.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_google_plus.h>
...
// public partial sealed class fa_google_plus :2
// {
// static fa_google_plus() :4
static void fa_google_plus__cctor_4_fn(uType* __type)
{
}

static void fa_google_plus_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_google_plus__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_google_plus_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_google_plus);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_google_plus", options);
    type->fp_build_ = fa_google_plus_build;
    type->fp_ctor_ = (void*)fa_google_plus__New4_fn;
    type->fp_cctor_ = fa_google_plus__cctor_4_fn;
...
// public fa_google_plus() :8
void fa_google_plus__ctor_8_fn(fa_google_plus* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_google_plus__InitializeUX1_fn(fa_google_plus* __this)
{
    __this->InitializeUX1();
}

// public fa_google_plus New() :8
void fa_google_plus__New4_fn(fa_google_plus** __retval)
{
    *__retval = fa_google_plus::New4();
}

// public fa_google_plus() [instance] :8
void fa_google_plus::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_google_plus::InitializeUX1()
{
    uStackFrame __("fa_google_plus", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D5"*/]);
    SourceLineNumber(295);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_google_plus New() [static] :8
fa_google_plus* fa_google_plus::New4()
{
    fa_google_plus* obj1 = (fa_google_plus*)uNew(fa_google_plus_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
