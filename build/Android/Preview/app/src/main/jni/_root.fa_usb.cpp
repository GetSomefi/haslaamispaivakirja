// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_usb.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_usb.h>
...
// public partial sealed class fa_usb :2
// {
// static fa_usb() :4
static void fa_usb__cctor_4_fn(uType* __type)
{
}

static void fa_usb_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_usb__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_usb_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_usb);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_usb", options);
    type->fp_build_ = fa_usb_build;
    type->fp_ctor_ = (void*)fa_usb__New4_fn;
    type->fp_cctor_ = fa_usb__cctor_4_fn;
...
// public fa_usb() :8
void fa_usb__ctor_8_fn(fa_usb* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_usb__InitializeUX1_fn(fa_usb* __this)
{
    __this->InitializeUX1();
}

// public fa_usb New() :8
void fa_usb__New4_fn(fa_usb** __retval)
{
    *__retval = fa_usb::New4();
}

// public fa_usb() [instance] :8
void fa_usb::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_usb::InitializeUX1()
{
    uStackFrame __("fa_usb", "InitializeUX()");
    Value(::STRINGS[0/*"\uF287"*/]);
    SourceLineNumber(652);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_usb New() [static] :8
fa_usb* fa_usb::New4()
{
    fa_usb* obj1 = (fa_usb*)uNew(fa_usb_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
