// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_adjust.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_adjust.h>
...
// public partial sealed class fa_adjust :2
// {
// static fa_adjust() :4
static void fa_adjust__cctor_4_fn(uType* __type)
{
}

static void fa_adjust_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_adjust__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_adjust_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_adjust);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_adjust", options);
    type->fp_build_ = fa_adjust_build;
    type->fp_ctor_ = (void*)fa_adjust__New4_fn;
    type->fp_cctor_ = fa_adjust__cctor_4_fn;
...
// public fa_adjust() :8
void fa_adjust__ctor_8_fn(fa_adjust* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_adjust__InitializeUX1_fn(fa_adjust* __this)
{
    __this->InitializeUX1();
}

// public fa_adjust New() :8
void fa_adjust__New4_fn(fa_adjust** __retval)
{
    *__retval = fa_adjust::New4();
}

// public fa_adjust() [instance] :8
void fa_adjust::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_adjust::InitializeUX1()
{
    uStackFrame __("fa_adjust", "InitializeUX()");
    Value(::STRINGS[0/*"\uF042"*/]);
    SourceLineNumber(3);
...
// public fa_adjust New() [static] :8
fa_adjust* fa_adjust::New4()
{
    fa_adjust* obj1 = (fa_adjust*)uNew(fa_adjust_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
