// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sort.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sort.h>
...
// public partial sealed class fa_sort :2
// {
// static fa_sort() :4
static void fa_sort__cctor_4_fn(uType* __type)
{
}

static void fa_sort_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sort__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sort_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sort);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sort", options);
    type->fp_build_ = fa_sort_build;
    type->fp_ctor_ = (void*)fa_sort__New4_fn;
    type->fp_cctor_ = fa_sort__cctor_4_fn;
...
// public fa_sort() :8
void fa_sort__ctor_8_fn(fa_sort* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sort__InitializeUX1_fn(fa_sort* __this)
{
    __this->InitializeUX1();
}

// public fa_sort New() :8
void fa_sort__New4_fn(fa_sort** __retval)
{
    *__retval = fa_sort::New4();
}

// public fa_sort() [instance] :8
void fa_sort::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_sort::InitializeUX1()
{
    uStackFrame __("fa_sort", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0DC"*/]);
    SourceLineNumber(546);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sort New() [static] :8
fa_sort* fa_sort::New4()
{
    fa_sort* obj1 = (fa_sort*)uNew(fa_sort_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
