// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_life_ring.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_life_ring.h>
...
// public partial sealed class fa_life_ring :2
// {
// static fa_life_ring() :4
static void fa_life_ring__cctor_4_fn(uType* __type)
{
}

static void fa_life_ring_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_life_ring__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_life_ring_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_life_ring);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_life_ring", options);
    type->fp_build_ = fa_life_ring_build;
    type->fp_ctor_ = (void*)fa_life_ring__New4_fn;
    type->fp_cctor_ = fa_life_ring__cctor_4_fn;
...
// public fa_life_ring() :8
void fa_life_ring__ctor_8_fn(fa_life_ring* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_life_ring__InitializeUX1_fn(fa_life_ring* __this)
{
    __this->InitializeUX1();
}

// public fa_life_ring New() :8
void fa_life_ring__New4_fn(fa_life_ring** __retval)
{
    *__retval = fa_life_ring::New4();
}

// public fa_life_ring() [instance] :8
void fa_life_ring::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_life_ring::InitializeUX1()
{
    uStackFrame __("fa_life_ring", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CD"*/]);
    SourceLineNumber(370);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_life_ring New() [static] :8
fa_life_ring* fa_life_ring::New4()
{
    fa_life_ring* obj1 = (fa_life_ring*)uNew(fa_life_ring_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
