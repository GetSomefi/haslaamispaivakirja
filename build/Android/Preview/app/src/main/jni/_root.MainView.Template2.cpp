...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"oldentrys"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("oldentrys");
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    ::g::OldEntrysPage* __self1 = ::g::OldEntrysPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"oldentrys"*/], false);
    __parent1 = parent;
