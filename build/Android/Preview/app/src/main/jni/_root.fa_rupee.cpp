// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rupee.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rupee.h>
...
// public partial sealed class fa_rupee :2
// {
// static fa_rupee() :4
static void fa_rupee__cctor_4_fn(uType* __type)
{
}

static void fa_rupee_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\226");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rupee__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rupee_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rupee);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rupee", options);
    type->fp_build_ = fa_rupee_build;
    type->fp_ctor_ = (void*)fa_rupee__New4_fn;
    type->fp_cctor_ = fa_rupee__cctor_4_fn;
...
// public fa_rupee() :8
void fa_rupee__ctor_8_fn(fa_rupee* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rupee__InitializeUX1_fn(fa_rupee* __this)
{
    __this->InitializeUX1();
}

// public fa_rupee New() :8
void fa_rupee__New4_fn(fa_rupee** __retval)
{
    *__retval = fa_rupee::New4();
}

// public fa_rupee() [instance] :8
void fa_rupee::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_rupee::InitializeUX1()
{
    uStackFrame __("fa_rupee", "InitializeUX()");
    Value(::STRINGS[0/*"\uF156"*/]);
    SourceLineNumber(509);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rupee New() [static] :8
fa_rupee* fa_rupee::New4()
{
    fa_rupee* obj1 = (fa_rupee*)uNew(fa_rupee_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
