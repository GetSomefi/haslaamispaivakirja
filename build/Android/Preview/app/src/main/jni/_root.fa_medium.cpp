// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_medium.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_medium.h>
...
// public partial sealed class fa_medium :2
// {
// static fa_medium() :4
static void fa_medium__cctor_4_fn(uType* __type)
{
}

static void fa_medium_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_medium__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_medium_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_medium);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_medium", options);
    type->fp_build_ = fa_medium_build;
    type->fp_ctor_ = (void*)fa_medium__New4_fn;
    type->fp_cctor_ = fa_medium__cctor_4_fn;
...
// public fa_medium() :8
void fa_medium__ctor_8_fn(fa_medium* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_medium__InitializeUX1_fn(fa_medium* __this)
{
    __this->InitializeUX1();
}

// public fa_medium New() :8
void fa_medium__New4_fn(fa_medium** __retval)
{
    *__retval = fa_medium::New4();
}

// public fa_medium() [instance] :8
void fa_medium::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_medium::InitializeUX1()
{
    uStackFrame __("fa_medium", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23A"*/]);
    SourceLineNumber(406);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_medium New() [static] :8
fa_medium* fa_medium::New4()
{
    fa_medium* obj1 = (fa_medium*)uNew(fa_medium_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
