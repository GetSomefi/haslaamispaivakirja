// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sellsy.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sellsy.h>
...
// public partial sealed class fa_sellsy :2
// {
// static fa_sellsy() :4
static void fa_sellsy__cctor_4_fn(uType* __type)
{
}

static void fa_sellsy_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sellsy__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sellsy_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sellsy);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sellsy", options);
    type->fp_build_ = fa_sellsy_build;
    type->fp_ctor_ = (void*)fa_sellsy__New4_fn;
    type->fp_cctor_ = fa_sellsy__cctor_4_fn;
...
// public fa_sellsy() :8
void fa_sellsy__ctor_8_fn(fa_sellsy* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sellsy__InitializeUX1_fn(fa_sellsy* __this)
{
    __this->InitializeUX1();
}

// public fa_sellsy New() :8
void fa_sellsy__New4_fn(fa_sellsy** __retval)
{
    *__retval = fa_sellsy::New4();
}

// public fa_sellsy() [instance] :8
void fa_sellsy::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sellsy::InitializeUX1()
{
    uStackFrame __("fa_sellsy", "InitializeUX()");
    Value(::STRINGS[0/*"\uF213"*/]);
    SourceLineNumber(517);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sellsy New() [static] :8
fa_sellsy* fa_sellsy::New4()
{
    fa_sellsy* obj1 = (fa_sellsy*)uNew(fa_sellsy_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
