// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_star.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_star.h>
...
// public partial sealed class fa_star :2
// {
// static fa_star() :4
static void fa_star__cctor_4_fn(uType* __type)
{
}

static void fa_star_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\205");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_star__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_star_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_star);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_star", options);
    type->fp_build_ = fa_star_build;
    type->fp_ctor_ = (void*)fa_star__New4_fn;
    type->fp_cctor_ = fa_star__cctor_4_fn;
...
// public fa_star() :8
void fa_star__ctor_8_fn(fa_star* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_star__InitializeUX1_fn(fa_star* __this)
{
    __this->InitializeUX1();
}

// public fa_star New() :8
void fa_star__New4_fn(fa_star** __retval)
{
    *__retval = fa_star::New4();
}

// public fa_star() [instance] :8
void fa_star::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_star::InitializeUX1()
{
    uStackFrame __("fa_star", "InitializeUX()");
    Value(::STRINGS[0/*"\uF005"*/]);
    SourceLineNumber(566);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_star New() [static] :8
fa_star* fa_star::New4()
{
    fa_star* obj1 = (fa_star*)uNew(fa_star_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
