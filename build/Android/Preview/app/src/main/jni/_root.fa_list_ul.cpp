// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_list_ul.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_list_ul.h>
...
// public partial sealed class fa_list_ul :2
// {
// static fa_list_ul() :4
static void fa_list_ul__cctor_4_fn(uType* __type)
{
}

static void fa_list_ul_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_list_ul__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_list_ul_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_list_ul);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_list_ul", options);
    type->fp_build_ = fa_list_ul_build;
    type->fp_ctor_ = (void*)fa_list_ul__New4_fn;
    type->fp_cctor_ = fa_list_ul__cctor_4_fn;
...
// public fa_list_ul() :8
void fa_list_ul__ctor_8_fn(fa_list_ul* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_list_ul__InitializeUX1_fn(fa_list_ul* __this)
{
    __this->InitializeUX1();
}

// public fa_list_ul New() :8
void fa_list_ul__New4_fn(fa_list_ul** __retval)
{
    *__retval = fa_list_ul::New4();
}

// public fa_list_ul() [instance] :8
void fa_list_ul::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_list_ul::InitializeUX1()
{
    uStackFrame __("fa_list_ul", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0CA"*/]);
    SourceLineNumber(381);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_list_ul New() [static] :8
fa_list_ul* fa_list_ul::New4()
{
    fa_list_ul* obj1 = (fa_list_ul*)uNew(fa_list_ul_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
