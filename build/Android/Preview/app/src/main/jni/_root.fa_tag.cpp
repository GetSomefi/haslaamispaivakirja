// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tag.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tag.h>
...
// public partial sealed class fa_tag :2
// {
// static fa_tag() :4
static void fa_tag__cctor_4_fn(uType* __type)
{
}

static void fa_tag_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tag__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tag_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tag);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tag", options);
    type->fp_build_ = fa_tag_build;
    type->fp_ctor_ = (void*)fa_tag__New4_fn;
    type->fp_cctor_ = fa_tag__cctor_4_fn;
...
// public fa_tag() :8
void fa_tag__ctor_8_fn(fa_tag* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tag__InitializeUX1_fn(fa_tag* __this)
{
    __this->InitializeUX1();
}

// public fa_tag New() :8
void fa_tag__New4_fn(fa_tag** __retval)
{
    *__retval = fa_tag::New4();
}

// public fa_tag() [instance] :8
void fa_tag::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_tag::InitializeUX1()
{
    uStackFrame __("fa_tag", "InitializeUX()");
    Value(::STRINGS[0/*"\uF02B"*/]);
    SourceLineNumber(595);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tag New() [static] :8
fa_tag* fa_tag::New4()
{
    fa_tag* obj1 = (fa_tag*)uNew(fa_tag_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
