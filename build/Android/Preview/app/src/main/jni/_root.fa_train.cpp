// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_train.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_train.h>
...
// public partial sealed class fa_train :2
// {
// static fa_train() :4
static void fa_train__cctor_4_fn(uType* __type)
{
}

static void fa_train_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\270");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_train__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_train_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_train);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_train", options);
    type->fp_build_ = fa_train_build;
    type->fp_ctor_ = (void*)fa_train__New4_fn;
    type->fp_cctor_ = fa_train__cctor_4_fn;
...
// public fa_train() :8
void fa_train__ctor_8_fn(fa_train* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_train__InitializeUX1_fn(fa_train* __this)
{
    __this->InitializeUX1();
}

// public fa_train New() :8
void fa_train__New4_fn(fa_train** __retval)
{
    *__retval = fa_train::New4();
}

// public fa_train() [instance] :8
void fa_train::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_train::InitializeUX1()
{
    uStackFrame __("fa_train", "InitializeUX()");
    Value(::STRINGS[0/*"\uF238"*/]);
    SourceLineNumber(624);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_train New() [static] :8
fa_train* fa_train::New4()
{
    fa_train* obj1 = (fa_train*)uNew(fa_train_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
