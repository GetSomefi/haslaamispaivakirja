// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/basic.TextBox.g.uno'.
...
{
    ::STRINGS[0] = uString::Const("Components/basic.TextBox.ux");
...
::g::Fuse::Controls::TextInput_type* TextBox_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextInput_type*)uClassType::New("basic.TextBox", options);
...
void TextBox::ctor_9()
{
    uStackFrame __("basic.TextBox", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("basic.TextBox", "InitializeUX()");
