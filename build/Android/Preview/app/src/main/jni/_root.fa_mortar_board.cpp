// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mortar_board.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mortar_board.h>
...
// public partial sealed class fa_mortar_board :2
// {
// static fa_mortar_board() :4
static void fa_mortar_board__cctor_4_fn(uType* __type)
{
}

static void fa_mortar_board_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mortar_board__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mortar_board_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mortar_board);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mortar_board", options);
    type->fp_build_ = fa_mortar_board_build;
    type->fp_ctor_ = (void*)fa_mortar_board__New4_fn;
    type->fp_cctor_ = fa_mortar_board__cctor_4_fn;
...
// public fa_mortar_board() :8
void fa_mortar_board__ctor_8_fn(fa_mortar_board* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mortar_board__InitializeUX1_fn(fa_mortar_board* __this)
{
    __this->InitializeUX1();
}

// public fa_mortar_board New() :8
void fa_mortar_board__New4_fn(fa_mortar_board** __retval)
{
    *__retval = fa_mortar_board::New4();
}

// public fa_mortar_board() [instance] :8
void fa_mortar_board::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mortar_board::InitializeUX1()
{
    uStackFrame __("fa_mortar_board", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19D"*/]);
    SourceLineNumber(422);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mortar_board New() [static] :8
fa_mortar_board* fa_mortar_board::New4()
{
    fa_mortar_board* obj1 = (fa_mortar_board*)uNew(fa_mortar_board_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
