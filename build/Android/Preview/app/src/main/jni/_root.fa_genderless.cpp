// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_genderless.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_genderless.h>
...
// public partial sealed class fa_genderless :2
// {
// static fa_genderless() :4
static void fa_genderless__cctor_4_fn(uType* __type)
{
}

static void fa_genderless_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_genderless__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_genderless_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_genderless);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_genderless", options);
    type->fp_build_ = fa_genderless_build;
    type->fp_ctor_ = (void*)fa_genderless__New4_fn;
    type->fp_cctor_ = fa_genderless__cctor_4_fn;
...
// public fa_genderless() :8
void fa_genderless__ctor_8_fn(fa_genderless* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_genderless__InitializeUX1_fn(fa_genderless* __this)
{
    __this->InitializeUX1();
}

// public fa_genderless New() :8
void fa_genderless__New4_fn(fa_genderless** __retval)
{
    *__retval = fa_genderless::New4();
}

// public fa_genderless() [instance] :8
void fa_genderless::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_genderless::InitializeUX1()
{
    uStackFrame __("fa_genderless", "InitializeUX()");
    Value(::STRINGS[0/*"\uF22D"*/]);
    SourceLineNumber(281);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_genderless New() [static] :8
fa_genderless* fa_genderless::New4()
{
    fa_genderless* obj1 = (fa_genderless*)uNew(fa_genderless_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
