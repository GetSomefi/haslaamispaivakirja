// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sort_numeric_desc.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sort_numeric_desc.h>
...
// public partial sealed class fa_sort_numeric_desc :2
// {
// static fa_sort_numeric_desc() :4
static void fa_sort_numeric_desc__cctor_4_fn(uType* __type)
{
}

static void fa_sort_numeric_desc_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sort_numeric_desc__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sort_numeric_desc_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sort_numeric_desc);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sort_numeric_desc", options);
    type->fp_build_ = fa_sort_numeric_desc_build;
    type->fp_ctor_ = (void*)fa_sort_numeric_desc__New4_fn;
    type->fp_cctor_ = fa_sort_numeric_desc__cctor_4_fn;
...
// public fa_sort_numeric_desc() :8
void fa_sort_numeric_desc__ctor_8_fn(fa_sort_numeric_desc* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sort_numeric_desc__InitializeUX1_fn(fa_sort_numeric_desc* __this)
{
    __this->InitializeUX1();
}

// public fa_sort_numeric_desc New() :8
void fa_sort_numeric_desc__New4_fn(fa_sort_numeric_desc** __retval)
{
    *__retval = fa_sort_numeric_desc::New4();
}

// public fa_sort_numeric_desc() [instance] :8
void fa_sort_numeric_desc::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sort_numeric_desc::InitializeUX1()
{
    uStackFrame __("fa_sort_numeric_desc", "InitializeUX()");
    Value(::STRINGS[0/*"\uF163"*/]);
    SourceLineNumber(555);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sort_numeric_desc New() [static] :8
fa_sort_numeric_desc* fa_sort_numeric_desc::New4()
{
    fa_sort_numeric_desc* obj1 = (fa_sort_numeric_desc*)uNew(fa_sort_numeric_desc_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
