// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_map_marker.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_map_marker.h>
...
// public partial sealed class fa_map_marker :2
// {
// static fa_map_marker() :4
static void fa_map_marker__cctor_4_fn(uType* __type)
{
}

static void fa_map_marker_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_map_marker__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_map_marker_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_map_marker);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_map_marker", options);
    type->fp_build_ = fa_map_marker_build;
    type->fp_ctor_ = (void*)fa_map_marker__New4_fn;
    type->fp_cctor_ = fa_map_marker__cctor_4_fn;
...
// public fa_map_marker() :8
void fa_map_marker__ctor_8_fn(fa_map_marker* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_map_marker__InitializeUX1_fn(fa_map_marker* __this)
{
    __this->InitializeUX1();
}

// public fa_map_marker New() :8
void fa_map_marker__New4_fn(fa_map_marker** __retval)
{
    *__retval = fa_map_marker::New4();
}

// public fa_map_marker() [instance] :8
void fa_map_marker::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_map_marker::InitializeUX1()
{
    uStackFrame __("fa_map_marker", "InitializeUX()");
    Value(::STRINGS[0/*"\uF041"*/]);
    SourceLineNumber(395);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_map_marker New() [static] :8
fa_map_marker* fa_map_marker::New4()
{
    fa_map_marker* obj1 = (fa_map_marker*)uNew(fa_map_marker_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
