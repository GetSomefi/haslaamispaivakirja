// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pinterest_square.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pinterest_square.h>
...
// public partial sealed class fa_pinterest_square :2
// {
// static fa_pinterest_square() :4
static void fa_pinterest_square__cctor_4_fn(uType* __type)
{
}

static void fa_pinterest_square_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pinterest_square__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pinterest_square_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pinterest_square);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pinterest_square", options);
    type->fp_build_ = fa_pinterest_square_build;
    type->fp_ctor_ = (void*)fa_pinterest_square__New4_fn;
    type->fp_cctor_ = fa_pinterest_square__cctor_4_fn;
...
// public fa_pinterest_square() :8
void fa_pinterest_square__ctor_8_fn(fa_pinterest_square* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pinterest_square__InitializeUX1_fn(fa_pinterest_square* __this)
{
    __this->InitializeUX1();
}

// public fa_pinterest_square New() :8
void fa_pinterest_square__New4_fn(fa_pinterest_square** __retval)
{
    *__retval = fa_pinterest_square::New4();
}

// public fa_pinterest_square() [instance] :8
void fa_pinterest_square::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pinterest_square::InitializeUX1()
{
    uStackFrame __("fa_pinterest_square", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D3"*/]);
    SourceLineNumber(463);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pinterest_square New() [static] :8
fa_pinterest_square* fa_pinterest_square::New4()
{
    fa_pinterest_square* obj1 = (fa_pinterest_square*)uNew(fa_pinterest_square_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
