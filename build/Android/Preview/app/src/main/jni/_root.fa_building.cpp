// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_building.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_building.h>
...
// public partial sealed class fa_building :2
// {
// static fa_building() :4
static void fa_building__cctor_4_fn(uType* __type)
{
}

static void fa_building_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_building__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_building_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_building);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_building", options);
    type->fp_build_ = fa_building_build;
    type->fp_ctor_ = (void*)fa_building__New4_fn;
    type->fp_cctor_ = fa_building__cctor_4_fn;
...
// public fa_building() :8
void fa_building__ctor_8_fn(fa_building* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_building__InitializeUX1_fn(fa_building* __this)
{
    __this->InitializeUX1();
}

// public fa_building New() :8
void fa_building__New4_fn(fa_building** __retval)
{
    *__retval = fa_building::New4();
}

// public fa_building() [instance] :8
void fa_building::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_building::InitializeUX1()
{
    uStackFrame __("fa_building", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1AD"*/]);
    SourceLineNumber(88);
...
// public fa_building New() [static] :8
fa_building* fa_building::New4()
{
    fa_building* obj1 = (fa_building*)uNew(fa_building_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
