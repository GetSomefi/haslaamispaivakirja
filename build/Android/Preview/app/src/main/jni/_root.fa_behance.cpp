// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_behance.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_behance.h>
...
// public partial sealed class fa_behance :2
// {
// static fa_behance() :4
static void fa_behance__cctor_4_fn(uType* __type)
{
}

static void fa_behance_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\264");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_behance__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_behance_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_behance);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_behance", options);
    type->fp_build_ = fa_behance_build;
    type->fp_ctor_ = (void*)fa_behance__New4_fn;
    type->fp_cctor_ = fa_behance__cctor_4_fn;
...
// public fa_behance() :8
void fa_behance__ctor_8_fn(fa_behance* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_behance__InitializeUX1_fn(fa_behance* __this)
{
    __this->InitializeUX1();
}

// public fa_behance New() :8
void fa_behance__New4_fn(fa_behance** __retval)
{
    *__retval = fa_behance::New4();
}

// public fa_behance() [instance] :8
void fa_behance::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_behance::InitializeUX1()
{
    uStackFrame __("fa_behance", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B4"*/]);
    SourceLineNumber(64);
...
// public fa_behance New() [static] :8
fa_behance* fa_behance::New4()
{
    fa_behance* obj1 = (fa_behance*)uNew(fa_behance_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
