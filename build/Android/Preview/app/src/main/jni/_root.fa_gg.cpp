// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gg.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gg.h>
...
// public partial sealed class fa_gg :2
// {
// static fa_gg() :4
static void fa_gg__cctor_4_fn(uType* __type)
{
}

static void fa_gg_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\240");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gg__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gg_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gg);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gg", options);
    type->fp_build_ = fa_gg_build;
    type->fp_ctor_ = (void*)fa_gg__New4_fn;
    type->fp_cctor_ = fa_gg__cctor_4_fn;
...
// public fa_gg() :8
void fa_gg__ctor_8_fn(fa_gg* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gg__InitializeUX1_fn(fa_gg* __this)
{
    __this->InitializeUX1();
}

// public fa_gg New() :8
void fa_gg__New4_fn(fa_gg** __retval)
{
    *__retval = fa_gg::New4();
}

// public fa_gg() [instance] :8
void fa_gg::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_gg::InitializeUX1()
{
    uStackFrame __("fa_gg", "InitializeUX()");
    Value(::STRINGS[0/*"\uF260"*/]);
    SourceLineNumber(283);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_gg New() [static] :8
fa_gg* fa_gg::New4()
{
    fa_gg* obj1 = (fa_gg*)uNew(fa_gg_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
