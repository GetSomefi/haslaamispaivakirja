// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_qrcode.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_qrcode.h>
...
// public partial sealed class fa_qrcode :2
// {
// static fa_qrcode() :4
static void fa_qrcode__cctor_4_fn(uType* __type)
{
}

static void fa_qrcode_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\251");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_qrcode__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_qrcode_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_qrcode);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_qrcode", options);
    type->fp_build_ = fa_qrcode_build;
    type->fp_ctor_ = (void*)fa_qrcode__New4_fn;
    type->fp_cctor_ = fa_qrcode__cctor_4_fn;
...
// public fa_qrcode() :8
void fa_qrcode__ctor_8_fn(fa_qrcode* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_qrcode__InitializeUX1_fn(fa_qrcode* __this)
{
    __this->InitializeUX1();
}

// public fa_qrcode New() :8
void fa_qrcode__New4_fn(fa_qrcode** __retval)
{
    *__retval = fa_qrcode::New4();
}

// public fa_qrcode() [instance] :8
void fa_qrcode::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_qrcode::InitializeUX1()
{
    uStackFrame __("fa_qrcode", "InitializeUX()");
    Value(::STRINGS[0/*"\uF029"*/]);
    SourceLineNumber(478);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_qrcode New() [static] :8
fa_qrcode* fa_qrcode::New4()
{
    fa_qrcode* obj1 = (fa_qrcode*)uNew(fa_qrcode_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
