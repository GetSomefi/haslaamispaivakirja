// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_external_link.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_external_link.h>
...
// public partial sealed class fa_external_link :2
// {
// static fa_external_link() :4
static void fa_external_link__cctor_4_fn(uType* __type)
{
}

static void fa_external_link_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_external_link__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_external_link_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_external_link);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_external_link", options);
    type->fp_build_ = fa_external_link_build;
    type->fp_ctor_ = (void*)fa_external_link__New4_fn;
    type->fp_cctor_ = fa_external_link__cctor_4_fn;
...
// public fa_external_link() :8
void fa_external_link__ctor_8_fn(fa_external_link* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_external_link__InitializeUX1_fn(fa_external_link* __this)
{
    __this->InitializeUX1();
}

// public fa_external_link New() :8
void fa_external_link__New4_fn(fa_external_link** __retval)
{
    *__retval = fa_external_link::New4();
}

// public fa_external_link() [instance] :8
void fa_external_link::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_external_link::InitializeUX1()
{
    uStackFrame __("fa_external_link", "InitializeUX()");
    Value(::STRINGS[0/*"\uF08E"*/]);
    SourceLineNumber(217);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_external_link New() [static] :8
fa_external_link* fa_external_link::New4()
{
    fa_external_link* obj1 = (fa_external_link*)uNew(fa_external_link_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
