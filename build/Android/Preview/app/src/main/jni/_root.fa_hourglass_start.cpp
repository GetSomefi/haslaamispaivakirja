// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_hourglass_start.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_hourglass_start.h>
...
// public partial sealed class fa_hourglass_start :2
// {
// static fa_hourglass_start() :4
static void fa_hourglass_start__cctor_4_fn(uType* __type)
{
}

static void fa_hourglass_start_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_hourglass_start__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_hourglass_start_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_hourglass_start);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_hourglass_start", options);
    type->fp_build_ = fa_hourglass_start_build;
    type->fp_ctor_ = (void*)fa_hourglass_start__New4_fn;
    type->fp_cctor_ = fa_hourglass_start__cctor_4_fn;
...
// public fa_hourglass_start() :8
void fa_hourglass_start__ctor_8_fn(fa_hourglass_start* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_hourglass_start__InitializeUX1_fn(fa_hourglass_start* __this)
{
    __this->InitializeUX1();
}

// public fa_hourglass_start New() :8
void fa_hourglass_start__New4_fn(fa_hourglass_start** __retval)
{
    *__retval = fa_hourglass_start::New4();
}

// public fa_hourglass_start() [instance] :8
void fa_hourglass_start::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_hourglass_start::InitializeUX1()
{
    uStackFrame __("fa_hourglass_start", "InitializeUX()");
    Value(::STRINGS[0/*"\uF251"*/]);
    SourceLineNumber(334);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_hourglass_start New() [static] :8
fa_hourglass_start* fa_hourglass_start::New4()
{
    fa_hourglass_start* obj1 = (fa_hourglass_start*)uNew(fa_hourglass_start_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
