// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_edge.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_edge.h>
...
// public partial sealed class fa_edge :2
// {
// static fa_edge() :4
static void fa_edge__cctor_4_fn(uType* __type)
{
}

static void fa_edge_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_edge__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_edge_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_edge);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_edge", options);
    type->fp_build_ = fa_edge_build;
    type->fp_ctor_ = (void*)fa_edge__New4_fn;
    type->fp_cctor_ = fa_edge__cctor_4_fn;
...
// public fa_edge() :8
void fa_edge__ctor_8_fn(fa_edge* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_edge__InitializeUX1_fn(fa_edge* __this)
{
    __this->InitializeUX1();
}

// public fa_edge New() :8
void fa_edge__New4_fn(fa_edge** __retval)
{
    *__retval = fa_edge::New4();
}

// public fa_edge() [instance] :8
void fa_edge::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_edge::InitializeUX1()
{
    uStackFrame __("fa_edge", "InitializeUX()");
    Value(::STRINGS[0/*"\uF282"*/]);
    SourceLineNumber(199);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_edge New() [static] :8
fa_edge* fa_edge::New4()
{
    fa_edge* obj1 = (fa_edge*)uNew(fa_edge_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
