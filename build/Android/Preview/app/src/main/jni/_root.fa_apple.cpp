// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_apple.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_apple.h>
...
// public partial sealed class fa_apple :2
// {
// static fa_apple() :4
static void fa_apple__cctor_4_fn(uType* __type)
{
}

static void fa_apple_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_apple__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_apple_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_apple);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_apple", options);
    type->fp_build_ = fa_apple_build;
    type->fp_ctor_ = (void*)fa_apple__New4_fn;
    type->fp_cctor_ = fa_apple__cctor_4_fn;
...
// public fa_apple() :8
void fa_apple__ctor_8_fn(fa_apple* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_apple__InitializeUX1_fn(fa_apple* __this)
{
    __this->InitializeUX1();
}

// public fa_apple New() :8
void fa_apple__New4_fn(fa_apple** __retval)
{
    *__retval = fa_apple::New4();
}

// public fa_apple() [instance] :8
void fa_apple::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_apple::InitializeUX1()
{
    uStackFrame __("fa_apple", "InitializeUX()");
    Value(::STRINGS[0/*"\uF179"*/]);
    SourceLineNumber(22);
...
// public fa_apple New() [static] :8
fa_apple* fa_apple::New4()
{
    fa_apple* obj1 = (fa_apple*)uNew(fa_apple_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
