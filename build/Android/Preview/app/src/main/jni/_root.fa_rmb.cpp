// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rmb.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rmb.h>
...
// public partial sealed class fa_rmb :2
// {
// static fa_rmb() :4
static void fa_rmb__cctor_4_fn(uType* __type)
{
}

static void fa_rmb_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rmb__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rmb_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rmb);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rmb", options);
    type->fp_build_ = fa_rmb_build;
    type->fp_ctor_ = (void*)fa_rmb__New4_fn;
    type->fp_cctor_ = fa_rmb__cctor_4_fn;
...
// public fa_rmb() :8
void fa_rmb__ctor_8_fn(fa_rmb* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rmb__InitializeUX1_fn(fa_rmb* __this)
{
    __this->InitializeUX1();
}

// public fa_rmb New() :8
void fa_rmb__New4_fn(fa_rmb** __retval)
{
    *__retval = fa_rmb::New4();
}

// public fa_rmb() [instance] :8
void fa_rmb::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_rmb::InitializeUX1()
{
    uStackFrame __("fa_rmb", "InitializeUX()");
    Value(::STRINGS[0/*"\uF157"*/]);
    SourceLineNumber(499);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rmb New() [static] :8
fa_rmb* fa_rmb::New4()
{
    fa_rmb* obj1 = (fa_rmb*)uNew(fa_rmb_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
