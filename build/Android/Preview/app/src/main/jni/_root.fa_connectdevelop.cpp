// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_connectdevelop.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_connectdevelop.h>
...
// public partial sealed class fa_connectdevelop :2
// {
// static fa_connectdevelop() :4
static void fa_connectdevelop__cctor_4_fn(uType* __type)
{
}

static void fa_connectdevelop_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\216");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_connectdevelop__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_connectdevelop_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_connectdevelop);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_connectdevelop", options);
    type->fp_build_ = fa_connectdevelop_build;
    type->fp_ctor_ = (void*)fa_connectdevelop__New4_fn;
    type->fp_cctor_ = fa_connectdevelop__cctor_4_fn;
...
// public fa_connectdevelop() :8
void fa_connectdevelop__ctor_8_fn(fa_connectdevelop* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_connectdevelop__InitializeUX1_fn(fa_connectdevelop* __this)
{
    __this->InitializeUX1();
}

// public fa_connectdevelop New() :8
void fa_connectdevelop__New4_fn(fa_connectdevelop** __retval)
{
    *__retval = fa_connectdevelop::New4();
}

// public fa_connectdevelop() [instance] :8
void fa_connectdevelop::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_connectdevelop::InitializeUX1()
{
    uStackFrame __("fa_connectdevelop", "InitializeUX()");
    Value(::STRINGS[0/*"\uF20E"*/]);
...
// public fa_connectdevelop New() [static] :8
fa_connectdevelop* fa_connectdevelop::New4()
{
    fa_connectdevelop* obj1 = (fa_connectdevelop*)uNew(fa_connectdevelop_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
