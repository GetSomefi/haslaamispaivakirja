// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_map.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_map.h>
...
// public partial sealed class fa_map :2
// {
// static fa_map() :4
static void fa_map__cctor_4_fn(uType* __type)
{
}

static void fa_map_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_map__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_map_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_map);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_map", options);
    type->fp_build_ = fa_map_build;
    type->fp_ctor_ = (void*)fa_map__New4_fn;
    type->fp_cctor_ = fa_map__cctor_4_fn;
...
// public fa_map() :8
void fa_map__ctor_8_fn(fa_map* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_map__InitializeUX1_fn(fa_map* __this)
{
    __this->InitializeUX1();
}

// public fa_map New() :8
void fa_map__New4_fn(fa_map** __retval)
{
    *__retval = fa_map::New4();
}

// public fa_map() [instance] :8
void fa_map::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_map::InitializeUX1()
{
    uStackFrame __("fa_map", "InitializeUX()");
    Value(::STRINGS[0/*"\uF279"*/]);
    SourceLineNumber(394);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_map New() [static] :8
fa_map* fa_map::New4()
{
    fa_map* obj1 = (fa_map*)uNew(fa_map_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
