// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_exclamation_triangle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_exclamation_triangle.h>
...
// public partial sealed class fa_exclamation_triangle :2
// {
// static fa_exclamation_triangle() :4
static void fa_exclamation_triangle__cctor_4_fn(uType* __type)
{
}

static void fa_exclamation_triangle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_exclamation_triangle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_exclamation_triangle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_exclamation_triangle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_exclamation_triangle", options);
    type->fp_build_ = fa_exclamation_triangle_build;
    type->fp_ctor_ = (void*)fa_exclamation_triangle__New4_fn;
    type->fp_cctor_ = fa_exclamation_triangle__cctor_4_fn;
...
// public fa_exclamation_triangle() :8
void fa_exclamation_triangle__ctor_8_fn(fa_exclamation_triangle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_exclamation_triangle__InitializeUX1_fn(fa_exclamation_triangle* __this)
{
    __this->InitializeUX1();
}

// public fa_exclamation_triangle New() :8
void fa_exclamation_triangle__New4_fn(fa_exclamation_triangle** __retval)
{
    *__retval = fa_exclamation_triangle::New4();
}

// public fa_exclamation_triangle() [instance] :8
void fa_exclamation_triangle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_exclamation_triangle::InitializeUX1()
{
    uStackFrame __("fa_exclamation_triangle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF071"*/]);
...
// public fa_exclamation_triangle New() [static] :8
fa_exclamation_triangle* fa_exclamation_triangle::New4()
{
    fa_exclamation_triangle* obj1 = (fa_exclamation_triangle*)uNew(fa_exclamation_triangle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
