// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_text_height.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_text_height.h>
...
// public partial sealed class fa_text_height :2
// {
// static fa_text_height() :4
static void fa_text_height__cctor_4_fn(uType* __type)
{
}

static void fa_text_height_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\264");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_text_height__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_text_height_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_text_height);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_text_height", options);
    type->fp_build_ = fa_text_height_build;
    type->fp_ctor_ = (void*)fa_text_height__New4_fn;
    type->fp_cctor_ = fa_text_height__cctor_4_fn;
...
// public fa_text_height() :8
void fa_text_height__ctor_8_fn(fa_text_height* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_text_height__InitializeUX1_fn(fa_text_height* __this)
{
    __this->InitializeUX1();
}

// public fa_text_height New() :8
void fa_text_height__New4_fn(fa_text_height** __retval)
{
    *__retval = fa_text_height::New4();
}

// public fa_text_height() [instance] :8
void fa_text_height::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_text_height::InitializeUX1()
{
    uStackFrame __("fa_text_height", "InitializeUX()");
    Value(::STRINGS[0/*"\uF034"*/]);
    SourceLineNumber(602);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_text_height New() [static] :8
fa_text_height* fa_text_height::New4()
{
    fa_text_height* obj1 = (fa_text_height*)uNew(fa_text_height_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
