// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_gittip.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_gittip.h>
...
// public partial sealed class fa_gittip :2
// {
// static fa_gittip() :4
static void fa_gittip__cctor_4_fn(uType* __type)
{
}

static void fa_gittip_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_gittip__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_gittip_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_gittip);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_gittip", options);
    type->fp_build_ = fa_gittip_build;
    type->fp_ctor_ = (void*)fa_gittip__New4_fn;
    type->fp_cctor_ = fa_gittip__cctor_4_fn;
...
// public fa_gittip() :8
void fa_gittip__ctor_8_fn(fa_gittip* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_gittip__InitializeUX1_fn(fa_gittip* __this)
{
    __this->InitializeUX1();
}

// public fa_gittip New() :8
void fa_gittip__New4_fn(fa_gittip** __retval)
{
    *__retval = fa_gittip::New4();
}

// public fa_gittip() [instance] :8
void fa_gittip::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_gittip::InitializeUX1()
{
    uStackFrame __("fa_gittip", "InitializeUX()");
    Value(::STRINGS[0/*"\uF184"*/]);
...
// public fa_gittip New() [static] :8
fa_gittip* fa_gittip::New4()
{
    fa_gittip* obj1 = (fa_gittip*)uNew(fa_gittip_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
