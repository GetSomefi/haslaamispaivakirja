// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_times_circle_o.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_times_circle_o.h>
...
// public partial sealed class fa_times_circle_o :2
// {
// static fa_times_circle_o() :4
static void fa_times_circle_o__cctor_4_fn(uType* __type)
{
}

static void fa_times_circle_o_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_times_circle_o__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_times_circle_o_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_times_circle_o);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_times_circle_o", options);
    type->fp_build_ = fa_times_circle_o_build;
    type->fp_ctor_ = (void*)fa_times_circle_o__New4_fn;
    type->fp_cctor_ = fa_times_circle_o__cctor_4_fn;
...
// public fa_times_circle_o() :8
void fa_times_circle_o__ctor_8_fn(fa_times_circle_o* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_times_circle_o__InitializeUX1_fn(fa_times_circle_o* __this)
{
    __this->InitializeUX1();
}

// public fa_times_circle_o New() :8
void fa_times_circle_o__New4_fn(fa_times_circle_o** __retval)
{
    *__retval = fa_times_circle_o::New4();
}

// public fa_times_circle_o() [instance] :8
void fa_times_circle_o::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_times_circle_o::InitializeUX1()
{
    uStackFrame __("fa_times_circle_o", "InitializeUX()");
    Value(::STRINGS[0/*"\uF05C"*/]);
    SourceLineNumber(615);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_times_circle_o New() [static] :8
fa_times_circle_o* fa_times_circle_o::New4()
{
    fa_times_circle_o* obj1 = (fa_times_circle_o*)uNew(fa_times_circle_o_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
