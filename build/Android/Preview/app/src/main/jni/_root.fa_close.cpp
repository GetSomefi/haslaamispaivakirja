// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_close.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_close.h>
...
// public partial sealed class fa_close :2
// {
// static fa_close() :4
static void fa_close__cctor_4_fn(uType* __type)
{
}

static void fa_close_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_close__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_close_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_close);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_close", options);
    type->fp_build_ = fa_close_build;
    type->fp_ctor_ = (void*)fa_close__New4_fn;
    type->fp_cctor_ = fa_close__cctor_4_fn;
...
// public fa_close() :8
void fa_close__ctor_8_fn(fa_close* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_close__InitializeUX1_fn(fa_close* __this)
{
    __this->InitializeUX1();
}

// public fa_close New() :8
void fa_close__New4_fn(fa_close** __retval)
{
    *__retval = fa_close::New4();
}

// public fa_close() [instance] :8
void fa_close::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_close::InitializeUX1()
{
    uStackFrame __("fa_close", "InitializeUX()");
    Value(::STRINGS[0/*"\uF00D"*/]);
...
// public fa_close New() [static] :8
fa_close* fa_close::New4()
{
    fa_close* obj1 = (fa_close*)uNew(fa_close_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
