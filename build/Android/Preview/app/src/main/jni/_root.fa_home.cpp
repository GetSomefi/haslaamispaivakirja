// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_home.g.uno'.
...
// public partial sealed class fa_home :2
// {
// static fa_home() :4
static void fa_home__cctor_4_fn(uType* __type)
{
}

static void fa_home_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_home__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_home_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_home);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_home", options);
    type->fp_build_ = fa_home_build;
    type->fp_ctor_ = (void*)fa_home__New4_fn;
    type->fp_cctor_ = fa_home__cctor_4_fn;
...
// public fa_home() :8
void fa_home__ctor_8_fn(fa_home* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_home__InitializeUX1_fn(fa_home* __this)
{
    __this->InitializeUX1();
}

// public fa_home New() :8
void fa_home__New4_fn(fa_home** __retval)
{
    *__retval = fa_home::New4();
}

// public fa_home() [instance] :8
void fa_home::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_home::InitializeUX1()
{
    uStackFrame __("fa_home", "InitializeUX()");
    Value(::STRINGS[0/*"\uF015"*/]);
    SourceLineNumber(324);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_home New() [static] :8
fa_home* fa_home::New4()
{
    fa_home* obj1 = (fa_home*)uNew(fa_home_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
