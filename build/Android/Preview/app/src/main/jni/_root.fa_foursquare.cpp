// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_foursquare.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_foursquare.h>
...
// public partial sealed class fa_foursquare :2
// {
// static fa_foursquare() :4
static void fa_foursquare__cctor_4_fn(uType* __type)
{
}

static void fa_foursquare_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\200");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_foursquare__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_foursquare_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_foursquare);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_foursquare", options);
    type->fp_build_ = fa_foursquare_build;
    type->fp_ctor_ = (void*)fa_foursquare__New4_fn;
    type->fp_cctor_ = fa_foursquare__cctor_4_fn;
...
// public fa_foursquare() :8
void fa_foursquare__ctor_8_fn(fa_foursquare* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_foursquare__InitializeUX1_fn(fa_foursquare* __this)
{
    __this->InitializeUX1();
}

// public fa_foursquare New() :8
void fa_foursquare__New4_fn(fa_foursquare** __retval)
{
    *__retval = fa_foursquare::New4();
}

// public fa_foursquare() [instance] :8
void fa_foursquare::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_foursquare::InitializeUX1()
{
    uStackFrame __("fa_foursquare", "InitializeUX()");
    Value(::STRINGS[0/*"\uF180"*/]);
    SourceLineNumber(272);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_foursquare New() [static] :8
fa_foursquare* fa_foursquare::New4()
{
    fa_foursquare* obj1 = (fa_foursquare*)uNew(fa_foursquare_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
