// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_chain_broken.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_chain_broken.h>
...
// public partial sealed class fa_chain_broken :2
// {
// static fa_chain_broken() :4
static void fa_chain_broken__cctor_4_fn(uType* __type)
{
}

static void fa_chain_broken_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\247");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_chain_broken__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_chain_broken_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_chain_broken);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_chain_broken", options);
    type->fp_build_ = fa_chain_broken_build;
    type->fp_ctor_ = (void*)fa_chain_broken__New4_fn;
    type->fp_cctor_ = fa_chain_broken__cctor_4_fn;
...
// public fa_chain_broken() :8
void fa_chain_broken__ctor_8_fn(fa_chain_broken* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_chain_broken__InitializeUX1_fn(fa_chain_broken* __this)
{
    __this->InitializeUX1();
}

// public fa_chain_broken New() :8
void fa_chain_broken__New4_fn(fa_chain_broken** __retval)
{
    *__retval = fa_chain_broken::New4();
}

// public fa_chain_broken() [instance] :8
void fa_chain_broken::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_chain_broken::InitializeUX1()
{
    uStackFrame __("fa_chain_broken", "InitializeUX()");
    Value(::STRINGS[0/*"\uF127"*/]);
    SourceLineNumber(126);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_chain_broken New() [static] :8
fa_chain_broken* fa_chain_broken::New4()
{
    fa_chain_broken* obj1 = (fa_chain_broken*)uNew(fa_chain_broken_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
