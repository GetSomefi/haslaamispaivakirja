// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mercury.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mercury.h>
...
// public partial sealed class fa_mercury :2
// {
// static fa_mercury() :4
static void fa_mercury__cctor_4_fn(uType* __type)
{
}

static void fa_mercury_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mercury__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mercury_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mercury);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mercury", options);
    type->fp_build_ = fa_mercury_build;
    type->fp_ctor_ = (void*)fa_mercury__New4_fn;
    type->fp_cctor_ = fa_mercury__cctor_4_fn;
...
// public fa_mercury() :8
void fa_mercury__ctor_8_fn(fa_mercury* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mercury__InitializeUX1_fn(fa_mercury* __this)
{
    __this->InitializeUX1();
}

// public fa_mercury New() :8
void fa_mercury__New4_fn(fa_mercury** __retval)
{
    *__retval = fa_mercury::New4();
}

// public fa_mercury() [instance] :8
void fa_mercury::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mercury::InitializeUX1()
{
    uStackFrame __("fa_mercury", "InitializeUX()");
    Value(::STRINGS[0/*"\uF223"*/]);
    SourceLineNumber(409);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mercury New() [static] :8
fa_mercury* fa_mercury::New4()
{
    fa_mercury* obj1 = (fa_mercury*)uNew(fa_mercury_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
