// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_header.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_header.h>
...
// public partial sealed class fa_header :2
// {
// static fa_header() :4
static void fa_header__cctor_4_fn(uType* __type)
{
}

static void fa_header_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_header__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_header_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_header);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_header", options);
    type->fp_build_ = fa_header_build;
    type->fp_ctor_ = (void*)fa_header__New4_fn;
    type->fp_cctor_ = fa_header__cctor_4_fn;
...
// public fa_header() :8
void fa_header__ctor_8_fn(fa_header* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_header__InitializeUX1_fn(fa_header* __this)
{
    __this->InitializeUX1();
}

// public fa_header New() :8
void fa_header__New4_fn(fa_header** __retval)
{
    *__retval = fa_header::New4();
}

// public fa_header() [instance] :8
void fa_header::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_header::InitializeUX1()
{
    uStackFrame __("fa_header", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1DC"*/]);
    SourceLineNumber(318);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_header New() [static] :8
fa_header* fa_header::New4()
{
    fa_header* obj1 = (fa_header*)uNew(fa_header_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
