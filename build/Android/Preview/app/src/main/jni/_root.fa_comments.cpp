// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_comments.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_comments.h>
...
// public partial sealed class fa_comments :2
// {
// static fa_comments() :4
static void fa_comments__cctor_4_fn(uType* __type)
{
}

static void fa_comments_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\206");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_comments__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_comments_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_comments);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_comments", options);
    type->fp_build_ = fa_comments_build;
    type->fp_ctor_ = (void*)fa_comments__New4_fn;
    type->fp_cctor_ = fa_comments__cctor_4_fn;
...
// public fa_comments() :8
void fa_comments__ctor_8_fn(fa_comments* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_comments__InitializeUX1_fn(fa_comments* __this)
{
    __this->InitializeUX1();
}

// public fa_comments New() :8
void fa_comments__New4_fn(fa_comments** __retval)
{
    *__retval = fa_comments::New4();
}

// public fa_comments() [instance] :8
void fa_comments::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_comments::InitializeUX1()
{
    uStackFrame __("fa_comments", "InitializeUX()");
    Value(::STRINGS[0/*"\uF086"*/]);
...
// public fa_comments New() [static] :8
fa_comments* fa_comments::New4()
{
    fa_comments* obj1 = (fa_comments*)uNew(fa_comments_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
