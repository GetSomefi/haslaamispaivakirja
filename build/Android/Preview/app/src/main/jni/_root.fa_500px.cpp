// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_500px.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_500px.h>
...
// public partial sealed class fa_500px :2
// {
// static fa_500px() :4
static void fa_500px__cctor_4_fn(uType* __type)
{
}

static void fa_500px_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_500px__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_500px_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_500px);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_500px", options);
    type->fp_build_ = fa_500px_build;
    type->fp_ctor_ = (void*)fa_500px__New4_fn;
    type->fp_cctor_ = fa_500px__cctor_4_fn;
...
// public fa_500px() :8
void fa_500px__ctor_8_fn(fa_500px* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_500px__InitializeUX1_fn(fa_500px* __this)
{
    __this->InitializeUX1();
}

// public fa_500px New() :8
void fa_500px__New4_fn(fa_500px** __retval)
{
    *__retval = fa_500px::New4();
}

// public fa_500px() [instance] :8
void fa_500px::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_500px::InitializeUX1()
{
    uStackFrame __("fa_500px", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26E"*/]);
    SourceLineNumber(2);
...
// public fa_500px New() [static] :8
fa_500px* fa_500px::New4()
{
    fa_500px* obj1 = (fa_500px*)uNew(fa_500px_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
