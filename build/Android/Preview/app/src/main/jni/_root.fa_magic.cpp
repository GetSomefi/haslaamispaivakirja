// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_magic.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_magic.h>
...
// public partial sealed class fa_magic :2
// {
// static fa_magic() :4
static void fa_magic__cctor_4_fn(uType* __type)
{
}

static void fa_magic_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_magic__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_magic_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_magic);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_magic", options);
    type->fp_build_ = fa_magic_build;
    type->fp_ctor_ = (void*)fa_magic__New4_fn;
    type->fp_cctor_ = fa_magic__cctor_4_fn;
...
// public fa_magic() :8
void fa_magic__ctor_8_fn(fa_magic* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_magic__InitializeUX1_fn(fa_magic* __this)
{
    __this->InitializeUX1();
}

// public fa_magic New() :8
void fa_magic__New4_fn(fa_magic** __retval)
{
    *__retval = fa_magic::New4();
}

// public fa_magic() [instance] :8
void fa_magic::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_magic::InitializeUX1()
{
    uStackFrame __("fa_magic", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D0"*/]);
    SourceLineNumber(388);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_magic New() [static] :8
fa_magic* fa_magic::New4()
{
    fa_magic* obj1 = (fa_magic*)uNew(fa_magic_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
