// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_street_view.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_street_view.h>
...
// public partial sealed class fa_street_view :2
// {
// static fa_street_view() :4
static void fa_street_view__cctor_4_fn(uType* __type)
{
}

static void fa_street_view_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\235");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_street_view__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_street_view_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_street_view);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_street_view", options);
    type->fp_build_ = fa_street_view_build;
    type->fp_ctor_ = (void*)fa_street_view__New4_fn;
    type->fp_cctor_ = fa_street_view__cctor_4_fn;
...
// public fa_street_view() :8
void fa_street_view__ctor_8_fn(fa_street_view* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_street_view__InitializeUX1_fn(fa_street_view* __this)
{
    __this->InitializeUX1();
}

// public fa_street_view New() :8
void fa_street_view__New4_fn(fa_street_view** __retval)
{
    *__retval = fa_street_view::New4();
}

// public fa_street_view() [instance] :8
void fa_street_view::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_street_view::InitializeUX1()
{
    uStackFrame __("fa_street_view", "InitializeUX()");
    Value(::STRINGS[0/*"\uF21D"*/]);
    SourceLineNumber(582);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_street_view New() [static] :8
fa_street_view* fa_street_view::New4()
{
    fa_street_view* obj1 = (fa_street_view*)uNew(fa_street_view_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
