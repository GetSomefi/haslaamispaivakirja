// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_superscript.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_superscript.h>
...
// public partial sealed class fa_superscript :2
// {
// static fa_superscript() :4
static void fa_superscript__cctor_4_fn(uType* __type)
{
}

static void fa_superscript_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_superscript__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_superscript_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_superscript);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_superscript", options);
    type->fp_build_ = fa_superscript_build;
    type->fp_ctor_ = (void*)fa_superscript__New4_fn;
    type->fp_cctor_ = fa_superscript__cctor_4_fn;
...
// public fa_superscript() :8
void fa_superscript__ctor_8_fn(fa_superscript* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_superscript__InitializeUX1_fn(fa_superscript* __this)
{
    __this->InitializeUX1();
}

// public fa_superscript New() :8
void fa_superscript__New4_fn(fa_superscript** __retval)
{
    *__retval = fa_superscript::New4();
}

// public fa_superscript() [instance] :8
void fa_superscript::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_superscript::InitializeUX1()
{
    uStackFrame __("fa_superscript", "InitializeUX()");
    Value(::STRINGS[0/*"\uF12B"*/]);
    SourceLineNumber(590);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_superscript New() [static] :8
fa_superscript* fa_superscript::New4()
{
    fa_superscript* obj1 = (fa_superscript*)uNew(fa_superscript_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
