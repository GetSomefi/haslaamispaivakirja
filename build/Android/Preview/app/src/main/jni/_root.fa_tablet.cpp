// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tablet.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tablet.h>
...
// public partial sealed class fa_tablet :2
// {
// static fa_tablet() :4
static void fa_tablet__cctor_4_fn(uType* __type)
{
}

static void fa_tablet_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tablet__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tablet_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tablet);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tablet", options);
    type->fp_build_ = fa_tablet_build;
    type->fp_ctor_ = (void*)fa_tablet__New4_fn;
    type->fp_cctor_ = fa_tablet__cctor_4_fn;
...
// public fa_tablet() :8
void fa_tablet__ctor_8_fn(fa_tablet* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tablet__InitializeUX1_fn(fa_tablet* __this)
{
    __this->InitializeUX1();
}

// public fa_tablet New() :8
void fa_tablet__New4_fn(fa_tablet** __retval)
{
    *__retval = fa_tablet::New4();
}

// public fa_tablet() [instance] :8
void fa_tablet::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tablet::InitializeUX1()
{
    uStackFrame __("fa_tablet", "InitializeUX()");
    Value(::STRINGS[0/*"\uF10A"*/]);
    SourceLineNumber(593);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tablet New() [static] :8
fa_tablet* fa_tablet::New4()
{
    fa_tablet* obj1 = (fa_tablet*)uNew(fa_tablet_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
