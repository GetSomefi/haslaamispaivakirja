// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_film.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_film.h>
...
// public partial sealed class fa_film :2
// {
// static fa_film() :4
static void fa_film__cctor_4_fn(uType* __type)
{
}

static void fa_film_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_film__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_film_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_film);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_film", options);
    type->fp_build_ = fa_film_build;
    type->fp_ctor_ = (void*)fa_film__New4_fn;
    type->fp_cctor_ = fa_film__cctor_4_fn;
...
// public fa_film() :8
void fa_film__ctor_8_fn(fa_film* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_film__InitializeUX1_fn(fa_film* __this)
{
    __this->InitializeUX1();
}

// public fa_film New() :8
void fa_film__New4_fn(fa_film** __retval)
{
    *__retval = fa_film::New4();
}

// public fa_film() [instance] :8
void fa_film::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_film::InitializeUX1()
{
    uStackFrame __("fa_film", "InitializeUX()");
    Value(::STRINGS[0/*"\uF008"*/]);
    SourceLineNumber(251);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_film New() [static] :8
fa_film* fa_film::New4()
{
    fa_film* obj1 = (fa_film*)uNew(fa_film_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
