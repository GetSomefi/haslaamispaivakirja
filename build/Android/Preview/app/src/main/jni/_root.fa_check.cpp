// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_check.g.uno'.
...
// public partial sealed class fa_check :2
// {
// static fa_check() :4
static void fa_check__cctor_4_fn(uType* __type)
{
}

static void fa_check_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_check__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_check_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_check);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_check", options);
    type->fp_build_ = fa_check_build;
    type->fp_ctor_ = (void*)fa_check__New4_fn;
    type->fp_cctor_ = fa_check__cctor_4_fn;
...
// public fa_check() :8
void fa_check__ctor_8_fn(fa_check* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_check__InitializeUX1_fn(fa_check* __this)
{
    __this->InitializeUX1();
}

// public fa_check New() :8
void fa_check__New4_fn(fa_check** __retval)
{
    *__retval = fa_check::New4();
}

// public fa_check() [instance] :8
void fa_check::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_check::InitializeUX1()
{
    uStackFrame __("fa_check", "InitializeUX()");
    Value(::STRINGS[0/*"\uF00C"*/]);
    SourceLineNumber(127);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_check New() [static] :8
fa_check* fa_check::New4()
{
    fa_check* obj1 = (fa_check*)uNew(fa_check_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
