// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_road.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_road.h>
...
// public partial sealed class fa_road :2
// {
// static fa_road() :4
static void fa_road__cctor_4_fn(uType* __type)
{
}

static void fa_road_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\230");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_road__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_road_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_road);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_road", options);
    type->fp_build_ = fa_road_build;
    type->fp_ctor_ = (void*)fa_road__New4_fn;
    type->fp_cctor_ = fa_road__cctor_4_fn;
...
// public fa_road() :8
void fa_road__ctor_8_fn(fa_road* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_road__InitializeUX1_fn(fa_road* __this)
{
    __this->InitializeUX1();
}

// public fa_road New() :8
void fa_road__New4_fn(fa_road** __retval)
{
    *__retval = fa_road::New4();
}

// public fa_road() [instance] :8
void fa_road::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_road::InitializeUX1()
{
    uStackFrame __("fa_road", "InitializeUX()");
    Value(::STRINGS[0/*"\uF018"*/]);
    SourceLineNumber(500);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_road New() [static] :8
fa_road* fa_road::New4()
{
    fa_road* obj1 = (fa_road*)uNew(fa_road_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
