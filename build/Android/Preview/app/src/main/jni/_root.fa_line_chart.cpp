// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_line_chart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_line_chart.h>
...
// public partial sealed class fa_line_chart :2
// {
// static fa_line_chart() :4
static void fa_line_chart__cctor_4_fn(uType* __type)
{
}

static void fa_line_chart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_line_chart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_line_chart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_line_chart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_line_chart", options);
    type->fp_build_ = fa_line_chart_build;
    type->fp_ctor_ = (void*)fa_line_chart__New4_fn;
    type->fp_cctor_ = fa_line_chart__cctor_4_fn;
...
// public fa_line_chart() :8
void fa_line_chart__ctor_8_fn(fa_line_chart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_line_chart__InitializeUX1_fn(fa_line_chart* __this)
{
    __this->InitializeUX1();
}

// public fa_line_chart New() :8
void fa_line_chart__New4_fn(fa_line_chart** __retval)
{
    *__retval = fa_line_chart::New4();
}

// public fa_line_chart() [instance] :8
void fa_line_chart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_line_chart::InitializeUX1()
{
    uStackFrame __("fa_line_chart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF201"*/]);
    SourceLineNumber(373);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_line_chart New() [static] :8
fa_line_chart* fa_line_chart::New4()
{
    fa_line_chart* obj1 = (fa_line_chart*)uNew(fa_line_chart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
