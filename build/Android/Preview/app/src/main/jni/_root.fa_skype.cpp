// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_skype.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_skype.h>
...
// public partial sealed class fa_skype :2
// {
// static fa_skype() :4
static void fa_skype__cctor_4_fn(uType* __type)
{
}

static void fa_skype_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_skype__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_skype_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_skype);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_skype", options);
    type->fp_build_ = fa_skype_build;
    type->fp_ctor_ = (void*)fa_skype__New4_fn;
    type->fp_cctor_ = fa_skype__cctor_4_fn;
...
// public fa_skype() :8
void fa_skype__ctor_8_fn(fa_skype* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_skype__InitializeUX1_fn(fa_skype* __this)
{
    __this->InitializeUX1();
}

// public fa_skype New() :8
void fa_skype__New4_fn(fa_skype** __retval)
{
    *__retval = fa_skype::New4();
}

// public fa_skype() [instance] :8
void fa_skype::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_skype::InitializeUX1()
{
    uStackFrame __("fa_skype", "InitializeUX()");
    Value(::STRINGS[0/*"\uF17E"*/]);
    SourceLineNumber(540);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_skype New() [static] :8
fa_skype* fa_skype::New4()
{
    fa_skype* obj1 = (fa_skype*)uNew(fa_skype_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
