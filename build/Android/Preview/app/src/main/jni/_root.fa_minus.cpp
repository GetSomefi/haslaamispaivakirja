// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_minus.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_minus.h>
...
// public partial sealed class fa_minus :2
// {
// static fa_minus() :4
static void fa_minus__cctor_4_fn(uType* __type)
{
}

static void fa_minus_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\250");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_minus__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_minus_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_minus);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_minus", options);
    type->fp_build_ = fa_minus_build;
    type->fp_ctor_ = (void*)fa_minus__New4_fn;
    type->fp_cctor_ = fa_minus__cctor_4_fn;
...
// public fa_minus() :8
void fa_minus__ctor_8_fn(fa_minus* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_minus__InitializeUX1_fn(fa_minus* __this)
{
    __this->InitializeUX1();
}

// public fa_minus New() :8
void fa_minus__New4_fn(fa_minus** __retval)
{
    *__retval = fa_minus::New4();
}

// public fa_minus() [instance] :8
void fa_minus::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_minus::InitializeUX1()
{
    uStackFrame __("fa_minus", "InitializeUX()");
    Value(::STRINGS[0/*"\uF068"*/]);
    SourceLineNumber(412);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_minus New() [static] :8
fa_minus* fa_minus::New4()
{
    fa_minus* obj1 = (fa_minus*)uNew(fa_minus_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
