// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_key.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_key.h>
...
// public partial sealed class fa_key :2
// {
// static fa_key() :4
static void fa_key__cctor_4_fn(uType* __type)
{
}

static void fa_key_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_key__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_key_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_key);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_key", options);
    type->fp_build_ = fa_key_build;
    type->fp_ctor_ = (void*)fa_key__New4_fn;
    type->fp_cctor_ = fa_key__cctor_4_fn;
...
// public fa_key() :8
void fa_key__ctor_8_fn(fa_key* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_key__InitializeUX1_fn(fa_key* __this)
{
    __this->InitializeUX1();
}

// public fa_key New() :8
void fa_key__New4_fn(fa_key** __retval)
{
    *__retval = fa_key::New4();
}

// public fa_key() [instance] :8
void fa_key::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_key::InitializeUX1()
{
    uStackFrame __("fa_key", "InitializeUX()");
    Value(::STRINGS[0/*"\uF084"*/]);
    SourceLineNumber(355);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_key New() [static] :8
fa_key* fa_key::New4()
{
    fa_key* obj1 = (fa_key*)uNew(fa_key_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
