// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_turkish_lira.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_turkish_lira.h>
...
// public partial sealed class fa_turkish_lira :2
// {
// static fa_turkish_lira() :4
static void fa_turkish_lira__cctor_4_fn(uType* __type)
{
}

static void fa_turkish_lira_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_turkish_lira__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_turkish_lira_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_turkish_lira);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_turkish_lira", options);
    type->fp_build_ = fa_turkish_lira_build;
    type->fp_ctor_ = (void*)fa_turkish_lira__New4_fn;
    type->fp_cctor_ = fa_turkish_lira__cctor_4_fn;
...
// public fa_turkish_lira() :8
void fa_turkish_lira__ctor_8_fn(fa_turkish_lira* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_turkish_lira__InitializeUX1_fn(fa_turkish_lira* __this)
{
    __this->InitializeUX1();
}

// public fa_turkish_lira New() :8
void fa_turkish_lira__New4_fn(fa_turkish_lira** __retval)
{
    *__retval = fa_turkish_lira::New4();
}

// public fa_turkish_lira() [instance] :8
void fa_turkish_lira::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_turkish_lira::InitializeUX1()
{
    uStackFrame __("fa_turkish_lira", "InitializeUX()");
    Value(::STRINGS[0/*"\uF195"*/]);
    SourceLineNumber(638);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_turkish_lira New() [static] :8
fa_turkish_lira* fa_turkish_lira::New4()
{
    fa_turkish_lira* obj1 = (fa_turkish_lira*)uNew(fa_turkish_lira_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
