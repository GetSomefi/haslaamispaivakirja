// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_stripe.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_stripe.h>
...
// public partial sealed class fa_cc_stripe :2
// {
// static fa_cc_stripe() :4
static void fa_cc_stripe__cctor_4_fn(uType* __type)
{
}

static void fa_cc_stripe_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\265");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_stripe__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_stripe_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_stripe);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_stripe", options);
    type->fp_build_ = fa_cc_stripe_build;
    type->fp_ctor_ = (void*)fa_cc_stripe__New4_fn;
    type->fp_cctor_ = fa_cc_stripe__cctor_4_fn;
...
// public fa_cc_stripe() :8
void fa_cc_stripe__ctor_8_fn(fa_cc_stripe* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_stripe__InitializeUX1_fn(fa_cc_stripe* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_stripe New() :8
void fa_cc_stripe__New4_fn(fa_cc_stripe** __retval)
{
    *__retval = fa_cc_stripe::New4();
}

// public fa_cc_stripe() [instance] :8
void fa_cc_stripe::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_stripe::InitializeUX1()
{
    uStackFrame __("fa_cc_stripe", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F5"*/]);
    SourceLineNumber(122);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cc_stripe New() [static] :8
fa_cc_stripe* fa_cc_stripe::New4()
{
    fa_cc_stripe* obj1 = (fa_cc_stripe*)uNew(fa_cc_stripe_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
