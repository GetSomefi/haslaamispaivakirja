// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tencent_weibo.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tencent_weibo.h>
...
// public partial sealed class fa_tencent_weibo :2
// {
// static fa_tencent_weibo() :4
static void fa_tencent_weibo__cctor_4_fn(uType* __type)
{
}

static void fa_tencent_weibo_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tencent_weibo__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tencent_weibo_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tencent_weibo);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tencent_weibo", options);
    type->fp_build_ = fa_tencent_weibo_build;
    type->fp_ctor_ = (void*)fa_tencent_weibo__New4_fn;
    type->fp_cctor_ = fa_tencent_weibo__cctor_4_fn;
...
// public fa_tencent_weibo() :8
void fa_tencent_weibo__ctor_8_fn(fa_tencent_weibo* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tencent_weibo__InitializeUX1_fn(fa_tencent_weibo* __this)
{
    __this->InitializeUX1();
}

// public fa_tencent_weibo New() :8
void fa_tencent_weibo__New4_fn(fa_tencent_weibo** __retval)
{
    *__retval = fa_tencent_weibo::New4();
}

// public fa_tencent_weibo() [instance] :8
void fa_tencent_weibo::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tencent_weibo::InitializeUX1()
{
    uStackFrame __("fa_tencent_weibo", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D5"*/]);
    SourceLineNumber(600);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_tencent_weibo New() [static] :8
fa_tencent_weibo* fa_tencent_weibo::New4()
{
    fa_tencent_weibo* obj1 = (fa_tencent_weibo*)uNew(fa_tencent_weibo_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
