// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_user.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_user.h>
...
// public partial sealed class fa_user :2
// {
// static fa_user() :4
static void fa_user__cctor_4_fn(uType* __type)
{
}

static void fa_user_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_user__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_user_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_user);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_user", options);
    type->fp_build_ = fa_user_build;
    type->fp_ctor_ = (void*)fa_user__New4_fn;
    type->fp_cctor_ = fa_user__cctor_4_fn;
...
// public fa_user() :8
void fa_user__ctor_8_fn(fa_user* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_user__InitializeUX1_fn(fa_user* __this)
{
    __this->InitializeUX1();
}

// public fa_user New() :8
void fa_user__New4_fn(fa_user** __retval)
{
    *__retval = fa_user::New4();
}

// public fa_user() [instance] :8
void fa_user::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_user::InitializeUX1()
{
    uStackFrame __("fa_user", "InitializeUX()");
    Value(::STRINGS[0/*"\uF007"*/]);
...
// public fa_user New() [static] :8
fa_user* fa_user::New4()
{
    fa_user* obj1 = (fa_user*)uNew(fa_user_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
