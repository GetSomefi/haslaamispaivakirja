// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_star_half_full.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_star_half_full.h>
...
// public partial sealed class fa_star_half_full :2
// {
// static fa_star_half_full() :4
static void fa_star_half_full__cctor_4_fn(uType* __type)
{
}

static void fa_star_half_full_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_star_half_full__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_star_half_full_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_star_half_full);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_star_half_full", options);
    type->fp_build_ = fa_star_half_full_build;
    type->fp_ctor_ = (void*)fa_star_half_full__New4_fn;
    type->fp_cctor_ = fa_star_half_full__cctor_4_fn;
...
// public fa_star_half_full() :8
void fa_star_half_full__ctor_8_fn(fa_star_half_full* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_star_half_full__InitializeUX1_fn(fa_star_half_full* __this)
{
    __this->InitializeUX1();
}

// public fa_star_half_full New() :8
void fa_star_half_full__New4_fn(fa_star_half_full** __retval)
{
    *__retval = fa_star_half_full::New4();
}

// public fa_star_half_full() [instance] :8
void fa_star_half_full::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_star_half_full::InitializeUX1()
{
    uStackFrame __("fa_star_half_full", "InitializeUX()");
    Value(::STRINGS[0/*"\uF123"*/]);
    SourceLineNumber(569);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_star_half_full New() [static] :8
fa_star_half_full* fa_star_half_full::New4()
{
    fa_star_half_full* obj1 = (fa_star_half_full*)uNew(fa_star_half_full_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
