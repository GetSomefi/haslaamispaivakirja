// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_female.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_female.h>
...
// public partial sealed class fa_female :2
// {
// static fa_female() :4
static void fa_female__cctor_4_fn(uType* __type)
{
}

static void fa_female_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\202");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_female__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_female_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_female);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_female", options);
    type->fp_build_ = fa_female_build;
    type->fp_ctor_ = (void*)fa_female__New4_fn;
    type->fp_cctor_ = fa_female__cctor_4_fn;
...
// public fa_female() :8
void fa_female__ctor_8_fn(fa_female* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_female__InitializeUX1_fn(fa_female* __this)
{
    __this->InitializeUX1();
}

// public fa_female New() :8
void fa_female__New4_fn(fa_female** __retval)
{
    *__retval = fa_female::New4();
}

// public fa_female() [instance] :8
void fa_female::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_female::InitializeUX1()
{
    uStackFrame __("fa_female", "InitializeUX()");
    Value(::STRINGS[0/*"\uF182"*/]);
    SourceLineNumber(230);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_female New() [static] :8
fa_female* fa_female::New4()
{
    fa_female* obj1 = (fa_female*)uNew(fa_female_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
