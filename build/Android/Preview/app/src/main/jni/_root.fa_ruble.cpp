// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ruble.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ruble.h>
...
// public partial sealed class fa_ruble :2
// {
// static fa_ruble() :4
static void fa_ruble__cctor_4_fn(uType* __type)
{
}

static void fa_ruble_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ruble__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ruble_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ruble);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ruble", options);
    type->fp_build_ = fa_ruble_build;
    type->fp_ctor_ = (void*)fa_ruble__New4_fn;
    type->fp_cctor_ = fa_ruble__cctor_4_fn;
...
// public fa_ruble() :8
void fa_ruble__ctor_8_fn(fa_ruble* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ruble__InitializeUX1_fn(fa_ruble* __this)
{
    __this->InitializeUX1();
}

// public fa_ruble New() :8
void fa_ruble__New4_fn(fa_ruble** __retval)
{
    *__retval = fa_ruble::New4();
}

// public fa_ruble() [instance] :8
void fa_ruble::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_ruble::InitializeUX1()
{
    uStackFrame __("fa_ruble", "InitializeUX()");
    Value(::STRINGS[0/*"\uF158"*/]);
    SourceLineNumber(508);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ruble New() [static] :8
fa_ruble* fa_ruble::New4()
{
    fa_ruble* obj1 = (fa_ruble*)uNew(fa_ruble_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
