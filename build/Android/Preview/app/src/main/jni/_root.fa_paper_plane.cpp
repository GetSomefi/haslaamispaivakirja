// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paper_plane.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paper_plane.h>
...
// public partial sealed class fa_paper_plane :2
// {
// static fa_paper_plane() :4
static void fa_paper_plane__cctor_4_fn(uType* __type)
{
}

static void fa_paper_plane_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\230");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paper_plane__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paper_plane_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paper_plane);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paper_plane", options);
    type->fp_build_ = fa_paper_plane_build;
    type->fp_ctor_ = (void*)fa_paper_plane__New4_fn;
    type->fp_cctor_ = fa_paper_plane__cctor_4_fn;
...
// public fa_paper_plane() :8
void fa_paper_plane__ctor_8_fn(fa_paper_plane* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paper_plane__InitializeUX1_fn(fa_paper_plane* __this)
{
    __this->InitializeUX1();
}

// public fa_paper_plane New() :8
void fa_paper_plane__New4_fn(fa_paper_plane** __retval)
{
    *__retval = fa_paper_plane::New4();
}

// public fa_paper_plane() [instance] :8
void fa_paper_plane::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paper_plane::InitializeUX1()
{
    uStackFrame __("fa_paper_plane", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D8"*/]);
    SourceLineNumber(440);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paper_plane New() [static] :8
fa_paper_plane* fa_paper_plane::New4()
{
    fa_paper_plane* obj1 = (fa_paper_plane*)uNew(fa_paper_plane_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
