// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bullhorn.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bullhorn.h>
...
// public partial sealed class fa_bullhorn :2
// {
// static fa_bullhorn() :4
static void fa_bullhorn__cctor_4_fn(uType* __type)
{
}

static void fa_bullhorn_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\241");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bullhorn__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bullhorn_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bullhorn);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bullhorn", options);
    type->fp_build_ = fa_bullhorn_build;
    type->fp_ctor_ = (void*)fa_bullhorn__New4_fn;
    type->fp_cctor_ = fa_bullhorn__cctor_4_fn;
...
// public fa_bullhorn() :8
void fa_bullhorn__ctor_8_fn(fa_bullhorn* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bullhorn__InitializeUX1_fn(fa_bullhorn* __this)
{
    __this->InitializeUX1();
}

// public fa_bullhorn New() :8
void fa_bullhorn__New4_fn(fa_bullhorn** __retval)
{
    *__retval = fa_bullhorn::New4();
}

// public fa_bullhorn() [instance] :8
void fa_bullhorn::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bullhorn::InitializeUX1()
{
    uStackFrame __("fa_bullhorn", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0A1"*/]);
    SourceLineNumber(90);
...
// public fa_bullhorn New() [static] :8
fa_bullhorn* fa_bullhorn::New4()
{
    fa_bullhorn* obj1 = (fa_bullhorn*)uNew(fa_bullhorn_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
