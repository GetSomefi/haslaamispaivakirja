// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_folder.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_folder.h>
...
// public partial sealed class fa_folder :2
// {
// static fa_folder() :4
static void fa_folder__cctor_4_fn(uType* __type)
{
}

static void fa_folder_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_folder__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_folder_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_folder);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_folder", options);
    type->fp_build_ = fa_folder_build;
    type->fp_ctor_ = (void*)fa_folder__New4_fn;
    type->fp_cctor_ = fa_folder__cctor_4_fn;
...
// public fa_folder() :8
void fa_folder__ctor_8_fn(fa_folder* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_folder__InitializeUX1_fn(fa_folder* __this)
{
    __this->InitializeUX1();
}

// public fa_folder New() :8
void fa_folder__New4_fn(fa_folder** __retval)
{
    *__retval = fa_folder::New4();
}

// public fa_folder() [instance] :8
void fa_folder::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_folder::InitializeUX1()
{
    uStackFrame __("fa_folder", "InitializeUX()");
    Value(::STRINGS[0/*"\uF07B"*/]);
    SourceLineNumber(263);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_folder New() [static] :8
fa_folder* fa_folder::New4()
{
    fa_folder* obj1 = (fa_folder*)uNew(fa_folder_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
