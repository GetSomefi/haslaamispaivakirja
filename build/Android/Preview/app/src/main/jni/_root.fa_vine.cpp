// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_vine.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_vine.h>
...
// public partial sealed class fa_vine :2
// {
// static fa_vine() :4
static void fa_vine__cctor_4_fn(uType* __type)
{
}

static void fa_vine_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_vine__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_vine_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_vine);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_vine", options);
    type->fp_build_ = fa_vine_build;
    type->fp_ctor_ = (void*)fa_vine__New4_fn;
    type->fp_cctor_ = fa_vine__cctor_4_fn;
...
// public fa_vine() :8
void fa_vine__ctor_8_fn(fa_vine* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_vine__InitializeUX1_fn(fa_vine* __this)
{
    __this->InitializeUX1();
}

// public fa_vine New() :8
void fa_vine__New4_fn(fa_vine** __retval)
{
    *__retval = fa_vine::New4();
}

// public fa_vine() [instance] :8
void fa_vine::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_vine::InitializeUX1()
{
    uStackFrame __("fa_vine", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CA"*/]);
    SourceLineNumber(667);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_vine New() [static] :8
fa_vine* fa_vine::New4()
{
    fa_vine* obj1 = (fa_vine*)uNew(fa_vine_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
