// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_leaf.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_leaf.h>
...
// public partial sealed class fa_leaf :2
// {
// static fa_leaf() :4
static void fa_leaf__cctor_4_fn(uType* __type)
{
}

static void fa_leaf_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_leaf__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_leaf_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_leaf);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_leaf", options);
    type->fp_build_ = fa_leaf_build;
    type->fp_ctor_ = (void*)fa_leaf__New4_fn;
    type->fp_cctor_ = fa_leaf__cctor_4_fn;
...
// public fa_leaf() :8
void fa_leaf__ctor_8_fn(fa_leaf* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_leaf__InitializeUX1_fn(fa_leaf* __this)
{
    __this->InitializeUX1();
}

// public fa_leaf New() :8
void fa_leaf__New4_fn(fa_leaf** __retval)
{
    *__retval = fa_leaf::New4();
}

// public fa_leaf() [instance] :8
void fa_leaf::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_leaf::InitializeUX1()
{
    uStackFrame __("fa_leaf", "InitializeUX()");
    Value(::STRINGS[0/*"\uF06C"*/]);
    SourceLineNumber(362);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_leaf New() [static] :8
fa_leaf* fa_leaf::New4()
{
    fa_leaf* obj1 = (fa_leaf*)uNew(fa_leaf_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
