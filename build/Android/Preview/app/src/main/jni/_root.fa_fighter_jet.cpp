// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_fighter_jet.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_fighter_jet.h>
...
// public partial sealed class fa_fighter_jet :2
// {
// static fa_fighter_jet() :4
static void fa_fighter_jet__cctor_4_fn(uType* __type)
{
}

static void fa_fighter_jet_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_fighter_jet__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_fighter_jet_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_fighter_jet);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_fighter_jet", options);
    type->fp_build_ = fa_fighter_jet_build;
    type->fp_ctor_ = (void*)fa_fighter_jet__New4_fn;
    type->fp_cctor_ = fa_fighter_jet__cctor_4_fn;
...
// public fa_fighter_jet() :8
void fa_fighter_jet__ctor_8_fn(fa_fighter_jet* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_fighter_jet__InitializeUX1_fn(fa_fighter_jet* __this)
{
    __this->InitializeUX1();
}

// public fa_fighter_jet New() :8
void fa_fighter_jet__New4_fn(fa_fighter_jet** __retval)
{
    *__retval = fa_fighter_jet::New4();
}

// public fa_fighter_jet() [instance] :8
void fa_fighter_jet::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_fighter_jet::InitializeUX1()
{
    uStackFrame __("fa_fighter_jet", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0FB"*/]);
    SourceLineNumber(231);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_fighter_jet New() [static] :8
fa_fighter_jet* fa_fighter_jet::New4()
{
    fa_fighter_jet* obj1 = (fa_fighter_jet*)uNew(fa_fighter_jet_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
