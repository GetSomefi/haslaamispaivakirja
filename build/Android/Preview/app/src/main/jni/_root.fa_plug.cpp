// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_plug.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_plug.h>
...
// public partial sealed class fa_plug :2
// {
// static fa_plug() :4
static void fa_plug__cctor_4_fn(uType* __type)
{
}

static void fa_plug_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\246");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_plug__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_plug_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_plug);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_plug", options);
    type->fp_build_ = fa_plug_build;
    type->fp_ctor_ = (void*)fa_plug__New4_fn;
    type->fp_cctor_ = fa_plug__cctor_4_fn;
...
// public fa_plug() :8
void fa_plug__ctor_8_fn(fa_plug* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_plug__InitializeUX1_fn(fa_plug* __this)
{
    __this->InitializeUX1();
}

// public fa_plug New() :8
void fa_plug__New4_fn(fa_plug** __retval)
{
    *__retval = fa_plug::New4();
}

// public fa_plug() [instance] :8
void fa_plug::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_plug::InitializeUX1()
{
    uStackFrame __("fa_plug", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E6"*/]);
    SourceLineNumber(468);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_plug New() [static] :8
fa_plug* fa_plug::New4()
{
    fa_plug* obj1 = (fa_plug*)uNew(fa_plug_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
