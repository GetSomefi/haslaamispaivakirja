// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_eur.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_eur.h>
...
// public partial sealed class fa_eur :2
// {
// static fa_eur() :4
static void fa_eur__cctor_4_fn(uType* __type)
{
}

static void fa_eur_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_eur__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_eur_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_eur);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_eur", options);
    type->fp_build_ = fa_eur_build;
    type->fp_ctor_ = (void*)fa_eur__New4_fn;
    type->fp_cctor_ = fa_eur__cctor_4_fn;
...
// public fa_eur() :8
void fa_eur__ctor_8_fn(fa_eur* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_eur__InitializeUX1_fn(fa_eur* __this)
{
    __this->InitializeUX1();
}

// public fa_eur New() :8
void fa_eur__New4_fn(fa_eur** __retval)
{
    *__retval = fa_eur::New4();
}

// public fa_eur() [instance] :8
void fa_eur::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_eur::InitializeUX1()
{
    uStackFrame __("fa_eur", "InitializeUX()");
    Value(::STRINGS[0/*"\uF153"*/]);
    SourceLineNumber(209);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_eur New() [static] :8
fa_eur* fa_eur::New4()
{
    fa_eur* obj1 = (fa_eur*)uNew(fa_eur_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
