// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paperclip.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paperclip.h>
...
// public partial sealed class fa_paperclip :2
// {
// static fa_paperclip() :4
static void fa_paperclip__cctor_4_fn(uType* __type)
{
}

static void fa_paperclip_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\206");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paperclip__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paperclip_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paperclip);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paperclip", options);
    type->fp_build_ = fa_paperclip_build;
    type->fp_ctor_ = (void*)fa_paperclip__New4_fn;
    type->fp_cctor_ = fa_paperclip__cctor_4_fn;
...
// public fa_paperclip() :8
void fa_paperclip__ctor_8_fn(fa_paperclip* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paperclip__InitializeUX1_fn(fa_paperclip* __this)
{
    __this->InitializeUX1();
}

// public fa_paperclip New() :8
void fa_paperclip__New4_fn(fa_paperclip** __retval)
{
    *__retval = fa_paperclip::New4();
}

// public fa_paperclip() [instance] :8
void fa_paperclip::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paperclip::InitializeUX1()
{
    uStackFrame __("fa_paperclip", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C6"*/]);
    SourceLineNumber(442);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paperclip New() [static] :8
fa_paperclip* fa_paperclip::New4()
{
    fa_paperclip* obj1 = (fa_paperclip*)uNew(fa_paperclip_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
