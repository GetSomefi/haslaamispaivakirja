// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cloud_upload.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cloud_upload.h>
...
// public partial sealed class fa_cloud_upload :2
// {
// static fa_cloud_upload() :4
static void fa_cloud_upload__cctor_4_fn(uType* __type)
{
}

static void fa_cloud_upload_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cloud_upload__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cloud_upload_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cloud_upload);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cloud_upload", options);
    type->fp_build_ = fa_cloud_upload_build;
    type->fp_ctor_ = (void*)fa_cloud_upload__New4_fn;
    type->fp_cctor_ = fa_cloud_upload__cctor_4_fn;
...
// public fa_cloud_upload() :8
void fa_cloud_upload__ctor_8_fn(fa_cloud_upload* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cloud_upload__InitializeUX1_fn(fa_cloud_upload* __this)
{
    __this->InitializeUX1();
}

// public fa_cloud_upload New() :8
void fa_cloud_upload__New4_fn(fa_cloud_upload** __retval)
{
    *__retval = fa_cloud_upload::New4();
}

// public fa_cloud_upload() [instance] :8
void fa_cloud_upload::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cloud_upload::InitializeUX1()
{
    uStackFrame __("fa_cloud_upload", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0EE"*/]);
    SourceLineNumber(152);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cloud_upload New() [static] :8
fa_cloud_upload* fa_cloud_upload::New4()
{
    fa_cloud_upload* obj1 = (fa_cloud_upload*)uNew(fa_cloud_upload_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
