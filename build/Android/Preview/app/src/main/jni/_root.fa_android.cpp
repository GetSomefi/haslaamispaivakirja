// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_android.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_android.h>
...
// public partial sealed class fa_android :2
// {
// static fa_android() :4
static void fa_android__cctor_4_fn(uType* __type)
{
}

static void fa_android_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\273");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_android__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_android_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_android);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_android", options);
    type->fp_build_ = fa_android_build;
    type->fp_ctor_ = (void*)fa_android__New4_fn;
    type->fp_cctor_ = fa_android__cctor_4_fn;
...
// public fa_android() :8
void fa_android__ctor_8_fn(fa_android* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_android__InitializeUX1_fn(fa_android* __this)
{
    __this->InitializeUX1();
}

// public fa_android New() :8
void fa_android__New4_fn(fa_android** __retval)
{
    *__retval = fa_android::New4();
}

// public fa_android() [instance] :8
void fa_android::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_android::InitializeUX1()
{
    uStackFrame __("fa_android", "InitializeUX()");
    Value(::STRINGS[0/*"\uF17B"*/]);
    SourceLineNumber(12);
...
// public fa_android New() [static] :8
fa_android* fa_android::New4()
{
    fa_android* obj1 = (fa_android*)uNew(fa_android_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
