// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_maxcdn.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_maxcdn.h>
...
// public partial sealed class fa_maxcdn :2
// {
// static fa_maxcdn() :4
static void fa_maxcdn__cctor_4_fn(uType* __type)
{
}

static void fa_maxcdn_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\266");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_maxcdn__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_maxcdn_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_maxcdn);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_maxcdn", options);
    type->fp_build_ = fa_maxcdn_build;
    type->fp_ctor_ = (void*)fa_maxcdn__New4_fn;
    type->fp_cctor_ = fa_maxcdn__cctor_4_fn;
...
// public fa_maxcdn() :8
void fa_maxcdn__ctor_8_fn(fa_maxcdn* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_maxcdn__InitializeUX1_fn(fa_maxcdn* __this)
{
    __this->InitializeUX1();
}

// public fa_maxcdn New() :8
void fa_maxcdn__New4_fn(fa_maxcdn** __retval)
{
    *__retval = fa_maxcdn::New4();
}

// public fa_maxcdn() [instance] :8
void fa_maxcdn::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_maxcdn::InitializeUX1()
{
    uStackFrame __("fa_maxcdn", "InitializeUX()");
    Value(::STRINGS[0/*"\uF136"*/]);
    SourceLineNumber(404);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_maxcdn New() [static] :8
fa_maxcdn* fa_maxcdn::New4()
{
    fa_maxcdn* obj1 = (fa_maxcdn*)uNew(fa_maxcdn_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
