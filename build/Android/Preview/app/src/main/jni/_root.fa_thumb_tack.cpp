// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_thumb_tack.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_thumb_tack.h>
...
// public partial sealed class fa_thumb_tack :2
// {
// static fa_thumb_tack() :4
static void fa_thumb_tack__cctor_4_fn(uType* __type)
{
}

static void fa_thumb_tack_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_thumb_tack__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_thumb_tack_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_thumb_tack);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_thumb_tack", options);
    type->fp_build_ = fa_thumb_tack_build;
    type->fp_ctor_ = (void*)fa_thumb_tack__New4_fn;
    type->fp_cctor_ = fa_thumb_tack__cctor_4_fn;
...
// public fa_thumb_tack() :8
void fa_thumb_tack__ctor_8_fn(fa_thumb_tack* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_thumb_tack__InitializeUX1_fn(fa_thumb_tack* __this)
{
    __this->InitializeUX1();
}

// public fa_thumb_tack New() :8
void fa_thumb_tack__New4_fn(fa_thumb_tack** __retval)
{
    *__retval = fa_thumb_tack::New4();
}

// public fa_thumb_tack() [instance] :8
void fa_thumb_tack::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_thumb_tack::InitializeUX1()
{
    uStackFrame __("fa_thumb_tack", "InitializeUX()");
    Value(::STRINGS[0/*"\uF08D"*/]);
    SourceLineNumber(607);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_thumb_tack New() [static] :8
fa_thumb_tack* fa_thumb_tack::New4()
{
    fa_thumb_tack* obj1 = (fa_thumb_tack*)uNew(fa_thumb_tack_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
