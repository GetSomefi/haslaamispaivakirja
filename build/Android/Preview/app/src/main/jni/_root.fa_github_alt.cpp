// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_github_alt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_github_alt.h>
...
// public partial sealed class fa_github_alt :2
// {
// static fa_github_alt() :4
static void fa_github_alt__cctor_4_fn(uType* __type)
{
}

static void fa_github_alt_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_github_alt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_github_alt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_github_alt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_github_alt", options);
    type->fp_build_ = fa_github_alt_build;
    type->fp_ctor_ = (void*)fa_github_alt__New4_fn;
    type->fp_cctor_ = fa_github_alt__cctor_4_fn;
...
// public fa_github_alt() :8
void fa_github_alt__ctor_8_fn(fa_github_alt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_github_alt__InitializeUX1_fn(fa_github_alt* __this)
{
    __this->InitializeUX1();
}

// public fa_github_alt New() :8
void fa_github_alt__New4_fn(fa_github_alt** __retval)
{
    *__retval = fa_github_alt::New4();
}

// public fa_github_alt() [instance] :8
void fa_github_alt::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_github_alt::InitializeUX1()
{
    uStackFrame __("fa_github_alt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF113"*/]);
...
// public fa_github_alt New() [static] :8
fa_github_alt* fa_github_alt::New4()
{
    fa_github_alt* obj1 = (fa_github_alt*)uNew(fa_github_alt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
