// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_phone.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_phone.h>
...
// public partial sealed class fa_phone :2
// {
// static fa_phone() :4
static void fa_phone__cctor_4_fn(uType* __type)
{
}

static void fa_phone_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_phone__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_phone_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_phone);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_phone", options);
    type->fp_build_ = fa_phone_build;
    type->fp_ctor_ = (void*)fa_phone__New4_fn;
    type->fp_cctor_ = fa_phone__cctor_4_fn;
...
// public fa_phone() :8
void fa_phone__ctor_8_fn(fa_phone* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_phone__InitializeUX1_fn(fa_phone* __this)
{
    __this->InitializeUX1();
}

// public fa_phone New() :8
void fa_phone__New4_fn(fa_phone** __retval)
{
    *__retval = fa_phone::New4();
}

// public fa_phone() [instance] :8
void fa_phone::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_phone::InitializeUX1()
{
    uStackFrame __("fa_phone", "InitializeUX()");
    Value(::STRINGS[0/*"\uF095"*/]);
    SourceLineNumber(454);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_phone New() [static] :8
fa_phone* fa_phone::New4()
{
    fa_phone* obj1 = (fa_phone*)uNew(fa_phone_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
