// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_sliders.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_sliders.h>
...
// public partial sealed class fa_sliders :2
// {
// static fa_sliders() :4
static void fa_sliders__cctor_4_fn(uType* __type)
{
}

static void fa_sliders_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_sliders__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_sliders_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_sliders);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_sliders", options);
    type->fp_build_ = fa_sliders_build;
    type->fp_ctor_ = (void*)fa_sliders__New4_fn;
    type->fp_cctor_ = fa_sliders__cctor_4_fn;
...
// public fa_sliders() :8
void fa_sliders__ctor_8_fn(fa_sliders* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_sliders__InitializeUX1_fn(fa_sliders* __this)
{
    __this->InitializeUX1();
}

// public fa_sliders New() :8
void fa_sliders__New4_fn(fa_sliders** __retval)
{
    *__retval = fa_sliders::New4();
}

// public fa_sliders() [instance] :8
void fa_sliders::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_sliders::InitializeUX1()
{
    uStackFrame __("fa_sliders", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1DE"*/]);
    SourceLineNumber(542);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_sliders New() [static] :8
fa_sliders* fa_sliders::New4()
{
    fa_sliders* obj1 = (fa_sliders*)uNew(fa_sliders_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
