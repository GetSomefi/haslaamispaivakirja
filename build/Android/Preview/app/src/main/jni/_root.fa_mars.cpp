// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mars.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mars.h>
...
// public partial sealed class fa_mars :2
// {
// static fa_mars() :4
static void fa_mars__cctor_4_fn(uType* __type)
{
}

static void fa_mars_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\242");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mars__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mars_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mars);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mars", options);
    type->fp_build_ = fa_mars_build;
    type->fp_ctor_ = (void*)fa_mars__New4_fn;
    type->fp_cctor_ = fa_mars__cctor_4_fn;
...
// public fa_mars() :8
void fa_mars__ctor_8_fn(fa_mars* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mars__InitializeUX1_fn(fa_mars* __this)
{
    __this->InitializeUX1();
}

// public fa_mars New() :8
void fa_mars__New4_fn(fa_mars** __retval)
{
    *__retval = fa_mars::New4();
}

// public fa_mars() [instance] :8
void fa_mars::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_mars::InitializeUX1()
{
    uStackFrame __("fa_mars", "InitializeUX()");
    Value(::STRINGS[0/*"\uF222"*/]);
    SourceLineNumber(399);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mars New() [static] :8
fa_mars* fa_mars::New4()
{
    fa_mars* obj1 = (fa_mars*)uNew(fa_mars_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
