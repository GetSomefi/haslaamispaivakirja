// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_edit.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_edit.h>
...
// public partial sealed class fa_edit :2
// {
// static fa_edit() :4
static void fa_edit__cctor_4_fn(uType* __type)
{
}

static void fa_edit_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_edit__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_edit_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_edit);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_edit", options);
    type->fp_build_ = fa_edit_build;
    type->fp_ctor_ = (void*)fa_edit__New4_fn;
    type->fp_cctor_ = fa_edit__cctor_4_fn;
...
// public fa_edit() :8
void fa_edit__ctor_8_fn(fa_edit* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_edit__InitializeUX1_fn(fa_edit* __this)
{
    __this->InitializeUX1();
}

// public fa_edit New() :8
void fa_edit__New4_fn(fa_edit** __retval)
{
    *__retval = fa_edit::New4();
}

// public fa_edit() [instance] :8
void fa_edit::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_edit::InitializeUX1()
{
    uStackFrame __("fa_edit", "InitializeUX()");
    Value(::STRINGS[0/*"\uF044"*/]);
    SourceLineNumber(200);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_edit New() [static] :8
fa_edit* fa_edit::New4()
{
    fa_edit* obj1 = (fa_edit*)uNew(fa_edit_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
