// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_puzzle_piece.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_puzzle_piece.h>
...
// public partial sealed class fa_puzzle_piece :2
// {
// static fa_puzzle_piece() :4
static void fa_puzzle_piece__cctor_4_fn(uType* __type)
{
}

static void fa_puzzle_piece_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_puzzle_piece__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_puzzle_piece_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_puzzle_piece);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_puzzle_piece", options);
    type->fp_build_ = fa_puzzle_piece_build;
    type->fp_ctor_ = (void*)fa_puzzle_piece__New4_fn;
    type->fp_cctor_ = fa_puzzle_piece__cctor_4_fn;
...
// public fa_puzzle_piece() :8
void fa_puzzle_piece__ctor_8_fn(fa_puzzle_piece* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_puzzle_piece__InitializeUX1_fn(fa_puzzle_piece* __this)
{
    __this->InitializeUX1();
}

// public fa_puzzle_piece New() :8
void fa_puzzle_piece__New4_fn(fa_puzzle_piece** __retval)
{
    *__retval = fa_puzzle_piece::New4();
}

// public fa_puzzle_piece() [instance] :8
void fa_puzzle_piece::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_puzzle_piece::InitializeUX1()
{
    uStackFrame __("fa_puzzle_piece", "InitializeUX()");
    Value(::STRINGS[0/*"\uF12E"*/]);
    SourceLineNumber(476);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_puzzle_piece New() [static] :8
fa_puzzle_piece* fa_puzzle_piece::New4()
{
    fa_puzzle_piece* obj1 = (fa_puzzle_piece*)uNew(fa_puzzle_piece_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
