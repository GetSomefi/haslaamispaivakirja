// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_exchange.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_exchange.h>
...
// public partial sealed class fa_exchange :2
// {
// static fa_exchange() :4
static void fa_exchange__cctor_4_fn(uType* __type)
{
}

static void fa_exchange_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_exchange__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_exchange_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_exchange);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_exchange", options);
    type->fp_build_ = fa_exchange_build;
    type->fp_ctor_ = (void*)fa_exchange__New4_fn;
    type->fp_cctor_ = fa_exchange__cctor_4_fn;
...
// public fa_exchange() :8
void fa_exchange__ctor_8_fn(fa_exchange* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_exchange__InitializeUX1_fn(fa_exchange* __this)
{
    __this->InitializeUX1();
}

// public fa_exchange New() :8
void fa_exchange__New4_fn(fa_exchange** __retval)
{
    *__retval = fa_exchange::New4();
}

// public fa_exchange() [instance] :8
void fa_exchange::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_exchange::InitializeUX1()
{
    uStackFrame __("fa_exchange", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0EC"*/]);
    SourceLineNumber(211);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_exchange New() [static] :8
fa_exchange* fa_exchange::New4()
{
    fa_exchange* obj1 = (fa_exchange*)uNew(fa_exchange_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
