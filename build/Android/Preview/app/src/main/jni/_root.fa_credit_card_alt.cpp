// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_credit_card_alt.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_credit_card_alt.h>
...
// public partial sealed class fa_credit_card_alt :2
// {
// static fa_credit_card_alt() :4
static void fa_credit_card_alt__cctor_4_fn(uType* __type)
{
}

static void fa_credit_card_alt_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_credit_card_alt__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_credit_card_alt_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_credit_card_alt);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_credit_card_alt", options);
    type->fp_build_ = fa_credit_card_alt_build;
    type->fp_ctor_ = (void*)fa_credit_card_alt__New4_fn;
    type->fp_cctor_ = fa_credit_card_alt__cctor_4_fn;
...
// public fa_credit_card_alt() :8
void fa_credit_card_alt__ctor_8_fn(fa_credit_card_alt* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_credit_card_alt__InitializeUX1_fn(fa_credit_card_alt* __this)
{
    __this->InitializeUX1();
}

// public fa_credit_card_alt New() :8
void fa_credit_card_alt__New4_fn(fa_credit_card_alt** __retval)
{
    *__retval = fa_credit_card_alt::New4();
}

// public fa_credit_card_alt() [instance] :8
void fa_credit_card_alt::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_credit_card_alt::InitializeUX1()
{
    uStackFrame __("fa_credit_card_alt", "InitializeUX()");
    Value(::STRINGS[0/*"\uF283"*/]);
...
// public fa_credit_card_alt New() [static] :8
fa_credit_card_alt* fa_credit_card_alt::New4()
{
    fa_credit_card_alt* obj1 = (fa_credit_card_alt*)uNew(fa_credit_card_alt_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
