// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_beer.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_beer.h>
...
// public partial sealed class fa_beer :2
// {
// static fa_beer() :4
static void fa_beer__cctor_4_fn(uType* __type)
{
}

static void fa_beer_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_beer__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_beer_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_beer);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_beer", options);
    type->fp_build_ = fa_beer_build;
    type->fp_ctor_ = (void*)fa_beer__New4_fn;
    type->fp_cctor_ = fa_beer__cctor_4_fn;
...
// public fa_beer() :8
void fa_beer__ctor_8_fn(fa_beer* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_beer__InitializeUX1_fn(fa_beer* __this)
{
    __this->InitializeUX1();
}

// public fa_beer New() :8
void fa_beer__New4_fn(fa_beer** __retval)
{
    *__retval = fa_beer::New4();
}

// public fa_beer() [instance] :8
void fa_beer::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_beer::InitializeUX1()
{
    uStackFrame __("fa_beer", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0FC"*/]);
    SourceLineNumber(63);
...
// public fa_beer New() [static] :8
fa_beer* fa_beer::New4()
{
    fa_beer* obj1 = (fa_beer*)uNew(fa_beer_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
