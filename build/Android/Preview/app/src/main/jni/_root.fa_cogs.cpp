// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cogs.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cogs.h>
...
// public partial sealed class fa_cogs :2
// {
// static fa_cogs() :4
static void fa_cogs__cctor_4_fn(uType* __type)
{
}

static void fa_cogs_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cogs__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cogs_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cogs);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cogs", options);
    type->fp_build_ = fa_cogs_build;
    type->fp_ctor_ = (void*)fa_cogs__New4_fn;
    type->fp_cctor_ = fa_cogs__cctor_4_fn;
...
// public fa_cogs() :8
void fa_cogs__ctor_8_fn(fa_cogs* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cogs__InitializeUX1_fn(fa_cogs* __this)
{
    __this->InitializeUX1();
}

// public fa_cogs New() :8
void fa_cogs__New4_fn(fa_cogs** __retval)
{
    *__retval = fa_cogs::New4();
}

// public fa_cogs() [instance] :8
void fa_cogs::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cogs::InitializeUX1()
{
    uStackFrame __("fa_cogs", "InitializeUX()");
    Value(::STRINGS[0/*"\uF085"*/]);
    SourceLineNumber(160);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cogs New() [static] :8
fa_cogs* fa_cogs::New4()
{
    fa_cogs* obj1 = (fa_cogs*)uNew(fa_cogs_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
