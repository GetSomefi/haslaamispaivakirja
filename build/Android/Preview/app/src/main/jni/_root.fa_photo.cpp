// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_photo.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_photo.h>
...
// public partial sealed class fa_photo :2
// {
// static fa_photo() :4
static void fa_photo__cctor_4_fn(uType* __type)
{
}

static void fa_photo_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_photo__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_photo_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_photo);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_photo", options);
    type->fp_build_ = fa_photo_build;
    type->fp_ctor_ = (void*)fa_photo__New4_fn;
    type->fp_cctor_ = fa_photo__cctor_4_fn;
...
// public fa_photo() :8
void fa_photo__ctor_8_fn(fa_photo* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_photo__InitializeUX1_fn(fa_photo* __this)
{
    __this->InitializeUX1();
}

// public fa_photo New() :8
void fa_photo__New4_fn(fa_photo** __retval)
{
    *__retval = fa_photo::New4();
}

// public fa_photo() [instance] :8
void fa_photo::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_photo::InitializeUX1()
{
    uStackFrame __("fa_photo", "InitializeUX()");
    Value(::STRINGS[0/*"\uF03E"*/]);
    SourceLineNumber(456);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_photo New() [static] :8
fa_photo* fa_photo::New4()
{
    fa_photo* obj1 = (fa_photo*)uNew(fa_photo_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
