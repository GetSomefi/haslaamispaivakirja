// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cc_mastercard.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_cc_mastercard.h>
...
// public partial sealed class fa_cc_mastercard :2
// {
// static fa_cc_mastercard() :4
static void fa_cc_mastercard__cctor_4_fn(uType* __type)
{
}

static void fa_cc_mastercard_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\261");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cc_mastercard__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cc_mastercard_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cc_mastercard);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cc_mastercard", options);
    type->fp_build_ = fa_cc_mastercard_build;
    type->fp_ctor_ = (void*)fa_cc_mastercard__New4_fn;
    type->fp_cctor_ = fa_cc_mastercard__cctor_4_fn;
...
// public fa_cc_mastercard() :8
void fa_cc_mastercard__ctor_8_fn(fa_cc_mastercard* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cc_mastercard__InitializeUX1_fn(fa_cc_mastercard* __this)
{
    __this->InitializeUX1();
}

// public fa_cc_mastercard New() :8
void fa_cc_mastercard__New4_fn(fa_cc_mastercard** __retval)
{
    *__retval = fa_cc_mastercard::New4();
}

// public fa_cc_mastercard() [instance] :8
void fa_cc_mastercard::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_cc_mastercard::InitializeUX1()
{
    uStackFrame __("fa_cc_mastercard", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1F1"*/]);
    SourceLineNumber(120);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cc_mastercard New() [static] :8
fa_cc_mastercard* fa_cc_mastercard::New4()
{
    fa_cc_mastercard* obj1 = (fa_cc_mastercard*)uNew(fa_cc_mastercard_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
