// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_expeditedssl.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_expeditedssl.h>
...
// public partial sealed class fa_expeditedssl :2
// {
// static fa_expeditedssl() :4
static void fa_expeditedssl__cctor_4_fn(uType* __type)
{
}

static void fa_expeditedssl_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_expeditedssl__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_expeditedssl_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_expeditedssl);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_expeditedssl", options);
    type->fp_build_ = fa_expeditedssl_build;
    type->fp_ctor_ = (void*)fa_expeditedssl__New4_fn;
    type->fp_cctor_ = fa_expeditedssl__cctor_4_fn;
...
// public fa_expeditedssl() :8
void fa_expeditedssl__ctor_8_fn(fa_expeditedssl* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_expeditedssl__InitializeUX1_fn(fa_expeditedssl* __this)
{
    __this->InitializeUX1();
}

// public fa_expeditedssl New() :8
void fa_expeditedssl__New4_fn(fa_expeditedssl** __retval)
{
    *__retval = fa_expeditedssl::New4();
}

// public fa_expeditedssl() [instance] :8
void fa_expeditedssl::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_expeditedssl::InitializeUX1()
{
    uStackFrame __("fa_expeditedssl", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23E"*/]);
...
// public fa_expeditedssl New() [static] :8
fa_expeditedssl* fa_expeditedssl::New4()
{
    fa_expeditedssl* obj1 = (fa_expeditedssl*)uNew(fa_expeditedssl_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
