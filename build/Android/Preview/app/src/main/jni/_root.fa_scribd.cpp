// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_scribd.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_scribd.h>
...
// public partial sealed class fa_scribd :2
// {
// static fa_scribd() :4
static void fa_scribd__cctor_4_fn(uType* __type)
{
}

static void fa_scribd_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\212");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_scribd__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_scribd_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_scribd);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_scribd", options);
    type->fp_build_ = fa_scribd_build;
    type->fp_ctor_ = (void*)fa_scribd__New4_fn;
    type->fp_cctor_ = fa_scribd__cctor_4_fn;
...
// public fa_scribd() :8
void fa_scribd__ctor_8_fn(fa_scribd* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_scribd__InitializeUX1_fn(fa_scribd* __this)
{
    __this->InitializeUX1();
}

// public fa_scribd New() :8
void fa_scribd__New4_fn(fa_scribd** __retval)
{
    *__retval = fa_scribd::New4();
}

// public fa_scribd() [instance] :8
void fa_scribd::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_scribd::InitializeUX1()
{
    uStackFrame __("fa_scribd", "InitializeUX()");
    Value(::STRINGS[0/*"\uF28A"*/]);
    SourceLineNumber(513);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_scribd New() [static] :8
fa_scribd* fa_scribd::New4()
{
    fa_scribd* obj1 = (fa_scribd*)uNew(fa_scribd_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
