// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bicycle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bicycle.h>
...
// public partial sealed class fa_bicycle :2
// {
// static fa_bicycle() :4
static void fa_bicycle__cctor_4_fn(uType* __type)
{
}

static void fa_bicycle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\206");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bicycle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bicycle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bicycle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bicycle", options);
    type->fp_build_ = fa_bicycle_build;
    type->fp_ctor_ = (void*)fa_bicycle__New4_fn;
    type->fp_cctor_ = fa_bicycle__cctor_4_fn;
...
// public fa_bicycle() :8
void fa_bicycle__ctor_8_fn(fa_bicycle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bicycle__InitializeUX1_fn(fa_bicycle* __this)
{
    __this->InitializeUX1();
}

// public fa_bicycle New() :8
void fa_bicycle__New4_fn(fa_bicycle** __retval)
{
    *__retval = fa_bicycle::New4();
}

// public fa_bicycle() [instance] :8
void fa_bicycle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bicycle::InitializeUX1()
{
    uStackFrame __("fa_bicycle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF206"*/]);
    SourceLineNumber(70);
...
// public fa_bicycle New() [static] :8
fa_bicycle* fa_bicycle::New4()
{
    fa_bicycle* obj1 = (fa_bicycle*)uNew(fa_bicycle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
