// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_battery_quarter.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_battery_quarter.h>
...
// public partial sealed class fa_battery_quarter :2
// {
// static fa_battery_quarter() :4
static void fa_battery_quarter__cctor_4_fn(uType* __type)
{
}

static void fa_battery_quarter_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_battery_quarter__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_battery_quarter_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_battery_quarter);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_battery_quarter", options);
    type->fp_build_ = fa_battery_quarter_build;
    type->fp_ctor_ = (void*)fa_battery_quarter__New4_fn;
    type->fp_cctor_ = fa_battery_quarter__cctor_4_fn;
...
// public fa_battery_quarter() :8
void fa_battery_quarter__ctor_8_fn(fa_battery_quarter* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_battery_quarter__InitializeUX1_fn(fa_battery_quarter* __this)
{
    __this->InitializeUX1();
}

// public fa_battery_quarter New() :8
void fa_battery_quarter__New4_fn(fa_battery_quarter** __retval)
{
    *__retval = fa_battery_quarter::New4();
}

// public fa_battery_quarter() [instance] :8
void fa_battery_quarter::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_battery_quarter::InitializeUX1()
{
    uStackFrame __("fa_battery_quarter", "InitializeUX()");
    Value(::STRINGS[0/*"\uF243"*/]);
    SourceLineNumber(60);
...
// public fa_battery_quarter New() [static] :8
fa_battery_quarter* fa_battery_quarter::New4()
{
    fa_battery_quarter* obj1 = (fa_battery_quarter*)uNew(fa_battery_quarter_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
