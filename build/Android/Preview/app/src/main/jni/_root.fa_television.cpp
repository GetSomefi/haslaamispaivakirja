// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_television.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_television.h>
...
// public partial sealed class fa_television :2
// {
// static fa_television() :4
static void fa_television__cctor_4_fn(uType* __type)
{
}

static void fa_television_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_television__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_television_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_television);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_television", options);
    type->fp_build_ = fa_television_build;
    type->fp_ctor_ = (void*)fa_television__New4_fn;
    type->fp_cctor_ = fa_television__cctor_4_fn;
...
// public fa_television() :8
void fa_television__ctor_8_fn(fa_television* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_television__InitializeUX1_fn(fa_television* __this)
{
    __this->InitializeUX1();
}

// public fa_television New() :8
void fa_television__New4_fn(fa_television** __retval)
{
    *__retval = fa_television::New4();
}

// public fa_television() [instance] :8
void fa_television::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_television::InitializeUX1()
{
    uStackFrame __("fa_television", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26C"*/]);
    SourceLineNumber(599);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_television New() [static] :8
fa_television* fa_television::New4()
{
    fa_television* obj1 = (fa_television*)uNew(fa_television_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
