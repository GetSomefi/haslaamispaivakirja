// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_opencart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_opencart.h>
...
// public partial sealed class fa_opencart :2
// {
// static fa_opencart() :4
static void fa_opencart__cctor_4_fn(uType* __type)
{
}

static void fa_opencart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_opencart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_opencart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_opencart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_opencart", options);
    type->fp_build_ = fa_opencart_build;
    type->fp_ctor_ = (void*)fa_opencart__New4_fn;
    type->fp_cctor_ = fa_opencart__cctor_4_fn;
...
// public fa_opencart() :8
void fa_opencart__ctor_8_fn(fa_opencart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_opencart__InitializeUX1_fn(fa_opencart* __this)
{
    __this->InitializeUX1();
}

// public fa_opencart New() :8
void fa_opencart__New4_fn(fa_opencart** __retval)
{
    *__retval = fa_opencart::New4();
}

// public fa_opencart() [instance] :8
void fa_opencart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_opencart::InitializeUX1()
{
    uStackFrame __("fa_opencart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23D"*/]);
    SourceLineNumber(433);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_opencart New() [static] :8
fa_opencart* fa_opencart::New4()
{
    fa_opencart* obj1 = (fa_opencart*)uNew(fa_opencart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
