...
{
    uStackFrame __("Haslaamispaivakirja_FuseElementsElement_X_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_FuseElementsElement_X_Property", "Set(Uno.UX.PropertyObject,Uno.UX.Size,Uno.UX.IPropertyListener)");
    ::g::Uno::UX::Size v_ = *v;
