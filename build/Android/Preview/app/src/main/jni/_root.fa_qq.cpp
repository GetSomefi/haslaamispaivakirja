// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_qq.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_qq.h>
...
// public partial sealed class fa_qq :2
// {
// static fa_qq() :4
static void fa_qq__cctor_4_fn(uType* __type)
{
}

static void fa_qq_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\226");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_qq__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_qq_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_qq);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_qq", options);
    type->fp_build_ = fa_qq_build;
    type->fp_ctor_ = (void*)fa_qq__New4_fn;
    type->fp_cctor_ = fa_qq__cctor_4_fn;
...
// public fa_qq() :8
void fa_qq__ctor_8_fn(fa_qq* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_qq__InitializeUX1_fn(fa_qq* __this)
{
    __this->InitializeUX1();
}

// public fa_qq New() :8
void fa_qq__New4_fn(fa_qq** __retval)
{
    *__retval = fa_qq::New4();
}

// public fa_qq() [instance] :8
void fa_qq::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_qq::InitializeUX1()
{
    uStackFrame __("fa_qq", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D6"*/]);
    SourceLineNumber(477);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_qq New() [static] :8
fa_qq* fa_qq::New4()
{
    fa_qq* obj1 = (fa_qq*)uNew(fa_qq_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
