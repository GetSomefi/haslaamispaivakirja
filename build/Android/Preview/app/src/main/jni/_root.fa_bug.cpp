// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bug.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bug.h>
...
// public partial sealed class fa_bug :2
// {
// static fa_bug() :4
static void fa_bug__cctor_4_fn(uType* __type)
{
}

static void fa_bug_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bug__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bug_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bug);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bug", options);
    type->fp_build_ = fa_bug_build;
    type->fp_ctor_ = (void*)fa_bug__New4_fn;
    type->fp_cctor_ = fa_bug__cctor_4_fn;
...
// public fa_bug() :8
void fa_bug__ctor_8_fn(fa_bug* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bug__InitializeUX1_fn(fa_bug* __this)
{
    __this->InitializeUX1();
}

// public fa_bug New() :8
void fa_bug__New4_fn(fa_bug** __retval)
{
    *__retval = fa_bug::New4();
}

// public fa_bug() [instance] :8
void fa_bug::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bug::InitializeUX1()
{
    uStackFrame __("fa_bug", "InitializeUX()");
    Value(::STRINGS[0/*"\uF188"*/]);
    SourceLineNumber(87);
...
// public fa_bug New() [static] :8
fa_bug* fa_bug::New4()
{
    fa_bug* obj1 = (fa_bug*)uNew(fa_bug_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
