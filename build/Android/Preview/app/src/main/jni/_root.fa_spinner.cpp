// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_spinner.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_spinner.h>
...
// public partial sealed class fa_spinner :2
// {
// static fa_spinner() :4
static void fa_spinner__cctor_4_fn(uType* __type)
{
}

static void fa_spinner_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_spinner__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_spinner_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_spinner);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_spinner", options);
    type->fp_build_ = fa_spinner_build;
    type->fp_ctor_ = (void*)fa_spinner__New4_fn;
    type->fp_cctor_ = fa_spinner__cctor_4_fn;
...
// public fa_spinner() :8
void fa_spinner__ctor_8_fn(fa_spinner* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_spinner__InitializeUX1_fn(fa_spinner* __this)
{
    __this->InitializeUX1();
}

// public fa_spinner New() :8
void fa_spinner__New4_fn(fa_spinner** __retval)
{
    *__retval = fa_spinner::New4();
}

// public fa_spinner() [instance] :8
void fa_spinner::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_spinner::InitializeUX1()
{
    uStackFrame __("fa_spinner", "InitializeUX()");
    Value(::STRINGS[0/*"\uF110"*/]);
    SourceLineNumber(559);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_spinner New() [static] :8
fa_spinner* fa_spinner::New4()
{
    fa_spinner* obj1 = (fa_spinner*)uNew(fa_spinner_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
