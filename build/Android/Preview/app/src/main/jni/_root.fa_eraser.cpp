// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_eraser.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_eraser.h>
...
// public partial sealed class fa_eraser :2
// {
// static fa_eraser() :4
static void fa_eraser__cctor_4_fn(uType* __type)
{
}

static void fa_eraser_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\255");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_eraser__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_eraser_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_eraser);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_eraser", options);
    type->fp_build_ = fa_eraser_build;
    type->fp_ctor_ = (void*)fa_eraser__New4_fn;
    type->fp_cctor_ = fa_eraser__cctor_4_fn;
...
// public fa_eraser() :8
void fa_eraser__ctor_8_fn(fa_eraser* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_eraser__InitializeUX1_fn(fa_eraser* __this)
{
    __this->InitializeUX1();
}

// public fa_eraser New() :8
void fa_eraser__New4_fn(fa_eraser** __retval)
{
    *__retval = fa_eraser::New4();
}

// public fa_eraser() [instance] :8
void fa_eraser::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_eraser::InitializeUX1()
{
    uStackFrame __("fa_eraser", "InitializeUX()");
    Value(::STRINGS[0/*"\uF12D"*/]);
    SourceLineNumber(208);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_eraser New() [static] :8
fa_eraser* fa_eraser::New4()
{
    fa_eraser* obj1 = (fa_eraser*)uNew(fa_eraser_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
