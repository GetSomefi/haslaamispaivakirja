...
{
    uStackFrame __("Haslaamispaivakirja_BasicSwipeToggleBig_Sendable_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("Haslaamispaivakirja_BasicSwipeToggleBig_Sendable_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
