// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_unsorted.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_unsorted.h>
...
// public partial sealed class fa_unsorted :2
// {
// static fa_unsorted() :4
static void fa_unsorted__cctor_4_fn(uType* __type)
{
}

static void fa_unsorted_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\234");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_unsorted__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_unsorted_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_unsorted);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_unsorted", options);
    type->fp_build_ = fa_unsorted_build;
    type->fp_ctor_ = (void*)fa_unsorted__New4_fn;
    type->fp_cctor_ = fa_unsorted__cctor_4_fn;
...
// public fa_unsorted() :8
void fa_unsorted__ctor_8_fn(fa_unsorted* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_unsorted__InitializeUX1_fn(fa_unsorted* __this)
{
    __this->InitializeUX1();
}

// public fa_unsorted New() :8
void fa_unsorted__New4_fn(fa_unsorted** __retval)
{
    *__retval = fa_unsorted::New4();
}

// public fa_unsorted() [instance] :8
void fa_unsorted::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_unsorted::InitializeUX1()
{
    uStackFrame __("fa_unsorted", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0DC"*/]);
    SourceLineNumber(650);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_unsorted New() [static] :8
fa_unsorted* fa_unsorted::New4()
{
    fa_unsorted* obj1 = (fa_unsorted*)uNew(fa_unsorted_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
