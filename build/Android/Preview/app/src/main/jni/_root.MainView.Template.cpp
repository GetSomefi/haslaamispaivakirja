...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"splash"*/]);
}
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    ::g::SplashPage* __self1 = ::g::SplashPage::New5(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template::__selector0_);
    __self1->SourceLineNumber(13);
