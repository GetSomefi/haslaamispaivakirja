// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_user_md.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_user_md.h>
...
// public partial sealed class fa_user_md :2
// {
// static fa_user_md() :4
static void fa_user_md__cctor_4_fn(uType* __type)
{
}

static void fa_user_md_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_user_md__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_user_md_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_user_md);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_user_md", options);
    type->fp_build_ = fa_user_md_build;
    type->fp_ctor_ = (void*)fa_user_md__New4_fn;
    type->fp_cctor_ = fa_user_md__cctor_4_fn;
...
// public fa_user_md() :8
void fa_user_md__ctor_8_fn(fa_user_md* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_user_md__InitializeUX1_fn(fa_user_md* __this)
{
    __this->InitializeUX1();
}

// public fa_user_md New() :8
void fa_user_md__New4_fn(fa_user_md** __retval)
{
    *__retval = fa_user_md::New4();
}

// public fa_user_md() [instance] :8
void fa_user_md::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_user_md::InitializeUX1()
{
    uStackFrame __("fa_user_md", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F0"*/]);
    SourceLineNumber(655);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_user_md New() [static] :8
fa_user_md* fa_user_md::New4()
{
    fa_user_md* obj1 = (fa_user_md*)uNew(fa_user_md_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
