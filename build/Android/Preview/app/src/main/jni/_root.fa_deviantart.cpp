// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_deviantart.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_deviantart.h>
...
// public partial sealed class fa_deviantart :2
// {
// static fa_deviantart() :4
static void fa_deviantart__cctor_4_fn(uType* __type)
{
}

static void fa_deviantart_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_deviantart__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_deviantart_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_deviantart);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_deviantart", options);
    type->fp_build_ = fa_deviantart_build;
    type->fp_ctor_ = (void*)fa_deviantart__New4_fn;
    type->fp_cctor_ = fa_deviantart__cctor_4_fn;
...
// public fa_deviantart() :8
void fa_deviantart__ctor_8_fn(fa_deviantart* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_deviantart__InitializeUX1_fn(fa_deviantart* __this)
{
    __this->InitializeUX1();
}

// public fa_deviantart New() :8
void fa_deviantart__New4_fn(fa_deviantart** __retval)
{
    *__retval = fa_deviantart::New4();
}

// public fa_deviantart() [instance] :8
void fa_deviantart::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_deviantart::InitializeUX1()
{
    uStackFrame __("fa_deviantart", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BD"*/]);
    SourceLineNumber(190);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_deviantart New() [static] :8
fa_deviantart* fa_deviantart::New4()
{
    fa_deviantart* obj1 = (fa_deviantart*)uNew(fa_deviantart_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
