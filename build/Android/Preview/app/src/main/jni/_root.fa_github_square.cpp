// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_github_square.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_github_square.h>
...
// public partial sealed class fa_github_square :2
// {
// static fa_github_square() :4
static void fa_github_square__cctor_4_fn(uType* __type)
{
}

static void fa_github_square_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_github_square__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_github_square_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_github_square);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_github_square", options);
    type->fp_build_ = fa_github_square_build;
    type->fp_ctor_ = (void*)fa_github_square__New4_fn;
    type->fp_cctor_ = fa_github_square__cctor_4_fn;
...
// public fa_github_square() :8
void fa_github_square__ctor_8_fn(fa_github_square* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_github_square__InitializeUX1_fn(fa_github_square* __this)
{
    __this->InitializeUX1();
}

// public fa_github_square New() :8
void fa_github_square__New4_fn(fa_github_square** __retval)
{
    *__retval = fa_github_square::New4();
}

// public fa_github_square() [instance] :8
void fa_github_square::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_github_square::InitializeUX1()
{
    uStackFrame __("fa_github_square", "InitializeUX()");
    Value(::STRINGS[0/*"\uF092"*/]);
...
// public fa_github_square New() [static] :8
fa_github_square* fa_github_square::New4()
{
    fa_github_square* obj1 = (fa_github_square*)uNew(fa_github_square_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
