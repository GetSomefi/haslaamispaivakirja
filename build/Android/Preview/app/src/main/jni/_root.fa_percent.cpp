// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_percent.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_percent.h>
...
// public partial sealed class fa_percent :2
// {
// static fa_percent() :4
static void fa_percent__cctor_4_fn(uType* __type)
{
}

static void fa_percent_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\212\225");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_percent__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_percent_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_percent);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_percent", options);
    type->fp_build_ = fa_percent_build;
    type->fp_ctor_ = (void*)fa_percent__New4_fn;
    type->fp_cctor_ = fa_percent__cctor_4_fn;
...
// public fa_percent() :8
void fa_percent__ctor_8_fn(fa_percent* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_percent__InitializeUX1_fn(fa_percent* __this)
{
    __this->InitializeUX1();
}

// public fa_percent New() :8
void fa_percent__New4_fn(fa_percent** __retval)
{
    *__retval = fa_percent::New4();
}

// public fa_percent() [instance] :8
void fa_percent::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_percent::InitializeUX1()
{
    uStackFrame __("fa_percent", "InitializeUX()");
    Value(::STRINGS[0/*"\uF295"*/]);
    SourceLineNumber(453);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_percent New() [static] :8
fa_percent* fa_percent::New4()
{
    fa_percent* obj1 = (fa_percent*)uNew(fa_percent_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
