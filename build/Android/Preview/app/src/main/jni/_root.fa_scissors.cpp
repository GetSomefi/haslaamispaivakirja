// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_scissors.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_scissors.h>
...
// public partial sealed class fa_scissors :2
// {
// static fa_scissors() :4
static void fa_scissors__cctor_4_fn(uType* __type)
{
}

static void fa_scissors_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\204");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_scissors__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_scissors_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_scissors);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_scissors", options);
    type->fp_build_ = fa_scissors_build;
    type->fp_ctor_ = (void*)fa_scissors__New4_fn;
    type->fp_cctor_ = fa_scissors__cctor_4_fn;
...
// public fa_scissors() :8
void fa_scissors__ctor_8_fn(fa_scissors* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_scissors__InitializeUX1_fn(fa_scissors* __this)
{
    __this->InitializeUX1();
}

// public fa_scissors New() :8
void fa_scissors__New4_fn(fa_scissors** __retval)
{
    *__retval = fa_scissors::New4();
}

// public fa_scissors() [instance] :8
void fa_scissors::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_scissors::InitializeUX1()
{
    uStackFrame __("fa_scissors", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C4"*/]);
    SourceLineNumber(512);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_scissors New() [static] :8
fa_scissors* fa_scissors::New4()
{
    fa_scissors* obj1 = (fa_scissors*)uNew(fa_scissors_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
