// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_dribbble.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_dribbble.h>
...
// public partial sealed class fa_dribbble :2
// {
// static fa_dribbble() :4
static void fa_dribbble__cctor_4_fn(uType* __type)
{
}

static void fa_dribbble_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\275");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_dribbble__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_dribbble_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_dribbble);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_dribbble", options);
    type->fp_build_ = fa_dribbble_build;
    type->fp_ctor_ = (void*)fa_dribbble__New4_fn;
    type->fp_cctor_ = fa_dribbble__cctor_4_fn;
...
// public fa_dribbble() :8
void fa_dribbble__ctor_8_fn(fa_dribbble* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_dribbble__InitializeUX1_fn(fa_dribbble* __this)
{
    __this->InitializeUX1();
}

// public fa_dribbble New() :8
void fa_dribbble__New4_fn(fa_dribbble** __retval)
{
    *__retval = fa_dribbble::New4();
}

// public fa_dribbble() [instance] :8
void fa_dribbble::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_dribbble::InitializeUX1()
{
    uStackFrame __("fa_dribbble", "InitializeUX()");
    Value(::STRINGS[0/*"\uF17D"*/]);
    SourceLineNumber(196);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_dribbble New() [static] :8
fa_dribbble* fa_dribbble::New4()
{
    fa_dribbble* obj1 = (fa_dribbble*)uNew(fa_dribbble_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
