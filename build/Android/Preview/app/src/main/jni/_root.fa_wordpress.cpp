// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wordpress.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wordpress.h>
...
// public partial sealed class fa_wordpress :2
// {
// static fa_wordpress() :4
static void fa_wordpress__cctor_4_fn(uType* __type)
{
}

static void fa_wordpress_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wordpress__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wordpress_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wordpress);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wordpress", options);
    type->fp_build_ = fa_wordpress_build;
    type->fp_ctor_ = (void*)fa_wordpress__New4_fn;
    type->fp_cctor_ = fa_wordpress__cctor_4_fn;
...
// public fa_wordpress() :8
void fa_wordpress__ctor_8_fn(fa_wordpress* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wordpress__InitializeUX1_fn(fa_wordpress* __this)
{
    __this->InitializeUX1();
}

// public fa_wordpress New() :8
void fa_wordpress__New4_fn(fa_wordpress** __retval)
{
    *__retval = fa_wordpress::New4();
}

// public fa_wordpress() [instance] :8
void fa_wordpress::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_wordpress::InitializeUX1()
{
    uStackFrame __("fa_wordpress", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19A"*/]);
    SourceLineNumber(682);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wordpress New() [static] :8
fa_wordpress* fa_wordpress::New4()
{
    fa_wordpress* obj1 = (fa_wordpress*)uNew(fa_wordpress_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
