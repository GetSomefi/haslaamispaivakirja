// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_soundcloud.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_soundcloud.h>
...
// public partial sealed class fa_soundcloud :2
// {
// static fa_soundcloud() :4
static void fa_soundcloud__cctor_4_fn(uType* __type)
{
}

static void fa_soundcloud_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_soundcloud__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_soundcloud_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_soundcloud);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_soundcloud", options);
    type->fp_build_ = fa_soundcloud_build;
    type->fp_ctor_ = (void*)fa_soundcloud__New4_fn;
    type->fp_cctor_ = fa_soundcloud__cctor_4_fn;
...
// public fa_soundcloud() :8
void fa_soundcloud__ctor_8_fn(fa_soundcloud* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_soundcloud__InitializeUX1_fn(fa_soundcloud* __this)
{
    __this->InitializeUX1();
}

// public fa_soundcloud New() :8
void fa_soundcloud__New4_fn(fa_soundcloud** __retval)
{
    *__retval = fa_soundcloud::New4();
}

// public fa_soundcloud() [instance] :8
void fa_soundcloud::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_soundcloud::InitializeUX1()
{
    uStackFrame __("fa_soundcloud", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1BE"*/]);
    SourceLineNumber(557);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_soundcloud New() [static] :8
fa_soundcloud* fa_soundcloud::New4()
{
    fa_soundcloud* obj1 = (fa_soundcloud*)uNew(fa_soundcloud_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
