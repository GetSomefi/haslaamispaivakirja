// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_caret_left.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_caret_left.h>
...
// public partial sealed class fa_caret_left :2
// {
// static fa_caret_left() :4
static void fa_caret_left__cctor_4_fn(uType* __type)
{
}

static void fa_caret_left_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\231");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_caret_left__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_caret_left_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_caret_left);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_caret_left", options);
    type->fp_build_ = fa_caret_left_build;
    type->fp_ctor_ = (void*)fa_caret_left__New4_fn;
    type->fp_cctor_ = fa_caret_left__cctor_4_fn;
...
// public fa_caret_left() :8
void fa_caret_left__ctor_8_fn(fa_caret_left* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_caret_left__InitializeUX1_fn(fa_caret_left* __this)
{
    __this->InitializeUX1();
}

// public fa_caret_left New() :8
void fa_caret_left__New4_fn(fa_caret_left** __retval)
{
    *__retval = fa_caret_left::New4();
}

// public fa_caret_left() [instance] :8
void fa_caret_left::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_caret_left::InitializeUX1()
{
    uStackFrame __("fa_caret_left", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D9"*/]);
    SourceLineNumber(106);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_caret_left New() [static] :8
fa_caret_left* fa_caret_left::New4()
{
    fa_caret_left* obj1 = (fa_caret_left*)uNew(fa_caret_left_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
