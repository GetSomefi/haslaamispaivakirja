// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_exclamation.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_exclamation.h>
...
// public partial sealed class fa_exclamation :2
// {
// static fa_exclamation() :4
static void fa_exclamation__cctor_4_fn(uType* __type)
{
}

static void fa_exclamation_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_exclamation__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_exclamation_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_exclamation);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_exclamation", options);
    type->fp_build_ = fa_exclamation_build;
    type->fp_ctor_ = (void*)fa_exclamation__New4_fn;
    type->fp_cctor_ = fa_exclamation__cctor_4_fn;
...
// public fa_exclamation() :8
void fa_exclamation__ctor_8_fn(fa_exclamation* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_exclamation__InitializeUX1_fn(fa_exclamation* __this)
{
    __this->InitializeUX1();
}

// public fa_exclamation New() :8
void fa_exclamation__New4_fn(fa_exclamation** __retval)
{
    *__retval = fa_exclamation::New4();
}

// public fa_exclamation() [instance] :8
void fa_exclamation::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_exclamation::InitializeUX1()
{
    uStackFrame __("fa_exclamation", "InitializeUX()");
    Value(::STRINGS[0/*"\uF12A"*/]);
...
// public fa_exclamation New() [static] :8
fa_exclamation* fa_exclamation::New4()
{
    fa_exclamation* obj1 = (fa_exclamation*)uNew(fa_exclamation_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
