// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_odnoklassniki.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_odnoklassniki.h>
...
// public partial sealed class fa_odnoklassniki :2
// {
// static fa_odnoklassniki() :4
static void fa_odnoklassniki__cctor_4_fn(uType* __type)
{
}

static void fa_odnoklassniki_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\243");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_odnoklassniki__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_odnoklassniki_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_odnoklassniki);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_odnoklassniki", options);
    type->fp_build_ = fa_odnoklassniki_build;
    type->fp_ctor_ = (void*)fa_odnoklassniki__New4_fn;
    type->fp_cctor_ = fa_odnoklassniki__cctor_4_fn;
...
// public fa_odnoklassniki() :8
void fa_odnoklassniki__ctor_8_fn(fa_odnoklassniki* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_odnoklassniki__InitializeUX1_fn(fa_odnoklassniki* __this)
{
    __this->InitializeUX1();
}

// public fa_odnoklassniki New() :8
void fa_odnoklassniki__New4_fn(fa_odnoklassniki** __retval)
{
    *__retval = fa_odnoklassniki::New4();
}

// public fa_odnoklassniki() [instance] :8
void fa_odnoklassniki::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_odnoklassniki::InitializeUX1()
{
    uStackFrame __("fa_odnoklassniki", "InitializeUX()");
    Value(::STRINGS[0/*"\uF263"*/]);
    SourceLineNumber(431);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_odnoklassniki New() [static] :8
fa_odnoklassniki* fa_odnoklassniki::New4()
{
    fa_odnoklassniki* obj1 = (fa_odnoklassniki*)uNew(fa_odnoklassniki_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
