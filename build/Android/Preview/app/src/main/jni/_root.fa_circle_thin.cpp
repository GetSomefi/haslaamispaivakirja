// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_circle_thin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_circle_thin.h>
...
// public partial sealed class fa_circle_thin :2
// {
// static fa_circle_thin() :4
static void fa_circle_thin__cctor_4_fn(uType* __type)
{
}

static void fa_circle_thin_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\233");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_circle_thin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_circle_thin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_circle_thin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_circle_thin", options);
    type->fp_build_ = fa_circle_thin_build;
    type->fp_ctor_ = (void*)fa_circle_thin__New4_fn;
    type->fp_cctor_ = fa_circle_thin__cctor_4_fn;
...
// public fa_circle_thin() :8
void fa_circle_thin__ctor_8_fn(fa_circle_thin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_circle_thin__InitializeUX1_fn(fa_circle_thin* __this)
{
    __this->InitializeUX1();
}

// public fa_circle_thin New() :8
void fa_circle_thin__New4_fn(fa_circle_thin** __retval)
{
    *__retval = fa_circle_thin::New4();
}

// public fa_circle_thin() [instance] :8
void fa_circle_thin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_circle_thin::InitializeUX1()
{
    uStackFrame __("fa_circle_thin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1DB"*/]);
    SourceLineNumber(145);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_circle_thin New() [static] :8
fa_circle_thin* fa_circle_thin::New4()
{
    fa_circle_thin* obj1 = (fa_circle_thin*)uNew(fa_circle_thin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
