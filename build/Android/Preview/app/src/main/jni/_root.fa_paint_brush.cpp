// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_paint_brush.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_paint_brush.h>
...
// public partial sealed class fa_paint_brush :2
// {
// static fa_paint_brush() :4
static void fa_paint_brush__cctor_4_fn(uType* __type)
{
}

static void fa_paint_brush_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_paint_brush__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_paint_brush_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_paint_brush);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_paint_brush", options);
    type->fp_build_ = fa_paint_brush_build;
    type->fp_ctor_ = (void*)fa_paint_brush__New4_fn;
    type->fp_cctor_ = fa_paint_brush__cctor_4_fn;
...
// public fa_paint_brush() :8
void fa_paint_brush__ctor_8_fn(fa_paint_brush* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_paint_brush__InitializeUX1_fn(fa_paint_brush* __this)
{
    __this->InitializeUX1();
}

// public fa_paint_brush New() :8
void fa_paint_brush__New4_fn(fa_paint_brush** __retval)
{
    *__retval = fa_paint_brush::New4();
}

// public fa_paint_brush() [instance] :8
void fa_paint_brush::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_paint_brush::InitializeUX1()
{
    uStackFrame __("fa_paint_brush", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1FC"*/]);
    SourceLineNumber(439);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_paint_brush New() [static] :8
fa_paint_brush* fa_paint_brush::New4()
{
    fa_paint_brush* obj1 = (fa_paint_brush*)uNew(fa_paint_brush_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
