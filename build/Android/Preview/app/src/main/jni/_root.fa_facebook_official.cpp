// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_facebook_official.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_facebook_official.h>
...
// public partial sealed class fa_facebook_official :2
// {
// static fa_facebook_official() :4
static void fa_facebook_official__cctor_4_fn(uType* __type)
{
}

static void fa_facebook_official_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_facebook_official__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_facebook_official_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_facebook_official);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_facebook_official", options);
    type->fp_build_ = fa_facebook_official_build;
    type->fp_ctor_ = (void*)fa_facebook_official__New4_fn;
    type->fp_cctor_ = fa_facebook_official__cctor_4_fn;
...
// public fa_facebook_official() :8
void fa_facebook_official__ctor_8_fn(fa_facebook_official* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_facebook_official__InitializeUX1_fn(fa_facebook_official* __this)
{
    __this->InitializeUX1();
}

// public fa_facebook_official New() :8
void fa_facebook_official__New4_fn(fa_facebook_official** __retval)
{
    *__retval = fa_facebook_official::New4();
}

// public fa_facebook_official() [instance] :8
void fa_facebook_official::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_facebook_official::InitializeUX1()
{
    uStackFrame __("fa_facebook_official", "InitializeUX()");
    Value(::STRINGS[0/*"\uF230"*/]);
    SourceLineNumber(224);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_facebook_official New() [static] :8
fa_facebook_official* fa_facebook_official::New4()
{
    fa_facebook_official* obj1 = (fa_facebook_official*)uNew(fa_facebook_official_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
