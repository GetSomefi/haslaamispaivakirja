// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pause.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pause.h>
...
// public partial sealed class fa_pause :2
// {
// static fa_pause() :4
static void fa_pause__cctor_4_fn(uType* __type)
{
}

static void fa_pause_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\214");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pause__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pause_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pause);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pause", options);
    type->fp_build_ = fa_pause_build;
    type->fp_ctor_ = (void*)fa_pause__New4_fn;
    type->fp_cctor_ = fa_pause__cctor_4_fn;
...
// public fa_pause() :8
void fa_pause__ctor_8_fn(fa_pause* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pause__InitializeUX1_fn(fa_pause* __this)
{
    __this->InitializeUX1();
}

// public fa_pause New() :8
void fa_pause__New4_fn(fa_pause** __retval)
{
    *__retval = fa_pause::New4();
}

// public fa_pause() [instance] :8
void fa_pause::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pause::InitializeUX1()
{
    uStackFrame __("fa_pause", "InitializeUX()");
    Value(::STRINGS[0/*"\uF04C"*/]);
    SourceLineNumber(445);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pause New() [static] :8
fa_pause* fa_pause::New4()
{
    fa_pause* obj1 = (fa_pause*)uNew(fa_pause_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
