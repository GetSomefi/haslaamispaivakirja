// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rebel.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rebel.h>
...
// public partial sealed class fa_rebel :2
// {
// static fa_rebel() :4
static void fa_rebel__cctor_4_fn(uType* __type)
{
}

static void fa_rebel_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\220");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rebel__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rebel_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rebel);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rebel", options);
    type->fp_build_ = fa_rebel_build;
    type->fp_ctor_ = (void*)fa_rebel__New4_fn;
    type->fp_cctor_ = fa_rebel__cctor_4_fn;
...
// public fa_rebel() :8
void fa_rebel__ctor_8_fn(fa_rebel* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rebel__InitializeUX1_fn(fa_rebel* __this)
{
    __this->InitializeUX1();
}

// public fa_rebel New() :8
void fa_rebel__New4_fn(fa_rebel** __retval)
{
    *__retval = fa_rebel::New4();
}

// public fa_rebel() [instance] :8
void fa_rebel::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_rebel::InitializeUX1()
{
    uStackFrame __("fa_rebel", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D0"*/]);
    SourceLineNumber(485);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rebel New() [static] :8
fa_rebel* fa_rebel::New4()
{
    fa_rebel* obj1 = (fa_rebel*)uNew(fa_rebel_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
