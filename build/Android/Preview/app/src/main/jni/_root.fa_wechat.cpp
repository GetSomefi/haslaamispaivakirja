// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_wechat.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_wechat.h>
...
// public partial sealed class fa_wechat :2
// {
// static fa_wechat() :4
static void fa_wechat__cctor_4_fn(uType* __type)
{
}

static void fa_wechat_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\227");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_wechat__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_wechat_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_wechat);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_wechat", options);
    type->fp_build_ = fa_wechat_build;
    type->fp_ctor_ = (void*)fa_wechat__New4_fn;
    type->fp_cctor_ = fa_wechat__cctor_4_fn;
...
// public fa_wechat() :8
void fa_wechat__ctor_8_fn(fa_wechat* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_wechat__InitializeUX1_fn(fa_wechat* __this)
{
    __this->InitializeUX1();
}

// public fa_wechat New() :8
void fa_wechat__New4_fn(fa_wechat** __retval)
{
    *__retval = fa_wechat::New4();
}

// public fa_wechat() [instance] :8
void fa_wechat::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_wechat::InitializeUX1()
{
    uStackFrame __("fa_wechat", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D7"*/]);
    SourceLineNumber(673);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_wechat New() [static] :8
fa_wechat* fa_wechat::New4()
{
    fa_wechat* obj1 = (fa_wechat*)uNew(fa_wechat_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
