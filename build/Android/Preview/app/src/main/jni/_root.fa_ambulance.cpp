// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ambulance.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ambulance.h>
...
// public partial sealed class fa_ambulance :2
// {
// static fa_ambulance() :4
static void fa_ambulance__cctor_4_fn(uType* __type)
{
}

static void fa_ambulance_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\271");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ambulance__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ambulance_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ambulance);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ambulance", options);
    type->fp_build_ = fa_ambulance_build;
    type->fp_ctor_ = (void*)fa_ambulance__New4_fn;
    type->fp_cctor_ = fa_ambulance__cctor_4_fn;
...
// public fa_ambulance() :8
void fa_ambulance__ctor_8_fn(fa_ambulance* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ambulance__InitializeUX1_fn(fa_ambulance* __this)
{
    __this->InitializeUX1();
}

// public fa_ambulance New() :8
void fa_ambulance__New4_fn(fa_ambulance** __retval)
{
    *__retval = fa_ambulance::New4();
}

// public fa_ambulance() [instance] :8
void fa_ambulance::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_ambulance::InitializeUX1()
{
    uStackFrame __("fa_ambulance", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F9"*/]);
    SourceLineNumber(10);
...
// public fa_ambulance New() [static] :8
fa_ambulance* fa_ambulance::New4()
{
    fa_ambulance* obj1 = (fa_ambulance*)uNew(fa_ambulance_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
