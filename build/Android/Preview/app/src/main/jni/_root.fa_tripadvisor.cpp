// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_tripadvisor.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_tripadvisor.h>
...
// public partial sealed class fa_tripadvisor :2
// {
// static fa_tripadvisor() :4
static void fa_tripadvisor__cctor_4_fn(uType* __type)
{
}

static void fa_tripadvisor_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\242");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_tripadvisor__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_tripadvisor_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_tripadvisor);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_tripadvisor", options);
    type->fp_build_ = fa_tripadvisor_build;
    type->fp_ctor_ = (void*)fa_tripadvisor__New4_fn;
    type->fp_cctor_ = fa_tripadvisor__cctor_4_fn;
...
// public fa_tripadvisor() :8
void fa_tripadvisor__ctor_8_fn(fa_tripadvisor* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_tripadvisor__InitializeUX1_fn(fa_tripadvisor* __this)
{
    __this->InitializeUX1();
}

// public fa_tripadvisor New() :8
void fa_tripadvisor__New4_fn(fa_tripadvisor** __retval)
{
    *__retval = fa_tripadvisor::New4();
}

// public fa_tripadvisor() [instance] :8
void fa_tripadvisor::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_tripadvisor::InitializeUX1()
{
    uStackFrame __("fa_tripadvisor", "InitializeUX()");
    Value(::STRINGS[0/*"\uF262"*/]);
...
// public fa_tripadvisor New() [static] :8
fa_tripadvisor* fa_tripadvisor::New4()
{
    fa_tripadvisor* obj1 = (fa_tripadvisor*)uNew(fa_tripadvisor_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
