// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_get_pocket.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_get_pocket.h>
...
// public partial sealed class fa_get_pocket :2
// {
// static fa_get_pocket() :4
static void fa_get_pocket__cctor_4_fn(uType* __type)
{
}

static void fa_get_pocket_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_get_pocket__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_get_pocket_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_get_pocket);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_get_pocket", options);
    type->fp_build_ = fa_get_pocket_build;
    type->fp_ctor_ = (void*)fa_get_pocket__New4_fn;
    type->fp_cctor_ = fa_get_pocket__cctor_4_fn;
...
// public fa_get_pocket() :8
void fa_get_pocket__ctor_8_fn(fa_get_pocket* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_get_pocket__InitializeUX1_fn(fa_get_pocket* __this)
{
    __this->InitializeUX1();
}

// public fa_get_pocket New() :8
void fa_get_pocket__New4_fn(fa_get_pocket** __retval)
{
    *__retval = fa_get_pocket::New4();
}

// public fa_get_pocket() [instance] :8
void fa_get_pocket::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_get_pocket::InitializeUX1()
{
    uStackFrame __("fa_get_pocket", "InitializeUX()");
    Value(::STRINGS[0/*"\uF265"*/]);
...
// public fa_get_pocket New() [static] :8
fa_get_pocket* fa_get_pocket::New4()
{
    fa_get_pocket* obj1 = (fa_get_pocket*)uNew(fa_get_pocket_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
