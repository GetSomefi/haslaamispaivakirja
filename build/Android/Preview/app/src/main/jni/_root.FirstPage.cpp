...
static void FirstPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)FirstPage__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
{
    uStackFrame __("FirstPage", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
{
    uStackFrame __("FirstPage", "InitializeUX()");
