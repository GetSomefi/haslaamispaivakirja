// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_support.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_support.h>
...
// public partial sealed class fa_support :2
// {
// static fa_support() :4
static void fa_support__cctor_4_fn(uType* __type)
{
}

static void fa_support_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_support__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_support_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_support);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_support", options);
    type->fp_build_ = fa_support_build;
    type->fp_ctor_ = (void*)fa_support__New4_fn;
    type->fp_cctor_ = fa_support__cctor_4_fn;
...
// public fa_support() :8
void fa_support__ctor_8_fn(fa_support* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_support__InitializeUX1_fn(fa_support* __this)
{
    __this->InitializeUX1();
}

// public fa_support New() :8
void fa_support__New4_fn(fa_support** __retval)
{
    *__retval = fa_support::New4();
}

// public fa_support() [instance] :8
void fa_support::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_support::InitializeUX1()
{
    uStackFrame __("fa_support", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1CD"*/]);
    SourceLineNumber(591);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_support New() [static] :8
fa_support* fa_support::New4()
{
    fa_support* obj1 = (fa_support*)uNew(fa_support_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
