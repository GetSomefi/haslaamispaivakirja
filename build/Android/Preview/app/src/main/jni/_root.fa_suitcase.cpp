// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_suitcase.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_suitcase.h>
...
// public partial sealed class fa_suitcase :2
// {
// static fa_suitcase() :4
static void fa_suitcase__cctor_4_fn(uType* __type)
{
}

static void fa_suitcase_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\262");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_suitcase__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_suitcase_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_suitcase);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_suitcase", options);
    type->fp_build_ = fa_suitcase_build;
    type->fp_ctor_ = (void*)fa_suitcase__New4_fn;
    type->fp_cctor_ = fa_suitcase__cctor_4_fn;
...
// public fa_suitcase() :8
void fa_suitcase__ctor_8_fn(fa_suitcase* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_suitcase__InitializeUX1_fn(fa_suitcase* __this)
{
    __this->InitializeUX1();
}

// public fa_suitcase New() :8
void fa_suitcase__New4_fn(fa_suitcase** __retval)
{
    *__retval = fa_suitcase::New4();
}

// public fa_suitcase() [instance] :8
void fa_suitcase::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_suitcase::InitializeUX1()
{
    uStackFrame __("fa_suitcase", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0F2"*/]);
...
// public fa_suitcase New() [static] :8
fa_suitcase* fa_suitcase::New4()
{
    fa_suitcase* obj1 = (fa_suitcase*)uNew(fa_suitcase_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
