// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_optin_monster.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_optin_monster.h>
...
// public partial sealed class fa_optin_monster :2
// {
// static fa_optin_monster() :4
static void fa_optin_monster__cctor_4_fn(uType* __type)
{
}

static void fa_optin_monster_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\274");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_optin_monster__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_optin_monster_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_optin_monster);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_optin_monster", options);
    type->fp_build_ = fa_optin_monster_build;
    type->fp_ctor_ = (void*)fa_optin_monster__New4_fn;
    type->fp_cctor_ = fa_optin_monster__cctor_4_fn;
...
// public fa_optin_monster() :8
void fa_optin_monster__ctor_8_fn(fa_optin_monster* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_optin_monster__InitializeUX1_fn(fa_optin_monster* __this)
{
    __this->InitializeUX1();
}

// public fa_optin_monster New() :8
void fa_optin_monster__New4_fn(fa_optin_monster** __retval)
{
    *__retval = fa_optin_monster::New4();
}

// public fa_optin_monster() [instance] :8
void fa_optin_monster::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_optin_monster::InitializeUX1()
{
    uStackFrame __("fa_optin_monster", "InitializeUX()");
    Value(::STRINGS[0/*"\uF23C"*/]);
    SourceLineNumber(436);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_optin_monster New() [static] :8
fa_optin_monster* fa_optin_monster::New4()
{
    fa_optin_monster* obj1 = (fa_optin_monster*)uNew(fa_optin_monster_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
