// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_clone.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_clone.h>
...
// public partial sealed class fa_clone :2
// {
// static fa_clone() :4
static void fa_clone__cctor_4_fn(uType* __type)
{
}

static void fa_clone_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_clone__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_clone_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_clone);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_clone", options);
    type->fp_build_ = fa_clone_build;
    type->fp_ctor_ = (void*)fa_clone__New4_fn;
    type->fp_cctor_ = fa_clone__cctor_4_fn;
...
// public fa_clone() :8
void fa_clone__ctor_8_fn(fa_clone* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_clone__InitializeUX1_fn(fa_clone* __this)
{
    __this->InitializeUX1();
}

// public fa_clone New() :8
void fa_clone__New4_fn(fa_clone** __retval)
{
    *__retval = fa_clone::New4();
}

// public fa_clone() [instance] :8
void fa_clone::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_clone::InitializeUX1()
{
    uStackFrame __("fa_clone", "InitializeUX()");
    Value(::STRINGS[0/*"\uF24D"*/]);
...
// public fa_clone New() [static] :8
fa_clone* fa_clone::New4()
{
    fa_clone* obj1 = (fa_clone*)uNew(fa_clone_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
