// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_globe.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_globe.h>
...
// public partial sealed class fa_globe :2
// {
// static fa_globe() :4
static void fa_globe__cctor_4_fn(uType* __type)
{
}

static void fa_globe_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_globe__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_globe_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_globe);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_globe", options);
    type->fp_build_ = fa_globe_build;
    type->fp_ctor_ = (void*)fa_globe__New4_fn;
    type->fp_cctor_ = fa_globe__cctor_4_fn;
...
// public fa_globe() :8
void fa_globe__ctor_8_fn(fa_globe* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_globe__InitializeUX1_fn(fa_globe* __this)
{
    __this->InitializeUX1();
}

// public fa_globe New() :8
void fa_globe__New4_fn(fa_globe** __retval)
{
    *__retval = fa_globe::New4();
}

// public fa_globe() [instance] :8
void fa_globe::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_globe::InitializeUX1()
{
    uStackFrame __("fa_globe", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0AC"*/]);
    SourceLineNumber(293);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_globe New() [static] :8
fa_globe* fa_globe::New4()
{
    fa_globe* obj1 = (fa_globe*)uNew(fa_globe_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
