// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_truck.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_truck.h>
...
// public partial sealed class fa_truck :2
// {
// static fa_truck() :4
static void fa_truck__cctor_4_fn(uType* __type)
{
}

static void fa_truck_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\221");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_truck__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_truck_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_truck);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_truck", options);
    type->fp_build_ = fa_truck_build;
    type->fp_ctor_ = (void*)fa_truck__New4_fn;
    type->fp_cctor_ = fa_truck__cctor_4_fn;
...
// public fa_truck() :8
void fa_truck__ctor_8_fn(fa_truck* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_truck__InitializeUX1_fn(fa_truck* __this)
{
    __this->InitializeUX1();
}

// public fa_truck New() :8
void fa_truck__New4_fn(fa_truck** __retval)
{
    *__retval = fa_truck::New4();
}

// public fa_truck() [instance] :8
void fa_truck::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_truck::InitializeUX1()
{
    uStackFrame __("fa_truck", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D1"*/]);
    SourceLineNumber(633);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_truck New() [static] :8
fa_truck* fa_truck::New4()
{
    fa_truck* obj1 = (fa_truck*)uNew(fa_truck_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
