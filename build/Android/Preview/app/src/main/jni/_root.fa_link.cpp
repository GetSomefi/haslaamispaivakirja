// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_link.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_link.h>
...
// {
// static fa_link() :4
static void fa_link__cctor_4_fn(uType* __type)
{
}

static void fa_link_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_link__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* fa_link_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_link);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_link", options);
    type->fp_build_ = fa_link_build;
    type->fp_ctor_ = (void*)fa_link__New4_fn;
    type->fp_cctor_ = fa_link__cctor_4_fn;
...
// public fa_link New() :8
void fa_link__New4_fn(fa_link** __retval)
{
    *__retval = fa_link::New4();
}

// public fa_link() [instance] :8
void fa_link::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_link::InitializeUX1()
{
    uStackFrame __("fa_link", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C1"*/]);
    SourceLineNumber(374);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_link New() [static] :8
fa_link* fa_link::New4()
{
    fa_link* obj1 = (fa_link*)uNew(fa_link_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
