// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_chain.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_chain.h>
...
// public partial sealed class fa_chain :2
// {
// static fa_chain() :4
static void fa_chain__cctor_4_fn(uType* __type)
{
}

static void fa_chain_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\201");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_chain__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_chain_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_chain);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_chain", options);
    type->fp_build_ = fa_chain_build;
    type->fp_ctor_ = (void*)fa_chain__New4_fn;
    type->fp_cctor_ = fa_chain__cctor_4_fn;
...
// public fa_chain() :8
void fa_chain__ctor_8_fn(fa_chain* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_chain__InitializeUX1_fn(fa_chain* __this)
{
    __this->InitializeUX1();
}

// public fa_chain New() :8
void fa_chain__New4_fn(fa_chain** __retval)
{
    *__retval = fa_chain::New4();
}

// public fa_chain() [instance] :8
void fa_chain::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_chain::InitializeUX1()
{
    uStackFrame __("fa_chain", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C1"*/]);
    SourceLineNumber(125);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_chain New() [static] :8
fa_chain* fa_chain::New4()
{
    fa_chain* obj1 = (fa_chain*)uNew(fa_chain_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
