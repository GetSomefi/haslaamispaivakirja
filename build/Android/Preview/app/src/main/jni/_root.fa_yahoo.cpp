// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_yahoo.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_yahoo.h>
...
// public partial sealed class fa_yahoo :2
// {
// static fa_yahoo() :4
static void fa_yahoo__cctor_4_fn(uType* __type)
{
}

static void fa_yahoo_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\236");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_yahoo__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_yahoo_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_yahoo);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_yahoo", options);
    type->fp_build_ = fa_yahoo_build;
    type->fp_ctor_ = (void*)fa_yahoo__New4_fn;
    type->fp_cctor_ = fa_yahoo__cctor_4_fn;
...
// public fa_yahoo() :8
void fa_yahoo__ctor_8_fn(fa_yahoo* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_yahoo__InitializeUX1_fn(fa_yahoo* __this)
{
    __this->InitializeUX1();
}

// public fa_yahoo New() :8
void fa_yahoo__New4_fn(fa_yahoo** __retval)
{
    *__retval = fa_yahoo::New4();
}

// public fa_yahoo() [instance] :8
void fa_yahoo::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_yahoo::InitializeUX1()
{
    uStackFrame __("fa_yahoo", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19E"*/]);
    SourceLineNumber(688);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_yahoo New() [static] :8
fa_yahoo* fa_yahoo::New4()
{
    fa_yahoo* obj1 = (fa_yahoo*)uNew(fa_yahoo_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
