// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_stop.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_stop.h>
...
// public partial sealed class fa_stop :2
// {
// static fa_stop() :4
static void fa_stop__cctor_4_fn(uType* __type)
{
}

static void fa_stop_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\215");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_stop__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_stop_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_stop);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_stop", options);
    type->fp_build_ = fa_stop_build;
    type->fp_ctor_ = (void*)fa_stop__New4_fn;
    type->fp_cctor_ = fa_stop__cctor_4_fn;
...
// public fa_stop() :8
void fa_stop__ctor_8_fn(fa_stop* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_stop__InitializeUX1_fn(fa_stop* __this)
{
    __this->InitializeUX1();
}

// public fa_stop New() :8
void fa_stop__New4_fn(fa_stop** __retval)
{
    *__retval = fa_stop::New4();
}

// public fa_stop() [instance] :8
void fa_stop::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_stop::InitializeUX1()
{
    uStackFrame __("fa_stop", "InitializeUX()");
    Value(::STRINGS[0/*"\uF04D"*/]);
    SourceLineNumber(579);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_stop New() [static] :8
fa_stop* fa_stop::New4()
{
    fa_stop* obj1 = (fa_stop*)uNew(fa_stop_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
