// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_terminal.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_terminal.h>
...
// public partial sealed class fa_terminal :2
// {
// static fa_terminal() :4
static void fa_terminal__cctor_4_fn(uType* __type)
{
}

static void fa_terminal_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\240");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_terminal__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_terminal_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_terminal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_terminal", options);
    type->fp_build_ = fa_terminal_build;
    type->fp_ctor_ = (void*)fa_terminal__New4_fn;
    type->fp_cctor_ = fa_terminal__cctor_4_fn;
...
// public fa_terminal() :8
void fa_terminal__ctor_8_fn(fa_terminal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_terminal__InitializeUX1_fn(fa_terminal* __this)
{
    __this->InitializeUX1();
}

// public fa_terminal New() :8
void fa_terminal__New4_fn(fa_terminal** __retval)
{
    *__retval = fa_terminal::New4();
}

// public fa_terminal() [instance] :8
void fa_terminal::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_terminal::InitializeUX1()
{
    uStackFrame __("fa_terminal", "InitializeUX()");
    Value(::STRINGS[0/*"\uF120"*/]);
    SourceLineNumber(601);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_terminal New() [static] :8
fa_terminal* fa_terminal::New4()
{
    fa_terminal* obj1 = (fa_terminal*)uNew(fa_terminal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
