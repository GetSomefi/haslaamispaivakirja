// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_mail_reply_all.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_mail_reply_all.h>
...
// public partial sealed class fa_mail_reply_all :2
// {
// static fa_mail_reply_all() :4
static void fa_mail_reply_all__cctor_4_fn(uType* __type)
{
}

static void fa_mail_reply_all_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\242");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_mail_reply_all__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_mail_reply_all_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_mail_reply_all);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_mail_reply_all", options);
    type->fp_build_ = fa_mail_reply_all_build;
    type->fp_ctor_ = (void*)fa_mail_reply_all__New4_fn;
    type->fp_cctor_ = fa_mail_reply_all__cctor_4_fn;
...
// public fa_mail_reply_all() :8
void fa_mail_reply_all__ctor_8_fn(fa_mail_reply_all* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_mail_reply_all__InitializeUX1_fn(fa_mail_reply_all* __this)
{
    __this->InitializeUX1();
}

// public fa_mail_reply_all New() :8
void fa_mail_reply_all__New4_fn(fa_mail_reply_all** __retval)
{
    *__retval = fa_mail_reply_all::New4();
}

// public fa_mail_reply_all() [instance] :8
void fa_mail_reply_all::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_mail_reply_all::InitializeUX1()
{
    uStackFrame __("fa_mail_reply_all", "InitializeUX()");
    Value(::STRINGS[0/*"\uF122"*/]);
    SourceLineNumber(392);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_mail_reply_all New() [static] :8
fa_mail_reply_all* fa_mail_reply_all::New4()
{
    fa_mail_reply_all* obj1 = (fa_mail_reply_all*)uNew(fa_mail_reply_all_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
