// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_rss.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_rss.h>
...
// public partial sealed class fa_rss :2
// {
// static fa_rss() :4
static void fa_rss__cctor_4_fn(uType* __type)
{
}

static void fa_rss_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_rss__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_rss_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_rss);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_rss", options);
    type->fp_build_ = fa_rss_build;
    type->fp_ctor_ = (void*)fa_rss__New4_fn;
    type->fp_cctor_ = fa_rss__cctor_4_fn;
...
// public fa_rss() :8
void fa_rss__ctor_8_fn(fa_rss* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_rss__InitializeUX1_fn(fa_rss* __this)
{
    __this->InitializeUX1();
}

// public fa_rss New() :8
void fa_rss__New4_fn(fa_rss** __retval)
{
    *__retval = fa_rss::New4();
}

// public fa_rss() [instance] :8
void fa_rss::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_rss::InitializeUX1()
{
    uStackFrame __("fa_rss", "InitializeUX()");
    Value(::STRINGS[0/*"\uF09E"*/]);
    SourceLineNumber(505);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_rss New() [static] :8
fa_rss* fa_rss::New4()
{
    fa_rss* obj1 = (fa_rss*)uNew(fa_rss_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
