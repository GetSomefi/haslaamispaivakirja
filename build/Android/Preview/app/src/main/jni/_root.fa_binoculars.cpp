// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_binoculars.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_binoculars.h>
...
// public partial sealed class fa_binoculars :2
// {
// static fa_binoculars() :4
static void fa_binoculars__cctor_4_fn(uType* __type)
{
}

static void fa_binoculars_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\245");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_binoculars__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_binoculars_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_binoculars);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_binoculars", options);
    type->fp_build_ = fa_binoculars_build;
    type->fp_ctor_ = (void*)fa_binoculars__New4_fn;
    type->fp_cctor_ = fa_binoculars__cctor_4_fn;
...
// public fa_binoculars() :8
void fa_binoculars__ctor_8_fn(fa_binoculars* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_binoculars__InitializeUX1_fn(fa_binoculars* __this)
{
    __this->InitializeUX1();
}

// public fa_binoculars New() :8
void fa_binoculars__New4_fn(fa_binoculars** __retval)
{
    *__retval = fa_binoculars::New4();
}

// public fa_binoculars() [instance] :8
void fa_binoculars::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_binoculars::InitializeUX1()
{
    uStackFrame __("fa_binoculars", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1E5"*/]);
    SourceLineNumber(71);
...
// public fa_binoculars New() [static] :8
fa_binoculars* fa_binoculars::New4()
{
    fa_binoculars* obj1 = (fa_binoculars*)uNew(fa_binoculars_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
