// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_child.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_child.h>
...
// public partial sealed class fa_child :2
// {
// static fa_child() :4
static void fa_child__cctor_4_fn(uType* __type)
{
}

static void fa_child_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\256");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_child__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_child_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_child);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_child", options);
    type->fp_build_ = fa_child_build;
    type->fp_ctor_ = (void*)fa_child__New4_fn;
    type->fp_cctor_ = fa_child__cctor_4_fn;
...
// public fa_child() :8
void fa_child__ctor_8_fn(fa_child* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_child__InitializeUX1_fn(fa_child* __this)
{
    __this->InitializeUX1();
}

// public fa_child New() :8
void fa_child__New4_fn(fa_child** __retval)
{
    *__retval = fa_child::New4();
}

// public fa_child() [instance] :8
void fa_child::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_child::InitializeUX1()
{
    uStackFrame __("fa_child", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1AE"*/]);
...
// public fa_child New() [static] :8
fa_child* fa_child::New4()
{
    fa_child* obj1 = (fa_child*)uNew(fa_child_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
