// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_camera.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_camera.h>
...
// public partial sealed class fa_camera :2
// {
// static fa_camera() :4
static void fa_camera__cctor_4_fn(uType* __type)
{
}

static void fa_camera_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\200\260");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_camera__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_camera_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_camera);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_camera", options);
    type->fp_build_ = fa_camera_build;
    type->fp_ctor_ = (void*)fa_camera__New4_fn;
    type->fp_cctor_ = fa_camera__cctor_4_fn;
...
// public fa_camera() :8
void fa_camera__ctor_8_fn(fa_camera* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_camera__InitializeUX1_fn(fa_camera* __this)
{
    __this->InitializeUX1();
}

// public fa_camera New() :8
void fa_camera__New4_fn(fa_camera** __retval)
{
    *__retval = fa_camera::New4();
}

// public fa_camera() [instance] :8
void fa_camera::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_camera::InitializeUX1()
{
    uStackFrame __("fa_camera", "InitializeUX()");
    Value(::STRINGS[0/*"\uF030"*/]);
    SourceLineNumber(102);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_camera New() [static] :8
fa_camera* fa_camera::New4()
{
    fa_camera* obj1 = (fa_camera*)uNew(fa_camera_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
