// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_camera_retro.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_camera_retro.h>
...
// public partial sealed class fa_camera_retro :2
// {
// static fa_camera_retro() :4
static void fa_camera_retro__cctor_4_fn(uType* __type)
{
}

static void fa_camera_retro_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\202\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_camera_retro__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_camera_retro_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_camera_retro);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_camera_retro", options);
    type->fp_build_ = fa_camera_retro_build;
    type->fp_ctor_ = (void*)fa_camera_retro__New4_fn;
    type->fp_cctor_ = fa_camera_retro__cctor_4_fn;
...
// public fa_camera_retro() :8
void fa_camera_retro__ctor_8_fn(fa_camera_retro* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_camera_retro__InitializeUX1_fn(fa_camera_retro* __this)
{
    __this->InitializeUX1();
}

// public fa_camera_retro New() :8
void fa_camera_retro__New4_fn(fa_camera_retro** __retval)
{
    *__retval = fa_camera_retro::New4();
}

// public fa_camera_retro() [instance] :8
void fa_camera_retro::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_camera_retro::InitializeUX1()
{
    uStackFrame __("fa_camera_retro", "InitializeUX()");
    Value(::STRINGS[0/*"\uF083"*/]);
...
// public fa_camera_retro New() [static] :8
fa_camera_retro* fa_camera_retro::New4()
{
    fa_camera_retro* obj1 = (fa_camera_retro*)uNew(fa_camera_retro_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
