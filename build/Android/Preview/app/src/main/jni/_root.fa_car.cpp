// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_car.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_car.h>
...
// public partial sealed class fa_car :2
// {
// static fa_car() :4
static void fa_car__cctor_4_fn(uType* __type)
{
}

static void fa_car_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_car__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_car_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_car);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_car", options);
    type->fp_build_ = fa_car_build;
    type->fp_ctor_ = (void*)fa_car__New4_fn;
    type->fp_cctor_ = fa_car__cctor_4_fn;
...
// public fa_car() :8
void fa_car__ctor_8_fn(fa_car* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_car__InitializeUX1_fn(fa_car* __this)
{
    __this->InitializeUX1();
}

// public fa_car New() :8
void fa_car__New4_fn(fa_car** __retval)
{
    *__retval = fa_car::New4();
}

// public fa_car() [instance] :8
void fa_car::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_car::InitializeUX1()
{
    uStackFrame __("fa_car", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1B9"*/]);
    SourceLineNumber(104);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_car New() [static] :8
fa_car* fa_car::New4()
{
    fa_car* obj1 = (fa_car*)uNew(fa_car_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
