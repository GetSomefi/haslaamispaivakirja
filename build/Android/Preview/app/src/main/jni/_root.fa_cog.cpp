// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_cog.g.uno'.
...
// public partial sealed class fa_cog :2
// {
// static fa_cog() :4
static void fa_cog__cctor_4_fn(uType* __type)
{
}

static void fa_cog_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_cog__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_cog_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_cog);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_cog", options);
    type->fp_build_ = fa_cog_build;
    type->fp_ctor_ = (void*)fa_cog__New4_fn;
    type->fp_cctor_ = fa_cog__cctor_4_fn;
...
// public fa_cog() :8
void fa_cog__ctor_8_fn(fa_cog* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_cog__InitializeUX1_fn(fa_cog* __this)
{
    __this->InitializeUX1();
}

// public fa_cog New() :8
void fa_cog__New4_fn(fa_cog** __retval)
{
    *__retval = fa_cog::New4();
}

// public fa_cog() [instance] :8
void fa_cog::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_cog::InitializeUX1()
{
    uStackFrame __("fa_cog", "InitializeUX()");
    Value(::STRINGS[0/*"\uF013"*/]);
    SourceLineNumber(159);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_cog New() [static] :8
fa_cog* fa_cog::New4()
{
    fa_cog* obj1 = (fa_cog*)uNew(fa_cog_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
