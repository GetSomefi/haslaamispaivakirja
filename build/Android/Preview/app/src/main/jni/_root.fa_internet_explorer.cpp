// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_internet_explorer.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_internet_explorer.h>
...
// public partial sealed class fa_internet_explorer :2
// {
// static fa_internet_explorer() :4
static void fa_internet_explorer__cctor_4_fn(uType* __type)
{
}

static void fa_internet_explorer_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\253");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_internet_explorer__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_internet_explorer_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_internet_explorer);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_internet_explorer", options);
    type->fp_build_ = fa_internet_explorer_build;
    type->fp_ctor_ = (void*)fa_internet_explorer__New4_fn;
    type->fp_cctor_ = fa_internet_explorer__cctor_4_fn;
...
// public fa_internet_explorer() :8
void fa_internet_explorer__ctor_8_fn(fa_internet_explorer* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_internet_explorer__InitializeUX1_fn(fa_internet_explorer* __this)
{
    __this->InitializeUX1();
}

// public fa_internet_explorer New() :8
void fa_internet_explorer__New4_fn(fa_internet_explorer** __retval)
{
    *__retval = fa_internet_explorer::New4();
}

// public fa_internet_explorer() [instance] :8
void fa_internet_explorer::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_internet_explorer::InitializeUX1()
{
    uStackFrame __("fa_internet_explorer", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26B"*/]);
    SourceLineNumber(348);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_internet_explorer New() [static] :8
fa_internet_explorer* fa_internet_explorer::New4()
{
    fa_internet_explorer* obj1 = (fa_internet_explorer*)uNew(fa_internet_explorer_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
