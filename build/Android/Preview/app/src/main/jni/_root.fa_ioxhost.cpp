// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_ioxhost.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_ioxhost.h>
...
// public partial sealed class fa_ioxhost :2
// {
// static fa_ioxhost() :4
static void fa_ioxhost__cctor_4_fn(uType* __type)
{
}

static void fa_ioxhost_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\210");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_ioxhost__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_ioxhost_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_ioxhost);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_ioxhost", options);
    type->fp_build_ = fa_ioxhost_build;
    type->fp_ctor_ = (void*)fa_ioxhost__New4_fn;
    type->fp_cctor_ = fa_ioxhost__cctor_4_fn;
...
// public fa_ioxhost() :8
void fa_ioxhost__ctor_8_fn(fa_ioxhost* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_ioxhost__InitializeUX1_fn(fa_ioxhost* __this)
{
    __this->InitializeUX1();
}

// public fa_ioxhost New() :8
void fa_ioxhost__New4_fn(fa_ioxhost** __retval)
{
    *__retval = fa_ioxhost::New4();
}

// public fa_ioxhost() [instance] :8
void fa_ioxhost::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_ioxhost::InitializeUX1()
{
    uStackFrame __("fa_ioxhost", "InitializeUX()");
    Value(::STRINGS[0/*"\uF208"*/]);
    SourceLineNumber(350);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_ioxhost New() [static] :8
fa_ioxhost* fa_ioxhost::New4()
{
    fa_ioxhost* obj1 = (fa_ioxhost*)uNew(fa_ioxhost_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
