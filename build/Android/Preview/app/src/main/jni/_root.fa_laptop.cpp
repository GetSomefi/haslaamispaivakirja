// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_laptop.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_laptop.h>
...
// public partial sealed class fa_laptop :2
// {
// static fa_laptop() :4
static void fa_laptop__cctor_4_fn(uType* __type)
{
}

static void fa_laptop_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\204\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_laptop__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_laptop_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_laptop);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_laptop", options);
    type->fp_build_ = fa_laptop_build;
    type->fp_ctor_ = (void*)fa_laptop__New4_fn;
    type->fp_cctor_ = fa_laptop__cctor_4_fn;
...
// public fa_laptop() :8
void fa_laptop__ctor_8_fn(fa_laptop* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_laptop__InitializeUX1_fn(fa_laptop* __this)
{
    __this->InitializeUX1();
}

// public fa_laptop New() :8
void fa_laptop__New4_fn(fa_laptop** __retval)
{
    *__retval = fa_laptop::New4();
}

// public fa_laptop() [instance] :8
void fa_laptop::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_laptop::InitializeUX1()
{
    uStackFrame __("fa_laptop", "InitializeUX()");
    Value(::STRINGS[0/*"\uF109"*/]);
    SourceLineNumber(359);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_laptop New() [static] :8
fa_laptop* fa_laptop::New4()
{
    fa_laptop* obj1 = (fa_laptop*)uNew(fa_laptop_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
