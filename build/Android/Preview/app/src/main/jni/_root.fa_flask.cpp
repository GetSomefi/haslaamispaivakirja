// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_flask.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_flask.h>
...
// public partial sealed class fa_flask :2
// {
// static fa_flask() :4
static void fa_flask__cctor_4_fn(uType* __type)
{
}

static void fa_flask_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\203");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_flask__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_flask_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_flask);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_flask", options);
    type->fp_build_ = fa_flask_build;
    type->fp_ctor_ = (void*)fa_flask__New4_fn;
    type->fp_cctor_ = fa_flask__cctor_4_fn;
...
// public fa_flask() :8
void fa_flask__ctor_8_fn(fa_flask* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_flask__InitializeUX1_fn(fa_flask* __this)
{
    __this->InitializeUX1();
}

// public fa_flask New() :8
void fa_flask__New4_fn(fa_flask** __retval)
{
    *__retval = fa_flask::New4();
}

// public fa_flask() [instance] :8
void fa_flask::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_flask::InitializeUX1()
{
    uStackFrame __("fa_flask", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0C3"*/]);
    SourceLineNumber(260);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_flask New() [static] :8
fa_flask* fa_flask::New4()
{
    fa_flask* obj1 = (fa_flask*)uNew(fa_flask_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
