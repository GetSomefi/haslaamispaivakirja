// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_angellist.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_angellist.h>
...
// public partial sealed class fa_angellist :2
// {
// static fa_angellist() :4
static void fa_angellist__cctor_4_fn(uType* __type)
{
}

static void fa_angellist_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\211");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_angellist__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_angellist_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_angellist);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_angellist", options);
    type->fp_build_ = fa_angellist_build;
    type->fp_ctor_ = (void*)fa_angellist__New4_fn;
    type->fp_cctor_ = fa_angellist__cctor_4_fn;
...
// public fa_angellist() :8
void fa_angellist__ctor_8_fn(fa_angellist* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_angellist__InitializeUX1_fn(fa_angellist* __this)
{
    __this->InitializeUX1();
}

// public fa_angellist New() :8
void fa_angellist__New4_fn(fa_angellist** __retval)
{
    *__retval = fa_angellist::New4();
}

// public fa_angellist() [instance] :8
void fa_angellist::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_angellist::InitializeUX1()
{
    uStackFrame __("fa_angellist", "InitializeUX()");
    Value(::STRINGS[0/*"\uF209"*/]);
    SourceLineNumber(13);
...
// public fa_angellist New() [static] :8
fa_angellist* fa_angellist::New4()
{
    fa_angellist* obj1 = (fa_angellist*)uNew(fa_angellist_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
