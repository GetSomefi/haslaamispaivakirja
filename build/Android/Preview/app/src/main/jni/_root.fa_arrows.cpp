// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_arrows.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_arrows.h>
...
// public partial sealed class fa_arrows :2
// {
// static fa_arrows() :4
static void fa_arrows__cctor_4_fn(uType* __type)
{
}

static void fa_arrows_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\201\207");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_arrows__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_arrows_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_arrows);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_arrows", options);
    type->fp_build_ = fa_arrows_build;
    type->fp_ctor_ = (void*)fa_arrows__New4_fn;
    type->fp_cctor_ = fa_arrows__cctor_4_fn;
...
// public fa_arrows() :8
void fa_arrows__ctor_8_fn(fa_arrows* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_arrows__InitializeUX1_fn(fa_arrows* __this)
{
    __this->InitializeUX1();
}

// public fa_arrows New() :8
void fa_arrows__New4_fn(fa_arrows** __retval)
{
    *__retval = fa_arrows::New4();
}

// public fa_arrows() [instance] :8
void fa_arrows::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_arrows::InitializeUX1()
{
    uStackFrame __("fa_arrows", "InitializeUX()");
    Value(::STRINGS[0/*"\uF047"*/]);
    SourceLineNumber(37);
...
// public fa_arrows New() [static] :8
fa_arrows* fa_arrows::New4()
{
    fa_arrows* obj1 = (fa_arrows*)uNew(fa_arrows_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
