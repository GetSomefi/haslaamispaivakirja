// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_git.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_git.h>
...
// public partial sealed class fa_git :2
// {
// static fa_git() :4
static void fa_git__cctor_4_fn(uType* __type)
{
}

static void fa_git_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\223");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_git__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_git_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_git);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_git", options);
    type->fp_build_ = fa_git_build;
    type->fp_ctor_ = (void*)fa_git__New4_fn;
    type->fp_cctor_ = fa_git__cctor_4_fn;
...
// public fa_git() :8
void fa_git__ctor_8_fn(fa_git* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_git__InitializeUX1_fn(fa_git* __this)
{
    __this->InitializeUX1();
}

// public fa_git New() :8
void fa_git__New4_fn(fa_git** __retval)
{
    *__retval = fa_git::New4();
}

// public fa_git() [instance] :8
void fa_git::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_git::InitializeUX1()
{
    uStackFrame __("fa_git", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1D3"*/]);
...
// public fa_git New() [static] :8
fa_git* fa_git::New4()
{
    fa_git* obj1 = (fa_git*)uNew(fa_git_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
