// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_opera.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_opera.h>
...
// public partial sealed class fa_opera :2
// {
// static fa_opera() :4
static void fa_opera__cctor_4_fn(uType* __type)
{
}

static void fa_opera_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\252");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_opera__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_opera_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_opera);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_opera", options);
    type->fp_build_ = fa_opera_build;
    type->fp_ctor_ = (void*)fa_opera__New4_fn;
    type->fp_cctor_ = fa_opera__cctor_4_fn;
...
// public fa_opera() :8
void fa_opera__ctor_8_fn(fa_opera* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_opera__InitializeUX1_fn(fa_opera* __this)
{
    __this->InitializeUX1();
}

// public fa_opera New() :8
void fa_opera__New4_fn(fa_opera** __retval)
{
    *__retval = fa_opera::New4();
}

// public fa_opera() [instance] :8
void fa_opera::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_opera::InitializeUX1()
{
    uStackFrame __("fa_opera", "InitializeUX()");
    Value(::STRINGS[0/*"\uF26A"*/]);
    SourceLineNumber(435);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_opera New() [static] :8
fa_opera* fa_opera::New4()
{
    fa_opera* obj1 = (fa_opera*)uNew(fa_opera_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
