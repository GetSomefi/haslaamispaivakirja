// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bitcoin.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bitcoin.h>
...
// public partial sealed class fa_bitcoin :2
// {
// static fa_bitcoin() :4
static void fa_bitcoin__cctor_4_fn(uType* __type)
{
}

static void fa_bitcoin_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\232");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bitcoin__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bitcoin_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bitcoin);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bitcoin", options);
    type->fp_build_ = fa_bitcoin_build;
    type->fp_ctor_ = (void*)fa_bitcoin__New4_fn;
    type->fp_cctor_ = fa_bitcoin__cctor_4_fn;
...
// public fa_bitcoin() :8
void fa_bitcoin__ctor_8_fn(fa_bitcoin* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bitcoin__InitializeUX1_fn(fa_bitcoin* __this)
{
    __this->InitializeUX1();
}

// public fa_bitcoin New() :8
void fa_bitcoin__New4_fn(fa_bitcoin** __retval)
{
    *__retval = fa_bitcoin::New4();
}

// public fa_bitcoin() [instance] :8
void fa_bitcoin::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_bitcoin::InitializeUX1()
{
    uStackFrame __("fa_bitcoin", "InitializeUX()");
    Value(::STRINGS[0/*"\uF15A"*/]);
    SourceLineNumber(75);
...
// public fa_bitcoin New() [static] :8
fa_bitcoin* fa_bitcoin::New4()
{
    fa_bitcoin* obj1 = (fa_bitcoin*)uNew(fa_bitcoin_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
