// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_windows.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_windows.h>
...
// public partial sealed class fa_windows :2
// {
// static fa_windows() :4
static void fa_windows__cctor_4_fn(uType* __type)
{
}

static void fa_windows_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\205\272");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_windows__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_windows_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_windows);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_windows", options);
    type->fp_build_ = fa_windows_build;
    type->fp_ctor_ = (void*)fa_windows__New4_fn;
    type->fp_cctor_ = fa_windows__cctor_4_fn;
...
// public fa_windows() :8
void fa_windows__ctor_8_fn(fa_windows* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_windows__InitializeUX1_fn(fa_windows* __this)
{
    __this->InitializeUX1();
}

// public fa_windows New() :8
void fa_windows__New4_fn(fa_windows** __retval)
{
    *__retval = fa_windows::New4();
}

// public fa_windows() [instance] :8
void fa_windows::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_windows::InitializeUX1()
{
    uStackFrame __("fa_windows", "InitializeUX()");
    Value(::STRINGS[0/*"\uF17A"*/]);
    SourceLineNumber(680);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_windows New() [static] :8
fa_windows* fa_windows::New4()
{
    fa_windows* obj1 = (fa_windows*)uNew(fa_windows_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
