// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_server.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_server.h>
...
// public partial sealed class fa_server :2
// {
// static fa_server() :4
static void fa_server__cctor_4_fn(uType* __type)
{
}

static void fa_server_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\210\263");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_server__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_server_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_server);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_server", options);
    type->fp_build_ = fa_server_build;
    type->fp_ctor_ = (void*)fa_server__New4_fn;
    type->fp_cctor_ = fa_server__cctor_4_fn;
...
// public fa_server() :8
void fa_server__ctor_8_fn(fa_server* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_server__InitializeUX1_fn(fa_server* __this)
{
    __this->InitializeUX1();
}

// public fa_server New() :8
void fa_server__New4_fn(fa_server** __retval)
{
    *__retval = fa_server::New4();
}

// public fa_server() [instance] :8
void fa_server::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_server::InitializeUX1()
{
    uStackFrame __("fa_server", "InitializeUX()");
    Value(::STRINGS[0/*"\uF233"*/]);
    SourceLineNumber(520);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_server New() [static] :8
fa_server* fa_server::New4()
{
    fa_server* obj1 = (fa_server*)uNew(fa_server_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
