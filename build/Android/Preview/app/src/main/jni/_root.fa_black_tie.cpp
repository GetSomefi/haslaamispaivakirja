// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_black_tie.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_black_tie.h>
...
// public partial sealed class fa_black_tie :2
// {
// static fa_black_tie() :4
static void fa_black_tie__cctor_4_fn(uType* __type)
{
}

static void fa_black_tie_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\211\276");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_black_tie__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_black_tie_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_black_tie);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_black_tie", options);
    type->fp_build_ = fa_black_tie_build;
    type->fp_ctor_ = (void*)fa_black_tie__New4_fn;
    type->fp_cctor_ = fa_black_tie__cctor_4_fn;
...
// public fa_black_tie() :8
void fa_black_tie__ctor_8_fn(fa_black_tie* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_black_tie__InitializeUX1_fn(fa_black_tie* __this)
{
    __this->InitializeUX1();
}

// public fa_black_tie New() :8
void fa_black_tie__New4_fn(fa_black_tie** __retval)
{
    *__retval = fa_black_tie::New4();
}

// public fa_black_tie() [instance] :8
void fa_black_tie::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_black_tie::InitializeUX1()
{
    uStackFrame __("fa_black_tie", "InitializeUX()");
    Value(::STRINGS[0/*"\uF27E"*/]);
    SourceLineNumber(76);
...
// public fa_black_tie New() [static] :8
fa_black_tie* fa_black_tie::New4()
{
    fa_black_tie* obj1 = (fa_black_tie*)uNew(fa_black_tie_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
