// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_space_shuttle.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_space_shuttle.h>
...
// public partial sealed class fa_space_shuttle :2
// {
// static fa_space_shuttle() :4
static void fa_space_shuttle__cctor_4_fn(uType* __type)
{
}

static void fa_space_shuttle_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\206\227");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_space_shuttle__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_space_shuttle_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_space_shuttle);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_space_shuttle", options);
    type->fp_build_ = fa_space_shuttle_build;
    type->fp_ctor_ = (void*)fa_space_shuttle__New4_fn;
    type->fp_cctor_ = fa_space_shuttle__cctor_4_fn;
...
// public fa_space_shuttle() :8
void fa_space_shuttle__ctor_8_fn(fa_space_shuttle* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_space_shuttle__InitializeUX1_fn(fa_space_shuttle* __this)
{
    __this->InitializeUX1();
}

// public fa_space_shuttle New() :8
void fa_space_shuttle__New4_fn(fa_space_shuttle** __retval)
{
    *__retval = fa_space_shuttle::New4();
}

// public fa_space_shuttle() [instance] :8
void fa_space_shuttle::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_space_shuttle::InitializeUX1()
{
    uStackFrame __("fa_space_shuttle", "InitializeUX()");
    Value(::STRINGS[0/*"\uF197"*/]);
    SourceLineNumber(558);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_space_shuttle New() [static] :8
fa_space_shuttle* fa_space_shuttle::New4()
{
    fa_space_shuttle* obj1 = (fa_space_shuttle*)uNew(fa_space_shuttle_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
