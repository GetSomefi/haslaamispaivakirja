// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_list_ol.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_list_ol.h>
...
// public partial sealed class fa_list_ol :2
// {
// static fa_list_ol() :4
static void fa_list_ol__cctor_4_fn(uType* __type)
{
}

static void fa_list_ol_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\213");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_list_ol__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_list_ol_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_list_ol);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_list_ol", options);
    type->fp_build_ = fa_list_ol_build;
    type->fp_ctor_ = (void*)fa_list_ol__New4_fn;
    type->fp_cctor_ = fa_list_ol__cctor_4_fn;
...
// public fa_list_ol() :8
void fa_list_ol__ctor_8_fn(fa_list_ol* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_list_ol__InitializeUX1_fn(fa_list_ol* __this)
{
    __this->InitializeUX1();
}

// public fa_list_ol New() :8
void fa_list_ol__New4_fn(fa_list_ol** __retval)
{
    *__retval = fa_list_ol::New4();
}

// public fa_list_ol() [instance] :8
void fa_list_ol::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_list_ol::InitializeUX1()
{
    uStackFrame __("fa_list_ol", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0CB"*/]);
    SourceLineNumber(380);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_list_ol New() [static] :8
fa_list_ol* fa_list_ol::New4()
{
    fa_list_ol* obj1 = (fa_list_ol*)uNew(fa_list_ol_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
