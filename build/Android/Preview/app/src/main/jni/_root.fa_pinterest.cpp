// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_pinterest.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_pinterest.h>
...
// public partial sealed class fa_pinterest :2
// {
// static fa_pinterest() :4
static void fa_pinterest__cctor_4_fn(uType* __type)
{
}

static void fa_pinterest_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\203\222");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_pinterest__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_pinterest_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_pinterest);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_pinterest", options);
    type->fp_build_ = fa_pinterest_build;
    type->fp_ctor_ = (void*)fa_pinterest__New4_fn;
    type->fp_cctor_ = fa_pinterest__cctor_4_fn;
...
// public fa_pinterest() :8
void fa_pinterest__ctor_8_fn(fa_pinterest* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_pinterest__InitializeUX1_fn(fa_pinterest* __this)
{
    __this->InitializeUX1();
}

// public fa_pinterest New() :8
void fa_pinterest__New4_fn(fa_pinterest** __retval)
{
    *__retval = fa_pinterest::New4();
}

// public fa_pinterest() [instance] :8
void fa_pinterest::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_pinterest::InitializeUX1()
{
    uStackFrame __("fa_pinterest", "InitializeUX()");
    Value(::STRINGS[0/*"\uF0D2"*/]);
    SourceLineNumber(461);
    SourceFileName(::STRINGS[1/*"Components/...*/]);
    Font(::g::MainView::fa());
}

// public fa_pinterest New() [static] :8
fa_pinterest* fa_pinterest::New4()
{
    fa_pinterest* obj1 = (fa_pinterest*)uNew(fa_pinterest_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
