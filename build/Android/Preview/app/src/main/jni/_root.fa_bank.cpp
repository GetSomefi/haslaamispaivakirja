// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_bank.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_bank.h>
...
// public partial sealed class fa_bank :2
// {
// static fa_bank() :4
static void fa_bank__cctor_4_fn(uType* __type)
{
}

static void fa_bank_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_bank__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_bank_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_bank);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_bank", options);
    type->fp_build_ = fa_bank_build;
    type->fp_ctor_ = (void*)fa_bank__New4_fn;
    type->fp_cctor_ = fa_bank__cctor_4_fn;
...
// public fa_bank() :8
void fa_bank__ctor_8_fn(fa_bank* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_bank__InitializeUX1_fn(fa_bank* __this)
{
    __this->InitializeUX1();
}

// public fa_bank New() :8
void fa_bank__New4_fn(fa_bank** __retval)
{
    *__retval = fa_bank::New4();
}

// public fa_bank() [instance] :8
void fa_bank::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void fa_bank::InitializeUX1()
{
    uStackFrame __("fa_bank", "InitializeUX()");
    Value(::STRINGS[0/*"\uF19C"*/]);
    SourceLineNumber(47);
...
// public fa_bank New() [static] :8
fa_bank* fa_bank::New4()
{
    fa_bank* obj1 = (fa_bank*)uNew(fa_bank_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
