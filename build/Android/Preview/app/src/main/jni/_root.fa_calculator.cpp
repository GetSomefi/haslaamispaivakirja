// This file was generated based on '/Users/petervirtanen/OneDrive/Fuse projektit/Häsläämispäiväkirja/build/Android/Preview/cache/ux15/fa_calculator.g.uno'.
// WARNING: Changes might be lost if you edit this file directly.

#include <_root.fa_calculator.h>
...
// public partial sealed class fa_calculator :2
// {
// static fa_calculator() :4
static void fa_calculator__cctor_4_fn(uType* __type)
{
}

static void fa_calculator_build(uType* type)
{
    ::STRINGS[0] = uString::Const("\357\207\254");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)fa_calculator__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* fa_calculator_typeof()
{
    ...
    options.ObjectSize = sizeof(fa_calculator);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("fa_calculator", options);
    type->fp_build_ = fa_calculator_build;
    type->fp_ctor_ = (void*)fa_calculator__New4_fn;
    type->fp_cctor_ = fa_calculator__cctor_4_fn;
...
// public fa_calculator() :8
void fa_calculator__ctor_8_fn(fa_calculator* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void fa_calculator__InitializeUX1_fn(fa_calculator* __this)
{
    __this->InitializeUX1();
}

// public fa_calculator New() :8
void fa_calculator__New4_fn(fa_calculator** __retval)
{
    *__retval = fa_calculator::New4();
}

// public fa_calculator() [instance] :8
void fa_calculator::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void fa_calculator::InitializeUX1()
{
    uStackFrame __("fa_calculator", "InitializeUX()");
    Value(::STRINGS[0/*"\uF1EC"*/]);
    SourceLineNumber(95);
...
// public fa_calculator New() [static] :8
fa_calculator* fa_calculator::New4()
{
    fa_calculator* obj1 = (fa_calculator*)uNew(fa_calculator_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
