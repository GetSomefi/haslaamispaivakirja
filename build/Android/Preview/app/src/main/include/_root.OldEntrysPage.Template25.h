...
namespace g{struct OldEntrysPage__Template25;}
...
struct OldEntrysPage__Template25 : ::g::Uno::UX::Template
{
    ...
    static OldEntrysPage__Template25* New2(::g::OldEntrysPage* parent, ::g::OldEntrysPage* parentInstance);
};
// }
