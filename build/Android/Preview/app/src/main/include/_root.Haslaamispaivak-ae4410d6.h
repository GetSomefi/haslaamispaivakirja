...
namespace g{struct Haslaamispaivakirja_BasicSwipeToggleBigTest_Sendable_Property;}
...
struct Haslaamispaivakirja_BasicSwipeToggleBigTest_Sendable_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::BasicSwipeToggleBigTest*> _obj;

    void ctor_3(::g::BasicSwipeToggleBigTest* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_BasicSwipeToggleBigTest_Sendable_Property* New1(::g::BasicSwipeToggleBigTest* obj, ::g::Uno::UX::Selector name);
};
// }
