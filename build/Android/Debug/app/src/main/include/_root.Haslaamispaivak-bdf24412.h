...
namespace g{struct Haslaamispaivakirja_FuseGesturesSwipeGesture_IsActive_Property;}
...
struct Haslaamispaivakirja_FuseGesturesSwipeGesture_IsActive_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Gestures::SwipeGesture*> _obj;

    void ctor_3(::g::Fuse::Gestures::SwipeGesture* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_FuseGesturesSwipeGesture_IsActive_Property* New1(::g::Fuse::Gestures::SwipeGesture* obj, ::g::Uno::UX::Selector name);
};
// }
