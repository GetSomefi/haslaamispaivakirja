...
namespace g{struct Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive;}
...
struct Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive_typeof()->Init(), _name_; }

    void ctor_1();
    static Haslaamispaivakirja_accessor_BasicSwipeToggle_IsActive* New1();
};
// }
