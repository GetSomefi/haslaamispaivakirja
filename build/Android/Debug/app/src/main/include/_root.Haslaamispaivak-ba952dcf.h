...
namespace g{struct Haslaamispaivakirja_listBtnButton_Text_Property;}
...
struct Haslaamispaivakirja_listBtnButton_Text_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::listBtn::Button*> _obj;

    void ctor_3(::g::listBtn::Button* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_listBtnButton_Text_Property* New1(::g::listBtn::Button* obj, ::g::Uno::UX::Selector name);
};
// }
