...
namespace g{struct OldEntrysPage__Template8;}
...
struct OldEntrysPage__Template8 : ::g::Uno::UX::Template
{
    ...
    static OldEntrysPage__Template8* New2(::g::OldEntrysPage* parent, ::g::OldEntrysPage* parentInstance);
};
// }
