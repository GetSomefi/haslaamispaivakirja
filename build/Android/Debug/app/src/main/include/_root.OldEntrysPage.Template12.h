...
namespace g{struct OldEntrysPage__Template12;}
...
struct OldEntrysPage__Template12 : ::g::Uno::UX::Template
{
    ...
    static OldEntrysPage__Template12* New2(::g::OldEntrysPage* parent, ::g::OldEntrysPage* parentInstance);
};
// }
