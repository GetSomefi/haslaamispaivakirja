...
namespace g{struct Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_PrimaryColor;}
...
struct Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_PrimaryColor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_PrimaryColor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_PrimaryColor_typeof()->Init(), _name_; }

    void ctor_1();
    static Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_PrimaryColor* New1();
};
// }
