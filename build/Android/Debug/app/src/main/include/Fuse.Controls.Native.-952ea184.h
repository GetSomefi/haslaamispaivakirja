// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.6.1/Android/Shape.uno.
...
void Shape__GetLayer_fn(::g::Java::Object* handle, int32_t* layer, ::g::Java::Object** __retval);
void Shape__MakeLayerDrawable_fn(::g::Java::Object* handle, int32_t* layerCount, ::g::Java::Object** __retval);
void Shape__OnShapeChanged_fn(Shape* __this);
void Shape__SelectOffset_fn(::g::Fuse::Drawing::GradientStop* a, ::g::Fuse::Drawing::GradientStop* b, int32_t* __retval);
...
void Shape__SetShapeDrawableColor_fn(::g::Java::Object* shapeDrawable, int32_t* r, int32_t* g, int32_t* b, int32_t* a, int32_t* opacity);
...
struct Shape : ::g::Fuse::Controls::Native::Android::View
{
    ...
    static ::g::Java::Object* GetLayer(::g::Java::Object* handle, int32_t layer);
    static ::g::Java::Object* MakeLayerDrawable(::g::Java::Object* handle, int32_t layerCount);
    static int32_t SelectOffset(::g::Fuse::Drawing::GradientStop* a, ::g::Fuse::Drawing::GradientStop* b);
    static void SetShapeDrawableColor(::g::Java::Object* shapeDrawable, int32_t r, int32_t g, int32_t b, int32_t a, int32_t opacity);
