...
namespace g{struct Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_SecondaryColor;}
...
struct Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_SecondaryColor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_SecondaryColor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_SecondaryColor_typeof()->Init(), _name_; }

    void ctor_1();
    static Häsläämispäiväkirja_accessor_BasicSwipeToggleBig_SecondaryColor* New1();
};
// }
