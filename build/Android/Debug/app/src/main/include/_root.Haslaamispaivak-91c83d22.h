...
namespace g{struct Haslaamispaivakirja_BasicSwipeToggleBig_Sendable_Property;}
...
struct Haslaamispaivakirja_BasicSwipeToggleBig_Sendable_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::BasicSwipeToggleBig*> _obj;

    void ctor_3(::g::BasicSwipeToggleBig* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_BasicSwipeToggleBig_Sendable_Property* New1(::g::BasicSwipeToggleBig* obj, ::g::Uno::UX::Selector name);
};
// }
