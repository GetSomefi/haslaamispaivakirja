...
namespace g{struct Haslaamispaivakirja_basicTextBoxFakeDropDown_Send_Property;}
...
struct Haslaamispaivakirja_basicTextBoxFakeDropDown_Send_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::basic::TextBoxFakeDropDown*> _obj;

    void ctor_3(::g::basic::TextBoxFakeDropDown* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_basicTextBoxFakeDropDown_Send_Property* New1(::g::basic::TextBoxFakeDropDown* obj, ::g::Uno::UX::Selector name);
};
// }
