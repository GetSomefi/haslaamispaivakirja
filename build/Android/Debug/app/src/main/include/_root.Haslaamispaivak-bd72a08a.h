...
namespace g{struct Haslaamispaivakirja_textDropDown_toimimaton_Send_Property;}
...
struct Haslaamispaivakirja_textDropDown_toimimaton_Send_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::textDropDown_toimimaton*> _obj;
};
// }
