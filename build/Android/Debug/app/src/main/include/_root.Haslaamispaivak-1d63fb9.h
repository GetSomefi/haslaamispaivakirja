...
namespace g{struct Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor;}

namespace g{

// internal sealed class Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor :21
// {
...
struct Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor_typeof()->Init(), _name_; }

    void ctor_1();
    static Haslaamispaivakirja_accessor_BasicSwipeToggle_PrimaryColor* New1();
};
// }
