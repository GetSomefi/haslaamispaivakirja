...
namespace g{struct OldEntrysPage__Template45;}
...
struct OldEntrysPage__Template45 : ::g::Uno::UX::Template
{
    ...
    static OldEntrysPage__Template45* New2(::g::OldEntrysPage* parent, ::g::OldEntrysPage* parentInstance);
};
// }
