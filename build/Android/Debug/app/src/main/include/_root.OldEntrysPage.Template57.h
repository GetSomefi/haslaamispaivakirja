...
namespace g{struct OldEntrysPage__Template57;}
...
struct OldEntrysPage__Template57 : ::g::Uno::UX::Template
{
    ...
    static OldEntrysPage__Template57* New2(::g::OldEntrysPage* parent, ::g::OldEntrysPage* parentInstance);
};
// }
