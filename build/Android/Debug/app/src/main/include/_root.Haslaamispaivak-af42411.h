...
namespace g{struct Haslaamispaivakirja_accessor_basic_TextBoxFakeDropDown_PlaceHolderColor;}
...
struct Haslaamispaivakirja_accessor_basic_TextBoxFakeDropDown_PlaceHolderColor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return Haslaamispaivakirja_accessor_basic_TextBoxFakeDropDown_PlaceHolderColor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return Haslaamispaivakirja_accessor_basic_TextBoxFakeDropDown_PlaceHolderColor_typeof()->Init(), _name_; }

    void ctor_1();
    static Haslaamispaivakirja_accessor_basic_TextBoxFakeDropDown_PlaceHolderColor* New1();
};
// }
