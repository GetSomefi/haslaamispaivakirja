...
namespace g{struct Haslaamispaivakirja_textDropDown_dropDownList_Property;}
...
struct Haslaamispaivakirja_textDropDown_dropDownList_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::textDropDown*> _obj;

    void ctor_3(::g::textDropDown* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_textDropDown_dropDownList_Property* New1(::g::textDropDown* obj, ::g::Uno::UX::Selector name);
};
// }
