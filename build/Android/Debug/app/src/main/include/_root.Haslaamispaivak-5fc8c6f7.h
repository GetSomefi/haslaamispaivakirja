...
namespace g{struct Haslaamispaivakirja_FuseAnimationsChangefloat4_Value_Property;}
...
struct Haslaamispaivakirja_FuseAnimationsChangefloat4_Value_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Animations::Change*> _obj;

    void ctor_3(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
    static Haslaamispaivakirja_FuseAnimationsChangefloat4_Value_Property* New1(::g::Fuse::Animations::Change* obj, ::g::Uno::UX::Selector name);
};
// }
