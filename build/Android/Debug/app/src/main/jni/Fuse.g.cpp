...
static void Node__cctor__fn(uType* __type)
{
    ...
    Node::_dataListeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[24/*string*/], ::TYPES[83/*Uno.Collections.List`1*/]->MakeType(::TYPES[6/*Fuse.Node.IDataListener*/], NULL), NULL)));
...
void Node::AddDataListener(int32_t type, uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[83/*Uno.Collections.List`1*/]->MakeType(::TYPES[6/*Fuse.Node.IDataListener*/], NULL));
