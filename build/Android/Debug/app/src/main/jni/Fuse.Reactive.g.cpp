...
static void BinaryOperator_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.9.0/BinaryOperator.uno");
...
{
    uString* r = ::g::Uno::String::op_Addition2(__this->Name(), ::STRINGS[48/*"("*/]);
    ...
    r = ::g::Uno::String::op_Addition2(r, ::STRINGS[49/*")"*/]);
...
{
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.9.0/FuseJS/DebugLog.uno");
    ...
    ::STRINGS[16] = uString::Const("warn");
    ::STRINGS[17] = uString::Const("info");
    ::STRINGS[18] = uString::Const("error");
    ::STRINGS[19] = uString::Const("dir");
    ::STRINGS[20] = uString::Const("console");
    ::STRINGS[21] = uString::Const("fuse-builtins");
    ::STRINGS[22] = uString::Const("(function(obj) {\tif (obj instanceof Error) return obj.stack;\treturn '' + obj;})");
...
uObject* Console::Dir(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(builder->ToString(), 0, ::STRINGS[4/*"/usr/local/...*/], 104);
    return NULL;
}
...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int32_t maxDepth, int32_t indent)
{
    ...
    if (uIs(obj, ::TYPES[10/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[11/*"Array["*/], uBox<int32_t>(::TYPES[4/*int*/], uPtr(a)->Length())), ::STRINGS[12/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[9/*""*/], uBox<int32_t>(::TYPES[4/*int*/], i)), ::STRINGS[10/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[15/*"log"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[16/*"warn"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)Console__Warn_fn));
    console->Item(::STRINGS[17/*"info"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)Console__Info_fn));
    console->Item(::STRINGS[18/*"error"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)Console__Error_fn));
    console->Item(::STRINGS[19/*"dir"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
uString* Console::ToString(::g::Fuse::Scripting::Context* context, uObject* obj)
{
    if (Console::_toStringFunction_ == NULL)
        Console::_toStringFunction_ = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[21/*"fuse-builtins"*/], ::STRINGS[22/*"(function(o...*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[23/*"'"*/], ::g::Uno::Object::ToString(uPtr(__this->Value()))), ::STRINGS[23/*"'"*/]), void();
}
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[24/*"{"*/], __this->Key()), ::STRINGS[25/*"}"*/]), void();
}
...
{
    ::STRINGS[9] = uString::Const("");
    ::STRINGS[26] = uString::Const("Cannot bind '");
    ::STRINGS[27] = uString::Const("' to property '");
    ::STRINGS[28] = uString::Const("'. The observable must contain exactly one ");
    ::STRINGS[29] = uString::Const(".");
    ::STRINGS[30] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.9.0/DataBinding.uno");
    ::STRINGS[31] = uString::Const("InvalidListOperation");
    ::STRINGS[32] = uString::Const("TryPushAsMarshalledValue");
    ::STRINGS[33] = uString::Const("number");
    ::STRINGS[34] = uString::Const("string");
    ::STRINGS[35] = uString::Const("value that can be converted to type ");
    ::TYPES[1] = ::g::Uno::IDisposable_typeof();
...
{
    if (Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(Parent(), &_busyTask, 0, ::STRINGS[9/*""*/]);
}
...
{
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[26/*"Cannot bind '"*/], Key()), ::STRINGS[27/*"' to proper...*/]), ::g::Uno::UX::Selector__op_Implicit2(uPtr(Target())->Name())), ::STRINGS[28/*"'. The obse...*/]), DataBinding::TypeToJSName(uPtr(Target())->PropertyType())), ::STRINGS[29/*"."*/]), this, ::STRINGS[30/*"/usr/local/...*/], 90, ::STRINGS[31/*"InvalidList...*/], NULL);
}
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[30/*"/usr/local/...*/], 327, ::STRINGS[32/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
uString* DataBinding::TypeToJSName(uType* t)
{
    if ((::g::Uno::Type::op_Equality(t, ::TYPES[4/*int*/]) || ::g::Uno::Type::op_Equality(t, ::TYPES[5/*float*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[6/*double*/]))
        return ::STRINGS[33/*"number"*/];

    if (::g::Uno::Type::op_Equality(t, ::TYPES[0/*string*/]))
        return ::STRINGS[34/*"string"*/];

    return ::g::Uno::String::op_Addition2(::STRINGS[35/*"value that ...*/], ::g::Uno::Type::FullName(uPtr(t)));
}
// }
...
void DataSubscription::FindData()
{
    ...
    {
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[24/*"{"*/], _key), ::STRINGS[36/*"} not found...*/]), _origin);
...
{
    ::STRINGS[37] = uString::Const("debug_log");
    ::STRINGS[5] = uString::Const("null");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.9.0/FuseJS/DebugLog.uno");
    ::TYPES[11] = ::g::Fuse::Scripting::Callback_typeof();
    type->SetDependencies(
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[37/*"debug_log"*/], uDelegate::New(::TYPES[11/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
{
    for (int32_t i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log3((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[5/*"null"*/], 0, ::STRINGS[4/*"/usr/local/...*/], 17);
...
{
    DeviceCaps::NameIsAndroid_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[38/*"isAndroid"*/]);
    DeviceCaps::NameIsIOS_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[39/*"isIOS"*/]);
    DeviceCaps::NameIsMac_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[40/*"isMac"*/]);
    DeviceCaps::NameIsWindows_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[41/*"isWindows"*/]);
    DeviceCaps::NameIsPreview_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[42/*"isPreview"*/]);
    DeviceCaps::NameOSVersion_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[43/*"osVersion"*/]);
    DeviceCaps::NameAPILevel_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[44/*"apiLevel"*/]);
    DeviceCaps::Device_ = DeviceCaps::New3();
}

static void DeviceCaps_build(uType* type)
{
    ::STRINGS[38] = uString::Const("isAndroid");
    ::STRINGS[39] = uString::Const("isIOS");
    ::STRINGS[40] = uString::Const("isMac");
    ::STRINGS[41] = uString::Const("isWindows");
    ::STRINGS[42] = uString::Const("isPreview");
    ::STRINGS[43] = uString::Const("osVersion");
    ::STRINGS[44] = uString::Const("apiLevel");
    type->SetDependencies(
...
{
    ctor_1();
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameIsAndroid_), uBox(::TYPES[7/*bool*/], true));
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameIsIOS_), uBox(::TYPES[7/*bool*/], false));
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameIsMac_), uBox(::TYPES[7/*bool*/], false));
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameIsWindows_), uBox(::TYPES[7/*bool*/], false));
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameIsPreview_), uBox(::TYPES[7/*bool*/], false));
    ...
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(Props()), ::g::Uno::UX::Selector__op_Implicit2(DeviceCaps::NameAPILevel_), uBox<int32_t>(::TYPES[4/*int*/], ::g::Fuse::Platform::SystemUI::APILevel()));
}
...
{
    ::STRINGS[46] = uString::Const("May not be null: listener");
    ::STRINGS[47] = uString::Const("May not be null: source");
    ::TYPES[13] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
{
    uString* ind1;
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[48/*"("*/], __this->Left()), ::STRINGS[13/*" "*/]), (ind1 = __this->Name(), (ind1 != NULL) ? ind1 : (uString*)__this->Symbol())), ::STRINGS[13/*" "*/]), __this->Right()), ::STRINGS[49/*")"*/]), void();
}
...
{
    if (__this->Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(__this->Parent(), &__this->_busyTask, 0, ::STRINGS[9/*""*/]);
}
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("too many parameters for "), ::g::Uno::UX::Selector__op_Implicit2(__this->_item)), __this, ::STRINGS[51/*"/usr/local/...*/], 34, uString::Const("Subscribe"), NULL);
        return *__retval = NULL, void();
    }
...
static void InstantiatorFunction__InstantiatorSubscription_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.9.0/InstantiatorFunction.uno");
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"invalid sea...*/], this, ::STRINGS[51/*"/usr/local/...*/], 102, ::STRINGS[52/*"OnNewNode"*/], NULL);
    ...
    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Could not f...*/], this, ::STRINGS[51/*"/usr/local/...*/], 110, ::STRINGS[52/*"OnNewNode"*/], NULL);
        ::g::Fuse::Reactive::IListener::OnLostData(uInterface(uPtr(_listener), ::TYPES[13/*Fuse.Reactive.IListener*/]), (uObject*)_expr);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[54/*"Unable to r...*/], this, ::STRINGS[51/*"/usr/local/...*/], 122, ::STRINGS[52/*"OnNewNode"*/]);
        ::g::Fuse::Reactive::IListener::OnLostData(uInterface(uPtr(_listener), ::TYPES[13/*Fuse.Reactive.IListener*/]), (uObject*)_expr);
        return;
    }
...
void LookUp__LookUpSubscription::ResultChanged()
{
    ...
    if (obj != NULL)
    {
        ...
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[35/*Fuse.IObject*/]), key))
            ...
            SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"Object does...*/], key), ::STRINGS[23/*"'"*/]), (uObject*)uPtr(_lu)->Index());
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Object::ToString(uPtr(__this->BaseObject())), ::STRINGS[29/*"."*/]), __this->Name()), void();
}
...
{
    ::g::Fuse::Reactive::Expression* ret1;
    uString* q = ::g::Uno::String::op_Addition2(funcName, ::STRINGS[48/*"("*/]);
    ...
    q = ::g::Uno::String::op_Addition2(q, ::STRINGS[49/*")"*/]);
    return q;
}
// }
...
{
    ErrorMessage((msg != NULL) ? msg : ::STRINGS[18/*"error"*/]);
}
